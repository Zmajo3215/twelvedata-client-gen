...
func NewGetTimeSeriesRvol200ResponseMetaIndicator() *GetTimeSeriesRvol200ResponseMetaIndicator {
...
func (o *GetTimeSeriesRvol200ResponseMetaIndicator) HasName() bool {
	if o != nil && !IsNil(o.Name) {
		return true
	}
...
func (o *GetTimeSeriesRvol200ResponseMetaIndicator) HasTimePeriod() bool {
	if o != nil && !IsNil(o.TimePeriod) {
		return true
	}
