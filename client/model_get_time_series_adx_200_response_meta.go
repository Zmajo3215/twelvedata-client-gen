...
// checks if the GetTimeSeriesAdx200ResponseMeta type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetTimeSeriesAdx200ResponseMeta{}

// GetTimeSeriesAdx200ResponseMeta Json object with request general information
type GetTimeSeriesAdx200ResponseMeta struct {
	...
	Indicator *GetTimeSeriesAdx200ResponseMetaIndicator `json:"indicator,omitempty"`
}
...
func NewGetTimeSeriesAdx200ResponseMeta() *GetTimeSeriesAdx200ResponseMeta {
	this := GetTimeSeriesAdx200ResponseMeta{}
	return &this
}
...
func (o *GetTimeSeriesAdx200ResponseMeta) HasSymbol() bool {
	if o != nil && !IsNil(o.Symbol) {
		return true
	}
...
func (o *GetTimeSeriesAdx200ResponseMeta) HasInterval() bool {
	if o != nil && !IsNil(o.Interval) {
		return true
	}
...
func (o *GetTimeSeriesAdx200ResponseMeta) HasCurrency() bool {
	if o != nil && !IsNil(o.Currency) {
		return true
	}
...
func (o *GetTimeSeriesAdx200ResponseMeta) HasExchangeTimezone() bool {
	if o != nil && !IsNil(o.ExchangeTimezone) {
		return true
	}
...
func (o *GetTimeSeriesAdx200ResponseMeta) HasExchange() bool {
	if o != nil && !IsNil(o.Exchange) {
		return true
	}
...
func (o *GetTimeSeriesAdx200ResponseMeta) HasMicCode() bool {
	if o != nil && !IsNil(o.MicCode) {
		return true
	}
...
func (o *GetTimeSeriesAdx200ResponseMeta) HasType() bool {
	if o != nil && !IsNil(o.Type) {
		return true
	}
...
func (o *GetTimeSeriesAdx200ResponseMeta) GetIndicator() GetTimeSeriesAdx200ResponseMetaIndicator {
	if o == nil || IsNil(o.Indicator) {
		var ret GetTimeSeriesAdx200ResponseMetaIndicator
		return ret
	}
	return *o.Indicator
}
...
func (o *GetTimeSeriesAdx200ResponseMeta) HasIndicator() bool {
	if o != nil && !IsNil(o.Indicator) {
		return true
	}
...
// SetIndicator gets a reference to the given GetTimeSeriesAdx200ResponseMetaIndicator and assigns it to the Indicator field.
func (o *GetTimeSeriesAdx200ResponseMeta) SetIndicator(v GetTimeSeriesAdx200ResponseMetaIndicator) {
	o.Indicator = &v
}

func (o GetTimeSeriesAdx200ResponseMeta) MarshalJSON() ([]byte, error) {
...
func (o GetTimeSeriesAdx200ResponseMeta) ToMap() (map[string]interface{}, error) {
...
type NullableGetTimeSeriesAdx200ResponseMeta struct {
	value *GetTimeSeriesAdx200ResponseMeta
	isSet bool
}

func (v NullableGetTimeSeriesAdx200ResponseMeta) Get() *GetTimeSeriesAdx200ResponseMeta {
	return v.value
}

func (v *NullableGetTimeSeriesAdx200ResponseMeta) Set(val *GetTimeSeriesAdx200ResponseMeta) {
	v.value = val
	v.isSet = true
}

func (v NullableGetTimeSeriesAdx200ResponseMeta) IsSet() bool {
	return v.isSet
}

func (v *NullableGetTimeSeriesAdx200ResponseMeta) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetTimeSeriesAdx200ResponseMeta(val *GetTimeSeriesAdx200ResponseMeta) *NullableGetTimeSeriesAdx200ResponseMeta {
	return &NullableGetTimeSeriesAdx200ResponseMeta{value: val, isSet: true}
}

func (v NullableGetTimeSeriesAdx200ResponseMeta) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetTimeSeriesAdx200ResponseMeta) UnmarshalJSON(src []byte) error {
	v.isSet = true
