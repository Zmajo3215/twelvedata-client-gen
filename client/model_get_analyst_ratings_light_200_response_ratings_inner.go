...
func NewGetAnalystRatingsLight200ResponseRatingsInner() *GetAnalystRatingsLight200ResponseRatingsInner {
...
func (o *GetAnalystRatingsLight200ResponseRatingsInner) HasDate() bool {
	if o != nil && !IsNil(o.Date) {
		return true
	}
...
func (o *GetAnalystRatingsLight200ResponseRatingsInner) HasFirm() bool {
	if o != nil && !IsNil(o.Firm) {
		return true
	}
