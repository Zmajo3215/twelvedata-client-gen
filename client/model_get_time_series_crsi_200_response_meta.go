...
// checks if the GetTimeSeriesCrsi200ResponseMeta type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetTimeSeriesCrsi200ResponseMeta{}

// GetTimeSeriesCrsi200ResponseMeta Json object with request general information
type GetTimeSeriesCrsi200ResponseMeta struct {
	...
	Indicator *GetTimeSeriesCrsi200ResponseMetaIndicator `json:"indicator,omitempty"`
}
...
func NewGetTimeSeriesCrsi200ResponseMeta() *GetTimeSeriesCrsi200ResponseMeta {
	this := GetTimeSeriesCrsi200ResponseMeta{}
	return &this
}
...
func (o *GetTimeSeriesCrsi200ResponseMeta) GetIndicator() GetTimeSeriesCrsi200ResponseMetaIndicator {
	if o == nil || IsNil(o.Indicator) {
		var ret GetTimeSeriesCrsi200ResponseMetaIndicator
		return ret
	}
	return *o.Indicator
}
...
// SetIndicator gets a reference to the given GetTimeSeriesCrsi200ResponseMetaIndicator and assigns it to the Indicator field.
func (o *GetTimeSeriesCrsi200ResponseMeta) SetIndicator(v GetTimeSeriesCrsi200ResponseMetaIndicator) {
	o.Indicator = &v
}

func (o GetTimeSeriesCrsi200ResponseMeta) MarshalJSON() ([]byte, error) {
...
func (o GetTimeSeriesCrsi200ResponseMeta) ToMap() (map[string]interface{}, error) {
...
type NullableGetTimeSeriesCrsi200ResponseMeta struct {
	value *GetTimeSeriesCrsi200ResponseMeta
	isSet bool
}

func (v NullableGetTimeSeriesCrsi200ResponseMeta) Get() *GetTimeSeriesCrsi200ResponseMeta {
	return v.value
}

func (v *NullableGetTimeSeriesCrsi200ResponseMeta) Set(val *GetTimeSeriesCrsi200ResponseMeta) {
	v.value = val
	v.isSet = true
}

func (v NullableGetTimeSeriesCrsi200ResponseMeta) IsSet() bool {
	return v.isSet
}

func (v *NullableGetTimeSeriesCrsi200ResponseMeta) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetTimeSeriesCrsi200ResponseMeta(val *GetTimeSeriesCrsi200ResponseMeta) *NullableGetTimeSeriesCrsi200ResponseMeta {
	return &NullableGetTimeSeriesCrsi200ResponseMeta{value: val, isSet: true}
}

func (v NullableGetTimeSeriesCrsi200ResponseMeta) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetTimeSeriesCrsi200ResponseMeta) UnmarshalJSON(src []byte) error {
	v.isSet = true
