...
type GetTimeSeriesPivotPointsHL200ResponseValuesInner struct {
	...
	PivotPointH *int64 `json:"pivot_point_h,omitempty"`
	// `1` if it is a low pivot point, otherwise `0`
	PivotPointL *int64 `json:"pivot_point_l,omitempty"`
}
...
// GetPivotPointH returns the PivotPointH field value if set, zero value otherwise.
func (o *GetTimeSeriesPivotPointsHL200ResponseValuesInner) GetPivotPointH() int64 {
	if o == nil || IsNil(o.PivotPointH) {
		var ret int64
		return ret
	}
...
// GetPivotPointHOk returns a tuple with the PivotPointH field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// SetPivotPointH gets a reference to the given int64 and assigns it to the PivotPointH field.
func (o *GetTimeSeriesPivotPointsHL200ResponseValuesInner) SetPivotPointH(v int64) {
	o.PivotPointH = &v
}

// GetPivotPointL returns the PivotPointL field value if set, zero value otherwise.
func (o *GetTimeSeriesPivotPointsHL200ResponseValuesInner) GetPivotPointL() int64 {
	if o == nil || IsNil(o.PivotPointL) {
		var ret int64
		return ret
	}
...
// GetPivotPointLOk returns a tuple with the PivotPointL field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// SetPivotPointL gets a reference to the given int64 and assigns it to the PivotPointL field.
...
func (o GetTimeSeriesPivotPointsHL200ResponseValuesInner) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.PivotPointH) {
		toSerialize["pivot_point_h"] = o.PivotPointH
	}
	if !IsNil(o.PivotPointL) {
