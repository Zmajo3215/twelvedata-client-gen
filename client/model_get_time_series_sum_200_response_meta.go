...
// checks if the GetTimeSeriesSum200ResponseMeta type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetTimeSeriesSum200ResponseMeta{}

// GetTimeSeriesSum200ResponseMeta Json object with request general information
type GetTimeSeriesSum200ResponseMeta struct {
	...
	Indicator *GetTimeSeriesSum200ResponseMetaIndicator `json:"indicator,omitempty"`
}
...
func NewGetTimeSeriesSum200ResponseMeta() *GetTimeSeriesSum200ResponseMeta {
	this := GetTimeSeriesSum200ResponseMeta{}
	return &this
}
...
func (o *GetTimeSeriesSum200ResponseMeta) HasSymbol() bool {
	if o != nil && !IsNil(o.Symbol) {
		return true
	}
...
func (o *GetTimeSeriesSum200ResponseMeta) HasInterval() bool {
	if o != nil && !IsNil(o.Interval) {
		return true
	}
...
func (o *GetTimeSeriesSum200ResponseMeta) HasCurrency() bool {
	if o != nil && !IsNil(o.Currency) {
		return true
	}
...
func (o *GetTimeSeriesSum200ResponseMeta) HasExchangeTimezone() bool {
	if o != nil && !IsNil(o.ExchangeTimezone) {
		return true
	}
...
func (o *GetTimeSeriesSum200ResponseMeta) HasExchange() bool {
	if o != nil && !IsNil(o.Exchange) {
		return true
	}
...
func (o *GetTimeSeriesSum200ResponseMeta) HasMicCode() bool {
	if o != nil && !IsNil(o.MicCode) {
		return true
	}
...
func (o *GetTimeSeriesSum200ResponseMeta) HasType() bool {
	if o != nil && !IsNil(o.Type) {
		return true
	}
...
func (o *GetTimeSeriesSum200ResponseMeta) GetIndicator() GetTimeSeriesSum200ResponseMetaIndicator {
	if o == nil || IsNil(o.Indicator) {
		var ret GetTimeSeriesSum200ResponseMetaIndicator
		return ret
	}
	return *o.Indicator
}
...
func (o *GetTimeSeriesSum200ResponseMeta) HasIndicator() bool {
	if o != nil && !IsNil(o.Indicator) {
		return true
	}
...
// SetIndicator gets a reference to the given GetTimeSeriesSum200ResponseMetaIndicator and assigns it to the Indicator field.
func (o *GetTimeSeriesSum200ResponseMeta) SetIndicator(v GetTimeSeriesSum200ResponseMetaIndicator) {
	o.Indicator = &v
}

func (o GetTimeSeriesSum200ResponseMeta) MarshalJSON() ([]byte, error) {
...
func (o GetTimeSeriesSum200ResponseMeta) ToMap() (map[string]interface{}, error) {
...
type NullableGetTimeSeriesSum200ResponseMeta struct {
	value *GetTimeSeriesSum200ResponseMeta
	isSet bool
}

func (v NullableGetTimeSeriesSum200ResponseMeta) Get() *GetTimeSeriesSum200ResponseMeta {
	return v.value
}

func (v *NullableGetTimeSeriesSum200ResponseMeta) Set(val *GetTimeSeriesSum200ResponseMeta) {
	v.value = val
	v.isSet = true
}

func (v NullableGetTimeSeriesSum200ResponseMeta) IsSet() bool {
	return v.isSet
}

func (v *NullableGetTimeSeriesSum200ResponseMeta) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetTimeSeriesSum200ResponseMeta(val *GetTimeSeriesSum200ResponseMeta) *NullableGetTimeSeriesSum200ResponseMeta {
	return &NullableGetTimeSeriesSum200ResponseMeta{value: val, isSet: true}
}

func (v NullableGetTimeSeriesSum200ResponseMeta) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetTimeSeriesSum200ResponseMeta) UnmarshalJSON(src []byte) error {
	v.isSet = true
