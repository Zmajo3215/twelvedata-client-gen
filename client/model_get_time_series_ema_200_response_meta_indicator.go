...
// checks if the GetTimeSeriesEma200ResponseMetaIndicator type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetTimeSeriesEma200ResponseMetaIndicator{}

// GetTimeSeriesEma200ResponseMetaIndicator Technical indicator information
type GetTimeSeriesEma200ResponseMetaIndicator struct {
...
func NewGetTimeSeriesEma200ResponseMetaIndicator() *GetTimeSeriesEma200ResponseMetaIndicator {
	this := GetTimeSeriesEma200ResponseMetaIndicator{}
	return &this
}
...
func (o *GetTimeSeriesEma200ResponseMetaIndicator) HasName() bool {
	if o != nil && !IsNil(o.Name) {
		return true
	}
...
func (o *GetTimeSeriesEma200ResponseMetaIndicator) HasSeriesType() bool {
	if o != nil && !IsNil(o.SeriesType) {
		return true
	}
...
func (o *GetTimeSeriesEma200ResponseMetaIndicator) HasTimePeriod() bool {
	if o != nil && !IsNil(o.TimePeriod) {
		return true
	}
...
func (o GetTimeSeriesEma200ResponseMetaIndicator) MarshalJSON() ([]byte, error) {
...
func (o GetTimeSeriesEma200ResponseMetaIndicator) ToMap() (map[string]interface{}, error) {
...
type NullableGetTimeSeriesEma200ResponseMetaIndicator struct {
	value *GetTimeSeriesEma200ResponseMetaIndicator
	isSet bool
}

func (v NullableGetTimeSeriesEma200ResponseMetaIndicator) Get() *GetTimeSeriesEma200ResponseMetaIndicator {
	return v.value
}

func (v *NullableGetTimeSeriesEma200ResponseMetaIndicator) Set(val *GetTimeSeriesEma200ResponseMetaIndicator) {
	v.value = val
	v.isSet = true
}

func (v NullableGetTimeSeriesEma200ResponseMetaIndicator) IsSet() bool {
	return v.isSet
}

func (v *NullableGetTimeSeriesEma200ResponseMetaIndicator) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetTimeSeriesEma200ResponseMetaIndicator(val *GetTimeSeriesEma200ResponseMetaIndicator) *NullableGetTimeSeriesEma200ResponseMetaIndicator {
	return &NullableGetTimeSeriesEma200ResponseMetaIndicator{value: val, isSet: true}
}

func (v NullableGetTimeSeriesEma200ResponseMetaIndicator) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetTimeSeriesEma200ResponseMetaIndicator) UnmarshalJSON(src []byte) error {
	v.isSet = true
