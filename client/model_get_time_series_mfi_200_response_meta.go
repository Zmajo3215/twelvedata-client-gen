...
type GetTimeSeriesMfi200ResponseMeta struct {
	...
	Indicator *GetTimeSeriesMfi200ResponseMetaIndicator `json:"indicator,omitempty"`
}
...
// SetIndicator gets a reference to the given GetTimeSeriesMfi200ResponseMetaIndicator and assigns it to the Indicator field.
