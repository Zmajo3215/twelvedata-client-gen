...
type GetTimeSeriesMinusDM200Response struct {
	Meta *GetTimeSeriesMinusDM200ResponseMeta `json:"meta,omitempty"`
	// Array of time series data points
	Values []GetTimeSeriesMinusDM200ResponseValuesInner `json:"values,omitempty"`
	// Response status
...
func NewGetTimeSeriesMinusDM200Response() *GetTimeSeriesMinusDM200Response {
...
func (o *GetTimeSeriesMinusDM200Response) HasMeta() bool {
	if o != nil && !IsNil(o.Meta) {
		return true
	}
...
// SetMeta gets a reference to the given GetTimeSeriesMinusDM200ResponseMeta and assigns it to the Meta field.
...
func (o *GetTimeSeriesMinusDM200Response) HasValues() bool {
	if o != nil && !IsNil(o.Values) {
		return true
	}
...
// SetValues gets a reference to the given []GetTimeSeriesMinusDM200ResponseValuesInner and assigns it to the Values field.
...
func (o *GetTimeSeriesMinusDM200Response) HasStatus() bool {
	if o != nil && !IsNil(o.Status) {
		return true
	}
