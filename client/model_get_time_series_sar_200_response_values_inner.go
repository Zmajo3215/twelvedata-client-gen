...
func NewGetTimeSeriesSar200ResponseValuesInner() *GetTimeSeriesSar200ResponseValuesInner {
...
func (o *GetTimeSeriesSar200ResponseValuesInner) HasDatetime() bool {
	if o != nil && !IsNil(o.Datetime) {
		return true
	}
...
func (o *GetTimeSeriesSar200ResponseValuesInner) HasSar() bool {
	if o != nil && !IsNil(o.Sar) {
		return true
	}
...
// SetSar gets a reference to the given string and assigns it to the Sar field.
