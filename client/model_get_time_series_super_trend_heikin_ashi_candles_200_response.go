...
type GetTimeSeriesSuperTrendHeikinAshiCandles200Response struct {
	Meta *GetTimeSeriesSuperTrendHeikinAshiCandles200ResponseMeta `json:"meta,omitempty"`
	// Array of time series data points
	Values []GetTimeSeriesSuperTrendHeikinAshiCandles200ResponseValuesInner `json:"values,omitempty"`
	// Response status
...
func NewGetTimeSeriesSuperTrendHeikinAshiCandles200Response() *GetTimeSeriesSuperTrendHeikinAshiCandles200Response {
...
func (o *GetTimeSeriesSuperTrendHeikinAshiCandles200Response) HasMeta() bool {
	if o != nil && !IsNil(o.Meta) {
		return true
	}
...
// SetMeta gets a reference to the given GetTimeSeriesSuperTrendHeikinAshiCandles200ResponseMeta and assigns it to the Meta field.
...
func (o *GetTimeSeriesSuperTrendHeikinAshiCandles200Response) HasValues() bool {
	if o != nil && !IsNil(o.Values) {
		return true
	}
...
// SetValues gets a reference to the given []GetTimeSeriesSuperTrendHeikinAshiCandles200ResponseValuesInner and assigns it to the Values field.
...
func (o *GetTimeSeriesSuperTrendHeikinAshiCandles200Response) HasStatus() bool {
	if o != nil && !IsNil(o.Status) {
		return true
	}
