...
func NewGetTimeSeriesBop200ResponseValuesInner() *GetTimeSeriesBop200ResponseValuesInner {
...
func (o *GetTimeSeriesBop200ResponseValuesInner) HasDatetime() bool {
	if o != nil && !IsNil(o.Datetime) {
		return true
	}
...
// GetBop returns the Bop field value if set, zero value otherwise.
func (o *GetTimeSeriesBop200ResponseValuesInner) GetBop() string {
	if o == nil || IsNil(o.Bop) {
		var ret string
		return ret
	}
	return *o.Bop
...
// GetBopOk returns a tuple with the Bop field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// HasBop returns a boolean if a field has been set.
func (o *GetTimeSeriesBop200ResponseValuesInner) HasBop() bool {
	if o != nil && !IsNil(o.Bop) {
		return true
	}
...
// SetBop gets a reference to the given string and assigns it to the Bop field.
