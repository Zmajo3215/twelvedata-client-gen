...
// checks if the GetTimeSeriesMult200ResponseMeta type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetTimeSeriesMult200ResponseMeta{}

// GetTimeSeriesMult200ResponseMeta Json object with request general information
type GetTimeSeriesMult200ResponseMeta struct {
	...
	Indicator *GetTimeSeriesMult200ResponseMetaIndicator `json:"indicator,omitempty"`
}
...
func NewGetTimeSeriesMult200ResponseMeta() *GetTimeSeriesMult200ResponseMeta {
	this := GetTimeSeriesMult200ResponseMeta{}
	return &this
}
...
func (o *GetTimeSeriesMult200ResponseMeta) HasSymbol() bool {
	if o != nil && !IsNil(o.Symbol) {
		return true
	}
...
func (o *GetTimeSeriesMult200ResponseMeta) HasInterval() bool {
	if o != nil && !IsNil(o.Interval) {
		return true
	}
...
func (o *GetTimeSeriesMult200ResponseMeta) HasCurrency() bool {
	if o != nil && !IsNil(o.Currency) {
		return true
	}
...
func (o *GetTimeSeriesMult200ResponseMeta) HasExchangeTimezone() bool {
	if o != nil && !IsNil(o.ExchangeTimezone) {
		return true
	}
...
func (o *GetTimeSeriesMult200ResponseMeta) HasExchange() bool {
	if o != nil && !IsNil(o.Exchange) {
		return true
	}
...
func (o *GetTimeSeriesMult200ResponseMeta) HasMicCode() bool {
	if o != nil && !IsNil(o.MicCode) {
		return true
	}
...
func (o *GetTimeSeriesMult200ResponseMeta) HasType() bool {
	if o != nil && !IsNil(o.Type) {
		return true
	}
...
func (o *GetTimeSeriesMult200ResponseMeta) GetIndicator() GetTimeSeriesMult200ResponseMetaIndicator {
	if o == nil || IsNil(o.Indicator) {
		var ret GetTimeSeriesMult200ResponseMetaIndicator
		return ret
	}
	return *o.Indicator
}
...
func (o *GetTimeSeriesMult200ResponseMeta) HasIndicator() bool {
	if o != nil && !IsNil(o.Indicator) {
		return true
	}
...
// SetIndicator gets a reference to the given GetTimeSeriesMult200ResponseMetaIndicator and assigns it to the Indicator field.
func (o *GetTimeSeriesMult200ResponseMeta) SetIndicator(v GetTimeSeriesMult200ResponseMetaIndicator) {
	o.Indicator = &v
}

func (o GetTimeSeriesMult200ResponseMeta) MarshalJSON() ([]byte, error) {
...
func (o GetTimeSeriesMult200ResponseMeta) ToMap() (map[string]interface{}, error) {
...
type NullableGetTimeSeriesMult200ResponseMeta struct {
	value *GetTimeSeriesMult200ResponseMeta
	isSet bool
}

func (v NullableGetTimeSeriesMult200ResponseMeta) Get() *GetTimeSeriesMult200ResponseMeta {
	return v.value
}

func (v *NullableGetTimeSeriesMult200ResponseMeta) Set(val *GetTimeSeriesMult200ResponseMeta) {
	v.value = val
	v.isSet = true
}

func (v NullableGetTimeSeriesMult200ResponseMeta) IsSet() bool {
	return v.isSet
}

func (v *NullableGetTimeSeriesMult200ResponseMeta) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetTimeSeriesMult200ResponseMeta(val *GetTimeSeriesMult200ResponseMeta) *NullableGetTimeSeriesMult200ResponseMeta {
	return &NullableGetTimeSeriesMult200ResponseMeta{value: val, isSet: true}
}

func (v NullableGetTimeSeriesMult200ResponseMeta) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetTimeSeriesMult200ResponseMeta) UnmarshalJSON(src []byte) error {
	v.isSet = true
