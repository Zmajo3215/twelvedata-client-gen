...
type GetEpsRevisions200Response struct {
	...
	// EPS revision data
	EpsRevision []GetEpsRevisions200ResponseEpsRevisionInner `json:"eps_revision,omitempty"`
...
// GetEpsRevision returns the EpsRevision field value if set, zero value otherwise.
func (o *GetEpsRevisions200Response) GetEpsRevision() []GetEpsRevisions200ResponseEpsRevisionInner {
	if o == nil || IsNil(o.EpsRevision) {
...
// GetEpsRevisionOk returns a tuple with the EpsRevision field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// SetEpsRevision gets a reference to the given []GetEpsRevisions200ResponseEpsRevisionInner and assigns it to the EpsRevision field.
