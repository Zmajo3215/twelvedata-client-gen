...
// checks if the GetETFsWorld200ResponseEtfComposition type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetETFsWorld200ResponseEtfComposition{}

// GetETFsWorld200ResponseEtfComposition Composition of a etf
type GetETFsWorld200ResponseEtfComposition struct {
...
func NewGetETFsWorld200ResponseEtfComposition() *GetETFsWorld200ResponseEtfComposition {
	this := GetETFsWorld200ResponseEtfComposition{}
	return &this
}
...
func (o GetETFsWorld200ResponseEtfComposition) MarshalJSON() ([]byte, error) {
...
func (o GetETFsWorld200ResponseEtfComposition) ToMap() (map[string]interface{}, error) {
...
type NullableGetETFsWorld200ResponseEtfComposition struct {
	value *GetETFsWorld200ResponseEtfComposition
	isSet bool
}

func (v NullableGetETFsWorld200ResponseEtfComposition) Get() *GetETFsWorld200ResponseEtfComposition {
	return v.value
}

func (v *NullableGetETFsWorld200ResponseEtfComposition) Set(val *GetETFsWorld200ResponseEtfComposition) {
	v.value = val
	v.isSet = true
}

func (v NullableGetETFsWorld200ResponseEtfComposition) IsSet() bool {
	return v.isSet
}

func (v *NullableGetETFsWorld200ResponseEtfComposition) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetETFsWorld200ResponseEtfComposition(val *GetETFsWorld200ResponseEtfComposition) *NullableGetETFsWorld200ResponseEtfComposition {
	return &NullableGetETFsWorld200ResponseEtfComposition{value: val, isSet: true}
}

func (v NullableGetETFsWorld200ResponseEtfComposition) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetETFsWorld200ResponseEtfComposition) UnmarshalJSON(src []byte) error {
	v.isSet = true
