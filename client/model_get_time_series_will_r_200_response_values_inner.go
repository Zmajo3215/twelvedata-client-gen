...
// GetWillr returns the Willr field value if set, zero value otherwise.
func (o *GetTimeSeriesWillR200ResponseValuesInner) GetWillr() string {
	if o == nil || IsNil(o.Willr) {
		var ret string
		return ret
	}
	return *o.Willr
...
// GetWillrOk returns a tuple with the Willr field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// SetWillr gets a reference to the given string and assigns it to the Willr field.
