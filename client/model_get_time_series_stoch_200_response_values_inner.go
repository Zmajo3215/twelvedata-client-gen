...
type GetTimeSeriesStoch200ResponseValuesInner struct {
	...
	// slow_k value
	SlowK *string `json:"slow_k,omitempty"`
	// slow_d value
	SlowD *string `json:"slow_d,omitempty"`
}
...
// GetSlowK returns the SlowK field value if set, zero value otherwise.
func (o *GetTimeSeriesStoch200ResponseValuesInner) GetSlowK() string {
	if o == nil || IsNil(o.SlowK) {
		var ret string
		return ret
	}
	return *o.SlowK
...
// GetSlowKOk returns a tuple with the SlowK field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// SetSlowK gets a reference to the given string and assigns it to the SlowK field.
func (o *GetTimeSeriesStoch200ResponseValuesInner) SetSlowK(v string) {
	o.SlowK = &v
}

// GetSlowD returns the SlowD field value if set, zero value otherwise.
func (o *GetTimeSeriesStoch200ResponseValuesInner) GetSlowD() string {
	if o == nil || IsNil(o.SlowD) {
		var ret string
		return ret
	}
	return *o.SlowD
...
// GetSlowDOk returns a tuple with the SlowD field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// SetSlowD gets a reference to the given string and assigns it to the SlowD field.
