...
// checks if the GetTimeSeriesKeltner200ResponseMeta type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetTimeSeriesKeltner200ResponseMeta{}

// GetTimeSeriesKeltner200ResponseMeta Json object with request general information
type GetTimeSeriesKeltner200ResponseMeta struct {
	...
	Indicator *GetTimeSeriesKeltner200ResponseMetaIndicator `json:"indicator,omitempty"`
}
...
func NewGetTimeSeriesKeltner200ResponseMeta() *GetTimeSeriesKeltner200ResponseMeta {
	this := GetTimeSeriesKeltner200ResponseMeta{}
	return &this
}
...
func (o *GetTimeSeriesKeltner200ResponseMeta) HasSymbol() bool {
	if o != nil && !IsNil(o.Symbol) {
		return true
	}
...
func (o *GetTimeSeriesKeltner200ResponseMeta) HasInterval() bool {
	if o != nil && !IsNil(o.Interval) {
		return true
	}
...
func (o *GetTimeSeriesKeltner200ResponseMeta) HasCurrency() bool {
	if o != nil && !IsNil(o.Currency) {
		return true
	}
...
func (o *GetTimeSeriesKeltner200ResponseMeta) HasExchangeTimezone() bool {
	if o != nil && !IsNil(o.ExchangeTimezone) {
		return true
	}
...
func (o *GetTimeSeriesKeltner200ResponseMeta) HasExchange() bool {
	if o != nil && !IsNil(o.Exchange) {
		return true
	}
...
func (o *GetTimeSeriesKeltner200ResponseMeta) HasMicCode() bool {
	if o != nil && !IsNil(o.MicCode) {
		return true
	}
...
func (o *GetTimeSeriesKeltner200ResponseMeta) HasType() bool {
	if o != nil && !IsNil(o.Type) {
		return true
	}
...
func (o *GetTimeSeriesKeltner200ResponseMeta) GetIndicator() GetTimeSeriesKeltner200ResponseMetaIndicator {
	if o == nil || IsNil(o.Indicator) {
		var ret GetTimeSeriesKeltner200ResponseMetaIndicator
		return ret
	}
	return *o.Indicator
}
...
func (o *GetTimeSeriesKeltner200ResponseMeta) HasIndicator() bool {
	if o != nil && !IsNil(o.Indicator) {
		return true
	}
...
// SetIndicator gets a reference to the given GetTimeSeriesKeltner200ResponseMetaIndicator and assigns it to the Indicator field.
func (o *GetTimeSeriesKeltner200ResponseMeta) SetIndicator(v GetTimeSeriesKeltner200ResponseMetaIndicator) {
	o.Indicator = &v
}

func (o GetTimeSeriesKeltner200ResponseMeta) MarshalJSON() ([]byte, error) {
...
func (o GetTimeSeriesKeltner200ResponseMeta) ToMap() (map[string]interface{}, error) {
...
type NullableGetTimeSeriesKeltner200ResponseMeta struct {
	value *GetTimeSeriesKeltner200ResponseMeta
	isSet bool
}

func (v NullableGetTimeSeriesKeltner200ResponseMeta) Get() *GetTimeSeriesKeltner200ResponseMeta {
	return v.value
}

func (v *NullableGetTimeSeriesKeltner200ResponseMeta) Set(val *GetTimeSeriesKeltner200ResponseMeta) {
	v.value = val
	v.isSet = true
}

func (v NullableGetTimeSeriesKeltner200ResponseMeta) IsSet() bool {
	return v.isSet
}

func (v *NullableGetTimeSeriesKeltner200ResponseMeta) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetTimeSeriesKeltner200ResponseMeta(val *GetTimeSeriesKeltner200ResponseMeta) *NullableGetTimeSeriesKeltner200ResponseMeta {
	return &NullableGetTimeSeriesKeltner200ResponseMeta{value: val, isSet: true}
}

func (v NullableGetTimeSeriesKeltner200ResponseMeta) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetTimeSeriesKeltner200ResponseMeta) UnmarshalJSON(src []byte) error {
	v.isSet = true
