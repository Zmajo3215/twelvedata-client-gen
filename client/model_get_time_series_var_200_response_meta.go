...
// checks if the GetTimeSeriesVar200ResponseMeta type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetTimeSeriesVar200ResponseMeta{}

// GetTimeSeriesVar200ResponseMeta Json object with request general information
type GetTimeSeriesVar200ResponseMeta struct {
	...
	Indicator *GetTimeSeriesVar200ResponseMetaIndicator `json:"indicator,omitempty"`
}
...
func NewGetTimeSeriesVar200ResponseMeta() *GetTimeSeriesVar200ResponseMeta {
	this := GetTimeSeriesVar200ResponseMeta{}
	return &this
}
...
func (o *GetTimeSeriesVar200ResponseMeta) HasSymbol() bool {
	if o != nil && !IsNil(o.Symbol) {
		return true
	}
...
func (o *GetTimeSeriesVar200ResponseMeta) HasInterval() bool {
	if o != nil && !IsNil(o.Interval) {
		return true
	}
...
func (o *GetTimeSeriesVar200ResponseMeta) HasCurrency() bool {
	if o != nil && !IsNil(o.Currency) {
		return true
	}
...
func (o *GetTimeSeriesVar200ResponseMeta) HasExchangeTimezone() bool {
	if o != nil && !IsNil(o.ExchangeTimezone) {
		return true
	}
...
func (o *GetTimeSeriesVar200ResponseMeta) HasExchange() bool {
	if o != nil && !IsNil(o.Exchange) {
		return true
	}
...
func (o *GetTimeSeriesVar200ResponseMeta) HasMicCode() bool {
	if o != nil && !IsNil(o.MicCode) {
		return true
	}
...
func (o *GetTimeSeriesVar200ResponseMeta) HasType() bool {
	if o != nil && !IsNil(o.Type) {
		return true
	}
...
func (o *GetTimeSeriesVar200ResponseMeta) GetIndicator() GetTimeSeriesVar200ResponseMetaIndicator {
	if o == nil || IsNil(o.Indicator) {
		var ret GetTimeSeriesVar200ResponseMetaIndicator
		return ret
	}
	return *o.Indicator
}
...
func (o *GetTimeSeriesVar200ResponseMeta) HasIndicator() bool {
	if o != nil && !IsNil(o.Indicator) {
		return true
	}
...
// SetIndicator gets a reference to the given GetTimeSeriesVar200ResponseMetaIndicator and assigns it to the Indicator field.
func (o *GetTimeSeriesVar200ResponseMeta) SetIndicator(v GetTimeSeriesVar200ResponseMetaIndicator) {
	o.Indicator = &v
}

func (o GetTimeSeriesVar200ResponseMeta) MarshalJSON() ([]byte, error) {
...
func (o GetTimeSeriesVar200ResponseMeta) ToMap() (map[string]interface{}, error) {
...
type NullableGetTimeSeriesVar200ResponseMeta struct {
	value *GetTimeSeriesVar200ResponseMeta
	isSet bool
}

func (v NullableGetTimeSeriesVar200ResponseMeta) Get() *GetTimeSeriesVar200ResponseMeta {
	return v.value
}

func (v *NullableGetTimeSeriesVar200ResponseMeta) Set(val *GetTimeSeriesVar200ResponseMeta) {
	v.value = val
	v.isSet = true
}

func (v NullableGetTimeSeriesVar200ResponseMeta) IsSet() bool {
	return v.isSet
}

func (v *NullableGetTimeSeriesVar200ResponseMeta) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetTimeSeriesVar200ResponseMeta(val *GetTimeSeriesVar200ResponseMeta) *NullableGetTimeSeriesVar200ResponseMeta {
	return &NullableGetTimeSeriesVar200ResponseMeta{value: val, isSet: true}
}

func (v NullableGetTimeSeriesVar200ResponseMeta) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetTimeSeriesVar200ResponseMeta) UnmarshalJSON(src []byte) error {
	v.isSet = true
