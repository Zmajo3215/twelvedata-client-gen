...
// checks if the GetTimeSeriesNatr200ResponseMeta type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetTimeSeriesNatr200ResponseMeta{}

// GetTimeSeriesNatr200ResponseMeta Json object with request general information
type GetTimeSeriesNatr200ResponseMeta struct {
	...
	Indicator *GetTimeSeriesNatr200ResponseMetaIndicator `json:"indicator,omitempty"`
}
...
func NewGetTimeSeriesNatr200ResponseMeta() *GetTimeSeriesNatr200ResponseMeta {
	this := GetTimeSeriesNatr200ResponseMeta{}
	return &this
}
...
func (o *GetTimeSeriesNatr200ResponseMeta) HasSymbol() bool {
	if o != nil && !IsNil(o.Symbol) {
		return true
	}
...
func (o *GetTimeSeriesNatr200ResponseMeta) HasInterval() bool {
	if o != nil && !IsNil(o.Interval) {
		return true
	}
...
func (o *GetTimeSeriesNatr200ResponseMeta) HasCurrency() bool {
	if o != nil && !IsNil(o.Currency) {
		return true
	}
...
func (o *GetTimeSeriesNatr200ResponseMeta) HasExchangeTimezone() bool {
	if o != nil && !IsNil(o.ExchangeTimezone) {
		return true
	}
...
func (o *GetTimeSeriesNatr200ResponseMeta) HasExchange() bool {
	if o != nil && !IsNil(o.Exchange) {
		return true
	}
...
func (o *GetTimeSeriesNatr200ResponseMeta) HasMicCode() bool {
	if o != nil && !IsNil(o.MicCode) {
		return true
	}
...
func (o *GetTimeSeriesNatr200ResponseMeta) HasType() bool {
	if o != nil && !IsNil(o.Type) {
		return true
	}
...
func (o *GetTimeSeriesNatr200ResponseMeta) GetIndicator() GetTimeSeriesNatr200ResponseMetaIndicator {
	if o == nil || IsNil(o.Indicator) {
		var ret GetTimeSeriesNatr200ResponseMetaIndicator
		return ret
	}
	return *o.Indicator
}
...
func (o *GetTimeSeriesNatr200ResponseMeta) HasIndicator() bool {
	if o != nil && !IsNil(o.Indicator) {
		return true
	}
...
// SetIndicator gets a reference to the given GetTimeSeriesNatr200ResponseMetaIndicator and assigns it to the Indicator field.
func (o *GetTimeSeriesNatr200ResponseMeta) SetIndicator(v GetTimeSeriesNatr200ResponseMetaIndicator) {
	o.Indicator = &v
}

func (o GetTimeSeriesNatr200ResponseMeta) MarshalJSON() ([]byte, error) {
...
func (o GetTimeSeriesNatr200ResponseMeta) ToMap() (map[string]interface{}, error) {
...
type NullableGetTimeSeriesNatr200ResponseMeta struct {
	value *GetTimeSeriesNatr200ResponseMeta
	isSet bool
}

func (v NullableGetTimeSeriesNatr200ResponseMeta) Get() *GetTimeSeriesNatr200ResponseMeta {
	return v.value
}

func (v *NullableGetTimeSeriesNatr200ResponseMeta) Set(val *GetTimeSeriesNatr200ResponseMeta) {
	v.value = val
	v.isSet = true
}

func (v NullableGetTimeSeriesNatr200ResponseMeta) IsSet() bool {
	return v.isSet
}

func (v *NullableGetTimeSeriesNatr200ResponseMeta) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetTimeSeriesNatr200ResponseMeta(val *GetTimeSeriesNatr200ResponseMeta) *NullableGetTimeSeriesNatr200ResponseMeta {
	return &NullableGetTimeSeriesNatr200ResponseMeta{value: val, isSet: true}
}

func (v NullableGetTimeSeriesNatr200ResponseMeta) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetTimeSeriesNatr200ResponseMeta) UnmarshalJSON(src []byte) error {
	v.isSet = true
