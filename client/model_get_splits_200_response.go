...
type GetSplits200Response struct {
	Meta *GetSplits200ResponseMeta `json:"meta,omitempty"`
	// List of stock splits
	Splits []GetSplits200ResponseSplitsInner `json:"splits,omitempty"`
}
...
func (o *GetSplits200Response) HasMeta() bool {
	if o != nil && !IsNil(o.Meta) {
		return true
	}
...
// SetMeta gets a reference to the given GetSplits200ResponseMeta and assigns it to the Meta field.
...
func (o *GetSplits200Response) HasSplits() bool {
	if o != nil && !IsNil(o.Splits) {
		return true
	}
...
// SetSplits gets a reference to the given []GetSplits200ResponseSplitsInner and assigns it to the Splits field.
