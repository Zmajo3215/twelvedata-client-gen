...
func NewGetTimeSeriesRsi200ResponseValuesInner() *GetTimeSeriesRsi200ResponseValuesInner {
...
func (o *GetTimeSeriesRsi200ResponseValuesInner) HasDatetime() bool {
	if o != nil && !IsNil(o.Datetime) {
		return true
	}
...
// GetRsi returns the Rsi field value if set, zero value otherwise.
...
func (o *GetTimeSeriesRsi200ResponseValuesInner) HasRsi() bool {
	if o != nil && !IsNil(o.Rsi) {
		return true
	}
...
// SetRsi gets a reference to the given string and assigns it to the Rsi field.
