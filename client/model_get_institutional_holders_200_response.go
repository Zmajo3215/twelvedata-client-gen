...
type GetInstitutionalHolders200Response struct {
	...
	InstitutionalHolders []InstitutionalHolderItem `json:"institutional_holders,omitempty"`
}
...
// GetInstitutionalHolders returns the InstitutionalHolders field value if set, zero value otherwise.
func (o *GetInstitutionalHolders200Response) GetInstitutionalHolders() []InstitutionalHolderItem {
	if o == nil || IsNil(o.InstitutionalHolders) {
...
// GetInstitutionalHoldersOk returns a tuple with the InstitutionalHolders field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// SetInstitutionalHolders gets a reference to the given []InstitutionalHolderItem and assigns it to the InstitutionalHolders field.
...
func (o GetInstitutionalHolders200Response) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.InstitutionalHolders) {
