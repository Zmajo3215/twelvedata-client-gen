...
type InlineObject17Meta struct {
	...
	Indicator *InlineObject17MetaIndicator `json:"indicator,omitempty"`
}
...
// SetIndicator gets a reference to the given InlineObject17MetaIndicator and assigns it to the Indicator field.
