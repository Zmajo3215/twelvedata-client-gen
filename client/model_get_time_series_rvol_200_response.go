...
type GetTimeSeriesRvol200Response struct {
	Meta *GetTimeSeriesRvol200ResponseMeta `json:"meta,omitempty"`
	// Array of time series data points
	Values []GetTimeSeriesRvol200ResponseValuesInner `json:"values,omitempty"`
	// Response status
...
func NewGetTimeSeriesRvol200Response() *GetTimeSeriesRvol200Response {
...
func (o *GetTimeSeriesRvol200Response) HasMeta() bool {
	if o != nil && !IsNil(o.Meta) {
		return true
	}
...
// SetMeta gets a reference to the given GetTimeSeriesRvol200ResponseMeta and assigns it to the Meta field.
...
func (o *GetTimeSeriesRvol200Response) HasValues() bool {
	if o != nil && !IsNil(o.Values) {
		return true
	}
...
// SetValues gets a reference to the given []GetTimeSeriesRvol200ResponseValuesInner and assigns it to the Values field.
...
func (o *GetTimeSeriesRvol200Response) HasStatus() bool {
	if o != nil && !IsNil(o.Status) {
		return true
	}
