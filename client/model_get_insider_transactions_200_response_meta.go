...
func NewGetInsiderTransactions200ResponseMeta() *GetInsiderTransactions200ResponseMeta {
...
func (o *GetInsiderTransactions200ResponseMeta) HasSymbol() bool {
	if o != nil && !IsNil(o.Symbol) {
		return true
	}
...
func (o *GetInsiderTransactions200ResponseMeta) HasName() bool {
	if o != nil && !IsNil(o.Name) {
		return true
	}
...
func (o *GetInsiderTransactions200ResponseMeta) HasCurrency() bool {
	if o != nil && !IsNil(o.Currency) {
		return true
	}
...
func (o *GetInsiderTransactions200ResponseMeta) HasExchange() bool {
	if o != nil && !IsNil(o.Exchange) {
		return true
	}
...
func (o *GetInsiderTransactions200ResponseMeta) HasMicCode() bool {
	if o != nil && !IsNil(o.MicCode) {
		return true
	}
...
func (o *GetInsiderTransactions200ResponseMeta) HasExchangeTimezone() bool {
	if o != nil && !IsNil(o.ExchangeTimezone) {
		return true
	}
