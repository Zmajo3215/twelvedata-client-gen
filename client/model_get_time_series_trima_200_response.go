...
type GetTimeSeriesTrima200Response struct {
	Meta *GetTimeSeriesTrima200ResponseMeta `json:"meta,omitempty"`
	// Array of time series data points
	Values []GetTimeSeriesTrima200ResponseValuesInner `json:"values,omitempty"`
	// Response status
...
// SetMeta gets a reference to the given GetTimeSeriesTrima200ResponseMeta and assigns it to the Meta field.
...
// SetValues gets a reference to the given []GetTimeSeriesTrima200ResponseValuesInner and assigns it to the Values field.
