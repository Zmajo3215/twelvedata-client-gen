...
type GetMutualFundsWorldComposition200Response struct {
	MutualFund *GetMutualFundsWorldComposition200ResponseMutualFund `json:"mutual_fund,omitempty"`
...
func NewGetMutualFundsWorldComposition200Response() *GetMutualFundsWorldComposition200Response {
...
func (o *GetMutualFundsWorldComposition200Response) HasMutualFund() bool {
	if o != nil && !IsNil(o.MutualFund) {
		return true
	}
...
// SetMutualFund gets a reference to the given GetMutualFundsWorldComposition200ResponseMutualFund and assigns it to the MutualFund field.
...
func (o *GetMutualFundsWorldComposition200Response) HasStatus() bool {
	if o != nil && !IsNil(o.Status) {
		return true
	}
