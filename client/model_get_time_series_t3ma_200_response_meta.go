...
// checks if the GetTimeSeriesT3ma200ResponseMeta type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetTimeSeriesT3ma200ResponseMeta{}

// GetTimeSeriesT3ma200ResponseMeta Json object with request general information
type GetTimeSeriesT3ma200ResponseMeta struct {
	...
	Indicator *GetTimeSeriesT3ma200ResponseMetaIndicator `json:"indicator,omitempty"`
}
...
func NewGetTimeSeriesT3ma200ResponseMeta() *GetTimeSeriesT3ma200ResponseMeta {
	this := GetTimeSeriesT3ma200ResponseMeta{}
	return &this
}
...
func (o *GetTimeSeriesT3ma200ResponseMeta) HasSymbol() bool {
	if o != nil && !IsNil(o.Symbol) {
		return true
	}
...
func (o *GetTimeSeriesT3ma200ResponseMeta) HasInterval() bool {
	if o != nil && !IsNil(o.Interval) {
		return true
	}
...
func (o *GetTimeSeriesT3ma200ResponseMeta) HasCurrency() bool {
	if o != nil && !IsNil(o.Currency) {
		return true
	}
...
func (o *GetTimeSeriesT3ma200ResponseMeta) HasExchangeTimezone() bool {
	if o != nil && !IsNil(o.ExchangeTimezone) {
		return true
	}
...
func (o *GetTimeSeriesT3ma200ResponseMeta) HasExchange() bool {
	if o != nil && !IsNil(o.Exchange) {
		return true
	}
...
func (o *GetTimeSeriesT3ma200ResponseMeta) HasMicCode() bool {
	if o != nil && !IsNil(o.MicCode) {
		return true
	}
...
func (o *GetTimeSeriesT3ma200ResponseMeta) HasType() bool {
	if o != nil && !IsNil(o.Type) {
		return true
	}
...
func (o *GetTimeSeriesT3ma200ResponseMeta) GetIndicator() GetTimeSeriesT3ma200ResponseMetaIndicator {
	if o == nil || IsNil(o.Indicator) {
		var ret GetTimeSeriesT3ma200ResponseMetaIndicator
		return ret
	}
	return *o.Indicator
}
...
func (o *GetTimeSeriesT3ma200ResponseMeta) HasIndicator() bool {
	if o != nil && !IsNil(o.Indicator) {
		return true
	}
...
// SetIndicator gets a reference to the given GetTimeSeriesT3ma200ResponseMetaIndicator and assigns it to the Indicator field.
func (o *GetTimeSeriesT3ma200ResponseMeta) SetIndicator(v GetTimeSeriesT3ma200ResponseMetaIndicator) {
	o.Indicator = &v
}

func (o GetTimeSeriesT3ma200ResponseMeta) MarshalJSON() ([]byte, error) {
...
func (o GetTimeSeriesT3ma200ResponseMeta) ToMap() (map[string]interface{}, error) {
...
type NullableGetTimeSeriesT3ma200ResponseMeta struct {
	value *GetTimeSeriesT3ma200ResponseMeta
	isSet bool
}

func (v NullableGetTimeSeriesT3ma200ResponseMeta) Get() *GetTimeSeriesT3ma200ResponseMeta {
	return v.value
}

func (v *NullableGetTimeSeriesT3ma200ResponseMeta) Set(val *GetTimeSeriesT3ma200ResponseMeta) {
	v.value = val
	v.isSet = true
}

func (v NullableGetTimeSeriesT3ma200ResponseMeta) IsSet() bool {
	return v.isSet
}

func (v *NullableGetTimeSeriesT3ma200ResponseMeta) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetTimeSeriesT3ma200ResponseMeta(val *GetTimeSeriesT3ma200ResponseMeta) *NullableGetTimeSeriesT3ma200ResponseMeta {
	return &NullableGetTimeSeriesT3ma200ResponseMeta{value: val, isSet: true}
}

func (v NullableGetTimeSeriesT3ma200ResponseMeta) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetTimeSeriesT3ma200ResponseMeta) UnmarshalJSON(src []byte) error {
	v.isSet = true
