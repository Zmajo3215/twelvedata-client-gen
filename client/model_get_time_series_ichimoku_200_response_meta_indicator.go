...
type GetTimeSeriesIchimoku200ResponseMetaIndicator struct {
	...
	ConversionLinePeriod *int64 `json:"conversion_line_period,omitempty"`
	// The time period used for generating the base line
	BaseLinePeriod *int64 `json:"base_line_period,omitempty"`
	// The time period used for generating the leading span B line
	LeadingSpanBPeriod *int64 `json:"leading_span_b_period,omitempty"`
	// The time period used for generating the lagging span line
	LaggingSpanPeriod *int64 `json:"lagging_span_period,omitempty"`
	// Indicates whether to include ahead span period
	IncludeAheadSpanPeriod *bool `json:"include_ahead_span_period,omitempty"`
}
...
// GetConversionLinePeriod returns the ConversionLinePeriod field value if set, zero value otherwise.
func (o *GetTimeSeriesIchimoku200ResponseMetaIndicator) GetConversionLinePeriod() int64 {
	if o == nil || IsNil(o.ConversionLinePeriod) {
		var ret int64
		return ret
	}
...
// GetConversionLinePeriodOk returns a tuple with the ConversionLinePeriod field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// SetConversionLinePeriod gets a reference to the given int64 and assigns it to the ConversionLinePeriod field.
func (o *GetTimeSeriesIchimoku200ResponseMetaIndicator) SetConversionLinePeriod(v int64) {
	o.ConversionLinePeriod = &v
}

// GetBaseLinePeriod returns the BaseLinePeriod field value if set, zero value otherwise.
func (o *GetTimeSeriesIchimoku200ResponseMetaIndicator) GetBaseLinePeriod() int64 {
	if o == nil || IsNil(o.BaseLinePeriod) {
		var ret int64
		return ret
	}
...
// GetBaseLinePeriodOk returns a tuple with the BaseLinePeriod field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// SetBaseLinePeriod gets a reference to the given int64 and assigns it to the BaseLinePeriod field.
func (o *GetTimeSeriesIchimoku200ResponseMetaIndicator) SetBaseLinePeriod(v int64) {
	o.BaseLinePeriod = &v
}

// GetLeadingSpanBPeriod returns the LeadingSpanBPeriod field value if set, zero value otherwise.
func (o *GetTimeSeriesIchimoku200ResponseMetaIndicator) GetLeadingSpanBPeriod() int64 {
	if o == nil || IsNil(o.LeadingSpanBPeriod) {
		var ret int64
		return ret
	}
...
// GetLeadingSpanBPeriodOk returns a tuple with the LeadingSpanBPeriod field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// SetLeadingSpanBPeriod gets a reference to the given int64 and assigns it to the LeadingSpanBPeriod field.
func (o *GetTimeSeriesIchimoku200ResponseMetaIndicator) SetLeadingSpanBPeriod(v int64) {
	o.LeadingSpanBPeriod = &v
}

// GetLaggingSpanPeriod returns the LaggingSpanPeriod field value if set, zero value otherwise.
func (o *GetTimeSeriesIchimoku200ResponseMetaIndicator) GetLaggingSpanPeriod() int64 {
	if o == nil || IsNil(o.LaggingSpanPeriod) {
		var ret int64
		return ret
	}
...
// GetLaggingSpanPeriodOk returns a tuple with the LaggingSpanPeriod field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// SetLaggingSpanPeriod gets a reference to the given int64 and assigns it to the LaggingSpanPeriod field.
func (o *GetTimeSeriesIchimoku200ResponseMetaIndicator) SetLaggingSpanPeriod(v int64) {
	o.LaggingSpanPeriod = &v
}

// GetIncludeAheadSpanPeriod returns the IncludeAheadSpanPeriod field value if set, zero value otherwise.
func (o *GetTimeSeriesIchimoku200ResponseMetaIndicator) GetIncludeAheadSpanPeriod() bool {
	if o == nil || IsNil(o.IncludeAheadSpanPeriod) {
		var ret bool
		return ret
	}
...
// GetIncludeAheadSpanPeriodOk returns a tuple with the IncludeAheadSpanPeriod field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// SetIncludeAheadSpanPeriod gets a reference to the given bool and assigns it to the IncludeAheadSpanPeriod field.
