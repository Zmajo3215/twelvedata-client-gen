...
// checks if the GetTimeSeriesSar200ResponseMeta type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetTimeSeriesSar200ResponseMeta{}

// GetTimeSeriesSar200ResponseMeta Json object with request general information
type GetTimeSeriesSar200ResponseMeta struct {
	...
	Indicator *GetTimeSeriesSar200ResponseMetaIndicator `json:"indicator,omitempty"`
}
...
func NewGetTimeSeriesSar200ResponseMeta() *GetTimeSeriesSar200ResponseMeta {
	this := GetTimeSeriesSar200ResponseMeta{}
	return &this
}
...
func (o *GetTimeSeriesSar200ResponseMeta) HasSymbol() bool {
	if o != nil && !IsNil(o.Symbol) {
		return true
	}
...
func (o *GetTimeSeriesSar200ResponseMeta) HasInterval() bool {
	if o != nil && !IsNil(o.Interval) {
		return true
	}
...
func (o *GetTimeSeriesSar200ResponseMeta) HasCurrency() bool {
	if o != nil && !IsNil(o.Currency) {
		return true
	}
...
func (o *GetTimeSeriesSar200ResponseMeta) HasExchangeTimezone() bool {
	if o != nil && !IsNil(o.ExchangeTimezone) {
		return true
	}
...
func (o *GetTimeSeriesSar200ResponseMeta) HasExchange() bool {
	if o != nil && !IsNil(o.Exchange) {
		return true
	}
...
func (o *GetTimeSeriesSar200ResponseMeta) HasMicCode() bool {
	if o != nil && !IsNil(o.MicCode) {
		return true
	}
...
func (o *GetTimeSeriesSar200ResponseMeta) HasType() bool {
	if o != nil && !IsNil(o.Type) {
		return true
	}
...
func (o *GetTimeSeriesSar200ResponseMeta) GetIndicator() GetTimeSeriesSar200ResponseMetaIndicator {
	if o == nil || IsNil(o.Indicator) {
		var ret GetTimeSeriesSar200ResponseMetaIndicator
		return ret
	}
	return *o.Indicator
}
...
func (o *GetTimeSeriesSar200ResponseMeta) HasIndicator() bool {
	if o != nil && !IsNil(o.Indicator) {
		return true
	}
...
// SetIndicator gets a reference to the given GetTimeSeriesSar200ResponseMetaIndicator and assigns it to the Indicator field.
func (o *GetTimeSeriesSar200ResponseMeta) SetIndicator(v GetTimeSeriesSar200ResponseMetaIndicator) {
	o.Indicator = &v
}

func (o GetTimeSeriesSar200ResponseMeta) MarshalJSON() ([]byte, error) {
...
func (o GetTimeSeriesSar200ResponseMeta) ToMap() (map[string]interface{}, error) {
...
type NullableGetTimeSeriesSar200ResponseMeta struct {
	value *GetTimeSeriesSar200ResponseMeta
	isSet bool
}

func (v NullableGetTimeSeriesSar200ResponseMeta) Get() *GetTimeSeriesSar200ResponseMeta {
	return v.value
}

func (v *NullableGetTimeSeriesSar200ResponseMeta) Set(val *GetTimeSeriesSar200ResponseMeta) {
	v.value = val
	v.isSet = true
}

func (v NullableGetTimeSeriesSar200ResponseMeta) IsSet() bool {
	return v.isSet
}

func (v *NullableGetTimeSeriesSar200ResponseMeta) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetTimeSeriesSar200ResponseMeta(val *GetTimeSeriesSar200ResponseMeta) *NullableGetTimeSeriesSar200ResponseMeta {
	return &NullableGetTimeSeriesSar200ResponseMeta{value: val, isSet: true}
}

func (v NullableGetTimeSeriesSar200ResponseMeta) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetTimeSeriesSar200ResponseMeta) UnmarshalJSON(src []byte) error {
	v.isSet = true
