...
type GetMutualFundsWorldPurchaseInfo200Response struct {
	MutualFund *GetMutualFundsWorldPurchaseInfo200ResponseMutualFund `json:"mutual_fund,omitempty"`
...
func NewGetMutualFundsWorldPurchaseInfo200Response() *GetMutualFundsWorldPurchaseInfo200Response {
...
func (o *GetMutualFundsWorldPurchaseInfo200Response) HasMutualFund() bool {
	if o != nil && !IsNil(o.MutualFund) {
		return true
	}
...
// SetMutualFund gets a reference to the given GetMutualFundsWorldPurchaseInfo200ResponseMutualFund and assigns it to the MutualFund field.
...
func (o *GetMutualFundsWorldPurchaseInfo200Response) HasStatus() bool {
	if o != nil && !IsNil(o.Status) {
		return true
	}
