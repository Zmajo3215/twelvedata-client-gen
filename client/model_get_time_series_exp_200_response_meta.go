...
// checks if the GetTimeSeriesExp200ResponseMeta type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetTimeSeriesExp200ResponseMeta{}

// GetTimeSeriesExp200ResponseMeta Json object with request general information
type GetTimeSeriesExp200ResponseMeta struct {
	...
	Indicator *GetTimeSeriesExp200ResponseMetaIndicator `json:"indicator,omitempty"`
}
...
func NewGetTimeSeriesExp200ResponseMeta() *GetTimeSeriesExp200ResponseMeta {
	this := GetTimeSeriesExp200ResponseMeta{}
	return &this
}
...
func (o *GetTimeSeriesExp200ResponseMeta) GetIndicator() GetTimeSeriesExp200ResponseMetaIndicator {
	if o == nil || IsNil(o.Indicator) {
		var ret GetTimeSeriesExp200ResponseMetaIndicator
		return ret
	}
	return *o.Indicator
}
...
// SetIndicator gets a reference to the given GetTimeSeriesExp200ResponseMetaIndicator and assigns it to the Indicator field.
func (o *GetTimeSeriesExp200ResponseMeta) SetIndicator(v GetTimeSeriesExp200ResponseMetaIndicator) {
	o.Indicator = &v
}

func (o GetTimeSeriesExp200ResponseMeta) MarshalJSON() ([]byte, error) {
...
func (o GetTimeSeriesExp200ResponseMeta) ToMap() (map[string]interface{}, error) {
...
type NullableGetTimeSeriesExp200ResponseMeta struct {
	value *GetTimeSeriesExp200ResponseMeta
	isSet bool
}

func (v NullableGetTimeSeriesExp200ResponseMeta) Get() *GetTimeSeriesExp200ResponseMeta {
	return v.value
}

func (v *NullableGetTimeSeriesExp200ResponseMeta) Set(val *GetTimeSeriesExp200ResponseMeta) {
	v.value = val
	v.isSet = true
}

func (v NullableGetTimeSeriesExp200ResponseMeta) IsSet() bool {
	return v.isSet
}

func (v *NullableGetTimeSeriesExp200ResponseMeta) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetTimeSeriesExp200ResponseMeta(val *GetTimeSeriesExp200ResponseMeta) *NullableGetTimeSeriesExp200ResponseMeta {
	return &NullableGetTimeSeriesExp200ResponseMeta{value: val, isSet: true}
}

func (v NullableGetTimeSeriesExp200ResponseMeta) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetTimeSeriesExp200ResponseMeta) UnmarshalJSON(src []byte) error {
	v.isSet = true
