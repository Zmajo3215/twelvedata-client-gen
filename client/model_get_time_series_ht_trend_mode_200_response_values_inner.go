...
type GetTimeSeriesHtTrendMode200ResponseValuesInner struct {
	...
	// ht_trendmode value
	HtTrendmode *string `json:"ht_trendmode,omitempty"`
}
...
func NewGetTimeSeriesHtTrendMode200ResponseValuesInner() *GetTimeSeriesHtTrendMode200ResponseValuesInner {
...
func (o *GetTimeSeriesHtTrendMode200ResponseValuesInner) HasDatetime() bool {
	if o != nil && !IsNil(o.Datetime) {
		return true
	}
...
// GetHtTrendmode returns the HtTrendmode field value if set, zero value otherwise.
func (o *GetTimeSeriesHtTrendMode200ResponseValuesInner) GetHtTrendmode() string {
	if o == nil || IsNil(o.HtTrendmode) {
		var ret string
		return ret
	}
...
// GetHtTrendmodeOk returns a tuple with the HtTrendmode field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// HasHtTrendmode returns a boolean if a field has been set.
func (o *GetTimeSeriesHtTrendMode200ResponseValuesInner) HasHtTrendmode() bool {
	if o != nil && !IsNil(o.HtTrendmode) {
		return true
	}
...
// SetHtTrendmode gets a reference to the given string and assigns it to the HtTrendmode field.
