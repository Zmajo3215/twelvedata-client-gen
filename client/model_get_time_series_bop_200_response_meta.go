...
// checks if the GetTimeSeriesBop200ResponseMeta type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetTimeSeriesBop200ResponseMeta{}

// GetTimeSeriesBop200ResponseMeta Json object with request general information
type GetTimeSeriesBop200ResponseMeta struct {
	...
	Indicator *GetTimeSeriesBop200ResponseMetaIndicator `json:"indicator,omitempty"`
}
...
func NewGetTimeSeriesBop200ResponseMeta() *GetTimeSeriesBop200ResponseMeta {
	this := GetTimeSeriesBop200ResponseMeta{}
	return &this
}
...
func (o *GetTimeSeriesBop200ResponseMeta) HasSymbol() bool {
	if o != nil && !IsNil(o.Symbol) {
		return true
	}
...
func (o *GetTimeSeriesBop200ResponseMeta) HasInterval() bool {
	if o != nil && !IsNil(o.Interval) {
		return true
	}
...
func (o *GetTimeSeriesBop200ResponseMeta) HasCurrency() bool {
	if o != nil && !IsNil(o.Currency) {
		return true
	}
...
func (o *GetTimeSeriesBop200ResponseMeta) HasExchangeTimezone() bool {
	if o != nil && !IsNil(o.ExchangeTimezone) {
		return true
	}
...
func (o *GetTimeSeriesBop200ResponseMeta) HasExchange() bool {
	if o != nil && !IsNil(o.Exchange) {
		return true
	}
...
func (o *GetTimeSeriesBop200ResponseMeta) HasMicCode() bool {
	if o != nil && !IsNil(o.MicCode) {
		return true
	}
...
func (o *GetTimeSeriesBop200ResponseMeta) HasType() bool {
	if o != nil && !IsNil(o.Type) {
		return true
	}
...
func (o *GetTimeSeriesBop200ResponseMeta) GetIndicator() GetTimeSeriesBop200ResponseMetaIndicator {
	if o == nil || IsNil(o.Indicator) {
		var ret GetTimeSeriesBop200ResponseMetaIndicator
		return ret
	}
	return *o.Indicator
}
...
func (o *GetTimeSeriesBop200ResponseMeta) HasIndicator() bool {
	if o != nil && !IsNil(o.Indicator) {
		return true
	}
...
// SetIndicator gets a reference to the given GetTimeSeriesBop200ResponseMetaIndicator and assigns it to the Indicator field.
func (o *GetTimeSeriesBop200ResponseMeta) SetIndicator(v GetTimeSeriesBop200ResponseMetaIndicator) {
	o.Indicator = &v
}

func (o GetTimeSeriesBop200ResponseMeta) MarshalJSON() ([]byte, error) {
...
func (o GetTimeSeriesBop200ResponseMeta) ToMap() (map[string]interface{}, error) {
...
type NullableGetTimeSeriesBop200ResponseMeta struct {
	value *GetTimeSeriesBop200ResponseMeta
	isSet bool
}

func (v NullableGetTimeSeriesBop200ResponseMeta) Get() *GetTimeSeriesBop200ResponseMeta {
	return v.value
}

func (v *NullableGetTimeSeriesBop200ResponseMeta) Set(val *GetTimeSeriesBop200ResponseMeta) {
	v.value = val
	v.isSet = true
}

func (v NullableGetTimeSeriesBop200ResponseMeta) IsSet() bool {
	return v.isSet
}

func (v *NullableGetTimeSeriesBop200ResponseMeta) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetTimeSeriesBop200ResponseMeta(val *GetTimeSeriesBop200ResponseMeta) *NullableGetTimeSeriesBop200ResponseMeta {
	return &NullableGetTimeSeriesBop200ResponseMeta{value: val, isSet: true}
}

func (v NullableGetTimeSeriesBop200ResponseMeta) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetTimeSeriesBop200ResponseMeta) UnmarshalJSON(src []byte) error {
	v.isSet = true
