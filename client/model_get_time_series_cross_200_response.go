...
type GetTimeSeriesCross200Response struct {
	Meta *CrossMeta `json:"meta,omitempty"`
	// Array of time series data points
	Values []TimeSeriesCrossItem `json:"values,omitempty"`
}
...
func NewGetTimeSeriesCross200Response() *GetTimeSeriesCross200Response {
...
func (o *GetTimeSeriesCross200Response) HasMeta() bool {
	if o != nil && !IsNil(o.Meta) {
		return true
	}
...
// SetMeta gets a reference to the given CrossMeta and assigns it to the Meta field.
...
func (o *GetTimeSeriesCross200Response) HasValues() bool {
	if o != nil && !IsNil(o.Values) {
		return true
	}
...
// SetValues gets a reference to the given []TimeSeriesCrossItem and assigns it to the Values field.
