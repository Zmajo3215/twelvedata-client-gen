...
type GetTimeSeriesFloor200ResponseMeta struct {
	...
	Indicator *GetTimeSeriesFloor200ResponseMetaIndicator `json:"indicator,omitempty"`
}
...
// SetIndicator gets a reference to the given GetTimeSeriesFloor200ResponseMetaIndicator and assigns it to the Indicator field.
