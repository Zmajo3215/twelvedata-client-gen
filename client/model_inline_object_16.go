...
type InlineObject16 struct {
	Meta *InlineObject16Meta `json:"meta,omitempty"`
	// Array of time series data points
	Values []InlineObject16ValuesInner `json:"values,omitempty"`
	// Response status
...
func (o *InlineObject16) HasMeta() bool {
	if o != nil && !IsNil(o.Meta) {
		return true
	}
...
// SetMeta gets a reference to the given InlineObject16Meta and assigns it to the Meta field.
...
func (o *InlineObject16) HasValues() bool {
	if o != nil && !IsNil(o.Values) {
		return true
	}
...
// SetValues gets a reference to the given []InlineObject16ValuesInner and assigns it to the Values field.
...
func (o *InlineObject16) HasStatus() bool {
	if o != nil && !IsNil(o.Status) {
		return true
	}
