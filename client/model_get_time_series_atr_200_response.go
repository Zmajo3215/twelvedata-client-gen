...
type GetTimeSeriesAtr200Response struct {
	Meta *GetTimeSeriesAtr200ResponseMeta `json:"meta,omitempty"`
	// Array of time series data points
	Values []GetTimeSeriesAtr200ResponseValuesInner `json:"values,omitempty"`
	// Response status
...
func NewGetTimeSeriesAtr200Response() *GetTimeSeriesAtr200Response {
...
func (o *GetTimeSeriesAtr200Response) HasMeta() bool {
	if o != nil && !IsNil(o.Meta) {
		return true
	}
...
// SetMeta gets a reference to the given GetTimeSeriesAtr200ResponseMeta and assigns it to the Meta field.
...
func (o *GetTimeSeriesAtr200Response) HasValues() bool {
	if o != nil && !IsNil(o.Values) {
		return true
	}
...
// SetValues gets a reference to the given []GetTimeSeriesAtr200ResponseValuesInner and assigns it to the Values field.
...
func (o *GetTimeSeriesAtr200Response) HasStatus() bool {
	if o != nil && !IsNil(o.Status) {
		return true
	}
