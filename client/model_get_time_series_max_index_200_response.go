...
type GetTimeSeriesMaxIndex200Response struct {
	Meta *GetTimeSeriesMaxIndex200ResponseMeta `json:"meta,omitempty"`
	// Array of time series data points
	Values []GetTimeSeriesMaxIndex200ResponseValuesInner `json:"values,omitempty"`
	// Response status
...
// SetMeta gets a reference to the given GetTimeSeriesMaxIndex200ResponseMeta and assigns it to the Meta field.
...
// SetValues gets a reference to the given []GetTimeSeriesMaxIndex200ResponseValuesInner and assigns it to the Values field.
