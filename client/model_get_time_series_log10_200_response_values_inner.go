...
type GetTimeSeriesLog10200ResponseValuesInner struct {
	...
	// Log10 value
	Log10 *string `json:"log10,omitempty"`
}
...
func NewGetTimeSeriesLog10200ResponseValuesInner() *GetTimeSeriesLog10200ResponseValuesInner {
...
func (o *GetTimeSeriesLog10200ResponseValuesInner) HasDatetime() bool {
	if o != nil && !IsNil(o.Datetime) {
		return true
	}
...
// GetLog10 returns the Log10 field value if set, zero value otherwise.
func (o *GetTimeSeriesLog10200ResponseValuesInner) GetLog10() string {
	if o == nil || IsNil(o.Log10) {
		var ret string
		return ret
	}
	return *o.Log10
...
// GetLog10Ok returns a tuple with the Log10 field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// HasLog10 returns a boolean if a field has been set.
func (o *GetTimeSeriesLog10200ResponseValuesInner) HasLog10() bool {
	if o != nil && !IsNil(o.Log10) {
		return true
	}
...
// SetLog10 gets a reference to the given string and assigns it to the Log10 field.
