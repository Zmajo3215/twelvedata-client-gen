...
type GetTimeSeries200Response struct {
	Meta *GetTimeSeries200ResponseMeta `json:"meta,omitempty"`
	// List of time series data points
	Values []TimeSeriesItem `json:"values,omitempty"`
	// Response status
...
// SetMeta gets a reference to the given GetTimeSeries200ResponseMeta and assigns it to the Meta field.
...
// SetValues gets a reference to the given []TimeSeriesItem and assigns it to the Values field.
