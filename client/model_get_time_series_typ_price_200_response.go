...
type GetTimeSeriesTypPrice200Response struct {
	Meta *GetTimeSeriesTypPrice200ResponseMeta `json:"meta,omitempty"`
	// Array of time series data points
	Values []GetTimeSeriesTypPrice200ResponseValuesInner `json:"values,omitempty"`
	// Response status
...
func NewGetTimeSeriesTypPrice200Response() *GetTimeSeriesTypPrice200Response {
...
func (o *GetTimeSeriesTypPrice200Response) HasMeta() bool {
	if o != nil && !IsNil(o.Meta) {
		return true
	}
...
// SetMeta gets a reference to the given GetTimeSeriesTypPrice200ResponseMeta and assigns it to the Meta field.
...
func (o *GetTimeSeriesTypPrice200Response) HasValues() bool {
	if o != nil && !IsNil(o.Values) {
		return true
	}
...
// SetValues gets a reference to the given []GetTimeSeriesTypPrice200ResponseValuesInner and assigns it to the Values field.
...
func (o *GetTimeSeriesTypPrice200Response) HasStatus() bool {
	if o != nil && !IsNil(o.Status) {
		return true
	}
