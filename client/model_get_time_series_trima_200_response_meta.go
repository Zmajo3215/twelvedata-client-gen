...
type GetTimeSeriesTrima200ResponseMeta struct {
	...
	Indicator *GetTimeSeriesTrima200ResponseMetaIndicator `json:"indicator,omitempty"`
}
...
// SetIndicator gets a reference to the given GetTimeSeriesTrima200ResponseMetaIndicator and assigns it to the Indicator field.
