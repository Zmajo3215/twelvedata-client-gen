...
type GetTimeSeriesDema200ResponseValuesInner struct {
	...
	// Dema value
	Dema *string `json:"dema,omitempty"`
}
...
func NewGetTimeSeriesDema200ResponseValuesInner() *GetTimeSeriesDema200ResponseValuesInner {
...
func (o *GetTimeSeriesDema200ResponseValuesInner) HasDatetime() bool {
	if o != nil && !IsNil(o.Datetime) {
		return true
	}
...
// GetDema returns the Dema field value if set, zero value otherwise.
func (o *GetTimeSeriesDema200ResponseValuesInner) GetDema() string {
	if o == nil || IsNil(o.Dema) {
		var ret string
		return ret
	}
	return *o.Dema
...
// GetDemaOk returns a tuple with the Dema field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// HasDema returns a boolean if a field has been set.
func (o *GetTimeSeriesDema200ResponseValuesInner) HasDema() bool {
	if o != nil && !IsNil(o.Dema) {
		return true
	}
...
// SetDema gets a reference to the given string and assigns it to the Dema field.
