...
type GetTimeSeriesKama200ResponseValuesInner struct {
	...
	// Kama value
	Kama *string `json:"kama,omitempty"`
}
...
func NewGetTimeSeriesKama200ResponseValuesInner() *GetTimeSeriesKama200ResponseValuesInner {
...
func (o *GetTimeSeriesKama200ResponseValuesInner) HasDatetime() bool {
	if o != nil && !IsNil(o.Datetime) {
		return true
	}
...
// GetKama returns the Kama field value if set, zero value otherwise.
func (o *GetTimeSeriesKama200ResponseValuesInner) GetKama() string {
	if o == nil || IsNil(o.Kama) {
		var ret string
		return ret
	}
	return *o.Kama
...
// GetKamaOk returns a tuple with the Kama field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// HasKama returns a boolean if a field has been set.
func (o *GetTimeSeriesKama200ResponseValuesInner) HasKama() bool {
	if o != nil && !IsNil(o.Kama) {
		return true
	}
...
// SetKama gets a reference to the given string and assigns it to the Kama field.
