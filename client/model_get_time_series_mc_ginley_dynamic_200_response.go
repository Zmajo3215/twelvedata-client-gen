...
type GetTimeSeriesMcGinleyDynamic200Response struct {
	Meta *GetTimeSeriesMcGinleyDynamic200ResponseMeta `json:"meta,omitempty"`
	// Array of time series data points
	Values []GetTimeSeriesMcGinleyDynamic200ResponseValuesInner `json:"values,omitempty"`
	// Response status
...
func NewGetTimeSeriesMcGinleyDynamic200Response() *GetTimeSeriesMcGinleyDynamic200Response {
...
func (o *GetTimeSeriesMcGinleyDynamic200Response) HasMeta() bool {
	if o != nil && !IsNil(o.Meta) {
		return true
	}
...
// SetMeta gets a reference to the given GetTimeSeriesMcGinleyDynamic200ResponseMeta and assigns it to the Meta field.
...
func (o *GetTimeSeriesMcGinleyDynamic200Response) HasValues() bool {
	if o != nil && !IsNil(o.Values) {
		return true
	}
...
// SetValues gets a reference to the given []GetTimeSeriesMcGinleyDynamic200ResponseValuesInner and assigns it to the Values field.
...
func (o *GetTimeSeriesMcGinleyDynamic200Response) HasStatus() bool {
	if o != nil && !IsNil(o.Status) {
		return true
	}
