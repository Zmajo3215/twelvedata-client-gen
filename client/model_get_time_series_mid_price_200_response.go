...
type GetTimeSeriesMidPrice200Response struct {
	Meta *GetTimeSeriesMidPrice200ResponseMeta `json:"meta,omitempty"`
	// Array of time series data points
	Values []GetTimeSeriesMidPrice200ResponseValuesInner `json:"values,omitempty"`
	// Response status
...
// SetMeta gets a reference to the given GetTimeSeriesMidPrice200ResponseMeta and assigns it to the Meta field.
...
// SetValues gets a reference to the given []GetTimeSeriesMidPrice200ResponseValuesInner and assigns it to the Values field.
