...
type GetTimeSeriesTrima200ResponseValuesInner struct {
	...
	// TRIMA value
	Trima *string `json:"trima,omitempty"`
}
...
// GetTrima returns the Trima field value if set, zero value otherwise.
func (o *GetTimeSeriesTrima200ResponseValuesInner) GetTrima() string {
	if o == nil || IsNil(o.Trima) {
		var ret string
		return ret
	}
	return *o.Trima
...
// GetTrimaOk returns a tuple with the Trima field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// SetTrima gets a reference to the given string and assigns it to the Trima field.
