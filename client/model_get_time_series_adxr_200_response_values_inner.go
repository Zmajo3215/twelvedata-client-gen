...
type GetTimeSeriesAdxr200ResponseValuesInner struct {
	...
	// Adxr value
	Adxr *string `json:"adxr,omitempty"`
}
...
func NewGetTimeSeriesAdxr200ResponseValuesInner() *GetTimeSeriesAdxr200ResponseValuesInner {
...
func (o *GetTimeSeriesAdxr200ResponseValuesInner) HasDatetime() bool {
	if o != nil && !IsNil(o.Datetime) {
		return true
	}
...
// GetAdxr returns the Adxr field value if set, zero value otherwise.
func (o *GetTimeSeriesAdxr200ResponseValuesInner) GetAdxr() string {
	if o == nil || IsNil(o.Adxr) {
		var ret string
		return ret
	}
	return *o.Adxr
...
// GetAdxrOk returns a tuple with the Adxr field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// HasAdxr returns a boolean if a field has been set.
func (o *GetTimeSeriesAdxr200ResponseValuesInner) HasAdxr() bool {
	if o != nil && !IsNil(o.Adxr) {
		return true
	}
...
// SetAdxr gets a reference to the given string and assigns it to the Adxr field.
