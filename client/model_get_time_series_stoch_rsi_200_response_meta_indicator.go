...
type GetTimeSeriesStochRsi200ResponseMetaIndicator struct {
	...
	RsiLength *int64 `json:"rsi_length,omitempty"`
	// Period length for computing the stochastic oscillator of the RSI
	StochLength *int64 `json:"stoch_length,omitempty"`
...
// GetRsiLength returns the RsiLength field value if set, zero value otherwise.
func (o *GetTimeSeriesStochRsi200ResponseMetaIndicator) GetRsiLength() int64 {
	if o == nil || IsNil(o.RsiLength) {
		var ret int64
		return ret
	}
	return *o.RsiLength
...
// GetRsiLengthOk returns a tuple with the RsiLength field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// SetRsiLength gets a reference to the given int64 and assigns it to the RsiLength field.
func (o *GetTimeSeriesStochRsi200ResponseMetaIndicator) SetRsiLength(v int64) {
	o.RsiLength = &v
}

// GetStochLength returns the StochLength field value if set, zero value otherwise.
func (o *GetTimeSeriesStochRsi200ResponseMetaIndicator) GetStochLength() int64 {
	if o == nil || IsNil(o.StochLength) {
		var ret int64
		return ret
	}
...
// GetStochLengthOk returns a tuple with the StochLength field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// SetStochLength gets a reference to the given int64 and assigns it to the StochLength field.
func (o *GetTimeSeriesStochRsi200ResponseMetaIndicator) SetStochLength(v int64) {
	o.StochLength = &v
}

// GetKPeriod returns the KPeriod field value if set, zero value otherwise.
func (o *GetTimeSeriesStochRsi200ResponseMetaIndicator) GetKPeriod() int64 {
	if o == nil || IsNil(o.KPeriod) {
		var ret int64
		return ret
	}
	return *o.KPeriod
...
// GetKPeriodOk returns a tuple with the KPeriod field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// SetKPeriod gets a reference to the given int64 and assigns it to the KPeriod field.
func (o *GetTimeSeriesStochRsi200ResponseMetaIndicator) SetKPeriod(v int64) {
	o.KPeriod = &v
}

// GetDPeriod returns the DPeriod field value if set, zero value otherwise.
func (o *GetTimeSeriesStochRsi200ResponseMetaIndicator) GetDPeriod() int64 {
	if o == nil || IsNil(o.DPeriod) {
		var ret int64
		return ret
	}
	return *o.DPeriod
...
// GetDPeriodOk returns a tuple with the DPeriod field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// SetDPeriod gets a reference to the given int64 and assigns it to the DPeriod field.
...
func (o GetTimeSeriesStochRsi200ResponseMetaIndicator) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.RsiLength) {
		toSerialize["rsi_length"] = o.RsiLength
	}
	if !IsNil(o.StochLength) {
