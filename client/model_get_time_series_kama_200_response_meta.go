...
type GetTimeSeriesKama200ResponseMeta struct {
	...
	Indicator *GetTimeSeriesKama200ResponseMetaIndicator `json:"indicator,omitempty"`
}
...
// SetIndicator gets a reference to the given GetTimeSeriesKama200ResponseMetaIndicator and assigns it to the Indicator field.
