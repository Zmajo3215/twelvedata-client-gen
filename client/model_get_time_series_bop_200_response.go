...
type GetTimeSeriesBop200Response struct {
	Meta *GetTimeSeriesBop200ResponseMeta `json:"meta,omitempty"`
	// Array of time series data points
	Values []GetTimeSeriesBop200ResponseValuesInner `json:"values,omitempty"`
	// Response status
...
func NewGetTimeSeriesBop200Response() *GetTimeSeriesBop200Response {
...
func (o *GetTimeSeriesBop200Response) HasMeta() bool {
	if o != nil && !IsNil(o.Meta) {
		return true
	}
...
// SetMeta gets a reference to the given GetTimeSeriesBop200ResponseMeta and assigns it to the Meta field.
...
func (o *GetTimeSeriesBop200Response) HasValues() bool {
	if o != nil && !IsNil(o.Values) {
		return true
	}
...
// SetValues gets a reference to the given []GetTimeSeriesBop200ResponseValuesInner and assigns it to the Values field.
...
func (o *GetTimeSeriesBop200Response) HasStatus() bool {
	if o != nil && !IsNil(o.Status) {
		return true
	}
