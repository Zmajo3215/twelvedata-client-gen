...
type GetTimeSeriesHtDcPhase200ResponseValuesInner struct {
	...
	// HT_DCPHASE value
	HtDcphase *string `json:"ht_dcphase,omitempty"`
}
...
// GetHtDcphase returns the HtDcphase field value if set, zero value otherwise.
func (o *GetTimeSeriesHtDcPhase200ResponseValuesInner) GetHtDcphase() string {
	if o == nil || IsNil(o.HtDcphase) {
		var ret string
		return ret
	}
	return *o.HtDcphase
...
// GetHtDcphaseOk returns a tuple with the HtDcphase field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// SetHtDcphase gets a reference to the given string and assigns it to the HtDcphase field.
