...
type GetTimeSeriesAd200Response struct {
	Meta *GetTimeSeriesAd200ResponseMeta `json:"meta,omitempty"`
	Values []GetTimeSeriesAd200ResponseValuesInner `json:"values,omitempty"`
	// Response status
...
// SetMeta gets a reference to the given GetTimeSeriesAd200ResponseMeta and assigns it to the Meta field.
...
// SetValues gets a reference to the given []GetTimeSeriesAd200ResponseValuesInner and assigns it to the Values field.
