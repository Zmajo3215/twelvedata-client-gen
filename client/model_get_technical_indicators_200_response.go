...
type GetTechnicalIndicators200Response struct {
	...
	Data map[string]GetTechnicalIndicators200ResponseDataValue `json:"data,omitempty"`
	// Response status
...
func NewGetTechnicalIndicators200Response() *GetTechnicalIndicators200Response {
...
func (o *GetTechnicalIndicators200Response) HasData() bool {
	if o != nil && !IsNil(o.Data) {
		return true
	}
...
// SetData gets a reference to the given map[string]GetTechnicalIndicators200ResponseDataValue and assigns it to the Data field.
...
func (o *GetTechnicalIndicators200Response) HasStatus() bool {
	if o != nil && !IsNil(o.Status) {
		return true
	}
