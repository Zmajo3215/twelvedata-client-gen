...
type GetTimeSeriesVwap200ResponseValuesInner struct {
	...
	// VWAP lower value
	VwapLower *float64 `json:"vwap_lower,omitempty"`
	// VWAP value
	Vwap *float64 `json:"vwap,omitempty"`
	// VWAP upper value
	VwapUpper *float64 `json:"vwap_upper,omitempty"`
}
...
// SetVwapLower gets a reference to the given float64 and assigns it to the VwapLower field.
func (o *GetTimeSeriesVwap200ResponseValuesInner) SetVwapLower(v float64) {
	o.VwapLower = &v
}

// GetVwap returns the Vwap field value if set, zero value otherwise.
func (o *GetTimeSeriesVwap200ResponseValuesInner) GetVwap() float64 {
	if o == nil || IsNil(o.Vwap) {
		var ret float64
		return ret
	}
	return *o.Vwap
...
// GetVwapOk returns a tuple with the Vwap field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// SetVwap gets a reference to the given float64 and assigns it to the Vwap field.
...
// SetVwapUpper gets a reference to the given float64 and assigns it to the VwapUpper field.
