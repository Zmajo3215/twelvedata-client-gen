...
type GetRecommendations200Response struct {
	Meta *GetRecommendations200ResponseMeta `json:"meta,omitempty"`
	Trends *GetRecommendations200ResponseTrends `json:"trends,omitempty"`
...
func NewGetRecommendations200Response() *GetRecommendations200Response {
...
func (o *GetRecommendations200Response) HasMeta() bool {
	if o != nil && !IsNil(o.Meta) {
		return true
	}
...
// SetMeta gets a reference to the given GetRecommendations200ResponseMeta and assigns it to the Meta field.
...
func (o *GetRecommendations200Response) HasTrends() bool {
	if o != nil && !IsNil(o.Trends) {
		return true
	}
...
// SetTrends gets a reference to the given GetRecommendations200ResponseTrends and assigns it to the Trends field.
...
func (o *GetRecommendations200Response) HasStatus() bool {
	if o != nil && !IsNil(o.Status) {
		return true
	}
