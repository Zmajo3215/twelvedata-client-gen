...
func NewGetTimeSeriesHtTrendline200ResponseMetaIndicator() *GetTimeSeriesHtTrendline200ResponseMetaIndicator {
...
func (o *GetTimeSeriesHtTrendline200ResponseMetaIndicator) HasName() bool {
	if o != nil && !IsNil(o.Name) {
		return true
	}
...
func (o *GetTimeSeriesHtTrendline200ResponseMetaIndicator) HasSeriesType() bool {
	if o != nil && !IsNil(o.SeriesType) {
		return true
	}
