...
func NewGetGrowthEstimates200Response() *GetGrowthEstimates200Response {
...
func (o *GetGrowthEstimates200Response) HasMeta() bool {
	if o != nil && !IsNil(o.Meta) {
		return true
	}
...
func (o *GetGrowthEstimates200Response) HasStatus() bool {
	if o != nil && !IsNil(o.Status) {
		return true
	}
