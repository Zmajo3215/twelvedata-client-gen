...
type GetTimeSeriesHtPhasor200ResponseValuesInner struct {
	...
	// In_phase value
	InPhase *string `json:"in_phase,omitempty"`
	// Quadrature value
	Quadrature *string `json:"quadrature,omitempty"`
}
...
func NewGetTimeSeriesHtPhasor200ResponseValuesInner() *GetTimeSeriesHtPhasor200ResponseValuesInner {
...
func (o *GetTimeSeriesHtPhasor200ResponseValuesInner) HasDatetime() bool {
	if o != nil && !IsNil(o.Datetime) {
		return true
	}
...
// GetInPhase returns the InPhase field value if set, zero value otherwise.
func (o *GetTimeSeriesHtPhasor200ResponseValuesInner) GetInPhase() string {
	if o == nil || IsNil(o.InPhase) {
		var ret string
		return ret
	}
	return *o.InPhase
...
// GetInPhaseOk returns a tuple with the InPhase field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// HasInPhase returns a boolean if a field has been set.
func (o *GetTimeSeriesHtPhasor200ResponseValuesInner) HasInPhase() bool {
	if o != nil && !IsNil(o.InPhase) {
		return true
	}
...
// SetInPhase gets a reference to the given string and assigns it to the InPhase field.
func (o *GetTimeSeriesHtPhasor200ResponseValuesInner) SetInPhase(v string) {
	o.InPhase = &v
}

// GetQuadrature returns the Quadrature field value if set, zero value otherwise.
func (o *GetTimeSeriesHtPhasor200ResponseValuesInner) GetQuadrature() string {
	if o == nil || IsNil(o.Quadrature) {
		var ret string
		return ret
	}
	return *o.Quadrature
...
// GetQuadratureOk returns a tuple with the Quadrature field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// HasQuadrature returns a boolean if a field has been set.
func (o *GetTimeSeriesHtPhasor200ResponseValuesInner) HasQuadrature() bool {
	if o != nil && !IsNil(o.Quadrature) {
		return true
	}
...
// SetQuadrature gets a reference to the given string and assigns it to the Quadrature field.
