...
// checks if the GetTimeSeriesPlusDI200ResponseMeta type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetTimeSeriesPlusDI200ResponseMeta{}

// GetTimeSeriesPlusDI200ResponseMeta Json object with request general information
type GetTimeSeriesPlusDI200ResponseMeta struct {
	...
	Indicator *GetTimeSeriesPlusDI200ResponseMetaIndicator `json:"indicator,omitempty"`
}
...
func NewGetTimeSeriesPlusDI200ResponseMeta() *GetTimeSeriesPlusDI200ResponseMeta {
	this := GetTimeSeriesPlusDI200ResponseMeta{}
	return &this
}
...
func (o *GetTimeSeriesPlusDI200ResponseMeta) HasSymbol() bool {
	if o != nil && !IsNil(o.Symbol) {
		return true
	}
...
func (o *GetTimeSeriesPlusDI200ResponseMeta) HasInterval() bool {
	if o != nil && !IsNil(o.Interval) {
		return true
	}
...
func (o *GetTimeSeriesPlusDI200ResponseMeta) HasCurrency() bool {
	if o != nil && !IsNil(o.Currency) {
		return true
	}
...
func (o *GetTimeSeriesPlusDI200ResponseMeta) HasExchangeTimezone() bool {
	if o != nil && !IsNil(o.ExchangeTimezone) {
		return true
	}
...
func (o *GetTimeSeriesPlusDI200ResponseMeta) HasExchange() bool {
	if o != nil && !IsNil(o.Exchange) {
		return true
	}
...
func (o *GetTimeSeriesPlusDI200ResponseMeta) HasMicCode() bool {
	if o != nil && !IsNil(o.MicCode) {
		return true
	}
...
func (o *GetTimeSeriesPlusDI200ResponseMeta) HasType() bool {
	if o != nil && !IsNil(o.Type) {
		return true
	}
...
func (o *GetTimeSeriesPlusDI200ResponseMeta) GetIndicator() GetTimeSeriesPlusDI200ResponseMetaIndicator {
	if o == nil || IsNil(o.Indicator) {
		var ret GetTimeSeriesPlusDI200ResponseMetaIndicator
		return ret
	}
	return *o.Indicator
}
...
func (o *GetTimeSeriesPlusDI200ResponseMeta) HasIndicator() bool {
	if o != nil && !IsNil(o.Indicator) {
		return true
	}
...
// SetIndicator gets a reference to the given GetTimeSeriesPlusDI200ResponseMetaIndicator and assigns it to the Indicator field.
func (o *GetTimeSeriesPlusDI200ResponseMeta) SetIndicator(v GetTimeSeriesPlusDI200ResponseMetaIndicator) {
	o.Indicator = &v
}

func (o GetTimeSeriesPlusDI200ResponseMeta) MarshalJSON() ([]byte, error) {
...
func (o GetTimeSeriesPlusDI200ResponseMeta) ToMap() (map[string]interface{}, error) {
...
type NullableGetTimeSeriesPlusDI200ResponseMeta struct {
	value *GetTimeSeriesPlusDI200ResponseMeta
	isSet bool
}

func (v NullableGetTimeSeriesPlusDI200ResponseMeta) Get() *GetTimeSeriesPlusDI200ResponseMeta {
	return v.value
}

func (v *NullableGetTimeSeriesPlusDI200ResponseMeta) Set(val *GetTimeSeriesPlusDI200ResponseMeta) {
	v.value = val
	v.isSet = true
}

func (v NullableGetTimeSeriesPlusDI200ResponseMeta) IsSet() bool {
	return v.isSet
}

func (v *NullableGetTimeSeriesPlusDI200ResponseMeta) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetTimeSeriesPlusDI200ResponseMeta(val *GetTimeSeriesPlusDI200ResponseMeta) *NullableGetTimeSeriesPlusDI200ResponseMeta {
	return &NullableGetTimeSeriesPlusDI200ResponseMeta{value: val, isSet: true}
}

func (v NullableGetTimeSeriesPlusDI200ResponseMeta) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetTimeSeriesPlusDI200ResponseMeta) UnmarshalJSON(src []byte) error {
	v.isSet = true
