...
type GetETFsWorldRisk200Response struct {
	Etf *GetETFsWorldRisk200ResponseEtf `json:"etf,omitempty"`
...
func NewGetETFsWorldRisk200Response() *GetETFsWorldRisk200Response {
...
func (o *GetETFsWorldRisk200Response) HasEtf() bool {
	if o != nil && !IsNil(o.Etf) {
		return true
	}
...
// SetEtf gets a reference to the given GetETFsWorldRisk200ResponseEtf and assigns it to the Etf field.
...
func (o *GetETFsWorldRisk200Response) HasStatus() bool {
	if o != nil && !IsNil(o.Status) {
		return true
	}
