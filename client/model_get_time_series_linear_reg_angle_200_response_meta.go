...
type GetTimeSeriesLinearRegAngle200ResponseMeta struct {
	...
	Indicator *GetTimeSeriesLinearRegAngle200ResponseMetaIndicator `json:"indicator,omitempty"`
}
...
// SetIndicator gets a reference to the given GetTimeSeriesLinearRegAngle200ResponseMetaIndicator and assigns it to the Indicator field.
