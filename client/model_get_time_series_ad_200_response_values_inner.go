...
func NewGetTimeSeriesAd200ResponseValuesInner() *GetTimeSeriesAd200ResponseValuesInner {
...
func (o *GetTimeSeriesAd200ResponseValuesInner) HasDatetime() bool {
	if o != nil && !IsNil(o.Datetime) {
		return true
	}
...
func (o *GetTimeSeriesAd200ResponseValuesInner) HasAd() bool {
	if o != nil && !IsNil(o.Ad) {
		return true
	}
...
// SetAd gets a reference to the given string and assigns it to the Ad field.
