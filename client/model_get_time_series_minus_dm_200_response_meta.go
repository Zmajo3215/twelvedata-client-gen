...
// checks if the GetTimeSeriesMinusDM200ResponseMeta type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetTimeSeriesMinusDM200ResponseMeta{}

// GetTimeSeriesMinusDM200ResponseMeta Json object with request general information
type GetTimeSeriesMinusDM200ResponseMeta struct {
	...
	Indicator *GetTimeSeriesMinusDM200ResponseMetaIndicator `json:"indicator,omitempty"`
}
...
func NewGetTimeSeriesMinusDM200ResponseMeta() *GetTimeSeriesMinusDM200ResponseMeta {
	this := GetTimeSeriesMinusDM200ResponseMeta{}
	return &this
}
...
func (o *GetTimeSeriesMinusDM200ResponseMeta) HasSymbol() bool {
	if o != nil && !IsNil(o.Symbol) {
		return true
	}
...
func (o *GetTimeSeriesMinusDM200ResponseMeta) HasInterval() bool {
	if o != nil && !IsNil(o.Interval) {
		return true
	}
...
func (o *GetTimeSeriesMinusDM200ResponseMeta) HasCurrency() bool {
	if o != nil && !IsNil(o.Currency) {
		return true
	}
...
func (o *GetTimeSeriesMinusDM200ResponseMeta) HasExchangeTimezone() bool {
	if o != nil && !IsNil(o.ExchangeTimezone) {
		return true
	}
...
func (o *GetTimeSeriesMinusDM200ResponseMeta) HasExchange() bool {
	if o != nil && !IsNil(o.Exchange) {
		return true
	}
...
func (o *GetTimeSeriesMinusDM200ResponseMeta) HasMicCode() bool {
	if o != nil && !IsNil(o.MicCode) {
		return true
	}
...
func (o *GetTimeSeriesMinusDM200ResponseMeta) HasType() bool {
	if o != nil && !IsNil(o.Type) {
		return true
	}
...
func (o *GetTimeSeriesMinusDM200ResponseMeta) GetIndicator() GetTimeSeriesMinusDM200ResponseMetaIndicator {
	if o == nil || IsNil(o.Indicator) {
		var ret GetTimeSeriesMinusDM200ResponseMetaIndicator
		return ret
	}
	return *o.Indicator
}
...
func (o *GetTimeSeriesMinusDM200ResponseMeta) HasIndicator() bool {
	if o != nil && !IsNil(o.Indicator) {
		return true
	}
...
// SetIndicator gets a reference to the given GetTimeSeriesMinusDM200ResponseMetaIndicator and assigns it to the Indicator field.
func (o *GetTimeSeriesMinusDM200ResponseMeta) SetIndicator(v GetTimeSeriesMinusDM200ResponseMetaIndicator) {
	o.Indicator = &v
}

func (o GetTimeSeriesMinusDM200ResponseMeta) MarshalJSON() ([]byte, error) {
...
func (o GetTimeSeriesMinusDM200ResponseMeta) ToMap() (map[string]interface{}, error) {
...
type NullableGetTimeSeriesMinusDM200ResponseMeta struct {
	value *GetTimeSeriesMinusDM200ResponseMeta
	isSet bool
}

func (v NullableGetTimeSeriesMinusDM200ResponseMeta) Get() *GetTimeSeriesMinusDM200ResponseMeta {
	return v.value
}

func (v *NullableGetTimeSeriesMinusDM200ResponseMeta) Set(val *GetTimeSeriesMinusDM200ResponseMeta) {
	v.value = val
	v.isSet = true
}

func (v NullableGetTimeSeriesMinusDM200ResponseMeta) IsSet() bool {
	return v.isSet
}

func (v *NullableGetTimeSeriesMinusDM200ResponseMeta) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetTimeSeriesMinusDM200ResponseMeta(val *GetTimeSeriesMinusDM200ResponseMeta) *NullableGetTimeSeriesMinusDM200ResponseMeta {
	return &NullableGetTimeSeriesMinusDM200ResponseMeta{value: val, isSet: true}
}

func (v NullableGetTimeSeriesMinusDM200ResponseMeta) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetTimeSeriesMinusDM200ResponseMeta) UnmarshalJSON(src []byte) error {
	v.isSet = true
