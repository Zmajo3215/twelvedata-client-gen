...
// checks if the GetTimeSeries200ResponseMeta type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetTimeSeries200ResponseMeta{}

// GetTimeSeries200ResponseMeta Json object with request general information
type GetTimeSeries200ResponseMeta struct {
...
func NewGetTimeSeries200ResponseMeta() *GetTimeSeries200ResponseMeta {
	this := GetTimeSeries200ResponseMeta{}
	return &this
}
...
func (o GetTimeSeries200ResponseMeta) MarshalJSON() ([]byte, error) {
...
func (o GetTimeSeries200ResponseMeta) ToMap() (map[string]interface{}, error) {
...
type NullableGetTimeSeries200ResponseMeta struct {
	value *GetTimeSeries200ResponseMeta
	isSet bool
}

func (v NullableGetTimeSeries200ResponseMeta) Get() *GetTimeSeries200ResponseMeta {
	return v.value
}

func (v *NullableGetTimeSeries200ResponseMeta) Set(val *GetTimeSeries200ResponseMeta) {
	v.value = val
	v.isSet = true
}

func (v NullableGetTimeSeries200ResponseMeta) IsSet() bool {
	return v.isSet
}

func (v *NullableGetTimeSeries200ResponseMeta) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetTimeSeries200ResponseMeta(val *GetTimeSeries200ResponseMeta) *NullableGetTimeSeries200ResponseMeta {
	return &NullableGetTimeSeries200ResponseMeta{value: val, isSet: true}
}

func (v NullableGetTimeSeries200ResponseMeta) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetTimeSeries200ResponseMeta) UnmarshalJSON(src []byte) error {
	v.isSet = true
