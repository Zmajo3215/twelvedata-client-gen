...
type GetTimeSeriesTRange200Response struct {
	Meta *GetTimeSeriesTRange200ResponseMeta `json:"meta,omitempty"`
	// Array of time series data points
	Values []GetTimeSeriesTRange200ResponseValuesInner `json:"values,omitempty"`
	// Response status
...
func NewGetTimeSeriesTRange200Response() *GetTimeSeriesTRange200Response {
...
func (o *GetTimeSeriesTRange200Response) HasMeta() bool {
	if o != nil && !IsNil(o.Meta) {
		return true
	}
...
// SetMeta gets a reference to the given GetTimeSeriesTRange200ResponseMeta and assigns it to the Meta field.
...
func (o *GetTimeSeriesTRange200Response) HasValues() bool {
	if o != nil && !IsNil(o.Values) {
		return true
	}
...
// SetValues gets a reference to the given []GetTimeSeriesTRange200ResponseValuesInner and assigns it to the Values field.
...
func (o *GetTimeSeriesTRange200Response) HasStatus() bool {
	if o != nil && !IsNil(o.Status) {
		return true
	}
