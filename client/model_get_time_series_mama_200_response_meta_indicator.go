...
type GetTimeSeriesMama200ResponseMetaIndicator struct {
	...
	FastLimit *float64 `json:"fast_limit,omitempty"`
	// The limit for the slow moving average
	SlowLimit *float64 `json:"slow_limit,omitempty"`
}
...
func NewGetTimeSeriesMama200ResponseMetaIndicator() *GetTimeSeriesMama200ResponseMetaIndicator {
...
func (o *GetTimeSeriesMama200ResponseMetaIndicator) HasName() bool {
	if o != nil && !IsNil(o.Name) {
		return true
	}
...
func (o *GetTimeSeriesMama200ResponseMetaIndicator) HasSeriesType() bool {
	if o != nil && !IsNil(o.SeriesType) {
		return true
	}
...
// GetFastLimit returns the FastLimit field value if set, zero value otherwise.
func (o *GetTimeSeriesMama200ResponseMetaIndicator) GetFastLimit() float64 {
	if o == nil || IsNil(o.FastLimit) {
		var ret float64
		return ret
	}
	return *o.FastLimit
...
// GetFastLimitOk returns a tuple with the FastLimit field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// HasFastLimit returns a boolean if a field has been set.
func (o *GetTimeSeriesMama200ResponseMetaIndicator) HasFastLimit() bool {
	if o != nil && !IsNil(o.FastLimit) {
		return true
	}
...
// SetFastLimit gets a reference to the given float64 and assigns it to the FastLimit field.
func (o *GetTimeSeriesMama200ResponseMetaIndicator) SetFastLimit(v float64) {
	o.FastLimit = &v
}

// GetSlowLimit returns the SlowLimit field value if set, zero value otherwise.
func (o *GetTimeSeriesMama200ResponseMetaIndicator) GetSlowLimit() float64 {
	if o == nil || IsNil(o.SlowLimit) {
		var ret float64
		return ret
	}
	return *o.SlowLimit
...
// GetSlowLimitOk returns a tuple with the SlowLimit field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// HasSlowLimit returns a boolean if a field has been set.
func (o *GetTimeSeriesMama200ResponseMetaIndicator) HasSlowLimit() bool {
	if o != nil && !IsNil(o.SlowLimit) {
		return true
	}
...
// SetSlowLimit gets a reference to the given float64 and assigns it to the SlowLimit field.
...
func (o GetTimeSeriesMama200ResponseMetaIndicator) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.FastLimit) {
		toSerialize["fast_limit"] = o.FastLimit
	}
	if !IsNil(o.SlowLimit) {
