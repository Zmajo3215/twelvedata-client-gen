...
type InlineObject10Meta struct {
	...
	Indicator *InlineObject10MetaIndicator `json:"indicator,omitempty"`
}
...
func NewInlineObject10Meta() *InlineObject10Meta {
...
func (o *InlineObject10Meta) HasSymbol() bool {
	if o != nil && !IsNil(o.Symbol) {
		return true
	}
...
func (o *InlineObject10Meta) HasInterval() bool {
	if o != nil && !IsNil(o.Interval) {
		return true
	}
...
func (o *InlineObject10Meta) HasCurrency() bool {
	if o != nil && !IsNil(o.Currency) {
		return true
	}
...
func (o *InlineObject10Meta) HasExchangeTimezone() bool {
	if o != nil && !IsNil(o.ExchangeTimezone) {
		return true
	}
...
func (o *InlineObject10Meta) HasExchange() bool {
	if o != nil && !IsNil(o.Exchange) {
		return true
	}
...
func (o *InlineObject10Meta) HasMicCode() bool {
	if o != nil && !IsNil(o.MicCode) {
		return true
	}
...
func (o *InlineObject10Meta) HasType() bool {
	if o != nil && !IsNil(o.Type) {
		return true
	}
...
func (o *InlineObject10Meta) HasIndicator() bool {
	if o != nil && !IsNil(o.Indicator) {
		return true
	}
...
// SetIndicator gets a reference to the given InlineObject10MetaIndicator and assigns it to the Indicator field.
