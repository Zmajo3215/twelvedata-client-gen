...
type GetRevenueEstimate200Response struct {
	...
	RevenueEstimate []GetRevenueEstimate200ResponseRevenueEstimateInner `json:"revenue_estimate,omitempty"`
...
func (o *GetRevenueEstimate200Response) GetRevenueEstimate() []GetRevenueEstimate200ResponseRevenueEstimateInner {
	if o == nil || IsNil(o.RevenueEstimate) {
...
// SetRevenueEstimate gets a reference to the given []GetRevenueEstimate200ResponseRevenueEstimateInner and assigns it to the RevenueEstimate field.
