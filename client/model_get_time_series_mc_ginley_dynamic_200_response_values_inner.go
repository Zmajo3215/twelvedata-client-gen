...
type GetTimeSeriesMcGinleyDynamic200ResponseValuesInner struct {
	...
	McginleyDynamic *string `json:"mcginley_dynamic,omitempty"`
}
...
// GetMcginleyDynamic returns the McginleyDynamic field value if set, zero value otherwise.
func (o *GetTimeSeriesMcGinleyDynamic200ResponseValuesInner) GetMcginleyDynamic() string {
	if o == nil || IsNil(o.McginleyDynamic) {
		var ret string
		return ret
	}
...
// GetMcginleyDynamicOk returns a tuple with the McginleyDynamic field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// SetMcginleyDynamic gets a reference to the given string and assigns it to the McginleyDynamic field.
