...
type GetTimeSeriesEma200Response struct {
	Meta *GetTimeSeriesEma200ResponseMeta `json:"meta,omitempty"`
	// Array of time series data points
	Values []GetTimeSeriesEma200ResponseValuesInner `json:"values,omitempty"`
	// Response status
...
// SetMeta gets a reference to the given GetTimeSeriesEma200ResponseMeta and assigns it to the Meta field.
...
// SetValues gets a reference to the given []GetTimeSeriesEma200ResponseValuesInner and assigns it to the Values field.
