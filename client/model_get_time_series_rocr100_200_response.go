...
type GetTimeSeriesRocr100200Response struct {
	Meta *GetTimeSeriesRocr100200ResponseMeta `json:"meta,omitempty"`
	// Array of time series data points
	Values []GetTimeSeriesRocr100200ResponseValuesInner `json:"values,omitempty"`
	// Response status
...
func NewGetTimeSeriesRocr100200Response() *GetTimeSeriesRocr100200Response {
...
func (o *GetTimeSeriesRocr100200Response) HasMeta() bool {
	if o != nil && !IsNil(o.Meta) {
		return true
	}
...
// SetMeta gets a reference to the given GetTimeSeriesRocr100200ResponseMeta and assigns it to the Meta field.
...
func (o *GetTimeSeriesRocr100200Response) HasValues() bool {
	if o != nil && !IsNil(o.Values) {
		return true
	}
...
// SetValues gets a reference to the given []GetTimeSeriesRocr100200ResponseValuesInner and assigns it to the Values field.
...
func (o *GetTimeSeriesRocr100200Response) HasStatus() bool {
	if o != nil && !IsNil(o.Status) {
		return true
	}
