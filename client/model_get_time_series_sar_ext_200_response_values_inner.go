...
type GetTimeSeriesSarExt200ResponseValuesInner struct {
	...
	// SAREXT value
	Sarext *string `json:"sarext,omitempty"`
}
...
func NewGetTimeSeriesSarExt200ResponseValuesInner() *GetTimeSeriesSarExt200ResponseValuesInner {
...
func (o *GetTimeSeriesSarExt200ResponseValuesInner) HasDatetime() bool {
	if o != nil && !IsNil(o.Datetime) {
		return true
	}
...
// GetSarext returns the Sarext field value if set, zero value otherwise.
func (o *GetTimeSeriesSarExt200ResponseValuesInner) GetSarext() string {
	if o == nil || IsNil(o.Sarext) {
		var ret string
		return ret
	}
	return *o.Sarext
...
// GetSarextOk returns a tuple with the Sarext field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// HasSarext returns a boolean if a field has been set.
func (o *GetTimeSeriesSarExt200ResponseValuesInner) HasSarext() bool {
	if o != nil && !IsNil(o.Sarext) {
		return true
	}
...
// SetSarext gets a reference to the given string and assigns it to the Sarext field.
