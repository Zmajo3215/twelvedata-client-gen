...
// checks if the GetTimeSeriesBeta200ResponseMeta type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetTimeSeriesBeta200ResponseMeta{}

// GetTimeSeriesBeta200ResponseMeta Json object with request general information
type GetTimeSeriesBeta200ResponseMeta struct {
	...
	Indicator *GetTimeSeriesBeta200ResponseMetaIndicator `json:"indicator,omitempty"`
}
...
func NewGetTimeSeriesBeta200ResponseMeta() *GetTimeSeriesBeta200ResponseMeta {
	this := GetTimeSeriesBeta200ResponseMeta{}
	return &this
}
...
func (o *GetTimeSeriesBeta200ResponseMeta) GetIndicator() GetTimeSeriesBeta200ResponseMetaIndicator {
	if o == nil || IsNil(o.Indicator) {
		var ret GetTimeSeriesBeta200ResponseMetaIndicator
		return ret
	}
	return *o.Indicator
}
...
// SetIndicator gets a reference to the given GetTimeSeriesBeta200ResponseMetaIndicator and assigns it to the Indicator field.
func (o *GetTimeSeriesBeta200ResponseMeta) SetIndicator(v GetTimeSeriesBeta200ResponseMetaIndicator) {
	o.Indicator = &v
}

func (o GetTimeSeriesBeta200ResponseMeta) MarshalJSON() ([]byte, error) {
...
func (o GetTimeSeriesBeta200ResponseMeta) ToMap() (map[string]interface{}, error) {
...
type NullableGetTimeSeriesBeta200ResponseMeta struct {
	value *GetTimeSeriesBeta200ResponseMeta
	isSet bool
}

func (v NullableGetTimeSeriesBeta200ResponseMeta) Get() *GetTimeSeriesBeta200ResponseMeta {
	return v.value
}

func (v *NullableGetTimeSeriesBeta200ResponseMeta) Set(val *GetTimeSeriesBeta200ResponseMeta) {
	v.value = val
	v.isSet = true
}

func (v NullableGetTimeSeriesBeta200ResponseMeta) IsSet() bool {
	return v.isSet
}

func (v *NullableGetTimeSeriesBeta200ResponseMeta) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetTimeSeriesBeta200ResponseMeta(val *GetTimeSeriesBeta200ResponseMeta) *NullableGetTimeSeriesBeta200ResponseMeta {
	return &NullableGetTimeSeriesBeta200ResponseMeta{value: val, isSet: true}
}

func (v NullableGetTimeSeriesBeta200ResponseMeta) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetTimeSeriesBeta200ResponseMeta) UnmarshalJSON(src []byte) error {
	v.isSet = true
