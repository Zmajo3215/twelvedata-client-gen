...
// checks if the InlineObject12Meta type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &InlineObject12Meta{}

// InlineObject12Meta Json object with request general information
type InlineObject12Meta struct {
	...
	Indicator *InlineObject12MetaIndicator `json:"indicator,omitempty"`
}
...
func (o *InlineObject12Meta) GetIndicator() InlineObject12MetaIndicator {
	if o == nil || IsNil(o.Indicator) {
		var ret InlineObject12MetaIndicator
		return ret
	}
	return *o.Indicator
}
...
// SetIndicator gets a reference to the given InlineObject12MetaIndicator and assigns it to the Indicator field.
func (o *InlineObject12Meta) SetIndicator(v InlineObject12MetaIndicator) {
	o.Indicator = &v
}

func (o InlineObject12Meta) MarshalJSON() ([]byte, error) {
...
func (o InlineObject12Meta) ToMap() (map[string]interface{}, error) {
...
type NullableInlineObject12Meta struct {
	value *InlineObject12Meta
	isSet bool
}

func (v NullableInlineObject12Meta) Get() *InlineObject12Meta {
	return v.value
}

func (v *NullableInlineObject12Meta) Set(val *InlineObject12Meta) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject12Meta) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject12Meta) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject12Meta(val *InlineObject12Meta) *NullableInlineObject12Meta {
	return &NullableInlineObject12Meta{value: val, isSet: true}
}

func (v NullableInlineObject12Meta) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject12Meta) UnmarshalJSON(src []byte) error {
	v.isSet = true
