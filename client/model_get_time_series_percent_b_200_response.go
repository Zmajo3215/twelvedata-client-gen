...
type GetTimeSeriesPercentB200Response struct {
	Meta *GetTimeSeriesPercentB200ResponseMeta `json:"meta,omitempty"`
	// Array of time series data points
	Values []GetTimeSeriesPercentB200ResponseValuesInner `json:"values,omitempty"`
	// Response status
...
// SetMeta gets a reference to the given GetTimeSeriesPercentB200ResponseMeta and assigns it to the Meta field.
...
// SetValues gets a reference to the given []GetTimeSeriesPercentB200ResponseValuesInner and assigns it to the Values field.
