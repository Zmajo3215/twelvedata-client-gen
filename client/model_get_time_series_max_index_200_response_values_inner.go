...
func NewGetTimeSeriesMaxIndex200ResponseValuesInner() *GetTimeSeriesMaxIndex200ResponseValuesInner {
...
func (o *GetTimeSeriesMaxIndex200ResponseValuesInner) HasDatetime() bool {
	if o != nil && !IsNil(o.Datetime) {
		return true
	}
...
func (o *GetTimeSeriesMaxIndex200ResponseValuesInner) HasMaxidx() bool {
	if o != nil && !IsNil(o.Maxidx) {
		return true
	}
