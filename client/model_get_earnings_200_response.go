...
type GetEarnings200Response struct {
	Meta *GetEarnings200ResponseMeta `json:"meta,omitempty"`
...
func NewGetEarnings200Response() *GetEarnings200Response {
...
func (o *GetEarnings200Response) HasMeta() bool {
	if o != nil && !IsNil(o.Meta) {
		return true
	}
...
// SetMeta gets a reference to the given GetEarnings200ResponseMeta and assigns it to the Meta field.
...
func (o *GetEarnings200Response) HasEarnings() bool {
	if o != nil && !IsNil(o.Earnings) {
		return true
	}
...
// SetEarnings gets a reference to the given []EarningsItem and assigns it to the Earnings field.
...
func (o *GetEarnings200Response) HasStatus() bool {
	if o != nil && !IsNil(o.Status) {
		return true
	}
