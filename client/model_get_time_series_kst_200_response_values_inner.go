...
type GetTimeSeriesKst200ResponseValuesInner struct {
	...
	// KST value
	Kst *string `json:"kst,omitempty"`
	// KST signal value
	KstSignal *string `json:"kst_signal,omitempty"`
}
...
// GetKst returns the Kst field value if set, zero value otherwise.
func (o *GetTimeSeriesKst200ResponseValuesInner) GetKst() string {
	if o == nil || IsNil(o.Kst) {
		var ret string
		return ret
	}
	return *o.Kst
...
// GetKstOk returns a tuple with the Kst field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// SetKst gets a reference to the given string and assigns it to the Kst field.
func (o *GetTimeSeriesKst200ResponseValuesInner) SetKst(v string) {
	o.Kst = &v
}

// GetKstSignal returns the KstSignal field value if set, zero value otherwise.
func (o *GetTimeSeriesKst200ResponseValuesInner) GetKstSignal() string {
	if o == nil || IsNil(o.KstSignal) {
		var ret string
		return ret
	}
	return *o.KstSignal
...
// GetKstSignalOk returns a tuple with the KstSignal field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// SetKstSignal gets a reference to the given string and assigns it to the KstSignal field.
