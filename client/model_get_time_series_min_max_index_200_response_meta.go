...
// checks if the GetTimeSeriesMinMaxIndex200ResponseMeta type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetTimeSeriesMinMaxIndex200ResponseMeta{}

// GetTimeSeriesMinMaxIndex200ResponseMeta Json object with request general information
type GetTimeSeriesMinMaxIndex200ResponseMeta struct {
	...
	Indicator *GetTimeSeriesMinMaxIndex200ResponseMetaIndicator `json:"indicator,omitempty"`
}
...
func NewGetTimeSeriesMinMaxIndex200ResponseMeta() *GetTimeSeriesMinMaxIndex200ResponseMeta {
	this := GetTimeSeriesMinMaxIndex200ResponseMeta{}
	return &this
}
...
func (o *GetTimeSeriesMinMaxIndex200ResponseMeta) GetIndicator() GetTimeSeriesMinMaxIndex200ResponseMetaIndicator {
	if o == nil || IsNil(o.Indicator) {
		var ret GetTimeSeriesMinMaxIndex200ResponseMetaIndicator
		return ret
	}
	return *o.Indicator
}
...
// SetIndicator gets a reference to the given GetTimeSeriesMinMaxIndex200ResponseMetaIndicator and assigns it to the Indicator field.
func (o *GetTimeSeriesMinMaxIndex200ResponseMeta) SetIndicator(v GetTimeSeriesMinMaxIndex200ResponseMetaIndicator) {
	o.Indicator = &v
}

func (o GetTimeSeriesMinMaxIndex200ResponseMeta) MarshalJSON() ([]byte, error) {
...
func (o GetTimeSeriesMinMaxIndex200ResponseMeta) ToMap() (map[string]interface{}, error) {
...
type NullableGetTimeSeriesMinMaxIndex200ResponseMeta struct {
	value *GetTimeSeriesMinMaxIndex200ResponseMeta
	isSet bool
}

func (v NullableGetTimeSeriesMinMaxIndex200ResponseMeta) Get() *GetTimeSeriesMinMaxIndex200ResponseMeta {
	return v.value
}

func (v *NullableGetTimeSeriesMinMaxIndex200ResponseMeta) Set(val *GetTimeSeriesMinMaxIndex200ResponseMeta) {
	v.value = val
	v.isSet = true
}

func (v NullableGetTimeSeriesMinMaxIndex200ResponseMeta) IsSet() bool {
	return v.isSet
}

func (v *NullableGetTimeSeriesMinMaxIndex200ResponseMeta) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetTimeSeriesMinMaxIndex200ResponseMeta(val *GetTimeSeriesMinMaxIndex200ResponseMeta) *NullableGetTimeSeriesMinMaxIndex200ResponseMeta {
	return &NullableGetTimeSeriesMinMaxIndex200ResponseMeta{value: val, isSet: true}
}

func (v NullableGetTimeSeriesMinMaxIndex200ResponseMeta) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetTimeSeriesMinMaxIndex200ResponseMeta) UnmarshalJSON(src []byte) error {
	v.isSet = true
