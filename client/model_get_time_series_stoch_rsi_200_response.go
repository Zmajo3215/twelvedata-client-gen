...
type GetTimeSeriesStochRsi200Response struct {
	Meta *GetTimeSeriesStochRsi200ResponseMeta `json:"meta,omitempty"`
	// Array of time series data points
	Values []GetTimeSeriesStochRsi200ResponseValuesInner `json:"values,omitempty"`
	// Response status
...
// SetMeta gets a reference to the given GetTimeSeriesStochRsi200ResponseMeta and assigns it to the Meta field.
...
// SetValues gets a reference to the given []GetTimeSeriesStochRsi200ResponseValuesInner and assigns it to the Values field.
