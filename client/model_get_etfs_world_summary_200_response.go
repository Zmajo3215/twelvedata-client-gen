...
type GetETFsWorldSummary200Response struct {
	Etf *GetETFsWorldSummary200ResponseEtf `json:"etf,omitempty"`
...
func NewGetETFsWorldSummary200Response() *GetETFsWorldSummary200Response {
...
func (o *GetETFsWorldSummary200Response) HasEtf() bool {
	if o != nil && !IsNil(o.Etf) {
		return true
	}
...
// SetEtf gets a reference to the given GetETFsWorldSummary200ResponseEtf and assigns it to the Etf field.
...
func (o *GetETFsWorldSummary200Response) HasStatus() bool {
	if o != nil && !IsNil(o.Status) {
		return true
	}
