...
// GetObv returns the Obv field value if set, zero value otherwise.
func (o *GetTimeSeriesObv200ResponseValuesInner) GetObv() string {
	if o == nil || IsNil(o.Obv) {
		var ret string
		return ret
	}
	return *o.Obv
...
// GetObvOk returns a tuple with the Obv field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// SetObv gets a reference to the given string and assigns it to the Obv field.
