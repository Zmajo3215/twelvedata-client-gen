...
// checks if the GetTimeSeriesMinusDI200ResponseMeta type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetTimeSeriesMinusDI200ResponseMeta{}

// GetTimeSeriesMinusDI200ResponseMeta Json object with request general information
type GetTimeSeriesMinusDI200ResponseMeta struct {
	...
	Indicator *GetTimeSeriesMinusDI200ResponseMetaIndicator `json:"indicator,omitempty"`
}
...
func NewGetTimeSeriesMinusDI200ResponseMeta() *GetTimeSeriesMinusDI200ResponseMeta {
	this := GetTimeSeriesMinusDI200ResponseMeta{}
	return &this
}
...
func (o *GetTimeSeriesMinusDI200ResponseMeta) HasSymbol() bool {
	if o != nil && !IsNil(o.Symbol) {
		return true
	}
...
func (o *GetTimeSeriesMinusDI200ResponseMeta) HasInterval() bool {
	if o != nil && !IsNil(o.Interval) {
		return true
	}
...
func (o *GetTimeSeriesMinusDI200ResponseMeta) HasCurrency() bool {
	if o != nil && !IsNil(o.Currency) {
		return true
	}
...
func (o *GetTimeSeriesMinusDI200ResponseMeta) HasExchangeTimezone() bool {
	if o != nil && !IsNil(o.ExchangeTimezone) {
		return true
	}
...
func (o *GetTimeSeriesMinusDI200ResponseMeta) HasExchange() bool {
	if o != nil && !IsNil(o.Exchange) {
		return true
	}
...
func (o *GetTimeSeriesMinusDI200ResponseMeta) HasMicCode() bool {
	if o != nil && !IsNil(o.MicCode) {
		return true
	}
...
func (o *GetTimeSeriesMinusDI200ResponseMeta) HasType() bool {
	if o != nil && !IsNil(o.Type) {
		return true
	}
...
func (o *GetTimeSeriesMinusDI200ResponseMeta) GetIndicator() GetTimeSeriesMinusDI200ResponseMetaIndicator {
	if o == nil || IsNil(o.Indicator) {
		var ret GetTimeSeriesMinusDI200ResponseMetaIndicator
		return ret
	}
	return *o.Indicator
}
...
func (o *GetTimeSeriesMinusDI200ResponseMeta) HasIndicator() bool {
	if o != nil && !IsNil(o.Indicator) {
		return true
	}
...
// SetIndicator gets a reference to the given GetTimeSeriesMinusDI200ResponseMetaIndicator and assigns it to the Indicator field.
func (o *GetTimeSeriesMinusDI200ResponseMeta) SetIndicator(v GetTimeSeriesMinusDI200ResponseMetaIndicator) {
	o.Indicator = &v
}

func (o GetTimeSeriesMinusDI200ResponseMeta) MarshalJSON() ([]byte, error) {
...
func (o GetTimeSeriesMinusDI200ResponseMeta) ToMap() (map[string]interface{}, error) {
...
type NullableGetTimeSeriesMinusDI200ResponseMeta struct {
	value *GetTimeSeriesMinusDI200ResponseMeta
	isSet bool
}

func (v NullableGetTimeSeriesMinusDI200ResponseMeta) Get() *GetTimeSeriesMinusDI200ResponseMeta {
	return v.value
}

func (v *NullableGetTimeSeriesMinusDI200ResponseMeta) Set(val *GetTimeSeriesMinusDI200ResponseMeta) {
	v.value = val
	v.isSet = true
}

func (v NullableGetTimeSeriesMinusDI200ResponseMeta) IsSet() bool {
	return v.isSet
}

func (v *NullableGetTimeSeriesMinusDI200ResponseMeta) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetTimeSeriesMinusDI200ResponseMeta(val *GetTimeSeriesMinusDI200ResponseMeta) *NullableGetTimeSeriesMinusDI200ResponseMeta {
	return &NullableGetTimeSeriesMinusDI200ResponseMeta{value: val, isSet: true}
}

func (v NullableGetTimeSeriesMinusDI200ResponseMeta) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetTimeSeriesMinusDI200ResponseMeta) UnmarshalJSON(src []byte) error {
	v.isSet = true
