...
type GetTimeSeriesKst200Response struct {
	Meta *GetTimeSeriesKst200ResponseMeta `json:"meta,omitempty"`
	// Array of time series data points
	Values []GetTimeSeriesKst200ResponseValuesInner `json:"values,omitempty"`
	// Response status
...
// SetMeta gets a reference to the given GetTimeSeriesKst200ResponseMeta and assigns it to the Meta field.
...
// SetValues gets a reference to the given []GetTimeSeriesKst200ResponseValuesInner and assigns it to the Values field.
