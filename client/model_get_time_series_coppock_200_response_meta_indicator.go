...
type GetTimeSeriesCoppock200ResponseMetaIndicator struct {
	...
	WmaPeriod *int64 `json:"wma_period,omitempty"`
	// Number of periods for long term rate of change
	LongRocPeriod *int64 `json:"long_roc_period,omitempty"`
	// Number of periods for short term rate of change
	ShortRocPeriod *int64 `json:"short_roc_period,omitempty"`
}
...
func NewGetTimeSeriesCoppock200ResponseMetaIndicator() *GetTimeSeriesCoppock200ResponseMetaIndicator {
...
func (o *GetTimeSeriesCoppock200ResponseMetaIndicator) HasName() bool {
	if o != nil && !IsNil(o.Name) {
		return true
	}
...
func (o *GetTimeSeriesCoppock200ResponseMetaIndicator) HasSeriesType() bool {
	if o != nil && !IsNil(o.SeriesType) {
		return true
	}
...
// GetWmaPeriod returns the WmaPeriod field value if set, zero value otherwise.
func (o *GetTimeSeriesCoppock200ResponseMetaIndicator) GetWmaPeriod() int64 {
	if o == nil || IsNil(o.WmaPeriod) {
		var ret int64
		return ret
	}
	return *o.WmaPeriod
...
// GetWmaPeriodOk returns a tuple with the WmaPeriod field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// HasWmaPeriod returns a boolean if a field has been set.
func (o *GetTimeSeriesCoppock200ResponseMetaIndicator) HasWmaPeriod() bool {
	if o != nil && !IsNil(o.WmaPeriod) {
		return true
	}
...
// SetWmaPeriod gets a reference to the given int64 and assigns it to the WmaPeriod field.
func (o *GetTimeSeriesCoppock200ResponseMetaIndicator) SetWmaPeriod(v int64) {
	o.WmaPeriod = &v
}

// GetLongRocPeriod returns the LongRocPeriod field value if set, zero value otherwise.
func (o *GetTimeSeriesCoppock200ResponseMetaIndicator) GetLongRocPeriod() int64 {
	if o == nil || IsNil(o.LongRocPeriod) {
		var ret int64
		return ret
	}
...
// GetLongRocPeriodOk returns a tuple with the LongRocPeriod field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// HasLongRocPeriod returns a boolean if a field has been set.
func (o *GetTimeSeriesCoppock200ResponseMetaIndicator) HasLongRocPeriod() bool {
	if o != nil && !IsNil(o.LongRocPeriod) {
		return true
	}
...
// SetLongRocPeriod gets a reference to the given int64 and assigns it to the LongRocPeriod field.
func (o *GetTimeSeriesCoppock200ResponseMetaIndicator) SetLongRocPeriod(v int64) {
	o.LongRocPeriod = &v
}

// GetShortRocPeriod returns the ShortRocPeriod field value if set, zero value otherwise.
func (o *GetTimeSeriesCoppock200ResponseMetaIndicator) GetShortRocPeriod() int64 {
	if o == nil || IsNil(o.ShortRocPeriod) {
		var ret int64
		return ret
	}
...
// GetShortRocPeriodOk returns a tuple with the ShortRocPeriod field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// HasShortRocPeriod returns a boolean if a field has been set.
func (o *GetTimeSeriesCoppock200ResponseMetaIndicator) HasShortRocPeriod() bool {
	if o != nil && !IsNil(o.ShortRocPeriod) {
		return true
	}
...
// SetShortRocPeriod gets a reference to the given int64 and assigns it to the ShortRocPeriod field.
