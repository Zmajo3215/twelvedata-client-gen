...
type GetTimeSeriesCrsi200ResponseValuesInner struct {
	...
	// crsi value
	Crsi *string `json:"crsi,omitempty"`
}
...
func NewGetTimeSeriesCrsi200ResponseValuesInner() *GetTimeSeriesCrsi200ResponseValuesInner {
...
func (o *GetTimeSeriesCrsi200ResponseValuesInner) HasDatetime() bool {
	if o != nil && !IsNil(o.Datetime) {
		return true
	}
...
// GetCrsi returns the Crsi field value if set, zero value otherwise.
func (o *GetTimeSeriesCrsi200ResponseValuesInner) GetCrsi() string {
	if o == nil || IsNil(o.Crsi) {
		var ret string
		return ret
	}
	return *o.Crsi
...
// GetCrsiOk returns a tuple with the Crsi field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// HasCrsi returns a boolean if a field has been set.
func (o *GetTimeSeriesCrsi200ResponseValuesInner) HasCrsi() bool {
	if o != nil && !IsNil(o.Crsi) {
		return true
	}
...
// SetCrsi gets a reference to the given string and assigns it to the Crsi field.
