...
type GetTimeSeriesMacdExt200ResponseMetaIndicator struct {
	...
	FastMaType *string `json:"fast_ma_type,omitempty"`
	...
	SlowMaType *string `json:"slow_ma_type,omitempty"`
	...
	SignalMaType *string `json:"signal_ma_type,omitempty"`
}
...
// GetFastMaType returns the FastMaType field value if set, zero value otherwise.
func (o *GetTimeSeriesMacdExt200ResponseMetaIndicator) GetFastMaType() string {
	if o == nil || IsNil(o.FastMaType) {
		var ret string
		return ret
	}
	return *o.FastMaType
...
// GetFastMaTypeOk returns a tuple with the FastMaType field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// SetFastMaType gets a reference to the given string and assigns it to the FastMaType field.
...
// GetSlowMaType returns the SlowMaType field value if set, zero value otherwise.
func (o *GetTimeSeriesMacdExt200ResponseMetaIndicator) GetSlowMaType() string {
	if o == nil || IsNil(o.SlowMaType) {
		var ret string
		return ret
	}
	return *o.SlowMaType
...
// GetSlowMaTypeOk returns a tuple with the SlowMaType field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// SetSlowMaType gets a reference to the given string and assigns it to the SlowMaType field.
...
// GetSignalMaType returns the SignalMaType field value if set, zero value otherwise.
func (o *GetTimeSeriesMacdExt200ResponseMetaIndicator) GetSignalMaType() string {
	if o == nil || IsNil(o.SignalMaType) {
		var ret string
		return ret
	}
...
// GetSignalMaTypeOk returns a tuple with the SignalMaType field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// SetSignalMaType gets a reference to the given string and assigns it to the SignalMaType field.
