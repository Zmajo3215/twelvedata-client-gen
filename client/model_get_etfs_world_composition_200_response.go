...
type GetETFsWorldComposition200Response struct {
	Etf *GetETFsWorldComposition200ResponseEtf `json:"etf,omitempty"`
...
func NewGetETFsWorldComposition200Response() *GetETFsWorldComposition200Response {
...
// GetEtfOk returns a tuple with the Etf field value if set, nil otherwise
...
func (o *GetETFsWorldComposition200Response) HasEtf() bool {
	if o != nil && !IsNil(o.Etf) {
		return true
	}
...
// SetEtf gets a reference to the given GetETFsWorldComposition200ResponseEtf and assigns it to the Etf field.
...
func (o *GetETFsWorldComposition200Response) HasStatus() bool {
	if o != nil && !IsNil(o.Status) {
		return true
	}
