...
type GetFundHolders200Response struct {
	Meta *GetFundHolders200ResponseMeta `json:"meta,omitempty"`
	// List of fund holders for the financial instrument
	FundHolders []FundHolderItem `json:"fund_holders,omitempty"`
}
...
func NewGetFundHolders200Response() *GetFundHolders200Response {
...
func (o *GetFundHolders200Response) HasMeta() bool {
	if o != nil && !IsNil(o.Meta) {
		return true
	}
...
// SetMeta gets a reference to the given GetFundHolders200ResponseMeta and assigns it to the Meta field.
func (o *GetFundHolders200Response) SetMeta(v GetFundHolders200ResponseMeta) {
	o.Meta = &v
}

// GetFundHolders returns the FundHolders field value if set, zero value otherwise.
func (o *GetFundHolders200Response) GetFundHolders() []FundHolderItem {
	if o == nil || IsNil(o.FundHolders) {
...
// GetFundHoldersOk returns a tuple with the FundHolders field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// HasFundHolders returns a boolean if a field has been set.
func (o *GetFundHolders200Response) HasFundHolders() bool {
	if o != nil && !IsNil(o.FundHolders) {
		return true
	}
...
// SetFundHolders gets a reference to the given []FundHolderItem and assigns it to the FundHolders field.
