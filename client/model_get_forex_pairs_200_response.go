...
type GetForexPairs200Response struct {
	// List of forex pairs
	Data []ForexResponseItem `json:"data,omitempty"`
	// Response status
...
func NewGetForexPairs200Response() *GetForexPairs200Response {
...
func (o *GetForexPairs200Response) HasData() bool {
	if o != nil && !IsNil(o.Data) {
		return true
	}
...
// SetData gets a reference to the given []ForexResponseItem and assigns it to the Data field.
...
func (o *GetForexPairs200Response) HasStatus() bool {
	if o != nil && !IsNil(o.Status) {
		return true
	}
