...
type InlineObject12 struct {
	Meta *InlineObject12Meta `json:"meta,omitempty"`
	// Array of time series data points
	Values []InlineObject12ValuesInner `json:"values,omitempty"`
	// Response status
...
// SetMeta gets a reference to the given InlineObject12Meta and assigns it to the Meta field.
...
// SetValues gets a reference to the given []InlineObject12ValuesInner and assigns it to the Values field.
