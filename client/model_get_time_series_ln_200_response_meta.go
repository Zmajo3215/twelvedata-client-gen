...
// checks if the GetTimeSeriesLn200ResponseMeta type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetTimeSeriesLn200ResponseMeta{}

// GetTimeSeriesLn200ResponseMeta Json object with request general information
type GetTimeSeriesLn200ResponseMeta struct {
	...
	Indicator *GetTimeSeriesLn200ResponseMetaIndicator `json:"indicator,omitempty"`
}
...
func NewGetTimeSeriesLn200ResponseMeta() *GetTimeSeriesLn200ResponseMeta {
	this := GetTimeSeriesLn200ResponseMeta{}
	return &this
}
...
func (o *GetTimeSeriesLn200ResponseMeta) HasSymbol() bool {
	if o != nil && !IsNil(o.Symbol) {
		return true
	}
...
func (o *GetTimeSeriesLn200ResponseMeta) HasInterval() bool {
	if o != nil && !IsNil(o.Interval) {
		return true
	}
...
func (o *GetTimeSeriesLn200ResponseMeta) HasCurrency() bool {
	if o != nil && !IsNil(o.Currency) {
		return true
	}
...
func (o *GetTimeSeriesLn200ResponseMeta) HasExchangeTimezone() bool {
	if o != nil && !IsNil(o.ExchangeTimezone) {
		return true
	}
...
func (o *GetTimeSeriesLn200ResponseMeta) HasExchange() bool {
	if o != nil && !IsNil(o.Exchange) {
		return true
	}
...
func (o *GetTimeSeriesLn200ResponseMeta) HasMicCode() bool {
	if o != nil && !IsNil(o.MicCode) {
		return true
	}
...
func (o *GetTimeSeriesLn200ResponseMeta) HasType() bool {
	if o != nil && !IsNil(o.Type) {
		return true
	}
...
func (o *GetTimeSeriesLn200ResponseMeta) GetIndicator() GetTimeSeriesLn200ResponseMetaIndicator {
	if o == nil || IsNil(o.Indicator) {
		var ret GetTimeSeriesLn200ResponseMetaIndicator
		return ret
	}
	return *o.Indicator
}
...
func (o *GetTimeSeriesLn200ResponseMeta) HasIndicator() bool {
	if o != nil && !IsNil(o.Indicator) {
		return true
	}
...
// SetIndicator gets a reference to the given GetTimeSeriesLn200ResponseMetaIndicator and assigns it to the Indicator field.
func (o *GetTimeSeriesLn200ResponseMeta) SetIndicator(v GetTimeSeriesLn200ResponseMetaIndicator) {
	o.Indicator = &v
}

func (o GetTimeSeriesLn200ResponseMeta) MarshalJSON() ([]byte, error) {
...
func (o GetTimeSeriesLn200ResponseMeta) ToMap() (map[string]interface{}, error) {
...
type NullableGetTimeSeriesLn200ResponseMeta struct {
	value *GetTimeSeriesLn200ResponseMeta
	isSet bool
}

func (v NullableGetTimeSeriesLn200ResponseMeta) Get() *GetTimeSeriesLn200ResponseMeta {
	return v.value
}

func (v *NullableGetTimeSeriesLn200ResponseMeta) Set(val *GetTimeSeriesLn200ResponseMeta) {
	v.value = val
	v.isSet = true
}

func (v NullableGetTimeSeriesLn200ResponseMeta) IsSet() bool {
	return v.isSet
}

func (v *NullableGetTimeSeriesLn200ResponseMeta) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetTimeSeriesLn200ResponseMeta(val *GetTimeSeriesLn200ResponseMeta) *NullableGetTimeSeriesLn200ResponseMeta {
	return &NullableGetTimeSeriesLn200ResponseMeta{value: val, isSet: true}
}

func (v NullableGetTimeSeriesLn200ResponseMeta) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetTimeSeriesLn200ResponseMeta) UnmarshalJSON(src []byte) error {
	v.isSet = true
