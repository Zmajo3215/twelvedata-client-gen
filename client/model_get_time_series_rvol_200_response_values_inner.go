...
type GetTimeSeriesRvol200ResponseValuesInner struct {
	...
	// RVOL value
	Rvol *string `json:"rvol,omitempty"`
}
...
// GetRvol returns the Rvol field value if set, zero value otherwise.
func (o *GetTimeSeriesRvol200ResponseValuesInner) GetRvol() string {
	if o == nil || IsNil(o.Rvol) {
		var ret string
		return ret
	}
	return *o.Rvol
...
// GetRvolOk returns a tuple with the Rvol field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// SetRvol gets a reference to the given string and assigns it to the Rvol field.
