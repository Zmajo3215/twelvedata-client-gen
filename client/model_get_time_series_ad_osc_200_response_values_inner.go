...
type GetTimeSeriesAdOsc200ResponseValuesInner struct {
	...
	// Adosc value
	Adosc *string `json:"adosc,omitempty"`
}
...
// GetAdosc returns the Adosc field value if set, zero value otherwise.
func (o *GetTimeSeriesAdOsc200ResponseValuesInner) GetAdosc() string {
	if o == nil || IsNil(o.Adosc) {
		var ret string
		return ret
	}
	return *o.Adosc
...
// GetAdoscOk returns a tuple with the Adosc field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// SetAdosc gets a reference to the given string and assigns it to the Adosc field.
