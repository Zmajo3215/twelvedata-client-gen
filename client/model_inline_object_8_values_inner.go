...
type InlineObject8ValuesInner struct {
	...
	// ACOS value
	Acos *string `json:"acos,omitempty"`
}
...
// GetAcos returns the Acos field value if set, zero value otherwise.
func (o *InlineObject8ValuesInner) GetAcos() string {
	if o == nil || IsNil(o.Acos) {
		var ret string
		return ret
	}
	return *o.Acos
...
// GetAcosOk returns a tuple with the Acos field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// SetAcos gets a reference to the given string and assigns it to the Acos field.
