...
type GetTimeSeriesLog10200Response struct {
	Meta *GetTimeSeriesLog10200ResponseMeta `json:"meta,omitempty"`
	// Array of time series data points
	Values []GetTimeSeriesLog10200ResponseValuesInner `json:"values,omitempty"`
	// Response status
...
func NewGetTimeSeriesLog10200Response() *GetTimeSeriesLog10200Response {
...
func (o *GetTimeSeriesLog10200Response) HasMeta() bool {
	if o != nil && !IsNil(o.Meta) {
		return true
	}
...
// SetMeta gets a reference to the given GetTimeSeriesLog10200ResponseMeta and assigns it to the Meta field.
...
func (o *GetTimeSeriesLog10200Response) HasValues() bool {
	if o != nil && !IsNil(o.Values) {
		return true
	}
...
// SetValues gets a reference to the given []GetTimeSeriesLog10200ResponseValuesInner and assigns it to the Values field.
...
func (o *GetTimeSeriesLog10200Response) HasStatus() bool {
	if o != nil && !IsNil(o.Status) {
		return true
	}
