...
type GetTimeSeriesWma200Response struct {
	Meta *GetTimeSeriesWma200ResponseMeta `json:"meta,omitempty"`
	// Array of time series data points
	Values []GetTimeSeriesWma200ResponseValuesInner `json:"values,omitempty"`
	// Response status
...
// SetMeta gets a reference to the given GetTimeSeriesWma200ResponseMeta and assigns it to the Meta field.
...
// SetValues gets a reference to the given []GetTimeSeriesWma200ResponseValuesInner and assigns it to the Values field.
