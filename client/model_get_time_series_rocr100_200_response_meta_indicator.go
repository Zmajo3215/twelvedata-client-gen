...
func NewGetTimeSeriesRocr100200ResponseMetaIndicator() *GetTimeSeriesRocr100200ResponseMetaIndicator {
...
func (o *GetTimeSeriesRocr100200ResponseMetaIndicator) HasName() bool {
	if o != nil && !IsNil(o.Name) {
		return true
	}
...
func (o *GetTimeSeriesRocr100200ResponseMetaIndicator) HasSeriesType() bool {
	if o != nil && !IsNil(o.SeriesType) {
		return true
	}
...
func (o *GetTimeSeriesRocr100200ResponseMetaIndicator) HasTimePeriod() bool {
	if o != nil && !IsNil(o.TimePeriod) {
		return true
	}
