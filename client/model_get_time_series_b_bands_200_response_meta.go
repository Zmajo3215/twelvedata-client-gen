...
// checks if the GetTimeSeriesBBands200ResponseMeta type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetTimeSeriesBBands200ResponseMeta{}

// GetTimeSeriesBBands200ResponseMeta Json object with request general information
type GetTimeSeriesBBands200ResponseMeta struct {
	...
	Indicator *GetTimeSeriesBBands200ResponseMetaIndicator `json:"indicator,omitempty"`
}
...
func NewGetTimeSeriesBBands200ResponseMeta() *GetTimeSeriesBBands200ResponseMeta {
	this := GetTimeSeriesBBands200ResponseMeta{}
	return &this
}
...
func (o *GetTimeSeriesBBands200ResponseMeta) HasSymbol() bool {
	if o != nil && !IsNil(o.Symbol) {
		return true
	}
...
func (o *GetTimeSeriesBBands200ResponseMeta) HasInterval() bool {
	if o != nil && !IsNil(o.Interval) {
		return true
	}
...
func (o *GetTimeSeriesBBands200ResponseMeta) HasCurrency() bool {
	if o != nil && !IsNil(o.Currency) {
		return true
	}
...
func (o *GetTimeSeriesBBands200ResponseMeta) HasExchangeTimezone() bool {
	if o != nil && !IsNil(o.ExchangeTimezone) {
		return true
	}
...
func (o *GetTimeSeriesBBands200ResponseMeta) HasExchange() bool {
	if o != nil && !IsNil(o.Exchange) {
		return true
	}
...
func (o *GetTimeSeriesBBands200ResponseMeta) HasMicCode() bool {
	if o != nil && !IsNil(o.MicCode) {
		return true
	}
...
func (o *GetTimeSeriesBBands200ResponseMeta) HasType() bool {
	if o != nil && !IsNil(o.Type) {
		return true
	}
...
func (o *GetTimeSeriesBBands200ResponseMeta) GetIndicator() GetTimeSeriesBBands200ResponseMetaIndicator {
	if o == nil || IsNil(o.Indicator) {
		var ret GetTimeSeriesBBands200ResponseMetaIndicator
		return ret
	}
	return *o.Indicator
}
...
func (o *GetTimeSeriesBBands200ResponseMeta) HasIndicator() bool {
	if o != nil && !IsNil(o.Indicator) {
		return true
	}
...
// SetIndicator gets a reference to the given GetTimeSeriesBBands200ResponseMetaIndicator and assigns it to the Indicator field.
func (o *GetTimeSeriesBBands200ResponseMeta) SetIndicator(v GetTimeSeriesBBands200ResponseMetaIndicator) {
	o.Indicator = &v
}

func (o GetTimeSeriesBBands200ResponseMeta) MarshalJSON() ([]byte, error) {
...
func (o GetTimeSeriesBBands200ResponseMeta) ToMap() (map[string]interface{}, error) {
...
type NullableGetTimeSeriesBBands200ResponseMeta struct {
	value *GetTimeSeriesBBands200ResponseMeta
	isSet bool
}

func (v NullableGetTimeSeriesBBands200ResponseMeta) Get() *GetTimeSeriesBBands200ResponseMeta {
	return v.value
}

func (v *NullableGetTimeSeriesBBands200ResponseMeta) Set(val *GetTimeSeriesBBands200ResponseMeta) {
	v.value = val
	v.isSet = true
}

func (v NullableGetTimeSeriesBBands200ResponseMeta) IsSet() bool {
	return v.isSet
}

func (v *NullableGetTimeSeriesBBands200ResponseMeta) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetTimeSeriesBBands200ResponseMeta(val *GetTimeSeriesBBands200ResponseMeta) *NullableGetTimeSeriesBBands200ResponseMeta {
	return &NullableGetTimeSeriesBBands200ResponseMeta{value: val, isSet: true}
}

func (v NullableGetTimeSeriesBBands200ResponseMeta) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetTimeSeriesBBands200ResponseMeta) UnmarshalJSON(src []byte) error {
	v.isSet = true
