...
// GetPpo returns the Ppo field value if set, zero value otherwise.
func (o *GetTimeSeriesPpo200ResponseValuesInner) GetPpo() string {
	if o == nil || IsNil(o.Ppo) {
		var ret string
		return ret
	}
	return *o.Ppo
...
// GetPpoOk returns a tuple with the Ppo field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// SetPpo gets a reference to the given string and assigns it to the Ppo field.
