...
// checks if the GetTimeSeriesStochRsi200ResponseMeta type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetTimeSeriesStochRsi200ResponseMeta{}

// GetTimeSeriesStochRsi200ResponseMeta Json object with request general information
type GetTimeSeriesStochRsi200ResponseMeta struct {
	...
	Indicator *GetTimeSeriesStochRsi200ResponseMetaIndicator `json:"indicator,omitempty"`
}
...
func NewGetTimeSeriesStochRsi200ResponseMeta() *GetTimeSeriesStochRsi200ResponseMeta {
	this := GetTimeSeriesStochRsi200ResponseMeta{}
	return &this
}
...
func (o *GetTimeSeriesStochRsi200ResponseMeta) GetIndicator() GetTimeSeriesStochRsi200ResponseMetaIndicator {
	if o == nil || IsNil(o.Indicator) {
		var ret GetTimeSeriesStochRsi200ResponseMetaIndicator
		return ret
	}
	return *o.Indicator
}
...
// SetIndicator gets a reference to the given GetTimeSeriesStochRsi200ResponseMetaIndicator and assigns it to the Indicator field.
func (o *GetTimeSeriesStochRsi200ResponseMeta) SetIndicator(v GetTimeSeriesStochRsi200ResponseMetaIndicator) {
	o.Indicator = &v
}

func (o GetTimeSeriesStochRsi200ResponseMeta) MarshalJSON() ([]byte, error) {
...
func (o GetTimeSeriesStochRsi200ResponseMeta) ToMap() (map[string]interface{}, error) {
...
type NullableGetTimeSeriesStochRsi200ResponseMeta struct {
	value *GetTimeSeriesStochRsi200ResponseMeta
	isSet bool
}

func (v NullableGetTimeSeriesStochRsi200ResponseMeta) Get() *GetTimeSeriesStochRsi200ResponseMeta {
	return v.value
}

func (v *NullableGetTimeSeriesStochRsi200ResponseMeta) Set(val *GetTimeSeriesStochRsi200ResponseMeta) {
	v.value = val
	v.isSet = true
}

func (v NullableGetTimeSeriesStochRsi200ResponseMeta) IsSet() bool {
	return v.isSet
}

func (v *NullableGetTimeSeriesStochRsi200ResponseMeta) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetTimeSeriesStochRsi200ResponseMeta(val *GetTimeSeriesStochRsi200ResponseMeta) *NullableGetTimeSeriesStochRsi200ResponseMeta {
	return &NullableGetTimeSeriesStochRsi200ResponseMeta{value: val, isSet: true}
}

func (v NullableGetTimeSeriesStochRsi200ResponseMeta) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetTimeSeriesStochRsi200ResponseMeta) UnmarshalJSON(src []byte) error {
	v.isSet = true
