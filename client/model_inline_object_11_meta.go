...
type InlineObject11Meta struct {
	...
	Indicator *InlineObject11MetaIndicator `json:"indicator,omitempty"`
}
...
func NewInlineObject11Meta() *InlineObject11Meta {
...
func (o *InlineObject11Meta) HasSymbol() bool {
	if o != nil && !IsNil(o.Symbol) {
		return true
	}
...
func (o *InlineObject11Meta) HasInterval() bool {
	if o != nil && !IsNil(o.Interval) {
		return true
	}
...
func (o *InlineObject11Meta) HasCurrency() bool {
	if o != nil && !IsNil(o.Currency) {
		return true
	}
...
func (o *InlineObject11Meta) HasExchangeTimezone() bool {
	if o != nil && !IsNil(o.ExchangeTimezone) {
		return true
	}
...
func (o *InlineObject11Meta) HasExchange() bool {
	if o != nil && !IsNil(o.Exchange) {
		return true
	}
...
func (o *InlineObject11Meta) HasMicCode() bool {
	if o != nil && !IsNil(o.MicCode) {
		return true
	}
...
func (o *InlineObject11Meta) HasType() bool {
	if o != nil && !IsNil(o.Type) {
		return true
	}
...
func (o *InlineObject11Meta) HasIndicator() bool {
	if o != nil && !IsNil(o.Indicator) {
		return true
	}
...
// SetIndicator gets a reference to the given InlineObject11MetaIndicator and assigns it to the Indicator field.
