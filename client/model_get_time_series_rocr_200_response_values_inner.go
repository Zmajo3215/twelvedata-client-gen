...
type GetTimeSeriesRocr200ResponseValuesInner struct {
	...
	// ROCR value
	Rocr *string `json:"rocr,omitempty"`
}
...
// GetRocr returns the Rocr field value if set, zero value otherwise.
func (o *GetTimeSeriesRocr200ResponseValuesInner) GetRocr() string {
	if o == nil || IsNil(o.Rocr) {
		var ret string
		return ret
	}
	return *o.Rocr
...
// GetRocrOk returns a tuple with the Rocr field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// SetRocr gets a reference to the given string and assigns it to the Rocr field.
