...
type GetTimeSeriesLn200Response struct {
	Meta *GetTimeSeriesLn200ResponseMeta `json:"meta,omitempty"`
	// Array of time series data points
	Values []GetTimeSeriesLn200ResponseValuesInner `json:"values,omitempty"`
	// Response status
...
func NewGetTimeSeriesLn200Response() *GetTimeSeriesLn200Response {
...
func (o *GetTimeSeriesLn200Response) HasMeta() bool {
	if o != nil && !IsNil(o.Meta) {
		return true
	}
...
// SetMeta gets a reference to the given GetTimeSeriesLn200ResponseMeta and assigns it to the Meta field.
...
func (o *GetTimeSeriesLn200Response) HasValues() bool {
	if o != nil && !IsNil(o.Values) {
		return true
	}
...
// SetValues gets a reference to the given []GetTimeSeriesLn200ResponseValuesInner and assigns it to the Values field.
...
func (o *GetTimeSeriesLn200Response) HasStatus() bool {
	if o != nil && !IsNil(o.Status) {
		return true
	}
