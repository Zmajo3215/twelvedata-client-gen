...
type GetTimeSeriesObv200Response struct {
	Meta *GetTimeSeriesObv200ResponseMeta `json:"meta,omitempty"`
	// Array of time series data points
	Values []GetTimeSeriesObv200ResponseValuesInner `json:"values,omitempty"`
	// Response status
...
// SetMeta gets a reference to the given GetTimeSeriesObv200ResponseMeta and assigns it to the Meta field.
...
// SetValues gets a reference to the given []GetTimeSeriesObv200ResponseValuesInner and assigns it to the Values field.
