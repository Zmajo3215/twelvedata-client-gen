...
func NewGetAnalystRatingsUsEquities200ResponseRatingsInner() *GetAnalystRatingsUsEquities200ResponseRatingsInner {
...
func (o *GetAnalystRatingsUsEquities200ResponseRatingsInner) HasDate() bool {
	if o != nil && !IsNil(o.Date) {
		return true
	}
...
// GetFirm returns the Firm field value if set, zero value otherwise.
func (o *GetAnalystRatingsUsEquities200ResponseRatingsInner) GetFirm() string {
	if o == nil || IsNil(o.Firm) {
		var ret string
		return ret
	}
	return *o.Firm
...
// GetFirmOk returns a tuple with the Firm field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// HasFirm returns a boolean if a field has been set.
func (o *GetAnalystRatingsUsEquities200ResponseRatingsInner) HasFirm() bool {
	if o != nil && !IsNil(o.Firm) {
		return true
	}
...
// SetFirm gets a reference to the given string and assigns it to the Firm field.
