...
type GetTimeSeriesLinearRegIntercept200ResponseValuesInner struct {
	...
	Linearregintercept *string `json:"linearregintercept,omitempty"`
}
...
func NewGetTimeSeriesLinearRegIntercept200ResponseValuesInner() *GetTimeSeriesLinearRegIntercept200ResponseValuesInner {
...
func (o *GetTimeSeriesLinearRegIntercept200ResponseValuesInner) HasDatetime() bool {
	if o != nil && !IsNil(o.Datetime) {
		return true
	}
...
// GetLinearregintercept returns the Linearregintercept field value if set, zero value otherwise.
func (o *GetTimeSeriesLinearRegIntercept200ResponseValuesInner) GetLinearregintercept() string {
	if o == nil || IsNil(o.Linearregintercept) {
		var ret string
		return ret
	}
...
// GetLinearreginterceptOk returns a tuple with the Linearregintercept field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// HasLinearregintercept returns a boolean if a field has been set.
func (o *GetTimeSeriesLinearRegIntercept200ResponseValuesInner) HasLinearregintercept() bool {
	if o != nil && !IsNil(o.Linearregintercept) {
		return true
	}
...
// SetLinearregintercept gets a reference to the given string and assigns it to the Linearregintercept field.
