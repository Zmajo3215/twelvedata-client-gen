...
type GetTimeSeriesUltOsc200ResponseMetaIndicator struct {
	...
	TimePeriod1 *int64 `json:"time_period_1,omitempty"`
	// The second time period used for calculation in the indicator
	TimePeriod2 *int64 `json:"time_period_2,omitempty"`
	// The third time period used for calculation in the indicator
	TimePeriod3 *int64 `json:"time_period_3,omitempty"`
}
...
// GetTimePeriod1 returns the TimePeriod1 field value if set, zero value otherwise.
func (o *GetTimeSeriesUltOsc200ResponseMetaIndicator) GetTimePeriod1() int64 {
	if o == nil || IsNil(o.TimePeriod1) {
		var ret int64
		return ret
	}
...
// GetTimePeriod1Ok returns a tuple with the TimePeriod1 field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// SetTimePeriod1 gets a reference to the given int64 and assigns it to the TimePeriod1 field.
func (o *GetTimeSeriesUltOsc200ResponseMetaIndicator) SetTimePeriod1(v int64) {
	o.TimePeriod1 = &v
}

// GetTimePeriod2 returns the TimePeriod2 field value if set, zero value otherwise.
func (o *GetTimeSeriesUltOsc200ResponseMetaIndicator) GetTimePeriod2() int64 {
	if o == nil || IsNil(o.TimePeriod2) {
		var ret int64
		return ret
	}
...
// GetTimePeriod2Ok returns a tuple with the TimePeriod2 field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// SetTimePeriod2 gets a reference to the given int64 and assigns it to the TimePeriod2 field.
func (o *GetTimeSeriesUltOsc200ResponseMetaIndicator) SetTimePeriod2(v int64) {
	o.TimePeriod2 = &v
}

// GetTimePeriod3 returns the TimePeriod3 field value if set, zero value otherwise.
func (o *GetTimeSeriesUltOsc200ResponseMetaIndicator) GetTimePeriod3() int64 {
	if o == nil || IsNil(o.TimePeriod3) {
		var ret int64
		return ret
	}
...
// GetTimePeriod3Ok returns a tuple with the TimePeriod3 field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// SetTimePeriod3 gets a reference to the given int64 and assigns it to the TimePeriod3 field.
