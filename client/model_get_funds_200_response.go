...
type GetFunds200Response struct {
	Result *GetFunds200ResponseResult `json:"result,omitempty"`
...
// SetResult gets a reference to the given GetFunds200ResponseResult and assigns it to the Result field.
