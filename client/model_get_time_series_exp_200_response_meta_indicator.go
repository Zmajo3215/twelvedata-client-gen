...
func NewGetTimeSeriesExp200ResponseMetaIndicator() *GetTimeSeriesExp200ResponseMetaIndicator {
...
func (o *GetTimeSeriesExp200ResponseMetaIndicator) HasName() bool {
	if o != nil && !IsNil(o.Name) {
		return true
	}
...
func (o *GetTimeSeriesExp200ResponseMetaIndicator) HasSeriesType() bool {
	if o != nil && !IsNil(o.SeriesType) {
		return true
	}
