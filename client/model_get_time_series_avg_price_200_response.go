...
type GetTimeSeriesAvgPrice200Response struct {
	Meta *GetTimeSeriesAvgPrice200ResponseMeta `json:"meta,omitempty"`
	// Array of time series data points
	Values []GetTimeSeriesAvgPrice200ResponseValuesInner `json:"values,omitempty"`
	// Response status
...
func NewGetTimeSeriesAvgPrice200Response() *GetTimeSeriesAvgPrice200Response {
...
func (o *GetTimeSeriesAvgPrice200Response) HasMeta() bool {
	if o != nil && !IsNil(o.Meta) {
		return true
	}
...
// SetMeta gets a reference to the given GetTimeSeriesAvgPrice200ResponseMeta and assigns it to the Meta field.
...
func (o *GetTimeSeriesAvgPrice200Response) HasValues() bool {
	if o != nil && !IsNil(o.Values) {
		return true
	}
...
// SetValues gets a reference to the given []GetTimeSeriesAvgPrice200ResponseValuesInner and assigns it to the Values field.
...
func (o *GetTimeSeriesAvgPrice200Response) HasStatus() bool {
	if o != nil && !IsNil(o.Status) {
		return true
	}
