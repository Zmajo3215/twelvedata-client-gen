...
type GetTimeSeriesAdxr200Response struct {
	Meta *GetTimeSeriesAdxr200ResponseMeta `json:"meta,omitempty"`
	// Array of time series data points
	Values []GetTimeSeriesAdxr200ResponseValuesInner `json:"values,omitempty"`
	// Response status
...
func NewGetTimeSeriesAdxr200Response() *GetTimeSeriesAdxr200Response {
...
func (o *GetTimeSeriesAdxr200Response) HasMeta() bool {
	if o != nil && !IsNil(o.Meta) {
		return true
	}
...
// SetMeta gets a reference to the given GetTimeSeriesAdxr200ResponseMeta and assigns it to the Meta field.
...
func (o *GetTimeSeriesAdxr200Response) HasValues() bool {
	if o != nil && !IsNil(o.Values) {
		return true
	}
...
// SetValues gets a reference to the given []GetTimeSeriesAdxr200ResponseValuesInner and assigns it to the Values field.
...
func (o *GetTimeSeriesAdxr200Response) HasStatus() bool {
	if o != nil && !IsNil(o.Status) {
		return true
	}
