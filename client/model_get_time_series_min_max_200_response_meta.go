...
// checks if the GetTimeSeriesMinMax200ResponseMeta type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetTimeSeriesMinMax200ResponseMeta{}

// GetTimeSeriesMinMax200ResponseMeta Json object with request general information
type GetTimeSeriesMinMax200ResponseMeta struct {
	...
	Indicator *GetTimeSeriesMinMax200ResponseMetaIndicator `json:"indicator,omitempty"`
}
...
func NewGetTimeSeriesMinMax200ResponseMeta() *GetTimeSeriesMinMax200ResponseMeta {
	this := GetTimeSeriesMinMax200ResponseMeta{}
	return &this
}
...
func (o *GetTimeSeriesMinMax200ResponseMeta) HasSymbol() bool {
	if o != nil && !IsNil(o.Symbol) {
		return true
	}
...
func (o *GetTimeSeriesMinMax200ResponseMeta) HasInterval() bool {
	if o != nil && !IsNil(o.Interval) {
		return true
	}
...
func (o *GetTimeSeriesMinMax200ResponseMeta) HasCurrency() bool {
	if o != nil && !IsNil(o.Currency) {
		return true
	}
...
func (o *GetTimeSeriesMinMax200ResponseMeta) HasExchangeTimezone() bool {
	if o != nil && !IsNil(o.ExchangeTimezone) {
		return true
	}
...
func (o *GetTimeSeriesMinMax200ResponseMeta) HasExchange() bool {
	if o != nil && !IsNil(o.Exchange) {
		return true
	}
...
func (o *GetTimeSeriesMinMax200ResponseMeta) HasMicCode() bool {
	if o != nil && !IsNil(o.MicCode) {
		return true
	}
...
func (o *GetTimeSeriesMinMax200ResponseMeta) HasType() bool {
	if o != nil && !IsNil(o.Type) {
		return true
	}
...
func (o *GetTimeSeriesMinMax200ResponseMeta) GetIndicator() GetTimeSeriesMinMax200ResponseMetaIndicator {
	if o == nil || IsNil(o.Indicator) {
		var ret GetTimeSeriesMinMax200ResponseMetaIndicator
		return ret
	}
	return *o.Indicator
}
...
func (o *GetTimeSeriesMinMax200ResponseMeta) HasIndicator() bool {
	if o != nil && !IsNil(o.Indicator) {
		return true
	}
...
// SetIndicator gets a reference to the given GetTimeSeriesMinMax200ResponseMetaIndicator and assigns it to the Indicator field.
func (o *GetTimeSeriesMinMax200ResponseMeta) SetIndicator(v GetTimeSeriesMinMax200ResponseMetaIndicator) {
	o.Indicator = &v
}

func (o GetTimeSeriesMinMax200ResponseMeta) MarshalJSON() ([]byte, error) {
...
func (o GetTimeSeriesMinMax200ResponseMeta) ToMap() (map[string]interface{}, error) {
...
type NullableGetTimeSeriesMinMax200ResponseMeta struct {
	value *GetTimeSeriesMinMax200ResponseMeta
	isSet bool
}

func (v NullableGetTimeSeriesMinMax200ResponseMeta) Get() *GetTimeSeriesMinMax200ResponseMeta {
	return v.value
}

func (v *NullableGetTimeSeriesMinMax200ResponseMeta) Set(val *GetTimeSeriesMinMax200ResponseMeta) {
	v.value = val
	v.isSet = true
}

func (v NullableGetTimeSeriesMinMax200ResponseMeta) IsSet() bool {
	return v.isSet
}

func (v *NullableGetTimeSeriesMinMax200ResponseMeta) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetTimeSeriesMinMax200ResponseMeta(val *GetTimeSeriesMinMax200ResponseMeta) *NullableGetTimeSeriesMinMax200ResponseMeta {
	return &NullableGetTimeSeriesMinMax200ResponseMeta{value: val, isSet: true}
}

func (v NullableGetTimeSeriesMinMax200ResponseMeta) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetTimeSeriesMinMax200ResponseMeta) UnmarshalJSON(src []byte) error {
	v.isSet = true
