...
type GetTimeSeriesIchimoku200ResponseMeta struct {
	...
	Indicator *GetTimeSeriesIchimoku200ResponseMetaIndicator `json:"indicator,omitempty"`
}
...
// SetIndicator gets a reference to the given GetTimeSeriesIchimoku200ResponseMetaIndicator and assigns it to the Indicator field.
