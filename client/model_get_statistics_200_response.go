...
type GetStatistics200Response struct {
	Meta *GetStatistics200ResponseMeta `json:"meta,omitempty"`
	Statistics *GetStatistics200ResponseStatistics `json:"statistics,omitempty"`
}
...
func NewGetStatistics200Response() *GetStatistics200Response {
...
func (o *GetStatistics200Response) HasMeta() bool {
	if o != nil && !IsNil(o.Meta) {
		return true
	}
...
// SetMeta gets a reference to the given GetStatistics200ResponseMeta and assigns it to the Meta field.
...
func (o *GetStatistics200Response) HasStatistics() bool {
	if o != nil && !IsNil(o.Statistics) {
		return true
	}
...
// SetStatistics gets a reference to the given GetStatistics200ResponseStatistics and assigns it to the Statistics field.
