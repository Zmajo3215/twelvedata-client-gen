...
type GetDividends200Response struct {
	Meta *GetDividends200ResponseMeta `json:"meta,omitempty"`
	// List of dividends
	Dividends []GetDividends200ResponseDividendsInner `json:"dividends,omitempty"`
}
...
// SetMeta gets a reference to the given GetDividends200ResponseMeta and assigns it to the Meta field.
...
// SetDividends gets a reference to the given []GetDividends200ResponseDividendsInner and assigns it to the Dividends field.
