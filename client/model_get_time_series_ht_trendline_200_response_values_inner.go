...
type GetTimeSeriesHtTrendline200ResponseValuesInner struct {
	...
	// HT_TRENDLINE value
	HtTrendline *string `json:"ht_trendline,omitempty"`
}
...
// GetHtTrendline returns the HtTrendline field value if set, zero value otherwise.
func (o *GetTimeSeriesHtTrendline200ResponseValuesInner) GetHtTrendline() string {
	if o == nil || IsNil(o.HtTrendline) {
		var ret string
		return ret
	}
...
// GetHtTrendlineOk returns a tuple with the HtTrendline field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// SetHtTrendline gets a reference to the given string and assigns it to the HtTrendline field.
