...
type GetTimeSeriesHlc3200ResponseMeta struct {
	...
	Indicator *GetTimeSeriesHlc3200ResponseMetaIndicator `json:"indicator,omitempty"`
}
...
// SetIndicator gets a reference to the given GetTimeSeriesHlc3200ResponseMetaIndicator and assigns it to the Indicator field.
