...
func NewGetETFsWorld200ResponseEtfSummary() *GetETFsWorld200ResponseEtfSummary {
...
func (o *GetETFsWorld200ResponseEtfSummary) HasSymbol() bool {
	if o != nil && !IsNil(o.Symbol) {
		return true
	}
...
func (o *GetETFsWorld200ResponseEtfSummary) HasName() bool {
	if o != nil && !IsNil(o.Name) {
		return true
	}
