...
type GetTimeSeriesRocr200Response struct {
	Meta *GetTimeSeriesRocr200ResponseMeta `json:"meta,omitempty"`
	// Array of time series data points
	Values []GetTimeSeriesRocr200ResponseValuesInner `json:"values,omitempty"`
	// Response status
...
func NewGetTimeSeriesRocr200Response() *GetTimeSeriesRocr200Response {
...
func (o *GetTimeSeriesRocr200Response) HasMeta() bool {
	if o != nil && !IsNil(o.Meta) {
		return true
	}
...
// SetMeta gets a reference to the given GetTimeSeriesRocr200ResponseMeta and assigns it to the Meta field.
...
func (o *GetTimeSeriesRocr200Response) HasValues() bool {
	if o != nil && !IsNil(o.Values) {
		return true
	}
...
// SetValues gets a reference to the given []GetTimeSeriesRocr200ResponseValuesInner and assigns it to the Values field.
...
func (o *GetTimeSeriesRocr200Response) HasStatus() bool {
	if o != nil && !IsNil(o.Status) {
		return true
	}
