...
// checks if the GetTimeSeriesPivotPointsHL200ResponseMeta type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetTimeSeriesPivotPointsHL200ResponseMeta{}

// GetTimeSeriesPivotPointsHL200ResponseMeta Json object with request general information
type GetTimeSeriesPivotPointsHL200ResponseMeta struct {
	...
	Indicator *GetTimeSeriesPivotPointsHL200ResponseMetaIndicator `json:"indicator,omitempty"`
}
...
func NewGetTimeSeriesPivotPointsHL200ResponseMeta() *GetTimeSeriesPivotPointsHL200ResponseMeta {
	this := GetTimeSeriesPivotPointsHL200ResponseMeta{}
	return &this
}
...
func (o *GetTimeSeriesPivotPointsHL200ResponseMeta) HasSymbol() bool {
	if o != nil && !IsNil(o.Symbol) {
		return true
	}
...
func (o *GetTimeSeriesPivotPointsHL200ResponseMeta) HasInterval() bool {
	if o != nil && !IsNil(o.Interval) {
		return true
	}
...
func (o *GetTimeSeriesPivotPointsHL200ResponseMeta) HasCurrency() bool {
	if o != nil && !IsNil(o.Currency) {
		return true
	}
...
func (o *GetTimeSeriesPivotPointsHL200ResponseMeta) HasExchangeTimezone() bool {
	if o != nil && !IsNil(o.ExchangeTimezone) {
		return true
	}
...
func (o *GetTimeSeriesPivotPointsHL200ResponseMeta) HasExchange() bool {
	if o != nil && !IsNil(o.Exchange) {
		return true
	}
...
func (o *GetTimeSeriesPivotPointsHL200ResponseMeta) HasMicCode() bool {
	if o != nil && !IsNil(o.MicCode) {
		return true
	}
...
func (o *GetTimeSeriesPivotPointsHL200ResponseMeta) HasType() bool {
	if o != nil && !IsNil(o.Type) {
		return true
	}
...
func (o *GetTimeSeriesPivotPointsHL200ResponseMeta) GetIndicator() GetTimeSeriesPivotPointsHL200ResponseMetaIndicator {
	if o == nil || IsNil(o.Indicator) {
		var ret GetTimeSeriesPivotPointsHL200ResponseMetaIndicator
		return ret
	}
	return *o.Indicator
}
...
func (o *GetTimeSeriesPivotPointsHL200ResponseMeta) HasIndicator() bool {
	if o != nil && !IsNil(o.Indicator) {
		return true
	}
...
// SetIndicator gets a reference to the given GetTimeSeriesPivotPointsHL200ResponseMetaIndicator and assigns it to the Indicator field.
func (o *GetTimeSeriesPivotPointsHL200ResponseMeta) SetIndicator(v GetTimeSeriesPivotPointsHL200ResponseMetaIndicator) {
	o.Indicator = &v
}

func (o GetTimeSeriesPivotPointsHL200ResponseMeta) MarshalJSON() ([]byte, error) {
...
func (o GetTimeSeriesPivotPointsHL200ResponseMeta) ToMap() (map[string]interface{}, error) {
...
type NullableGetTimeSeriesPivotPointsHL200ResponseMeta struct {
	value *GetTimeSeriesPivotPointsHL200ResponseMeta
	isSet bool
}

func (v NullableGetTimeSeriesPivotPointsHL200ResponseMeta) Get() *GetTimeSeriesPivotPointsHL200ResponseMeta {
	return v.value
}

func (v *NullableGetTimeSeriesPivotPointsHL200ResponseMeta) Set(val *GetTimeSeriesPivotPointsHL200ResponseMeta) {
	v.value = val
	v.isSet = true
}

func (v NullableGetTimeSeriesPivotPointsHL200ResponseMeta) IsSet() bool {
	return v.isSet
}

func (v *NullableGetTimeSeriesPivotPointsHL200ResponseMeta) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetTimeSeriesPivotPointsHL200ResponseMeta(val *GetTimeSeriesPivotPointsHL200ResponseMeta) *NullableGetTimeSeriesPivotPointsHL200ResponseMeta {
	return &NullableGetTimeSeriesPivotPointsHL200ResponseMeta{value: val, isSet: true}
}

func (v NullableGetTimeSeriesPivotPointsHL200ResponseMeta) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetTimeSeriesPivotPointsHL200ResponseMeta) UnmarshalJSON(src []byte) error {
	v.isSet = true
