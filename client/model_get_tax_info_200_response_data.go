...
type GetTaxInfo200ResponseData struct {
	...
	TaxIndicator *string `json:"tax_indicator,omitempty"`
}
...
func NewGetTaxInfo200ResponseData() *GetTaxInfo200ResponseData {
...
// GetTaxIndicator returns the TaxIndicator field value if set, zero value otherwise.
func (o *GetTaxInfo200ResponseData) GetTaxIndicator() string {
	if o == nil || IsNil(o.TaxIndicator) {
		var ret string
		return ret
	}
...
// GetTaxIndicatorOk returns a tuple with the TaxIndicator field value if set, nil otherwise
...
// HasTaxIndicator returns a boolean if a field has been set.
func (o *GetTaxInfo200ResponseData) HasTaxIndicator() bool {
	if o != nil && !IsNil(o.TaxIndicator) {
		return true
	}
...
// SetTaxIndicator gets a reference to the given string and assigns it to the TaxIndicator field.
