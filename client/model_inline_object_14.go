...
type InlineObject14 struct {
	Meta *InlineObject14Meta `json:"meta,omitempty"`
	// Array of time series data points
	Values []InlineObject14ValuesInner `json:"values,omitempty"`
	// Response status
...
func (o *InlineObject14) HasMeta() bool {
	if o != nil && !IsNil(o.Meta) {
		return true
	}
...
// SetMeta gets a reference to the given InlineObject14Meta and assigns it to the Meta field.
...
func (o *InlineObject14) HasValues() bool {
	if o != nil && !IsNil(o.Values) {
		return true
	}
...
// SetValues gets a reference to the given []InlineObject14ValuesInner and assigns it to the Values field.
...
func (o *InlineObject14) HasStatus() bool {
	if o != nil && !IsNil(o.Status) {
		return true
	}
