...
type GetTimeSeriesHtPhasor200Response struct {
	Meta *GetTimeSeriesHtPhasor200ResponseMeta `json:"meta,omitempty"`
	// Array of time series data points
	Values []GetTimeSeriesHtPhasor200ResponseValuesInner `json:"values,omitempty"`
	// Response status
...
func NewGetTimeSeriesHtPhasor200Response() *GetTimeSeriesHtPhasor200Response {
...
func (o *GetTimeSeriesHtPhasor200Response) HasMeta() bool {
	if o != nil && !IsNil(o.Meta) {
		return true
	}
...
// SetMeta gets a reference to the given GetTimeSeriesHtPhasor200ResponseMeta and assigns it to the Meta field.
...
func (o *GetTimeSeriesHtPhasor200Response) HasValues() bool {
	if o != nil && !IsNil(o.Values) {
		return true
	}
...
// SetValues gets a reference to the given []GetTimeSeriesHtPhasor200ResponseValuesInner and assigns it to the Values field.
...
func (o *GetTimeSeriesHtPhasor200Response) HasStatus() bool {
	if o != nil && !IsNil(o.Status) {
		return true
	}
