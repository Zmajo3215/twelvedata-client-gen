...
type GetTimeSeriesKama200Response struct {
	Meta *GetTimeSeriesKama200ResponseMeta `json:"meta,omitempty"`
	// Array of time series data points
	Values []GetTimeSeriesKama200ResponseValuesInner `json:"values,omitempty"`
	// Response status
...
// SetMeta gets a reference to the given GetTimeSeriesKama200ResponseMeta and assigns it to the Meta field.
...
// SetValues gets a reference to the given []GetTimeSeriesKama200ResponseValuesInner and assigns it to the Values field.
