...
func NewGetTimeSeriesCmo200ResponseValuesInner() *GetTimeSeriesCmo200ResponseValuesInner {
...
func (o *GetTimeSeriesCmo200ResponseValuesInner) HasDatetime() bool {
	if o != nil && !IsNil(o.Datetime) {
		return true
	}
...
// GetCmo returns the Cmo field value if set, zero value otherwise.
func (o *GetTimeSeriesCmo200ResponseValuesInner) GetCmo() string {
	if o == nil || IsNil(o.Cmo) {
		var ret string
		return ret
	}
	return *o.Cmo
...
// GetCmoOk returns a tuple with the Cmo field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// HasCmo returns a boolean if a field has been set.
func (o *GetTimeSeriesCmo200ResponseValuesInner) HasCmo() bool {
	if o != nil && !IsNil(o.Cmo) {
		return true
	}
...
// SetCmo gets a reference to the given string and assigns it to the Cmo field.
