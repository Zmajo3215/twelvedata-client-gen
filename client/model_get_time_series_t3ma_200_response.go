...
type GetTimeSeriesT3ma200Response struct {
	Meta *GetTimeSeriesT3ma200ResponseMeta `json:"meta,omitempty"`
	// Array of time series data points
	Values []GetTimeSeriesT3ma200ResponseValuesInner `json:"values,omitempty"`
	// Response status
...
func NewGetTimeSeriesT3ma200Response() *GetTimeSeriesT3ma200Response {
...
func (o *GetTimeSeriesT3ma200Response) HasMeta() bool {
	if o != nil && !IsNil(o.Meta) {
		return true
	}
...
// SetMeta gets a reference to the given GetTimeSeriesT3ma200ResponseMeta and assigns it to the Meta field.
...
func (o *GetTimeSeriesT3ma200Response) HasValues() bool {
	if o != nil && !IsNil(o.Values) {
		return true
	}
...
// SetValues gets a reference to the given []GetTimeSeriesT3ma200ResponseValuesInner and assigns it to the Values field.
...
func (o *GetTimeSeriesT3ma200Response) HasStatus() bool {
	if o != nil && !IsNil(o.Status) {
		return true
	}
