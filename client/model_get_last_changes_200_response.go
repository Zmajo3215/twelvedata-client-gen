...
type GetLastChanges200Response struct {
	Pagination *GetLastChanges200ResponsePagination `json:"pagination,omitempty"`
	// Data contains the list of last changes
	Data []LastChangeResponseItem `json:"data,omitempty"`
}
...
// SetPagination gets a reference to the given GetLastChanges200ResponsePagination and assigns it to the Pagination field.
...
// SetData gets a reference to the given []LastChangeResponseItem and assigns it to the Data field.
