...
// GetFigiCode returns the FigiCode field value if set, zero value otherwise.
func (o *StocksResponseItem) GetFigiCode() string {
	if o == nil || IsNil(o.FigiCode) {
		var ret string
		return ret
	}
	return *o.FigiCode
...
// SetFigiCode gets a reference to the given string and assigns it to the FigiCode field.
