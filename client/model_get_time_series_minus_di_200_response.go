...
type GetTimeSeriesMinusDI200Response struct {
	Meta *GetTimeSeriesMinusDI200ResponseMeta `json:"meta,omitempty"`
	// Array of time series data points
	Values []GetTimeSeriesMinusDI200ResponseValuesInner `json:"values,omitempty"`
	// Response status
...
// SetMeta gets a reference to the given GetTimeSeriesMinusDI200ResponseMeta and assigns it to the Meta field.
...
// SetValues gets a reference to the given []GetTimeSeriesMinusDI200ResponseValuesInner and assigns it to the Values field.
