...
type GetTimeSeriesPivotPointsHL200Response struct {
	Meta *GetTimeSeriesPivotPointsHL200ResponseMeta `json:"meta,omitempty"`
	// Array of time series data points
	Values []GetTimeSeriesPivotPointsHL200ResponseValuesInner `json:"values,omitempty"`
	// Response status
...
// SetMeta gets a reference to the given GetTimeSeriesPivotPointsHL200ResponseMeta and assigns it to the Meta field.
...
// SetValues gets a reference to the given []GetTimeSeriesPivotPointsHL200ResponseValuesInner and assigns it to the Values field.
