...
// checks if the GetTimeSeriesAtr200ResponseMeta type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetTimeSeriesAtr200ResponseMeta{}

// GetTimeSeriesAtr200ResponseMeta Json object with request general information
type GetTimeSeriesAtr200ResponseMeta struct {
	...
	Indicator *GetTimeSeriesAtr200ResponseMetaIndicator `json:"indicator,omitempty"`
}
...
func NewGetTimeSeriesAtr200ResponseMeta() *GetTimeSeriesAtr200ResponseMeta {
	this := GetTimeSeriesAtr200ResponseMeta{}
	return &this
}
...
func (o *GetTimeSeriesAtr200ResponseMeta) GetIndicator() GetTimeSeriesAtr200ResponseMetaIndicator {
	if o == nil || IsNil(o.Indicator) {
		var ret GetTimeSeriesAtr200ResponseMetaIndicator
		return ret
	}
	return *o.Indicator
}
...
// SetIndicator gets a reference to the given GetTimeSeriesAtr200ResponseMetaIndicator and assigns it to the Indicator field.
func (o *GetTimeSeriesAtr200ResponseMeta) SetIndicator(v GetTimeSeriesAtr200ResponseMetaIndicator) {
	o.Indicator = &v
}

func (o GetTimeSeriesAtr200ResponseMeta) MarshalJSON() ([]byte, error) {
...
func (o GetTimeSeriesAtr200ResponseMeta) ToMap() (map[string]interface{}, error) {
...
type NullableGetTimeSeriesAtr200ResponseMeta struct {
	value *GetTimeSeriesAtr200ResponseMeta
	isSet bool
}

func (v NullableGetTimeSeriesAtr200ResponseMeta) Get() *GetTimeSeriesAtr200ResponseMeta {
	return v.value
}

func (v *NullableGetTimeSeriesAtr200ResponseMeta) Set(val *GetTimeSeriesAtr200ResponseMeta) {
	v.value = val
	v.isSet = true
}

func (v NullableGetTimeSeriesAtr200ResponseMeta) IsSet() bool {
	return v.isSet
}

func (v *NullableGetTimeSeriesAtr200ResponseMeta) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetTimeSeriesAtr200ResponseMeta(val *GetTimeSeriesAtr200ResponseMeta) *NullableGetTimeSeriesAtr200ResponseMeta {
	return &NullableGetTimeSeriesAtr200ResponseMeta{value: val, isSet: true}
}

func (v NullableGetTimeSeriesAtr200ResponseMeta) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetTimeSeriesAtr200ResponseMeta) UnmarshalJSON(src []byte) error {
	v.isSet = true
