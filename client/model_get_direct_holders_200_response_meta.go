...
func NewGetDirectHolders200ResponseMeta() *GetDirectHolders200ResponseMeta {
...
func (o *GetDirectHolders200ResponseMeta) HasSymbol() bool {
	if o != nil && !IsNil(o.Symbol) {
		return true
	}
...
func (o *GetDirectHolders200ResponseMeta) HasName() bool {
	if o != nil && !IsNil(o.Name) {
		return true
	}
...
func (o *GetDirectHolders200ResponseMeta) HasCurrency() bool {
	if o != nil && !IsNil(o.Currency) {
		return true
	}
...
func (o *GetDirectHolders200ResponseMeta) HasExchange() bool {
	if o != nil && !IsNil(o.Exchange) {
		return true
	}
...
func (o *GetDirectHolders200ResponseMeta) HasMicCode() bool {
	if o != nil && !IsNil(o.MicCode) {
		return true
	}
...
func (o *GetDirectHolders200ResponseMeta) HasExchangeTimezone() bool {
	if o != nil && !IsNil(o.ExchangeTimezone) {
		return true
	}
