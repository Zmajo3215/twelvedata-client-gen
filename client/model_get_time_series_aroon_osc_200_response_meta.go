...
// checks if the GetTimeSeriesAroonOsc200ResponseMeta type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetTimeSeriesAroonOsc200ResponseMeta{}

// GetTimeSeriesAroonOsc200ResponseMeta Json object with request general information
type GetTimeSeriesAroonOsc200ResponseMeta struct {
	...
	Indicator *GetTimeSeriesAroonOsc200ResponseMetaIndicator `json:"indicator,omitempty"`
}
...
func NewGetTimeSeriesAroonOsc200ResponseMeta() *GetTimeSeriesAroonOsc200ResponseMeta {
	this := GetTimeSeriesAroonOsc200ResponseMeta{}
	return &this
}
...
func (o *GetTimeSeriesAroonOsc200ResponseMeta) HasSymbol() bool {
	if o != nil && !IsNil(o.Symbol) {
		return true
	}
...
func (o *GetTimeSeriesAroonOsc200ResponseMeta) HasInterval() bool {
	if o != nil && !IsNil(o.Interval) {
		return true
	}
...
func (o *GetTimeSeriesAroonOsc200ResponseMeta) HasCurrency() bool {
	if o != nil && !IsNil(o.Currency) {
		return true
	}
...
func (o *GetTimeSeriesAroonOsc200ResponseMeta) HasExchangeTimezone() bool {
	if o != nil && !IsNil(o.ExchangeTimezone) {
		return true
	}
...
func (o *GetTimeSeriesAroonOsc200ResponseMeta) HasExchange() bool {
	if o != nil && !IsNil(o.Exchange) {
		return true
	}
...
func (o *GetTimeSeriesAroonOsc200ResponseMeta) HasMicCode() bool {
	if o != nil && !IsNil(o.MicCode) {
		return true
	}
...
func (o *GetTimeSeriesAroonOsc200ResponseMeta) HasType() bool {
	if o != nil && !IsNil(o.Type) {
		return true
	}
...
func (o *GetTimeSeriesAroonOsc200ResponseMeta) GetIndicator() GetTimeSeriesAroonOsc200ResponseMetaIndicator {
	if o == nil || IsNil(o.Indicator) {
		var ret GetTimeSeriesAroonOsc200ResponseMetaIndicator
		return ret
	}
	return *o.Indicator
}
...
func (o *GetTimeSeriesAroonOsc200ResponseMeta) HasIndicator() bool {
	if o != nil && !IsNil(o.Indicator) {
		return true
	}
...
// SetIndicator gets a reference to the given GetTimeSeriesAroonOsc200ResponseMetaIndicator and assigns it to the Indicator field.
func (o *GetTimeSeriesAroonOsc200ResponseMeta) SetIndicator(v GetTimeSeriesAroonOsc200ResponseMetaIndicator) {
	o.Indicator = &v
}

func (o GetTimeSeriesAroonOsc200ResponseMeta) MarshalJSON() ([]byte, error) {
...
func (o GetTimeSeriesAroonOsc200ResponseMeta) ToMap() (map[string]interface{}, error) {
...
type NullableGetTimeSeriesAroonOsc200ResponseMeta struct {
	value *GetTimeSeriesAroonOsc200ResponseMeta
	isSet bool
}

func (v NullableGetTimeSeriesAroonOsc200ResponseMeta) Get() *GetTimeSeriesAroonOsc200ResponseMeta {
	return v.value
}

func (v *NullableGetTimeSeriesAroonOsc200ResponseMeta) Set(val *GetTimeSeriesAroonOsc200ResponseMeta) {
	v.value = val
	v.isSet = true
}

func (v NullableGetTimeSeriesAroonOsc200ResponseMeta) IsSet() bool {
	return v.isSet
}

func (v *NullableGetTimeSeriesAroonOsc200ResponseMeta) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetTimeSeriesAroonOsc200ResponseMeta(val *GetTimeSeriesAroonOsc200ResponseMeta) *NullableGetTimeSeriesAroonOsc200ResponseMeta {
	return &NullableGetTimeSeriesAroonOsc200ResponseMeta{value: val, isSet: true}
}

func (v NullableGetTimeSeriesAroonOsc200ResponseMeta) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetTimeSeriesAroonOsc200ResponseMeta) UnmarshalJSON(src []byte) error {
	v.isSet = true
