...
type GetTimeSeriesCeil200Response struct {
	Meta *GetTimeSeriesCeil200ResponseMeta `json:"meta,omitempty"`
	// Array of time series data points
	Values []GetTimeSeriesCeil200ResponseValuesInner `json:"values,omitempty"`
	// Response status
...
func NewGetTimeSeriesCeil200Response() *GetTimeSeriesCeil200Response {
...
func (o *GetTimeSeriesCeil200Response) HasMeta() bool {
	if o != nil && !IsNil(o.Meta) {
		return true
	}
...
// SetMeta gets a reference to the given GetTimeSeriesCeil200ResponseMeta and assigns it to the Meta field.
...
func (o *GetTimeSeriesCeil200Response) HasValues() bool {
	if o != nil && !IsNil(o.Values) {
		return true
	}
...
// SetValues gets a reference to the given []GetTimeSeriesCeil200ResponseValuesInner and assigns it to the Values field.
...
func (o *GetTimeSeriesCeil200Response) HasStatus() bool {
	if o != nil && !IsNil(o.Status) {
		return true
	}
