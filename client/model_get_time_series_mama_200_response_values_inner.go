...
type GetTimeSeriesMama200ResponseValuesInner struct {
	...
	// FAMA value
	Fama *string `json:"fama,omitempty"`
}
...
func NewGetTimeSeriesMama200ResponseValuesInner() *GetTimeSeriesMama200ResponseValuesInner {
...
func (o *GetTimeSeriesMama200ResponseValuesInner) HasDatetime() bool {
	if o != nil && !IsNil(o.Datetime) {
		return true
	}
...
// GetMama returns the Mama field value if set, zero value otherwise.
func (o *GetTimeSeriesMama200ResponseValuesInner) GetMama() string {
	if o == nil || IsNil(o.Mama) {
		var ret string
		return ret
	}
	return *o.Mama
...
// GetMamaOk returns a tuple with the Mama field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// HasMama returns a boolean if a field has been set.
func (o *GetTimeSeriesMama200ResponseValuesInner) HasMama() bool {
	if o != nil && !IsNil(o.Mama) {
		return true
	}
...
// SetMama gets a reference to the given string and assigns it to the Mama field.
func (o *GetTimeSeriesMama200ResponseValuesInner) SetMama(v string) {
	o.Mama = &v
}

// GetFama returns the Fama field value if set, zero value otherwise.
func (o *GetTimeSeriesMama200ResponseValuesInner) GetFama() string {
	if o == nil || IsNil(o.Fama) {
		var ret string
		return ret
	}
	return *o.Fama
...
// GetFamaOk returns a tuple with the Fama field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// HasFama returns a boolean if a field has been set.
func (o *GetTimeSeriesMama200ResponseValuesInner) HasFama() bool {
	if o != nil && !IsNil(o.Fama) {
		return true
	}
...
// SetFama gets a reference to the given string and assigns it to the Fama field.
