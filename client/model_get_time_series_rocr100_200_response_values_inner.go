...
type GetTimeSeriesRocr100200ResponseValuesInner struct {
	...
	// rocr100 value
	Rocr100 *string `json:"rocr100,omitempty"`
}
...
func NewGetTimeSeriesRocr100200ResponseValuesInner() *GetTimeSeriesRocr100200ResponseValuesInner {
...
func (o *GetTimeSeriesRocr100200ResponseValuesInner) HasDatetime() bool {
	if o != nil && !IsNil(o.Datetime) {
		return true
	}
...
// GetRocr100 returns the Rocr100 field value if set, zero value otherwise.
func (o *GetTimeSeriesRocr100200ResponseValuesInner) GetRocr100() string {
	if o == nil || IsNil(o.Rocr100) {
		var ret string
		return ret
	}
	return *o.Rocr100
...
// GetRocr100Ok returns a tuple with the Rocr100 field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// HasRocr100 returns a boolean if a field has been set.
func (o *GetTimeSeriesRocr100200ResponseValuesInner) HasRocr100() bool {
	if o != nil && !IsNil(o.Rocr100) {
		return true
	}
...
// SetRocr100 gets a reference to the given string and assigns it to the Rocr100 field.
