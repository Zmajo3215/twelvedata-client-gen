...
type GetTimeSeriesMinusDM200ResponseValuesInner struct {
	...
	MinusDm *string `json:"minus_dm,omitempty"`
}
...
func NewGetTimeSeriesMinusDM200ResponseValuesInner() *GetTimeSeriesMinusDM200ResponseValuesInner {
...
func (o *GetTimeSeriesMinusDM200ResponseValuesInner) HasDatetime() bool {
	if o != nil && !IsNil(o.Datetime) {
		return true
	}
...
// GetMinusDm returns the MinusDm field value if set, zero value otherwise.
func (o *GetTimeSeriesMinusDM200ResponseValuesInner) GetMinusDm() string {
	if o == nil || IsNil(o.MinusDm) {
		var ret string
		return ret
	}
	return *o.MinusDm
...
// GetMinusDmOk returns a tuple with the MinusDm field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// HasMinusDm returns a boolean if a field has been set.
func (o *GetTimeSeriesMinusDM200ResponseValuesInner) HasMinusDm() bool {
	if o != nil && !IsNil(o.MinusDm) {
		return true
	}
...
// SetMinusDm gets a reference to the given string and assigns it to the MinusDm field.
