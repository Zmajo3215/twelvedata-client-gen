...
type GetMarketCap200Response struct {
	Meta *GetMarketCap200ResponseMeta `json:"meta,omitempty"`
	// Market capitalization values
	MarketCap []GetMarketCap200ResponseMarketCapInner `json:"market_cap,omitempty"`
}
...
// SetMeta gets a reference to the given GetMarketCap200ResponseMeta and assigns it to the Meta field.
...
// SetMarketCap gets a reference to the given []GetMarketCap200ResponseMarketCapInner and assigns it to the MarketCap field.
