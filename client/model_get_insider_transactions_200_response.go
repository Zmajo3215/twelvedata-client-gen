...
type GetInsiderTransactions200Response struct {
	Meta *GetInsiderTransactions200ResponseMeta `json:"meta,omitempty"`
	// List of insider transactions
	InsiderTransactions []GetInsiderTransactions200ResponseInsiderTransactionsInner `json:"insider_transactions,omitempty"`
}
...
func NewGetInsiderTransactions200Response() *GetInsiderTransactions200Response {
...
func (o *GetInsiderTransactions200Response) HasMeta() bool {
	if o != nil && !IsNil(o.Meta) {
		return true
	}
...
// SetMeta gets a reference to the given GetInsiderTransactions200ResponseMeta and assigns it to the Meta field.
...
func (o *GetInsiderTransactions200Response) GetInsiderTransactions() []GetInsiderTransactions200ResponseInsiderTransactionsInner {
	if o == nil || IsNil(o.InsiderTransactions) {
...
func (o *GetInsiderTransactions200Response) HasInsiderTransactions() bool {
	if o != nil && !IsNil(o.InsiderTransactions) {
		return true
	}
...
// SetInsiderTransactions gets a reference to the given []GetInsiderTransactions200ResponseInsiderTransactionsInner and assigns it to the InsiderTransactions field.
...
func (o GetInsiderTransactions200Response) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.InsiderTransactions) {
