...
func NewInlineObject11ValuesInner() *InlineObject11ValuesInner {
...
func (o *InlineObject11ValuesInner) HasDatetime() bool {
	if o != nil && !IsNil(o.Datetime) {
		return true
	}
...
func (o *InlineObject11ValuesInner) HasCos() bool {
	if o != nil && !IsNil(o.Cos) {
		return true
	}
...
// SetCos gets a reference to the given string and assigns it to the Cos field.
