...
type GetEpsTrend200Response struct {
	...
	// EPS trend data
	EpsTrend []GetEpsTrend200ResponseEpsTrendInner `json:"eps_trend,omitempty"`
...
func NewGetEpsTrend200Response() *GetEpsTrend200Response {
...
func (o *GetEpsTrend200Response) HasMeta() bool {
	if o != nil && !IsNil(o.Meta) {
		return true
	}
...
// GetEpsTrend returns the EpsTrend field value if set, zero value otherwise.
func (o *GetEpsTrend200Response) GetEpsTrend() []GetEpsTrend200ResponseEpsTrendInner {
	if o == nil || IsNil(o.EpsTrend) {
...
// GetEpsTrendOk returns a tuple with the EpsTrend field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// HasEpsTrend returns a boolean if a field has been set.
func (o *GetEpsTrend200Response) HasEpsTrend() bool {
	if o != nil && !IsNil(o.EpsTrend) {
		return true
	}
...
// SetEpsTrend gets a reference to the given []GetEpsTrend200ResponseEpsTrendInner and assigns it to the EpsTrend field.
...
func (o *GetEpsTrend200Response) HasStatus() bool {
	if o != nil && !IsNil(o.Status) {
		return true
	}
