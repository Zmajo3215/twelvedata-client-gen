...
type GetTimeSeriesLinearRegIntercept200Response struct {
	Meta *GetTimeSeriesLinearRegIntercept200ResponseMeta `json:"meta,omitempty"`
	// Array of time series data points
	Values []GetTimeSeriesLinearRegIntercept200ResponseValuesInner `json:"values,omitempty"`
	// Response status
...
func NewGetTimeSeriesLinearRegIntercept200Response() *GetTimeSeriesLinearRegIntercept200Response {
...
func (o *GetTimeSeriesLinearRegIntercept200Response) HasMeta() bool {
	if o != nil && !IsNil(o.Meta) {
		return true
	}
...
// SetMeta gets a reference to the given GetTimeSeriesLinearRegIntercept200ResponseMeta and assigns it to the Meta field.
...
func (o *GetTimeSeriesLinearRegIntercept200Response) HasValues() bool {
	if o != nil && !IsNil(o.Values) {
		return true
	}
...
// SetValues gets a reference to the given []GetTimeSeriesLinearRegIntercept200ResponseValuesInner and assigns it to the Values field.
...
func (o *GetTimeSeriesLinearRegIntercept200Response) HasStatus() bool {
	if o != nil && !IsNil(o.Status) {
		return true
	}
