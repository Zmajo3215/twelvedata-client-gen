...
func NewGetTimeSeriesMom200ResponseValuesInner() *GetTimeSeriesMom200ResponseValuesInner {
...
func (o *GetTimeSeriesMom200ResponseValuesInner) HasDatetime() bool {
	if o != nil && !IsNil(o.Datetime) {
		return true
	}
...
// GetMom returns the Mom field value if set, zero value otherwise.
func (o *GetTimeSeriesMom200ResponseValuesInner) GetMom() string {
	if o == nil || IsNil(o.Mom) {
		var ret string
		return ret
	}
	return *o.Mom
...
func (o *GetTimeSeriesMom200ResponseValuesInner) HasMom() bool {
	if o != nil && !IsNil(o.Mom) {
		return true
	}
...
// SetMom gets a reference to the given string and assigns it to the Mom field.
