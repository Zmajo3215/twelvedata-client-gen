...
type GetTimeSeriesStochF200Response struct {
	Meta *GetTimeSeriesStochF200ResponseMeta `json:"meta,omitempty"`
	// Array of time series data points
	Values []GetTimeSeriesStochF200ResponseValuesInner `json:"values,omitempty"`
	// Response status
...
// SetMeta gets a reference to the given GetTimeSeriesStochF200ResponseMeta and assigns it to the Meta field.
...
// SetValues gets a reference to the given []GetTimeSeriesStochF200ResponseValuesInner and assigns it to the Values field.
