...
type GetMutualFundsWorldSustainability200Response struct {
	MutualFund *GetMutualFundsWorldSustainability200ResponseMutualFund `json:"mutual_fund,omitempty"`
...
func NewGetMutualFundsWorldSustainability200Response() *GetMutualFundsWorldSustainability200Response {
...
// GetMutualFundOk returns a tuple with the MutualFund field value if set, nil otherwise
...
// HasMutualFund returns a boolean if a field has been set.
func (o *GetMutualFundsWorldSustainability200Response) HasMutualFund() bool {
	if o != nil && !IsNil(o.MutualFund) {
		return true
	}
...
// SetMutualFund gets a reference to the given GetMutualFundsWorldSustainability200ResponseMutualFund and assigns it to the MutualFund field.
...
func (o *GetMutualFundsWorldSustainability200Response) HasStatus() bool {
	if o != nil && !IsNil(o.Status) {
		return true
	}
