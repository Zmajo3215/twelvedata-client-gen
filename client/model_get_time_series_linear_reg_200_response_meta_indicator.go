...
func NewGetTimeSeriesLinearReg200ResponseMetaIndicator() *GetTimeSeriesLinearReg200ResponseMetaIndicator {
...
func (o *GetTimeSeriesLinearReg200ResponseMetaIndicator) HasName() bool {
	if o != nil && !IsNil(o.Name) {
		return true
	}
...
func (o *GetTimeSeriesLinearReg200ResponseMetaIndicator) HasSeriesType() bool {
	if o != nil && !IsNil(o.SeriesType) {
		return true
	}
...
func (o *GetTimeSeriesLinearReg200ResponseMetaIndicator) HasTimePeriod() bool {
	if o != nil && !IsNil(o.TimePeriod) {
		return true
	}
