...
// GetTsf returns the Tsf field value if set, zero value otherwise.
func (o *GetTimeSeriesTsf200ResponseValuesInner) GetTsf() string {
	if o == nil || IsNil(o.Tsf) {
		var ret string
		return ret
	}
	return *o.Tsf
...
// GetTsfOk returns a tuple with the Tsf field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// SetTsf gets a reference to the given string and assigns it to the Tsf field.
