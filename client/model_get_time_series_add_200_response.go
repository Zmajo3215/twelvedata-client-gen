...
type GetTimeSeriesAdd200Response struct {
	Meta *GetTimeSeriesAdd200ResponseMeta `json:"meta,omitempty"`
	// Array of time series data points
	Values []GetTimeSeriesAdd200ResponseValuesInner `json:"values,omitempty"`
	// Response status
...
// SetMeta gets a reference to the given GetTimeSeriesAdd200ResponseMeta and assigns it to the Meta field.
...
// SetValues gets a reference to the given []GetTimeSeriesAdd200ResponseValuesInner and assigns it to the Values field.
