...
func NewGetTimeSeriesSuperTrend200ResponseValuesInner() *GetTimeSeriesSuperTrend200ResponseValuesInner {
...
func (o *GetTimeSeriesSuperTrend200ResponseValuesInner) HasDatetime() bool {
	if o != nil && !IsNil(o.Datetime) {
		return true
	}
...
func (o *GetTimeSeriesSuperTrend200ResponseValuesInner) HasSupertrend() bool {
	if o != nil && !IsNil(o.Supertrend) {
		return true
	}
