...
type GetTimeSeriesCorrel200ResponseMetaIndicator struct {
	...
	SeriesType1 *string `json:"series_type_1,omitempty"`
	// Price type used as the second part of technical indicator
	SeriesType2 *string `json:"series_type_2,omitempty"`
...
func NewGetTimeSeriesCorrel200ResponseMetaIndicator() *GetTimeSeriesCorrel200ResponseMetaIndicator {
...
func (o *GetTimeSeriesCorrel200ResponseMetaIndicator) HasName() bool {
	if o != nil && !IsNil(o.Name) {
		return true
	}
...
// GetSeriesType1 returns the SeriesType1 field value if set, zero value otherwise.
func (o *GetTimeSeriesCorrel200ResponseMetaIndicator) GetSeriesType1() string {
	if o == nil || IsNil(o.SeriesType1) {
		var ret string
		return ret
	}
...
// GetSeriesType1Ok returns a tuple with the SeriesType1 field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// HasSeriesType1 returns a boolean if a field has been set.
func (o *GetTimeSeriesCorrel200ResponseMetaIndicator) HasSeriesType1() bool {
	if o != nil && !IsNil(o.SeriesType1) {
		return true
	}
...
// SetSeriesType1 gets a reference to the given string and assigns it to the SeriesType1 field.
func (o *GetTimeSeriesCorrel200ResponseMetaIndicator) SetSeriesType1(v string) {
	o.SeriesType1 = &v
}

// GetSeriesType2 returns the SeriesType2 field value if set, zero value otherwise.
func (o *GetTimeSeriesCorrel200ResponseMetaIndicator) GetSeriesType2() string {
	if o == nil || IsNil(o.SeriesType2) {
		var ret string
		return ret
	}
...
// GetSeriesType2Ok returns a tuple with the SeriesType2 field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// HasSeriesType2 returns a boolean if a field has been set.
func (o *GetTimeSeriesCorrel200ResponseMetaIndicator) HasSeriesType2() bool {
	if o != nil && !IsNil(o.SeriesType2) {
		return true
	}
...
// SetSeriesType2 gets a reference to the given string and assigns it to the SeriesType2 field.
...
func (o *GetTimeSeriesCorrel200ResponseMetaIndicator) HasTimePeriod() bool {
	if o != nil && !IsNil(o.TimePeriod) {
		return true
	}
...
func (o GetTimeSeriesCorrel200ResponseMetaIndicator) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.SeriesType1) {
		toSerialize["series_type_1"] = o.SeriesType1
	}
	if !IsNil(o.SeriesType2) {
