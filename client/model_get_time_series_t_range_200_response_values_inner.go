...
type GetTimeSeriesTRange200ResponseValuesInner struct {
	...
	// trange value
	Trange *string `json:"trange,omitempty"`
}
...
func NewGetTimeSeriesTRange200ResponseValuesInner() *GetTimeSeriesTRange200ResponseValuesInner {
...
func (o *GetTimeSeriesTRange200ResponseValuesInner) HasDatetime() bool {
	if o != nil && !IsNil(o.Datetime) {
		return true
	}
...
// GetTrange returns the Trange field value if set, zero value otherwise.
func (o *GetTimeSeriesTRange200ResponseValuesInner) GetTrange() string {
	if o == nil || IsNil(o.Trange) {
		var ret string
		return ret
	}
	return *o.Trange
...
// GetTrangeOk returns a tuple with the Trange field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// HasTrange returns a boolean if a field has been set.
func (o *GetTimeSeriesTRange200ResponseValuesInner) HasTrange() bool {
	if o != nil && !IsNil(o.Trange) {
		return true
	}
...
// SetTrange gets a reference to the given string and assigns it to the Trange field.
