...
type GetTimeSeriesMacdExt200Response struct {
	Meta *GetTimeSeriesMacdExt200ResponseMeta `json:"meta,omitempty"`
	// Array of time series data points
	Values []GetTimeSeriesMacdExt200ResponseValuesInner `json:"values,omitempty"`
	// Response status
...
func NewGetTimeSeriesMacdExt200Response() *GetTimeSeriesMacdExt200Response {
...
func (o *GetTimeSeriesMacdExt200Response) HasMeta() bool {
	if o != nil && !IsNil(o.Meta) {
		return true
	}
...
// SetMeta gets a reference to the given GetTimeSeriesMacdExt200ResponseMeta and assigns it to the Meta field.
...
func (o *GetTimeSeriesMacdExt200Response) HasValues() bool {
	if o != nil && !IsNil(o.Values) {
		return true
	}
...
// SetValues gets a reference to the given []GetTimeSeriesMacdExt200ResponseValuesInner and assigns it to the Values field.
...
func (o *GetTimeSeriesMacdExt200Response) HasStatus() bool {
	if o != nil && !IsNil(o.Status) {
		return true
	}
