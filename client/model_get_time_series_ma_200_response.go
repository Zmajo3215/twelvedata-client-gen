...
type GetTimeSeriesMa200Response struct {
	Meta *GetTimeSeriesMa200ResponseMeta `json:"meta,omitempty"`
	// Array of time series data points
	Values []GetTimeSeriesMa200ResponseValuesInner `json:"values,omitempty"`
	// Response status
...
func NewGetTimeSeriesMa200Response() *GetTimeSeriesMa200Response {
...
func (o *GetTimeSeriesMa200Response) HasMeta() bool {
	if o != nil && !IsNil(o.Meta) {
		return true
	}
...
// SetMeta gets a reference to the given GetTimeSeriesMa200ResponseMeta and assigns it to the Meta field.
...
func (o *GetTimeSeriesMa200Response) HasValues() bool {
	if o != nil && !IsNil(o.Values) {
		return true
	}
...
// SetValues gets a reference to the given []GetTimeSeriesMa200ResponseValuesInner and assigns it to the Values field.
...
func (o *GetTimeSeriesMa200Response) HasStatus() bool {
	if o != nil && !IsNil(o.Status) {
		return true
	}
