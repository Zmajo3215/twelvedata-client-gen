...
type GetTimeSeriesLinearReg200Response struct {
	Meta *GetTimeSeriesLinearReg200ResponseMeta `json:"meta,omitempty"`
	// Array of time series data points
	Values []GetTimeSeriesLinearReg200ResponseValuesInner `json:"values,omitempty"`
	// Response status
...
func NewGetTimeSeriesLinearReg200Response() *GetTimeSeriesLinearReg200Response {
...
func (o *GetTimeSeriesLinearReg200Response) HasMeta() bool {
	if o != nil && !IsNil(o.Meta) {
		return true
	}
...
// SetMeta gets a reference to the given GetTimeSeriesLinearReg200ResponseMeta and assigns it to the Meta field.
...
func (o *GetTimeSeriesLinearReg200Response) HasValues() bool {
	if o != nil && !IsNil(o.Values) {
		return true
	}
...
// SetValues gets a reference to the given []GetTimeSeriesLinearReg200ResponseValuesInner and assigns it to the Values field.
...
func (o *GetTimeSeriesLinearReg200Response) HasStatus() bool {
	if o != nil && !IsNil(o.Status) {
		return true
	}
