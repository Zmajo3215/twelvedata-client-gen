...
type GetMutualFundsWorldSummary200Response struct {
	MutualFund *GetMutualFundsWorldSummary200ResponseMutualFund `json:"mutual_fund,omitempty"`
...
func NewGetMutualFundsWorldSummary200Response() *GetMutualFundsWorldSummary200Response {
...
func (o *GetMutualFundsWorldSummary200Response) HasMutualFund() bool {
	if o != nil && !IsNil(o.MutualFund) {
		return true
	}
...
// SetMutualFund gets a reference to the given GetMutualFundsWorldSummary200ResponseMutualFund and assigns it to the MutualFund field.
...
func (o *GetMutualFundsWorldSummary200Response) HasStatus() bool {
	if o != nil && !IsNil(o.Status) {
		return true
	}
