...
type GetTimeSeriesHeikinashiCandles200Response struct {
	Meta *GetTimeSeriesHeikinashiCandles200ResponseMeta `json:"meta,omitempty"`
	// Array of time series data points
	Values []GetTimeSeriesHeikinashiCandles200ResponseValuesInner `json:"values,omitempty"`
	// Response status
...
// SetMeta gets a reference to the given GetTimeSeriesHeikinashiCandles200ResponseMeta and assigns it to the Meta field.
...
// SetValues gets a reference to the given []GetTimeSeriesHeikinashiCandles200ResponseValuesInner and assigns it to the Values field.
