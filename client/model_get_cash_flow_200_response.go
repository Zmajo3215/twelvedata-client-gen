...
type GetCashFlow200Response struct {
	Meta *GetCashFlow200ResponseMeta `json:"meta,omitempty"`
	// Cash flow data
	CashFlow []CashFlowStruct `json:"cash_flow,omitempty"`
}
...
func NewGetCashFlow200Response() *GetCashFlow200Response {
...
func (o *GetCashFlow200Response) HasMeta() bool {
	if o != nil && !IsNil(o.Meta) {
		return true
	}
...
// SetMeta gets a reference to the given GetCashFlow200ResponseMeta and assigns it to the Meta field.
...
func (o *GetCashFlow200Response) HasCashFlow() bool {
	if o != nil && !IsNil(o.CashFlow) {
		return true
	}
...
// SetCashFlow gets a reference to the given []CashFlowStruct and assigns it to the CashFlow field.
