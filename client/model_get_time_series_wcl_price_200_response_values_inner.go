...
type GetTimeSeriesWclPrice200ResponseValuesInner struct {
	...
	// wclprice value
	Wclprice *float64 `json:"wclprice,omitempty"`
}
...
// GetWclprice returns the Wclprice field value if set, zero value otherwise.
func (o *GetTimeSeriesWclPrice200ResponseValuesInner) GetWclprice() float64 {
	if o == nil || IsNil(o.Wclprice) {
		var ret float64
		return ret
	}
	return *o.Wclprice
...
// GetWclpriceOk returns a tuple with the Wclprice field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// SetWclprice gets a reference to the given float64 and assigns it to the Wclprice field.
