...
type GetMutualFundsWorldPerformance200Response struct {
	MutualFund *GetMutualFundsWorldPerformance200ResponseMutualFund `json:"mutual_fund,omitempty"`
...
func NewGetMutualFundsWorldPerformance200Response() *GetMutualFundsWorldPerformance200Response {
...
func (o *GetMutualFundsWorldPerformance200Response) HasMutualFund() bool {
	if o != nil && !IsNil(o.MutualFund) {
		return true
	}
...
// SetMutualFund gets a reference to the given GetMutualFundsWorldPerformance200ResponseMutualFund and assigns it to the MutualFund field.
...
func (o *GetMutualFundsWorldPerformance200Response) HasStatus() bool {
	if o != nil && !IsNil(o.Status) {
		return true
	}
