...
// checks if the GetTimeSeriesDiv200ResponseMeta type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetTimeSeriesDiv200ResponseMeta{}

// GetTimeSeriesDiv200ResponseMeta Json object with request general information
type GetTimeSeriesDiv200ResponseMeta struct {
	...
	Indicator *GetTimeSeriesDiv200ResponseMetaIndicator `json:"indicator,omitempty"`
}
...
func NewGetTimeSeriesDiv200ResponseMeta() *GetTimeSeriesDiv200ResponseMeta {
	this := GetTimeSeriesDiv200ResponseMeta{}
	return &this
}
...
func (o *GetTimeSeriesDiv200ResponseMeta) HasSymbol() bool {
	if o != nil && !IsNil(o.Symbol) {
		return true
	}
...
func (o *GetTimeSeriesDiv200ResponseMeta) HasInterval() bool {
	if o != nil && !IsNil(o.Interval) {
		return true
	}
...
func (o *GetTimeSeriesDiv200ResponseMeta) HasCurrency() bool {
	if o != nil && !IsNil(o.Currency) {
		return true
	}
...
func (o *GetTimeSeriesDiv200ResponseMeta) HasExchangeTimezone() bool {
	if o != nil && !IsNil(o.ExchangeTimezone) {
		return true
	}
...
func (o *GetTimeSeriesDiv200ResponseMeta) HasExchange() bool {
	if o != nil && !IsNil(o.Exchange) {
		return true
	}
...
func (o *GetTimeSeriesDiv200ResponseMeta) HasMicCode() bool {
	if o != nil && !IsNil(o.MicCode) {
		return true
	}
...
func (o *GetTimeSeriesDiv200ResponseMeta) HasType() bool {
	if o != nil && !IsNil(o.Type) {
		return true
	}
...
func (o *GetTimeSeriesDiv200ResponseMeta) GetIndicator() GetTimeSeriesDiv200ResponseMetaIndicator {
	if o == nil || IsNil(o.Indicator) {
		var ret GetTimeSeriesDiv200ResponseMetaIndicator
		return ret
	}
	return *o.Indicator
}
...
func (o *GetTimeSeriesDiv200ResponseMeta) HasIndicator() bool {
	if o != nil && !IsNil(o.Indicator) {
		return true
	}
...
// SetIndicator gets a reference to the given GetTimeSeriesDiv200ResponseMetaIndicator and assigns it to the Indicator field.
func (o *GetTimeSeriesDiv200ResponseMeta) SetIndicator(v GetTimeSeriesDiv200ResponseMetaIndicator) {
	o.Indicator = &v
}

func (o GetTimeSeriesDiv200ResponseMeta) MarshalJSON() ([]byte, error) {
...
func (o GetTimeSeriesDiv200ResponseMeta) ToMap() (map[string]interface{}, error) {
...
type NullableGetTimeSeriesDiv200ResponseMeta struct {
	value *GetTimeSeriesDiv200ResponseMeta
	isSet bool
}

func (v NullableGetTimeSeriesDiv200ResponseMeta) Get() *GetTimeSeriesDiv200ResponseMeta {
	return v.value
}

func (v *NullableGetTimeSeriesDiv200ResponseMeta) Set(val *GetTimeSeriesDiv200ResponseMeta) {
	v.value = val
	v.isSet = true
}

func (v NullableGetTimeSeriesDiv200ResponseMeta) IsSet() bool {
	return v.isSet
}

func (v *NullableGetTimeSeriesDiv200ResponseMeta) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetTimeSeriesDiv200ResponseMeta(val *GetTimeSeriesDiv200ResponseMeta) *NullableGetTimeSeriesDiv200ResponseMeta {
	return &NullableGetTimeSeriesDiv200ResponseMeta{value: val, isSet: true}
}

func (v NullableGetTimeSeriesDiv200ResponseMeta) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetTimeSeriesDiv200ResponseMeta) UnmarshalJSON(src []byte) error {
	v.isSet = true
