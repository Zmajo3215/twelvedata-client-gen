...
type GetTimeSeriesMedPrice200Response struct {
	Meta *GetTimeSeriesMedPrice200ResponseMeta `json:"meta,omitempty"`
	// Array of time series data points
	Values []GetTimeSeriesMedPrice200ResponseValuesInner `json:"values,omitempty"`
	// Response status
...
// SetMeta gets a reference to the given GetTimeSeriesMedPrice200ResponseMeta and assigns it to the Meta field.
...
// SetValues gets a reference to the given []GetTimeSeriesMedPrice200ResponseValuesInner and assigns it to the Values field.
