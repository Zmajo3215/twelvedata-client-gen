...
// checks if the GetTimeSeriesHeikinashiCandles200ResponseMeta type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetTimeSeriesHeikinashiCandles200ResponseMeta{}

// GetTimeSeriesHeikinashiCandles200ResponseMeta Json object with request general information
type GetTimeSeriesHeikinashiCandles200ResponseMeta struct {
	...
	Indicator *GetTimeSeriesHeikinashiCandles200ResponseMetaIndicator `json:"indicator,omitempty"`
}
...
func NewGetTimeSeriesHeikinashiCandles200ResponseMeta() *GetTimeSeriesHeikinashiCandles200ResponseMeta {
	this := GetTimeSeriesHeikinashiCandles200ResponseMeta{}
	return &this
}
...
func (o *GetTimeSeriesHeikinashiCandles200ResponseMeta) HasSymbol() bool {
	if o != nil && !IsNil(o.Symbol) {
		return true
	}
...
func (o *GetTimeSeriesHeikinashiCandles200ResponseMeta) HasInterval() bool {
	if o != nil && !IsNil(o.Interval) {
		return true
	}
...
func (o *GetTimeSeriesHeikinashiCandles200ResponseMeta) HasCurrency() bool {
	if o != nil && !IsNil(o.Currency) {
		return true
	}
...
func (o *GetTimeSeriesHeikinashiCandles200ResponseMeta) HasExchangeTimezone() bool {
	if o != nil && !IsNil(o.ExchangeTimezone) {
		return true
	}
...
func (o *GetTimeSeriesHeikinashiCandles200ResponseMeta) HasExchange() bool {
	if o != nil && !IsNil(o.Exchange) {
		return true
	}
...
func (o *GetTimeSeriesHeikinashiCandles200ResponseMeta) HasMicCode() bool {
	if o != nil && !IsNil(o.MicCode) {
		return true
	}
...
func (o *GetTimeSeriesHeikinashiCandles200ResponseMeta) HasType() bool {
	if o != nil && !IsNil(o.Type) {
		return true
	}
...
func (o *GetTimeSeriesHeikinashiCandles200ResponseMeta) GetIndicator() GetTimeSeriesHeikinashiCandles200ResponseMetaIndicator {
	if o == nil || IsNil(o.Indicator) {
		var ret GetTimeSeriesHeikinashiCandles200ResponseMetaIndicator
		return ret
	}
	return *o.Indicator
}
...
func (o *GetTimeSeriesHeikinashiCandles200ResponseMeta) HasIndicator() bool {
	if o != nil && !IsNil(o.Indicator) {
		return true
	}
...
// SetIndicator gets a reference to the given GetTimeSeriesHeikinashiCandles200ResponseMetaIndicator and assigns it to the Indicator field.
...
func (o GetTimeSeriesHeikinashiCandles200ResponseMeta) MarshalJSON() ([]byte, error) {
...
func (o GetTimeSeriesHeikinashiCandles200ResponseMeta) ToMap() (map[string]interface{}, error) {
...
type NullableGetTimeSeriesHeikinashiCandles200ResponseMeta struct {
	value *GetTimeSeriesHeikinashiCandles200ResponseMeta
	isSet bool
}

func (v NullableGetTimeSeriesHeikinashiCandles200ResponseMeta) Get() *GetTimeSeriesHeikinashiCandles200ResponseMeta {
	return v.value
}

func (v *NullableGetTimeSeriesHeikinashiCandles200ResponseMeta) Set(val *GetTimeSeriesHeikinashiCandles200ResponseMeta) {
	v.value = val
	v.isSet = true
}

func (v NullableGetTimeSeriesHeikinashiCandles200ResponseMeta) IsSet() bool {
	return v.isSet
}

func (v *NullableGetTimeSeriesHeikinashiCandles200ResponseMeta) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetTimeSeriesHeikinashiCandles200ResponseMeta(val *GetTimeSeriesHeikinashiCandles200ResponseMeta) *NullableGetTimeSeriesHeikinashiCandles200ResponseMeta {
	return &NullableGetTimeSeriesHeikinashiCandles200ResponseMeta{value: val, isSet: true}
}

func (v NullableGetTimeSeriesHeikinashiCandles200ResponseMeta) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetTimeSeriesHeikinashiCandles200ResponseMeta) UnmarshalJSON(src []byte) error {
	v.isSet = true
