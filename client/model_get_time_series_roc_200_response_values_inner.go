...
func NewGetTimeSeriesRoc200ResponseValuesInner() *GetTimeSeriesRoc200ResponseValuesInner {
...
func (o *GetTimeSeriesRoc200ResponseValuesInner) HasDatetime() bool {
	if o != nil && !IsNil(o.Datetime) {
		return true
	}
...
func (o *GetTimeSeriesRoc200ResponseValuesInner) HasRoc() bool {
	if o != nil && !IsNil(o.Roc) {
		return true
	}
...
// SetRoc gets a reference to the given string and assigns it to the Roc field.
