...
type GetTimeSeriesMax200Response struct {
	Meta *GetTimeSeriesMax200ResponseMeta `json:"meta,omitempty"`
	// Array of time series data points
	Values []GetTimeSeriesMax200ResponseValuesInner `json:"values,omitempty"`
	// Response status
...
func NewGetTimeSeriesMax200Response() *GetTimeSeriesMax200Response {
...
func (o *GetTimeSeriesMax200Response) HasMeta() bool {
	if o != nil && !IsNil(o.Meta) {
		return true
	}
...
// SetMeta gets a reference to the given GetTimeSeriesMax200ResponseMeta and assigns it to the Meta field.
...
func (o *GetTimeSeriesMax200Response) HasValues() bool {
	if o != nil && !IsNil(o.Values) {
		return true
	}
...
// SetValues gets a reference to the given []GetTimeSeriesMax200ResponseValuesInner and assigns it to the Values field.
...
func (o *GetTimeSeriesMax200Response) HasStatus() bool {
	if o != nil && !IsNil(o.Status) {
		return true
	}
