...
type GetTimeSeriesWillR200Response struct {
	Meta *GetTimeSeriesWillR200ResponseMeta `json:"meta,omitempty"`
	// Array of time series data points
	Values []GetTimeSeriesWillR200ResponseValuesInner `json:"values,omitempty"`
	// Response status
...
func NewGetTimeSeriesWillR200Response() *GetTimeSeriesWillR200Response {
...
func (o *GetTimeSeriesWillR200Response) HasMeta() bool {
	if o != nil && !IsNil(o.Meta) {
		return true
	}
...
// SetMeta gets a reference to the given GetTimeSeriesWillR200ResponseMeta and assigns it to the Meta field.
...
func (o *GetTimeSeriesWillR200Response) HasValues() bool {
	if o != nil && !IsNil(o.Values) {
		return true
	}
...
// SetValues gets a reference to the given []GetTimeSeriesWillR200ResponseValuesInner and assigns it to the Values field.
...
func (o *GetTimeSeriesWillR200Response) HasStatus() bool {
	if o != nil && !IsNil(o.Status) {
		return true
	}
