...
func NewGetTimeSeriesTema200ResponseValuesInner() *GetTimeSeriesTema200ResponseValuesInner {
...
func (o *GetTimeSeriesTema200ResponseValuesInner) HasDatetime() bool {
	if o != nil && !IsNil(o.Datetime) {
		return true
	}
...
// GetTema returns the Tema field value if set, zero value otherwise.
func (o *GetTimeSeriesTema200ResponseValuesInner) GetTema() string {
	if o == nil || IsNil(o.Tema) {
		var ret string
		return ret
	}
	return *o.Tema
...
// GetTemaOk returns a tuple with the Tema field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// HasTema returns a boolean if a field has been set.
func (o *GetTimeSeriesTema200ResponseValuesInner) HasTema() bool {
	if o != nil && !IsNil(o.Tema) {
		return true
	}
...
// SetTema gets a reference to the given string and assigns it to the Tema field.
