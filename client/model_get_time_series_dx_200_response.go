...
type GetTimeSeriesDx200Response struct {
	Meta *GetTimeSeriesDx200ResponseMeta `json:"meta,omitempty"`
	// Array of time series data points
	Values []GetTimeSeriesDx200ResponseValuesInner `json:"values,omitempty"`
	// Response status
...
// SetMeta gets a reference to the given GetTimeSeriesDx200ResponseMeta and assigns it to the Meta field.
...
// SetValues gets a reference to the given []GetTimeSeriesDx200ResponseValuesInner and assigns it to the Values field.
