...
type InlineObject17 struct {
	Meta *InlineObject17Meta `json:"meta,omitempty"`
	// Array of time series data points
	Values []InlineObject17ValuesInner `json:"values,omitempty"`
	// Response status
...
func (o *InlineObject17) HasMeta() bool {
	if o != nil && !IsNil(o.Meta) {
		return true
	}
...
// SetMeta gets a reference to the given InlineObject17Meta and assigns it to the Meta field.
...
func (o *InlineObject17) HasValues() bool {
	if o != nil && !IsNil(o.Values) {
		return true
	}
...
// SetValues gets a reference to the given []InlineObject17ValuesInner and assigns it to the Values field.
