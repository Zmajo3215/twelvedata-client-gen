...
type GetTimeSeriesAroon200Response struct {
	Meta *GetTimeSeriesAroon200ResponseMeta `json:"meta,omitempty"`
	// Array of time series data points
	Values []GetTimeSeriesAroon200ResponseValuesInner `json:"values,omitempty"`
	// Response status
...
// SetMeta gets a reference to the given GetTimeSeriesAroon200ResponseMeta and assigns it to the Meta field.
...
// SetValues gets a reference to the given []GetTimeSeriesAroon200ResponseValuesInner and assigns it to the Values field.
