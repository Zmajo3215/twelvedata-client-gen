...
type GetPriceTarget200Response struct {
	Meta *GetPriceTarget200ResponseMeta `json:"meta,omitempty"`
	PriceTarget *GetPriceTarget200ResponsePriceTarget `json:"price_target,omitempty"`
	// Response status
...
// SetMeta gets a reference to the given GetPriceTarget200ResponseMeta and assigns it to the Meta field.
...
// SetPriceTarget gets a reference to the given GetPriceTarget200ResponsePriceTarget and assigns it to the PriceTarget field.
