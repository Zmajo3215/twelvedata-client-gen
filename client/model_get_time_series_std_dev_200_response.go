...
type GetTimeSeriesStdDev200Response struct {
	Meta *GetTimeSeriesStdDev200ResponseMeta `json:"meta,omitempty"`
	// Array of time series data points
	Values []GetTimeSeriesStdDev200ResponseValuesInner `json:"values,omitempty"`
	// Response status
...
// SetMeta gets a reference to the given GetTimeSeriesStdDev200ResponseMeta and assigns it to the Meta field.
...
// SetValues gets a reference to the given []GetTimeSeriesStdDev200ResponseValuesInner and assigns it to the Values field.
