...
// checks if the GetTimeSeriesTsf200ResponseMeta type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetTimeSeriesTsf200ResponseMeta{}

// GetTimeSeriesTsf200ResponseMeta Json object with request general information
type GetTimeSeriesTsf200ResponseMeta struct {
	...
	Indicator *GetTimeSeriesTsf200ResponseMetaIndicator `json:"indicator,omitempty"`
}
...
func NewGetTimeSeriesTsf200ResponseMeta() *GetTimeSeriesTsf200ResponseMeta {
	this := GetTimeSeriesTsf200ResponseMeta{}
	return &this
}
...
func (o *GetTimeSeriesTsf200ResponseMeta) GetIndicator() GetTimeSeriesTsf200ResponseMetaIndicator {
	if o == nil || IsNil(o.Indicator) {
		var ret GetTimeSeriesTsf200ResponseMetaIndicator
		return ret
	}
	return *o.Indicator
}
...
// SetIndicator gets a reference to the given GetTimeSeriesTsf200ResponseMetaIndicator and assigns it to the Indicator field.
func (o *GetTimeSeriesTsf200ResponseMeta) SetIndicator(v GetTimeSeriesTsf200ResponseMetaIndicator) {
	o.Indicator = &v
}

func (o GetTimeSeriesTsf200ResponseMeta) MarshalJSON() ([]byte, error) {
...
func (o GetTimeSeriesTsf200ResponseMeta) ToMap() (map[string]interface{}, error) {
...
type NullableGetTimeSeriesTsf200ResponseMeta struct {
	value *GetTimeSeriesTsf200ResponseMeta
	isSet bool
}

func (v NullableGetTimeSeriesTsf200ResponseMeta) Get() *GetTimeSeriesTsf200ResponseMeta {
	return v.value
}

func (v *NullableGetTimeSeriesTsf200ResponseMeta) Set(val *GetTimeSeriesTsf200ResponseMeta) {
	v.value = val
	v.isSet = true
}

func (v NullableGetTimeSeriesTsf200ResponseMeta) IsSet() bool {
	return v.isSet
}

func (v *NullableGetTimeSeriesTsf200ResponseMeta) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetTimeSeriesTsf200ResponseMeta(val *GetTimeSeriesTsf200ResponseMeta) *NullableGetTimeSeriesTsf200ResponseMeta {
	return &NullableGetTimeSeriesTsf200ResponseMeta{value: val, isSet: true}
}

func (v NullableGetTimeSeriesTsf200ResponseMeta) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetTimeSeriesTsf200ResponseMeta) UnmarshalJSON(src []byte) error {
	v.isSet = true
