...
type GetTimeSeriesUltOsc200ResponseValuesInner struct {
	...
	Ultosc *string `json:"ultosc,omitempty"`
}
...
// GetUltosc returns the Ultosc field value if set, zero value otherwise.
func (o *GetTimeSeriesUltOsc200ResponseValuesInner) GetUltosc() string {
	if o == nil || IsNil(o.Ultosc) {
		var ret string
		return ret
	}
	return *o.Ultosc
...
// GetUltoscOk returns a tuple with the Ultosc field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// SetUltosc gets a reference to the given string and assigns it to the Ultosc field.
