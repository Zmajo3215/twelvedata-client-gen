...
func NewGetAnalystRatingsLight200Response() *GetAnalystRatingsLight200Response {
...
func (o *GetAnalystRatingsLight200Response) HasMeta() bool {
	if o != nil && !IsNil(o.Meta) {
		return true
	}
...
func (o *GetAnalystRatingsLight200Response) HasStatus() bool {
	if o != nil && !IsNil(o.Status) {
		return true
	}
