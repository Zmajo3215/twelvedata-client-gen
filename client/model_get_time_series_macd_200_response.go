...
type GetTimeSeriesMacd200Response struct {
	Meta *GetTimeSeriesMacd200ResponseMeta `json:"meta,omitempty"`
	// Array of time series data points
	Values []GetTimeSeriesMacd200ResponseValuesInner `json:"values,omitempty"`
	// Response status
...
func NewGetTimeSeriesMacd200Response() *GetTimeSeriesMacd200Response {
...
func (o *GetTimeSeriesMacd200Response) HasMeta() bool {
	if o != nil && !IsNil(o.Meta) {
		return true
	}
...
// SetMeta gets a reference to the given GetTimeSeriesMacd200ResponseMeta and assigns it to the Meta field.
...
func (o *GetTimeSeriesMacd200Response) HasValues() bool {
	if o != nil && !IsNil(o.Values) {
		return true
	}
...
// SetValues gets a reference to the given []GetTimeSeriesMacd200ResponseValuesInner and assigns it to the Values field.
...
func (o *GetTimeSeriesMacd200Response) HasStatus() bool {
	if o != nil && !IsNil(o.Status) {
		return true
	}
