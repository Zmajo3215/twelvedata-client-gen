...
type GetMutualFundsWorldRatings200Response struct {
	MutualFund *GetMutualFundsWorldRatings200ResponseMutualFund `json:"mutual_fund,omitempty"`
...
func NewGetMutualFundsWorldRatings200Response() *GetMutualFundsWorldRatings200Response {
...
func (o *GetMutualFundsWorldRatings200Response) HasMutualFund() bool {
	if o != nil && !IsNil(o.MutualFund) {
		return true
	}
...
// SetMutualFund gets a reference to the given GetMutualFundsWorldRatings200ResponseMutualFund and assigns it to the MutualFund field.
...
func (o *GetMutualFundsWorldRatings200Response) HasStatus() bool {
	if o != nil && !IsNil(o.Status) {
		return true
	}
