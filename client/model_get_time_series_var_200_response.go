...
type GetTimeSeriesVar200Response struct {
	Meta *GetTimeSeriesVar200ResponseMeta `json:"meta,omitempty"`
	// Array of time series data points
	Values []GetTimeSeriesVar200ResponseValuesInner `json:"values,omitempty"`
	// Response status
...
// SetMeta gets a reference to the given GetTimeSeriesVar200ResponseMeta and assigns it to the Meta field.
...
// SetValues gets a reference to the given []GetTimeSeriesVar200ResponseValuesInner and assigns it to the Values field.
