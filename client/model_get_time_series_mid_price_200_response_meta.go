...
// checks if the GetTimeSeriesMidPrice200ResponseMeta type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetTimeSeriesMidPrice200ResponseMeta{}

// GetTimeSeriesMidPrice200ResponseMeta Json object with request general information
type GetTimeSeriesMidPrice200ResponseMeta struct {
	...
	Indicator *GetTimeSeriesMidPrice200ResponseMetaIndicator `json:"indicator,omitempty"`
}
...
func NewGetTimeSeriesMidPrice200ResponseMeta() *GetTimeSeriesMidPrice200ResponseMeta {
	this := GetTimeSeriesMidPrice200ResponseMeta{}
	return &this
}
...
func (o *GetTimeSeriesMidPrice200ResponseMeta) HasSymbol() bool {
	if o != nil && !IsNil(o.Symbol) {
		return true
	}
...
func (o *GetTimeSeriesMidPrice200ResponseMeta) HasInterval() bool {
	if o != nil && !IsNil(o.Interval) {
		return true
	}
...
func (o *GetTimeSeriesMidPrice200ResponseMeta) HasType() bool {
	if o != nil && !IsNil(o.Type) {
		return true
	}
...
func (o *GetTimeSeriesMidPrice200ResponseMeta) GetIndicator() GetTimeSeriesMidPrice200ResponseMetaIndicator {
	if o == nil || IsNil(o.Indicator) {
		var ret GetTimeSeriesMidPrice200ResponseMetaIndicator
		return ret
	}
	return *o.Indicator
}
...
func (o *GetTimeSeriesMidPrice200ResponseMeta) HasIndicator() bool {
	if o != nil && !IsNil(o.Indicator) {
		return true
	}
...
// SetIndicator gets a reference to the given GetTimeSeriesMidPrice200ResponseMetaIndicator and assigns it to the Indicator field.
func (o *GetTimeSeriesMidPrice200ResponseMeta) SetIndicator(v GetTimeSeriesMidPrice200ResponseMetaIndicator) {
	o.Indicator = &v
}

func (o GetTimeSeriesMidPrice200ResponseMeta) MarshalJSON() ([]byte, error) {
...
func (o GetTimeSeriesMidPrice200ResponseMeta) ToMap() (map[string]interface{}, error) {
...
type NullableGetTimeSeriesMidPrice200ResponseMeta struct {
	value *GetTimeSeriesMidPrice200ResponseMeta
	isSet bool
}

func (v NullableGetTimeSeriesMidPrice200ResponseMeta) Get() *GetTimeSeriesMidPrice200ResponseMeta {
	return v.value
}

func (v *NullableGetTimeSeriesMidPrice200ResponseMeta) Set(val *GetTimeSeriesMidPrice200ResponseMeta) {
	v.value = val
	v.isSet = true
}

func (v NullableGetTimeSeriesMidPrice200ResponseMeta) IsSet() bool {
	return v.isSet
}

func (v *NullableGetTimeSeriesMidPrice200ResponseMeta) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetTimeSeriesMidPrice200ResponseMeta(val *GetTimeSeriesMidPrice200ResponseMeta) *NullableGetTimeSeriesMidPrice200ResponseMeta {
	return &NullableGetTimeSeriesMidPrice200ResponseMeta{value: val, isSet: true}
}

func (v NullableGetTimeSeriesMidPrice200ResponseMeta) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetTimeSeriesMidPrice200ResponseMeta) UnmarshalJSON(src []byte) error {
	v.isSet = true
