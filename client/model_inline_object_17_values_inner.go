...
type InlineObject17ValuesInner struct {
	...
	// TANH value
	Tanh *string `json:"tanh,omitempty"`
}
...
// GetTanh returns the Tanh field value if set, zero value otherwise.
func (o *InlineObject17ValuesInner) GetTanh() string {
	if o == nil || IsNil(o.Tanh) {
		var ret string
		return ret
	}
	return *o.Tanh
...
// GetTanhOk returns a tuple with the Tanh field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// SetTanh gets a reference to the given string and assigns it to the Tanh field.
