...
type GetTimeSeriesSarExt200Response struct {
	Meta *GetTimeSeriesSarExt200ResponseMeta `json:"meta,omitempty"`
	// Array of time series data points
	Values []GetTimeSeriesSarExt200ResponseValuesInner `json:"values,omitempty"`
	// Response status
...
// SetMeta gets a reference to the given GetTimeSeriesSarExt200ResponseMeta and assigns it to the Meta field.
...
// SetValues gets a reference to the given []GetTimeSeriesSarExt200ResponseValuesInner and assigns it to the Values field.
