...
// GetCeil returns the Ceil field value if set, zero value otherwise.
func (o *GetTimeSeriesCeil200ResponseValuesInner) GetCeil() string {
	if o == nil || IsNil(o.Ceil) {
		var ret string
		return ret
	}
	return *o.Ceil
...
// GetCeilOk returns a tuple with the Ceil field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// SetCeil gets a reference to the given string and assigns it to the Ceil field.
