...
func NewGetTimeSeriesMult200ResponseValuesInner() *GetTimeSeriesMult200ResponseValuesInner {
...
func (o *GetTimeSeriesMult200ResponseValuesInner) HasDatetime() bool {
	if o != nil && !IsNil(o.Datetime) {
		return true
	}
...
// GetMult returns the Mult field value if set, zero value otherwise.
func (o *GetTimeSeriesMult200ResponseValuesInner) GetMult() string {
	if o == nil || IsNil(o.Mult) {
		var ret string
		return ret
	}
	return *o.Mult
...
// GetMultOk returns a tuple with the Mult field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// HasMult returns a boolean if a field has been set.
func (o *GetTimeSeriesMult200ResponseValuesInner) HasMult() bool {
	if o != nil && !IsNil(o.Mult) {
		return true
	}
...
// SetMult gets a reference to the given string and assigns it to the Mult field.
