...
type GetTimeSeriesLinearRegIntercept200ResponseMeta struct {
	...
	Indicator *GetTimeSeriesLinearRegIntercept200ResponseMetaIndicator `json:"indicator,omitempty"`
}
...
func NewGetTimeSeriesLinearRegIntercept200ResponseMeta() *GetTimeSeriesLinearRegIntercept200ResponseMeta {
...
func (o *GetTimeSeriesLinearRegIntercept200ResponseMeta) HasSymbol() bool {
	if o != nil && !IsNil(o.Symbol) {
		return true
	}
...
func (o *GetTimeSeriesLinearRegIntercept200ResponseMeta) HasInterval() bool {
	if o != nil && !IsNil(o.Interval) {
		return true
	}
...
func (o *GetTimeSeriesLinearRegIntercept200ResponseMeta) HasCurrency() bool {
	if o != nil && !IsNil(o.Currency) {
		return true
	}
...
func (o *GetTimeSeriesLinearRegIntercept200ResponseMeta) HasExchangeTimezone() bool {
	if o != nil && !IsNil(o.ExchangeTimezone) {
		return true
	}
...
func (o *GetTimeSeriesLinearRegIntercept200ResponseMeta) HasExchange() bool {
	if o != nil && !IsNil(o.Exchange) {
		return true
	}
...
func (o *GetTimeSeriesLinearRegIntercept200ResponseMeta) HasMicCode() bool {
	if o != nil && !IsNil(o.MicCode) {
		return true
	}
...
func (o *GetTimeSeriesLinearRegIntercept200ResponseMeta) HasType() bool {
	if o != nil && !IsNil(o.Type) {
		return true
	}
...
func (o *GetTimeSeriesLinearRegIntercept200ResponseMeta) HasIndicator() bool {
	if o != nil && !IsNil(o.Indicator) {
		return true
	}
...
// SetIndicator gets a reference to the given GetTimeSeriesLinearRegIntercept200ResponseMetaIndicator and assigns it to the Indicator field.
