...
func NewGetTimeSeriesCmo200ResponseMetaIndicator() *GetTimeSeriesCmo200ResponseMetaIndicator {
...
func (o *GetTimeSeriesCmo200ResponseMetaIndicator) HasName() bool {
	if o != nil && !IsNil(o.Name) {
		return true
	}
...
func (o *GetTimeSeriesCmo200ResponseMetaIndicator) HasSeriesType() bool {
	if o != nil && !IsNil(o.SeriesType) {
		return true
	}
...
func (o *GetTimeSeriesCmo200ResponseMetaIndicator) HasTimePeriod() bool {
	if o != nil && !IsNil(o.TimePeriod) {
		return true
	}
