...
type InlineObject10ValuesInner struct {
	...
	// ATAN value
	Atan *string `json:"atan,omitempty"`
}
...
func NewInlineObject10ValuesInner() *InlineObject10ValuesInner {
...
func (o *InlineObject10ValuesInner) HasDatetime() bool {
	if o != nil && !IsNil(o.Datetime) {
		return true
	}
...
// GetAtan returns the Atan field value if set, zero value otherwise.
func (o *InlineObject10ValuesInner) GetAtan() string {
	if o == nil || IsNil(o.Atan) {
		var ret string
		return ret
	}
	return *o.Atan
...
// GetAtanOk returns a tuple with the Atan field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// HasAtan returns a boolean if a field has been set.
func (o *InlineObject10ValuesInner) HasAtan() bool {
	if o != nil && !IsNil(o.Atan) {
		return true
	}
...
// SetAtan gets a reference to the given string and assigns it to the Atan field.
