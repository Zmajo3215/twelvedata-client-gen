...
type GetTimeSeriesHtDcPeriod200ResponseValuesInner struct {
	...
	// ht_dcperiod value
	HtDcperiod *string `json:"ht_dcperiod,omitempty"`
}
...
func NewGetTimeSeriesHtDcPeriod200ResponseValuesInner() *GetTimeSeriesHtDcPeriod200ResponseValuesInner {
...
func (o *GetTimeSeriesHtDcPeriod200ResponseValuesInner) HasDatetime() bool {
	if o != nil && !IsNil(o.Datetime) {
		return true
	}
...
// GetHtDcperiod returns the HtDcperiod field value if set, zero value otherwise.
func (o *GetTimeSeriesHtDcPeriod200ResponseValuesInner) GetHtDcperiod() string {
	if o == nil || IsNil(o.HtDcperiod) {
		var ret string
		return ret
	}
	return *o.HtDcperiod
...
// GetHtDcperiodOk returns a tuple with the HtDcperiod field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// HasHtDcperiod returns a boolean if a field has been set.
func (o *GetTimeSeriesHtDcPeriod200ResponseValuesInner) HasHtDcperiod() bool {
	if o != nil && !IsNil(o.HtDcperiod) {
		return true
	}
...
// SetHtDcperiod gets a reference to the given string and assigns it to the HtDcperiod field.
