...
type GetTimeSeriesMin200Response struct {
	Meta *GetTimeSeriesMin200ResponseMeta `json:"meta,omitempty"`
	// Array of time series data points
	Values []GetTimeSeriesMin200ResponseValuesInner `json:"values,omitempty"`
	// Response status
...
// SetMeta gets a reference to the given GetTimeSeriesMin200ResponseMeta and assigns it to the Meta field.
...
// SetValues gets a reference to the given []GetTimeSeriesMin200ResponseValuesInner and assigns it to the Values field.
