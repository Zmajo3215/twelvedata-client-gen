...
func NewGetTimeSeriesDpo200ResponseValuesInner() *GetTimeSeriesDpo200ResponseValuesInner {
...
func (o *GetTimeSeriesDpo200ResponseValuesInner) HasDatetime() bool {
	if o != nil && !IsNil(o.Datetime) {
		return true
	}
...
func (o *GetTimeSeriesDpo200ResponseValuesInner) HasDpo() bool {
	if o != nil && !IsNil(o.Dpo) {
		return true
	}
...
// SetDpo gets a reference to the given string and assigns it to the Dpo field.
