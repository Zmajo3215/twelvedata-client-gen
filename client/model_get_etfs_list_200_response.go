...
type GetETFsList200Response struct {
	Result *GetETFsList200ResponseResult `json:"result,omitempty"`
...
func NewGetETFsList200Response() *GetETFsList200Response {
...
func (o *GetETFsList200Response) HasResult() bool {
	if o != nil && !IsNil(o.Result) {
		return true
	}
...
// SetResult gets a reference to the given GetETFsList200ResponseResult and assigns it to the Result field.
...
func (o *GetETFsList200Response) HasStatus() bool {
	if o != nil && !IsNil(o.Status) {
		return true
	}
