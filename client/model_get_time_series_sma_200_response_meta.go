...
// checks if the GetTimeSeriesSma200ResponseMeta type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetTimeSeriesSma200ResponseMeta{}

// GetTimeSeriesSma200ResponseMeta Json object with request general information
type GetTimeSeriesSma200ResponseMeta struct {
	...
	Indicator *GetTimeSeriesSma200ResponseMetaIndicator `json:"indicator,omitempty"`
}
...
func NewGetTimeSeriesSma200ResponseMeta() *GetTimeSeriesSma200ResponseMeta {
	this := GetTimeSeriesSma200ResponseMeta{}
	return &this
}
...
func (o *GetTimeSeriesSma200ResponseMeta) GetIndicator() GetTimeSeriesSma200ResponseMetaIndicator {
	if o == nil || IsNil(o.Indicator) {
		var ret GetTimeSeriesSma200ResponseMetaIndicator
		return ret
	}
	return *o.Indicator
}
...
// SetIndicator gets a reference to the given GetTimeSeriesSma200ResponseMetaIndicator and assigns it to the Indicator field.
func (o *GetTimeSeriesSma200ResponseMeta) SetIndicator(v GetTimeSeriesSma200ResponseMetaIndicator) {
	o.Indicator = &v
}

func (o GetTimeSeriesSma200ResponseMeta) MarshalJSON() ([]byte, error) {
...
func (o GetTimeSeriesSma200ResponseMeta) ToMap() (map[string]interface{}, error) {
...
type NullableGetTimeSeriesSma200ResponseMeta struct {
	value *GetTimeSeriesSma200ResponseMeta
	isSet bool
}

func (v NullableGetTimeSeriesSma200ResponseMeta) Get() *GetTimeSeriesSma200ResponseMeta {
	return v.value
}

func (v *NullableGetTimeSeriesSma200ResponseMeta) Set(val *GetTimeSeriesSma200ResponseMeta) {
	v.value = val
	v.isSet = true
}

func (v NullableGetTimeSeriesSma200ResponseMeta) IsSet() bool {
	return v.isSet
}

func (v *NullableGetTimeSeriesSma200ResponseMeta) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetTimeSeriesSma200ResponseMeta(val *GetTimeSeriesSma200ResponseMeta) *NullableGetTimeSeriesSma200ResponseMeta {
	return &NullableGetTimeSeriesSma200ResponseMeta{value: val, isSet: true}
}

func (v NullableGetTimeSeriesSma200ResponseMeta) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetTimeSeriesSma200ResponseMeta) UnmarshalJSON(src []byte) error {
	v.isSet = true
