...
// checks if the GetTimeSeriesMedPrice200ResponseMeta type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetTimeSeriesMedPrice200ResponseMeta{}

// GetTimeSeriesMedPrice200ResponseMeta Json object with request general information
type GetTimeSeriesMedPrice200ResponseMeta struct {
	...
	Indicator *GetTimeSeriesMedPrice200ResponseMetaIndicator `json:"indicator,omitempty"`
}
...
func NewGetTimeSeriesMedPrice200ResponseMeta() *GetTimeSeriesMedPrice200ResponseMeta {
	this := GetTimeSeriesMedPrice200ResponseMeta{}
	return &this
}
...
func (o *GetTimeSeriesMedPrice200ResponseMeta) GetIndicator() GetTimeSeriesMedPrice200ResponseMetaIndicator {
	if o == nil || IsNil(o.Indicator) {
		var ret GetTimeSeriesMedPrice200ResponseMetaIndicator
		return ret
	}
	return *o.Indicator
}
...
// SetIndicator gets a reference to the given GetTimeSeriesMedPrice200ResponseMetaIndicator and assigns it to the Indicator field.
func (o *GetTimeSeriesMedPrice200ResponseMeta) SetIndicator(v GetTimeSeriesMedPrice200ResponseMetaIndicator) {
	o.Indicator = &v
}

func (o GetTimeSeriesMedPrice200ResponseMeta) MarshalJSON() ([]byte, error) {
...
func (o GetTimeSeriesMedPrice200ResponseMeta) ToMap() (map[string]interface{}, error) {
...
type NullableGetTimeSeriesMedPrice200ResponseMeta struct {
	value *GetTimeSeriesMedPrice200ResponseMeta
	isSet bool
}

func (v NullableGetTimeSeriesMedPrice200ResponseMeta) Get() *GetTimeSeriesMedPrice200ResponseMeta {
	return v.value
}

func (v *NullableGetTimeSeriesMedPrice200ResponseMeta) Set(val *GetTimeSeriesMedPrice200ResponseMeta) {
	v.value = val
	v.isSet = true
}

func (v NullableGetTimeSeriesMedPrice200ResponseMeta) IsSet() bool {
	return v.isSet
}

func (v *NullableGetTimeSeriesMedPrice200ResponseMeta) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetTimeSeriesMedPrice200ResponseMeta(val *GetTimeSeriesMedPrice200ResponseMeta) *NullableGetTimeSeriesMedPrice200ResponseMeta {
	return &NullableGetTimeSeriesMedPrice200ResponseMeta{value: val, isSet: true}
}

func (v NullableGetTimeSeriesMedPrice200ResponseMeta) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetTimeSeriesMedPrice200ResponseMeta) UnmarshalJSON(src []byte) error {
	v.isSet = true
