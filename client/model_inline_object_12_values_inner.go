...
type InlineObject12ValuesInner struct {
	...
	// COSH value
	Cosh *string `json:"cosh,omitempty"`
}
...
func NewInlineObject12ValuesInner() *InlineObject12ValuesInner {
...
func (o *InlineObject12ValuesInner) HasDatetime() bool {
	if o != nil && !IsNil(o.Datetime) {
		return true
	}
...
// GetCosh returns the Cosh field value if set, zero value otherwise.
func (o *InlineObject12ValuesInner) GetCosh() string {
	if o == nil || IsNil(o.Cosh) {
		var ret string
		return ret
	}
	return *o.Cosh
...
// GetCoshOk returns a tuple with the Cosh field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// HasCosh returns a boolean if a field has been set.
func (o *InlineObject12ValuesInner) HasCosh() bool {
	if o != nil && !IsNil(o.Cosh) {
		return true
	}
...
// SetCosh gets a reference to the given string and assigns it to the Cosh field.
