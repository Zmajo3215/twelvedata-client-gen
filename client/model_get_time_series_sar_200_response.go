...
type GetTimeSeriesSar200Response struct {
	Meta *GetTimeSeriesSar200ResponseMeta `json:"meta,omitempty"`
	// Array of time series data points
	Values []GetTimeSeriesSar200ResponseValuesInner `json:"values,omitempty"`
	// Response status
...
// SetMeta gets a reference to the given GetTimeSeriesSar200ResponseMeta and assigns it to the Meta field.
...
// SetValues gets a reference to the given []GetTimeSeriesSar200ResponseValuesInner and assigns it to the Values field.
