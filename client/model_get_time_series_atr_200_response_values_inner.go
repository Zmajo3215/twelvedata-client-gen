...
func NewGetTimeSeriesAtr200ResponseValuesInner() *GetTimeSeriesAtr200ResponseValuesInner {
...
func (o *GetTimeSeriesAtr200ResponseValuesInner) HasDatetime() bool {
	if o != nil && !IsNil(o.Datetime) {
		return true
	}
...
// GetAtr returns the Atr field value if set, zero value otherwise.
func (o *GetTimeSeriesAtr200ResponseValuesInner) GetAtr() string {
	if o == nil || IsNil(o.Atr) {
		var ret string
		return ret
	}
	return *o.Atr
...
// GetAtrOk returns a tuple with the Atr field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// HasAtr returns a boolean if a field has been set.
func (o *GetTimeSeriesAtr200ResponseValuesInner) HasAtr() bool {
	if o != nil && !IsNil(o.Atr) {
		return true
	}
...
// SetAtr gets a reference to the given string and assigns it to the Atr field.
