...
type GetTimeSeriesTypPrice200ResponseValuesInner struct {
	...
	// typprice value
	Typprice *string `json:"typprice,omitempty"`
}
...
func NewGetTimeSeriesTypPrice200ResponseValuesInner() *GetTimeSeriesTypPrice200ResponseValuesInner {
...
func (o *GetTimeSeriesTypPrice200ResponseValuesInner) HasDatetime() bool {
	if o != nil && !IsNil(o.Datetime) {
		return true
	}
...
// GetTypprice returns the Typprice field value if set, zero value otherwise.
func (o *GetTimeSeriesTypPrice200ResponseValuesInner) GetTypprice() string {
	if o == nil || IsNil(o.Typprice) {
		var ret string
		return ret
	}
	return *o.Typprice
...
// GetTyppriceOk returns a tuple with the Typprice field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// HasTypprice returns a boolean if a field has been set.
func (o *GetTimeSeriesTypPrice200ResponseValuesInner) HasTypprice() bool {
	if o != nil && !IsNil(o.Typprice) {
		return true
	}
...
// SetTypprice gets a reference to the given string and assigns it to the Typprice field.
