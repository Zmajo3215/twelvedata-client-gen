...
func NewGetTimeSeriesStdDev200ResponseMetaIndicator() *GetTimeSeriesStdDev200ResponseMetaIndicator {
...
func (o *GetTimeSeriesStdDev200ResponseMetaIndicator) HasName() bool {
	if o != nil && !IsNil(o.Name) {
		return true
	}
...
func (o *GetTimeSeriesStdDev200ResponseMetaIndicator) HasSeriesType() bool {
	if o != nil && !IsNil(o.SeriesType) {
		return true
	}
...
func (o *GetTimeSeriesStdDev200ResponseMetaIndicator) HasTimePeriod() bool {
	if o != nil && !IsNil(o.TimePeriod) {
		return true
	}
...
func (o *GetTimeSeriesStdDev200ResponseMetaIndicator) HasSd() bool {
	if o != nil && !IsNil(o.Sd) {
		return true
	}
