...
type GetExchangeSchedule200Response struct {
	Data []ExchangeScheduleResponseItem `json:"data,omitempty"`
}
...
// SetData gets a reference to the given []ExchangeScheduleResponseItem and assigns it to the Data field.
