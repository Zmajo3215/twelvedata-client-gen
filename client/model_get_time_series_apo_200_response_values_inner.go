...
func NewGetTimeSeriesApo200ResponseValuesInner() *GetTimeSeriesApo200ResponseValuesInner {
...
func (o *GetTimeSeriesApo200ResponseValuesInner) HasDatetime() bool {
	if o != nil && !IsNil(o.Datetime) {
		return true
	}
...
// GetApo returns the Apo field value if set, zero value otherwise.
func (o *GetTimeSeriesApo200ResponseValuesInner) GetApo() string {
	if o == nil || IsNil(o.Apo) {
		var ret string
		return ret
	}
	return *o.Apo
...
// GetApoOk returns a tuple with the Apo field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// HasApo returns a boolean if a field has been set.
func (o *GetTimeSeriesApo200ResponseValuesInner) HasApo() bool {
	if o != nil && !IsNil(o.Apo) {
		return true
	}
...
// SetApo gets a reference to the given string and assigns it to the Apo field.
