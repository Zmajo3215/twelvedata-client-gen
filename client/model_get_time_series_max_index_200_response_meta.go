...
// checks if the GetTimeSeriesMaxIndex200ResponseMeta type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetTimeSeriesMaxIndex200ResponseMeta{}

// GetTimeSeriesMaxIndex200ResponseMeta Json object with request general information
type GetTimeSeriesMaxIndex200ResponseMeta struct {
	...
	Indicator *GetTimeSeriesMaxIndex200ResponseMetaIndicator `json:"indicator,omitempty"`
}
...
func NewGetTimeSeriesMaxIndex200ResponseMeta() *GetTimeSeriesMaxIndex200ResponseMeta {
	this := GetTimeSeriesMaxIndex200ResponseMeta{}
	return &this
}
...
func (o *GetTimeSeriesMaxIndex200ResponseMeta) HasSymbol() bool {
	if o != nil && !IsNil(o.Symbol) {
		return true
	}
...
func (o *GetTimeSeriesMaxIndex200ResponseMeta) HasInterval() bool {
	if o != nil && !IsNil(o.Interval) {
		return true
	}
...
func (o *GetTimeSeriesMaxIndex200ResponseMeta) HasCurrency() bool {
	if o != nil && !IsNil(o.Currency) {
		return true
	}
...
func (o *GetTimeSeriesMaxIndex200ResponseMeta) HasExchangeTimezone() bool {
	if o != nil && !IsNil(o.ExchangeTimezone) {
		return true
	}
...
func (o *GetTimeSeriesMaxIndex200ResponseMeta) HasExchange() bool {
	if o != nil && !IsNil(o.Exchange) {
		return true
	}
...
func (o *GetTimeSeriesMaxIndex200ResponseMeta) HasMicCode() bool {
	if o != nil && !IsNil(o.MicCode) {
		return true
	}
...
func (o *GetTimeSeriesMaxIndex200ResponseMeta) HasType() bool {
	if o != nil && !IsNil(o.Type) {
		return true
	}
...
func (o *GetTimeSeriesMaxIndex200ResponseMeta) GetIndicator() GetTimeSeriesMaxIndex200ResponseMetaIndicator {
	if o == nil || IsNil(o.Indicator) {
		var ret GetTimeSeriesMaxIndex200ResponseMetaIndicator
		return ret
	}
	return *o.Indicator
}
...
func (o *GetTimeSeriesMaxIndex200ResponseMeta) HasIndicator() bool {
	if o != nil && !IsNil(o.Indicator) {
		return true
	}
...
// SetIndicator gets a reference to the given GetTimeSeriesMaxIndex200ResponseMetaIndicator and assigns it to the Indicator field.
func (o *GetTimeSeriesMaxIndex200ResponseMeta) SetIndicator(v GetTimeSeriesMaxIndex200ResponseMetaIndicator) {
	o.Indicator = &v
}

func (o GetTimeSeriesMaxIndex200ResponseMeta) MarshalJSON() ([]byte, error) {
...
func (o GetTimeSeriesMaxIndex200ResponseMeta) ToMap() (map[string]interface{}, error) {
...
type NullableGetTimeSeriesMaxIndex200ResponseMeta struct {
	value *GetTimeSeriesMaxIndex200ResponseMeta
	isSet bool
}

func (v NullableGetTimeSeriesMaxIndex200ResponseMeta) Get() *GetTimeSeriesMaxIndex200ResponseMeta {
	return v.value
}

func (v *NullableGetTimeSeriesMaxIndex200ResponseMeta) Set(val *GetTimeSeriesMaxIndex200ResponseMeta) {
	v.value = val
	v.isSet = true
}

func (v NullableGetTimeSeriesMaxIndex200ResponseMeta) IsSet() bool {
	return v.isSet
}

func (v *NullableGetTimeSeriesMaxIndex200ResponseMeta) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetTimeSeriesMaxIndex200ResponseMeta(val *GetTimeSeriesMaxIndex200ResponseMeta) *NullableGetTimeSeriesMaxIndex200ResponseMeta {
	return &NullableGetTimeSeriesMaxIndex200ResponseMeta{value: val, isSet: true}
}

func (v NullableGetTimeSeriesMaxIndex200ResponseMeta) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetTimeSeriesMaxIndex200ResponseMeta) UnmarshalJSON(src []byte) error {
	v.isSet = true
