...
type GetTimeSeriesBBands200Response struct {
	Meta *GetTimeSeriesBBands200ResponseMeta `json:"meta,omitempty"`
	// Array of time series data points
	Values []GetTimeSeriesBBands200ResponseValuesInner `json:"values,omitempty"`
	// Response status
...
// SetMeta gets a reference to the given GetTimeSeriesBBands200ResponseMeta and assigns it to the Meta field.
...
// SetValues gets a reference to the given []GetTimeSeriesBBands200ResponseValuesInner and assigns it to the Values field.
