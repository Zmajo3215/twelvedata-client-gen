...
type GetETFsWorldPerformance200Response struct {
	Etf *GetETFsWorldPerformance200ResponseEtf `json:"etf,omitempty"`
...
func NewGetETFsWorldPerformance200Response() *GetETFsWorldPerformance200Response {
...
func (o *GetETFsWorldPerformance200Response) HasEtf() bool {
	if o != nil && !IsNil(o.Etf) {
		return true
	}
...
// SetEtf gets a reference to the given GetETFsWorldPerformance200ResponseEtf and assigns it to the Etf field.
...
func (o *GetETFsWorldPerformance200Response) HasStatus() bool {
	if o != nil && !IsNil(o.Status) {
		return true
	}
