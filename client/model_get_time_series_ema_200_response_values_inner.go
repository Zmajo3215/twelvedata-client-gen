...
func NewGetTimeSeriesEma200ResponseValuesInner() *GetTimeSeriesEma200ResponseValuesInner {
...
func (o *GetTimeSeriesEma200ResponseValuesInner) HasDatetime() bool {
	if o != nil && !IsNil(o.Datetime) {
		return true
	}
...
// GetEma returns the Ema field value if set, zero value otherwise.
...
func (o *GetTimeSeriesEma200ResponseValuesInner) HasEma() bool {
	if o != nil && !IsNil(o.Ema) {
		return true
	}
...
// SetEma gets a reference to the given string and assigns it to the Ema field.
