...
func NewSymbolSearchResponseItemAccess() *SymbolSearchResponseItemAccess {
...
func (o *SymbolSearchResponseItemAccess) HasGlobal() bool {
	if o != nil && !IsNil(o.Global) {
		return true
	}
...
func (o *SymbolSearchResponseItemAccess) HasPlan() bool {
	if o != nil && !IsNil(o.Plan) {
		return true
	}
