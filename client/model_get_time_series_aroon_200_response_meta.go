...
// checks if the GetTimeSeriesAroon200ResponseMeta type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetTimeSeriesAroon200ResponseMeta{}

// GetTimeSeriesAroon200ResponseMeta Json object with request general information
type GetTimeSeriesAroon200ResponseMeta struct {
	...
	Indicator *GetTimeSeriesAroon200ResponseMetaIndicator `json:"indicator,omitempty"`
}
...
func NewGetTimeSeriesAroon200ResponseMeta() *GetTimeSeriesAroon200ResponseMeta {
	this := GetTimeSeriesAroon200ResponseMeta{}
	return &this
}
...
func (o *GetTimeSeriesAroon200ResponseMeta) GetIndicator() GetTimeSeriesAroon200ResponseMetaIndicator {
	if o == nil || IsNil(o.Indicator) {
		var ret GetTimeSeriesAroon200ResponseMetaIndicator
		return ret
	}
	return *o.Indicator
}
...
// SetIndicator gets a reference to the given GetTimeSeriesAroon200ResponseMetaIndicator and assigns it to the Indicator field.
func (o *GetTimeSeriesAroon200ResponseMeta) SetIndicator(v GetTimeSeriesAroon200ResponseMetaIndicator) {
	o.Indicator = &v
}

func (o GetTimeSeriesAroon200ResponseMeta) MarshalJSON() ([]byte, error) {
...
func (o GetTimeSeriesAroon200ResponseMeta) ToMap() (map[string]interface{}, error) {
...
type NullableGetTimeSeriesAroon200ResponseMeta struct {
	value *GetTimeSeriesAroon200ResponseMeta
	isSet bool
}

func (v NullableGetTimeSeriesAroon200ResponseMeta) Get() *GetTimeSeriesAroon200ResponseMeta {
	return v.value
}

func (v *NullableGetTimeSeriesAroon200ResponseMeta) Set(val *GetTimeSeriesAroon200ResponseMeta) {
	v.value = val
	v.isSet = true
}

func (v NullableGetTimeSeriesAroon200ResponseMeta) IsSet() bool {
	return v.isSet
}

func (v *NullableGetTimeSeriesAroon200ResponseMeta) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetTimeSeriesAroon200ResponseMeta(val *GetTimeSeriesAroon200ResponseMeta) *NullableGetTimeSeriesAroon200ResponseMeta {
	return &NullableGetTimeSeriesAroon200ResponseMeta{value: val, isSet: true}
}

func (v NullableGetTimeSeriesAroon200ResponseMeta) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetTimeSeriesAroon200ResponseMeta) UnmarshalJSON(src []byte) error {
	v.isSet = true
