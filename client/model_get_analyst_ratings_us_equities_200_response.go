...
type GetAnalystRatingsUsEquities200Response struct {
	Meta *GetAnalystRatingsLight200ResponseMeta `json:"meta,omitempty"`
...
func NewGetAnalystRatingsUsEquities200Response() *GetAnalystRatingsUsEquities200Response {
...
func (o *GetAnalystRatingsUsEquities200Response) HasMeta() bool {
	if o != nil && !IsNil(o.Meta) {
		return true
	}
...
// SetMeta gets a reference to the given GetAnalystRatingsLight200ResponseMeta and assigns it to the Meta field.
...
func (o *GetAnalystRatingsUsEquities200Response) HasStatus() bool {
	if o != nil && !IsNil(o.Status) {
		return true
	}
