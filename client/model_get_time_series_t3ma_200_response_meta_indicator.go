...
type GetTimeSeriesT3ma200ResponseMetaIndicator struct {
	...
	VFactor *float64 `json:"v_factor,omitempty"`
}
...
func NewGetTimeSeriesT3ma200ResponseMetaIndicator() *GetTimeSeriesT3ma200ResponseMetaIndicator {
...
func (o *GetTimeSeriesT3ma200ResponseMetaIndicator) HasName() bool {
	if o != nil && !IsNil(o.Name) {
		return true
	}
...
func (o *GetTimeSeriesT3ma200ResponseMetaIndicator) HasSeriesType() bool {
	if o != nil && !IsNil(o.SeriesType) {
		return true
	}
...
func (o *GetTimeSeriesT3ma200ResponseMetaIndicator) HasTimePeriod() bool {
	if o != nil && !IsNil(o.TimePeriod) {
		return true
	}
...
// GetVFactor returns the VFactor field value if set, zero value otherwise.
func (o *GetTimeSeriesT3ma200ResponseMetaIndicator) GetVFactor() float64 {
	if o == nil || IsNil(o.VFactor) {
		var ret float64
		return ret
	}
	return *o.VFactor
...
// GetVFactorOk returns a tuple with the VFactor field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// HasVFactor returns a boolean if a field has been set.
func (o *GetTimeSeriesT3ma200ResponseMetaIndicator) HasVFactor() bool {
	if o != nil && !IsNil(o.VFactor) {
		return true
	}
...
// SetVFactor gets a reference to the given float64 and assigns it to the VFactor field.
