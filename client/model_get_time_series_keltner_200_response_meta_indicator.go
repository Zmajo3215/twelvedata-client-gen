...
type GetTimeSeriesKeltner200ResponseMetaIndicator struct {
	...
	AtrTimePeriod *int64 `json:"atr_time_period,omitempty"`
...
// GetAtrTimePeriod returns the AtrTimePeriod field value if set, zero value otherwise.
func (o *GetTimeSeriesKeltner200ResponseMetaIndicator) GetAtrTimePeriod() int64 {
	if o == nil || IsNil(o.AtrTimePeriod) {
		var ret int64
		return ret
	}
...
// GetAtrTimePeriodOk returns a tuple with the AtrTimePeriod field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// SetAtrTimePeriod gets a reference to the given int64 and assigns it to the AtrTimePeriod field.
