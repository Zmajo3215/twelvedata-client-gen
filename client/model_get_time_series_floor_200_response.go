...
type GetTimeSeriesFloor200Response struct {
	Meta *GetTimeSeriesFloor200ResponseMeta `json:"meta,omitempty"`
	// Array of time series data points
	Values []GetTimeSeriesFloor200ResponseValuesInner `json:"values,omitempty"`
	// Response status
...
func NewGetTimeSeriesFloor200Response() *GetTimeSeriesFloor200Response {
...
func (o *GetTimeSeriesFloor200Response) HasMeta() bool {
	if o != nil && !IsNil(o.Meta) {
		return true
	}
...
// SetMeta gets a reference to the given GetTimeSeriesFloor200ResponseMeta and assigns it to the Meta field.
...
func (o *GetTimeSeriesFloor200Response) HasValues() bool {
	if o != nil && !IsNil(o.Values) {
		return true
	}
...
// SetValues gets a reference to the given []GetTimeSeriesFloor200ResponseValuesInner and assigns it to the Values field.
...
func (o *GetTimeSeriesFloor200Response) HasStatus() bool {
	if o != nil && !IsNil(o.Status) {
		return true
	}
