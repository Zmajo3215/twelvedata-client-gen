...
type GetTimeSeriesIchimoku200Response struct {
	Meta *GetTimeSeriesIchimoku200ResponseMeta `json:"meta,omitempty"`
	// Array of time series data points
	Values []GetTimeSeriesIchimoku200ResponseValuesInner `json:"values,omitempty"`
	// Response status
...
func NewGetTimeSeriesIchimoku200Response() *GetTimeSeriesIchimoku200Response {
...
func (o *GetTimeSeriesIchimoku200Response) HasMeta() bool {
	if o != nil && !IsNil(o.Meta) {
		return true
	}
...
// SetMeta gets a reference to the given GetTimeSeriesIchimoku200ResponseMeta and assigns it to the Meta field.
...
func (o *GetTimeSeriesIchimoku200Response) HasValues() bool {
	if o != nil && !IsNil(o.Values) {
		return true
	}
...
// SetValues gets a reference to the given []GetTimeSeriesIchimoku200ResponseValuesInner and assigns it to the Values field.
...
func (o *GetTimeSeriesIchimoku200Response) HasStatus() bool {
	if o != nil && !IsNil(o.Status) {
		return true
	}
