...
type GetTimeSeriesHtSine200Response struct {
	Meta *GetTimeSeriesHtSine200ResponseMeta `json:"meta,omitempty"`
	// Array of time series data points
	Values []GetTimeSeriesHtSine200ResponseValuesInner `json:"values,omitempty"`
	// Response status
...
func NewGetTimeSeriesHtSine200Response() *GetTimeSeriesHtSine200Response {
...
func (o *GetTimeSeriesHtSine200Response) HasMeta() bool {
	if o != nil && !IsNil(o.Meta) {
		return true
	}
...
// SetMeta gets a reference to the given GetTimeSeriesHtSine200ResponseMeta and assigns it to the Meta field.
...
func (o *GetTimeSeriesHtSine200Response) HasValues() bool {
	if o != nil && !IsNil(o.Values) {
		return true
	}
...
// SetValues gets a reference to the given []GetTimeSeriesHtSine200ResponseValuesInner and assigns it to the Values field.
...
func (o *GetTimeSeriesHtSine200Response) HasStatus() bool {
	if o != nil && !IsNil(o.Status) {
		return true
	}
