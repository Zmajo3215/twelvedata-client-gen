...
type GetTimeSeriesMinMaxIndex200Response struct {
	Meta *GetTimeSeriesMinMaxIndex200ResponseMeta `json:"meta,omitempty"`
	// Array of time series data points
	Values []GetTimeSeriesMinMaxIndex200ResponseValuesInner `json:"values,omitempty"`
	// Response status
...
// SetMeta gets a reference to the given GetTimeSeriesMinMaxIndex200ResponseMeta and assigns it to the Meta field.
...
// SetValues gets a reference to the given []GetTimeSeriesMinMaxIndex200ResponseValuesInner and assigns it to the Values field.
