...
type GetTimeSeriesSuperTrend200Response struct {
	Meta *GetTimeSeriesSuperTrend200ResponseMeta `json:"meta,omitempty"`
	// Array of time series data points
	Values []GetTimeSeriesSuperTrend200ResponseValuesInner `json:"values,omitempty"`
	// Response status
...
// SetMeta gets a reference to the given GetTimeSeriesSuperTrend200ResponseMeta and assigns it to the Meta field.
...
// SetValues gets a reference to the given []GetTimeSeriesSuperTrend200ResponseValuesInner and assigns it to the Values field.
