...
type GetTimeSeriesApo200Response struct {
	Meta *GetTimeSeriesApo200ResponseMeta `json:"meta,omitempty"`
	// Array of time series data points
	Values []GetTimeSeriesApo200ResponseValuesInner `json:"values,omitempty"`
	// Response status
...
func NewGetTimeSeriesApo200Response() *GetTimeSeriesApo200Response {
...
func (o *GetTimeSeriesApo200Response) HasMeta() bool {
	if o != nil && !IsNil(o.Meta) {
		return true
	}
...
// SetMeta gets a reference to the given GetTimeSeriesApo200ResponseMeta and assigns it to the Meta field.
...
func (o *GetTimeSeriesApo200Response) HasValues() bool {
	if o != nil && !IsNil(o.Values) {
		return true
	}
...
// SetValues gets a reference to the given []GetTimeSeriesApo200ResponseValuesInner and assigns it to the Values field.
...
func (o *GetTimeSeriesApo200Response) HasStatus() bool {
	if o != nil && !IsNil(o.Status) {
		return true
	}
