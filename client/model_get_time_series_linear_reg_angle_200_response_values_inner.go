...
type GetTimeSeriesLinearRegAngle200ResponseValuesInner struct {
	...
	Linearregangle *string `json:"linearregangle,omitempty"`
}
...
func NewGetTimeSeriesLinearRegAngle200ResponseValuesInner() *GetTimeSeriesLinearRegAngle200ResponseValuesInner {
...
func (o *GetTimeSeriesLinearRegAngle200ResponseValuesInner) HasDatetime() bool {
	if o != nil && !IsNil(o.Datetime) {
		return true
	}
...
// GetLinearregangle returns the Linearregangle field value if set, zero value otherwise.
func (o *GetTimeSeriesLinearRegAngle200ResponseValuesInner) GetLinearregangle() string {
	if o == nil || IsNil(o.Linearregangle) {
		var ret string
		return ret
	}
...
// GetLinearregangleOk returns a tuple with the Linearregangle field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// HasLinearregangle returns a boolean if a field has been set.
func (o *GetTimeSeriesLinearRegAngle200ResponseValuesInner) HasLinearregangle() bool {
	if o != nil && !IsNil(o.Linearregangle) {
		return true
	}
...
// SetLinearregangle gets a reference to the given string and assigns it to the Linearregangle field.
