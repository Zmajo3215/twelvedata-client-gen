...
// checks if the GetTimeSeriesHtTrendline200ResponseMeta type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetTimeSeriesHtTrendline200ResponseMeta{}

// GetTimeSeriesHtTrendline200ResponseMeta Json object with request general information
type GetTimeSeriesHtTrendline200ResponseMeta struct {
	...
	Indicator *GetTimeSeriesHtTrendline200ResponseMetaIndicator `json:"indicator,omitempty"`
}
...
func NewGetTimeSeriesHtTrendline200ResponseMeta() *GetTimeSeriesHtTrendline200ResponseMeta {
	this := GetTimeSeriesHtTrendline200ResponseMeta{}
	return &this
}
...
func (o *GetTimeSeriesHtTrendline200ResponseMeta) GetIndicator() GetTimeSeriesHtTrendline200ResponseMetaIndicator {
	if o == nil || IsNil(o.Indicator) {
		var ret GetTimeSeriesHtTrendline200ResponseMetaIndicator
		return ret
	}
	return *o.Indicator
}
...
// SetIndicator gets a reference to the given GetTimeSeriesHtTrendline200ResponseMetaIndicator and assigns it to the Indicator field.
func (o *GetTimeSeriesHtTrendline200ResponseMeta) SetIndicator(v GetTimeSeriesHtTrendline200ResponseMetaIndicator) {
	o.Indicator = &v
}

func (o GetTimeSeriesHtTrendline200ResponseMeta) MarshalJSON() ([]byte, error) {
...
func (o GetTimeSeriesHtTrendline200ResponseMeta) ToMap() (map[string]interface{}, error) {
...
type NullableGetTimeSeriesHtTrendline200ResponseMeta struct {
	value *GetTimeSeriesHtTrendline200ResponseMeta
	isSet bool
}

func (v NullableGetTimeSeriesHtTrendline200ResponseMeta) Get() *GetTimeSeriesHtTrendline200ResponseMeta {
	return v.value
}

func (v *NullableGetTimeSeriesHtTrendline200ResponseMeta) Set(val *GetTimeSeriesHtTrendline200ResponseMeta) {
	v.value = val
	v.isSet = true
}

func (v NullableGetTimeSeriesHtTrendline200ResponseMeta) IsSet() bool {
	return v.isSet
}

func (v *NullableGetTimeSeriesHtTrendline200ResponseMeta) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetTimeSeriesHtTrendline200ResponseMeta(val *GetTimeSeriesHtTrendline200ResponseMeta) *NullableGetTimeSeriesHtTrendline200ResponseMeta {
	return &NullableGetTimeSeriesHtTrendline200ResponseMeta{value: val, isSet: true}
}

func (v NullableGetTimeSeriesHtTrendline200ResponseMeta) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetTimeSeriesHtTrendline200ResponseMeta) UnmarshalJSON(src []byte) error {
	v.isSet = true
