...
type GetTimeSeriesDiv200Response struct {
	Meta *GetTimeSeriesDiv200ResponseMeta `json:"meta,omitempty"`
	// Array of time series data points
	Values []GetTimeSeriesDiv200ResponseValuesInner `json:"values,omitempty"`
	// Response status
...
// SetMeta gets a reference to the given GetTimeSeriesDiv200ResponseMeta and assigns it to the Meta field.
...
// SetValues gets a reference to the given []GetTimeSeriesDiv200ResponseValuesInner and assigns it to the Values field.
