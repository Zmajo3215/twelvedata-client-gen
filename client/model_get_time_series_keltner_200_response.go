...
type GetTimeSeriesKeltner200Response struct {
	Meta *GetTimeSeriesKeltner200ResponseMeta `json:"meta,omitempty"`
	// Array of time series data points
	Values []GetTimeSeriesKeltner200ResponseValuesInner `json:"values,omitempty"`
	// Response status
...
// SetMeta gets a reference to the given GetTimeSeriesKeltner200ResponseMeta and assigns it to the Meta field.
...
// SetValues gets a reference to the given []GetTimeSeriesKeltner200ResponseValuesInner and assigns it to the Values field.
