...
// checks if the GetTimeSeriesMidPoint200ResponseMeta type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetTimeSeriesMidPoint200ResponseMeta{}

// GetTimeSeriesMidPoint200ResponseMeta Json object with request general information
type GetTimeSeriesMidPoint200ResponseMeta struct {
	...
	Indicator *GetTimeSeriesMidPoint200ResponseMetaIndicator `json:"indicator,omitempty"`
}
...
func NewGetTimeSeriesMidPoint200ResponseMeta() *GetTimeSeriesMidPoint200ResponseMeta {
	this := GetTimeSeriesMidPoint200ResponseMeta{}
	return &this
}
...
func (o *GetTimeSeriesMidPoint200ResponseMeta) HasSymbol() bool {
	if o != nil && !IsNil(o.Symbol) {
		return true
	}
...
func (o *GetTimeSeriesMidPoint200ResponseMeta) HasInterval() bool {
	if o != nil && !IsNil(o.Interval) {
		return true
	}
...
func (o *GetTimeSeriesMidPoint200ResponseMeta) HasCurrency() bool {
	if o != nil && !IsNil(o.Currency) {
		return true
	}
...
func (o *GetTimeSeriesMidPoint200ResponseMeta) HasExchangeTimezone() bool {
	if o != nil && !IsNil(o.ExchangeTimezone) {
		return true
	}
...
func (o *GetTimeSeriesMidPoint200ResponseMeta) HasExchange() bool {
	if o != nil && !IsNil(o.Exchange) {
		return true
	}
...
func (o *GetTimeSeriesMidPoint200ResponseMeta) HasMicCode() bool {
	if o != nil && !IsNil(o.MicCode) {
		return true
	}
...
func (o *GetTimeSeriesMidPoint200ResponseMeta) HasType() bool {
	if o != nil && !IsNil(o.Type) {
		return true
	}
...
func (o *GetTimeSeriesMidPoint200ResponseMeta) GetIndicator() GetTimeSeriesMidPoint200ResponseMetaIndicator {
	if o == nil || IsNil(o.Indicator) {
		var ret GetTimeSeriesMidPoint200ResponseMetaIndicator
		return ret
	}
	return *o.Indicator
}
...
func (o *GetTimeSeriesMidPoint200ResponseMeta) HasIndicator() bool {
	if o != nil && !IsNil(o.Indicator) {
		return true
	}
...
// SetIndicator gets a reference to the given GetTimeSeriesMidPoint200ResponseMetaIndicator and assigns it to the Indicator field.
func (o *GetTimeSeriesMidPoint200ResponseMeta) SetIndicator(v GetTimeSeriesMidPoint200ResponseMetaIndicator) {
	o.Indicator = &v
}

func (o GetTimeSeriesMidPoint200ResponseMeta) MarshalJSON() ([]byte, error) {
...
func (o GetTimeSeriesMidPoint200ResponseMeta) ToMap() (map[string]interface{}, error) {
...
type NullableGetTimeSeriesMidPoint200ResponseMeta struct {
	value *GetTimeSeriesMidPoint200ResponseMeta
	isSet bool
}

func (v NullableGetTimeSeriesMidPoint200ResponseMeta) Get() *GetTimeSeriesMidPoint200ResponseMeta {
	return v.value
}

func (v *NullableGetTimeSeriesMidPoint200ResponseMeta) Set(val *GetTimeSeriesMidPoint200ResponseMeta) {
	v.value = val
	v.isSet = true
}

func (v NullableGetTimeSeriesMidPoint200ResponseMeta) IsSet() bool {
	return v.isSet
}

func (v *NullableGetTimeSeriesMidPoint200ResponseMeta) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetTimeSeriesMidPoint200ResponseMeta(val *GetTimeSeriesMidPoint200ResponseMeta) *NullableGetTimeSeriesMidPoint200ResponseMeta {
	return &NullableGetTimeSeriesMidPoint200ResponseMeta{value: val, isSet: true}
}

func (v NullableGetTimeSeriesMidPoint200ResponseMeta) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetTimeSeriesMidPoint200ResponseMeta) UnmarshalJSON(src []byte) error {
	v.isSet = true
