...
func NewGetTimeSeriesDpo200ResponseMetaIndicator() *GetTimeSeriesDpo200ResponseMetaIndicator {
...
func (o *GetTimeSeriesDpo200ResponseMetaIndicator) HasName() bool {
	if o != nil && !IsNil(o.Name) {
		return true
	}
...
func (o *GetTimeSeriesDpo200ResponseMetaIndicator) HasSeriesType() bool {
	if o != nil && !IsNil(o.SeriesType) {
		return true
	}
...
func (o *GetTimeSeriesDpo200ResponseMetaIndicator) HasTimePeriod() bool {
	if o != nil && !IsNil(o.TimePeriod) {
		return true
	}
...
// GetCentered returns the Centered field value if set, zero value otherwise.
func (o *GetTimeSeriesDpo200ResponseMetaIndicator) GetCentered() bool {
	if o == nil || IsNil(o.Centered) {
		var ret bool
		return ret
	}
	return *o.Centered
...
// GetCenteredOk returns a tuple with the Centered field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// HasCentered returns a boolean if a field has been set.
func (o *GetTimeSeriesDpo200ResponseMetaIndicator) HasCentered() bool {
	if o != nil && !IsNil(o.Centered) {
		return true
	}
...
// SetCentered gets a reference to the given bool and assigns it to the Centered field.
