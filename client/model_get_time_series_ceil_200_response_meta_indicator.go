...
func NewGetTimeSeriesCeil200ResponseMetaIndicator() *GetTimeSeriesCeil200ResponseMetaIndicator {
...
func (o *GetTimeSeriesCeil200ResponseMetaIndicator) HasName() bool {
	if o != nil && !IsNil(o.Name) {
		return true
	}
...
func (o *GetTimeSeriesCeil200ResponseMetaIndicator) HasSeriesType() bool {
	if o != nil && !IsNil(o.SeriesType) {
		return true
	}
