...
// checks if the GetTimeSeriesRvol200ResponseMeta type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetTimeSeriesRvol200ResponseMeta{}

// GetTimeSeriesRvol200ResponseMeta Json object with request general information
type GetTimeSeriesRvol200ResponseMeta struct {
	...
	Indicator *GetTimeSeriesRvol200ResponseMetaIndicator `json:"indicator,omitempty"`
}
...
func NewGetTimeSeriesRvol200ResponseMeta() *GetTimeSeriesRvol200ResponseMeta {
	this := GetTimeSeriesRvol200ResponseMeta{}
	return &this
}
...
func (o *GetTimeSeriesRvol200ResponseMeta) HasSymbol() bool {
	if o != nil && !IsNil(o.Symbol) {
		return true
	}
...
func (o *GetTimeSeriesRvol200ResponseMeta) HasInterval() bool {
	if o != nil && !IsNil(o.Interval) {
		return true
	}
...
func (o *GetTimeSeriesRvol200ResponseMeta) HasCurrency() bool {
	if o != nil && !IsNil(o.Currency) {
		return true
	}
...
func (o *GetTimeSeriesRvol200ResponseMeta) HasExchangeTimezone() bool {
	if o != nil && !IsNil(o.ExchangeTimezone) {
		return true
	}
...
func (o *GetTimeSeriesRvol200ResponseMeta) HasExchange() bool {
	if o != nil && !IsNil(o.Exchange) {
		return true
	}
...
func (o *GetTimeSeriesRvol200ResponseMeta) HasMicCode() bool {
	if o != nil && !IsNil(o.MicCode) {
		return true
	}
...
func (o *GetTimeSeriesRvol200ResponseMeta) HasType() bool {
	if o != nil && !IsNil(o.Type) {
		return true
	}
...
func (o *GetTimeSeriesRvol200ResponseMeta) GetIndicator() GetTimeSeriesRvol200ResponseMetaIndicator {
	if o == nil || IsNil(o.Indicator) {
		var ret GetTimeSeriesRvol200ResponseMetaIndicator
		return ret
	}
	return *o.Indicator
}
...
func (o *GetTimeSeriesRvol200ResponseMeta) HasIndicator() bool {
	if o != nil && !IsNil(o.Indicator) {
		return true
	}
...
// SetIndicator gets a reference to the given GetTimeSeriesRvol200ResponseMetaIndicator and assigns it to the Indicator field.
func (o *GetTimeSeriesRvol200ResponseMeta) SetIndicator(v GetTimeSeriesRvol200ResponseMetaIndicator) {
	o.Indicator = &v
}

func (o GetTimeSeriesRvol200ResponseMeta) MarshalJSON() ([]byte, error) {
...
func (o GetTimeSeriesRvol200ResponseMeta) ToMap() (map[string]interface{}, error) {
...
type NullableGetTimeSeriesRvol200ResponseMeta struct {
	value *GetTimeSeriesRvol200ResponseMeta
	isSet bool
}

func (v NullableGetTimeSeriesRvol200ResponseMeta) Get() *GetTimeSeriesRvol200ResponseMeta {
	return v.value
}

func (v *NullableGetTimeSeriesRvol200ResponseMeta) Set(val *GetTimeSeriesRvol200ResponseMeta) {
	v.value = val
	v.isSet = true
}

func (v NullableGetTimeSeriesRvol200ResponseMeta) IsSet() bool {
	return v.isSet
}

func (v *NullableGetTimeSeriesRvol200ResponseMeta) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetTimeSeriesRvol200ResponseMeta(val *GetTimeSeriesRvol200ResponseMeta) *NullableGetTimeSeriesRvol200ResponseMeta {
	return &NullableGetTimeSeriesRvol200ResponseMeta{value: val, isSet: true}
}

func (v NullableGetTimeSeriesRvol200ResponseMeta) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetTimeSeriesRvol200ResponseMeta) UnmarshalJSON(src []byte) error {
	v.isSet = true
