...
type GetTimeSeriesAdx200Response struct {
	Meta *GetTimeSeriesAdx200ResponseMeta `json:"meta,omitempty"`
	// Array of time series data points
	Values []GetTimeSeriesAdx200ResponseValuesInner `json:"values,omitempty"`
	// Response status
...
func NewGetTimeSeriesAdx200Response() *GetTimeSeriesAdx200Response {
...
func (o *GetTimeSeriesAdx200Response) HasMeta() bool {
	if o != nil && !IsNil(o.Meta) {
		return true
	}
...
// SetMeta gets a reference to the given GetTimeSeriesAdx200ResponseMeta and assigns it to the Meta field.
...
func (o *GetTimeSeriesAdx200Response) HasValues() bool {
	if o != nil && !IsNil(o.Values) {
		return true
	}
...
// SetValues gets a reference to the given []GetTimeSeriesAdx200ResponseValuesInner and assigns it to the Values field.
...
func (o *GetTimeSeriesAdx200Response) HasStatus() bool {
	if o != nil && !IsNil(o.Status) {
		return true
	}
