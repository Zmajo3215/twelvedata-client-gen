...
type GetLogo200Response struct {
	Meta *GetLogo200ResponseMeta `json:"meta,omitempty"`
...
func NewGetLogo200Response() *GetLogo200Response {
...
func (o *GetLogo200Response) HasMeta() bool {
	if o != nil && !IsNil(o.Meta) {
		return true
	}
...
// SetMeta gets a reference to the given GetLogo200ResponseMeta and assigns it to the Meta field.
