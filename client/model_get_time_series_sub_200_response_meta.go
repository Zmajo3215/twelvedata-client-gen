...
// checks if the GetTimeSeriesSub200ResponseMeta type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetTimeSeriesSub200ResponseMeta{}

// GetTimeSeriesSub200ResponseMeta Json object with request general information
type GetTimeSeriesSub200ResponseMeta struct {
	...
	Indicator *GetTimeSeriesSub200ResponseMetaIndicator `json:"indicator,omitempty"`
}
...
func NewGetTimeSeriesSub200ResponseMeta() *GetTimeSeriesSub200ResponseMeta {
	this := GetTimeSeriesSub200ResponseMeta{}
	return &this
}
...
func (o *GetTimeSeriesSub200ResponseMeta) GetIndicator() GetTimeSeriesSub200ResponseMetaIndicator {
	if o == nil || IsNil(o.Indicator) {
		var ret GetTimeSeriesSub200ResponseMetaIndicator
		return ret
	}
	return *o.Indicator
}
...
// SetIndicator gets a reference to the given GetTimeSeriesSub200ResponseMetaIndicator and assigns it to the Indicator field.
func (o *GetTimeSeriesSub200ResponseMeta) SetIndicator(v GetTimeSeriesSub200ResponseMetaIndicator) {
	o.Indicator = &v
}

func (o GetTimeSeriesSub200ResponseMeta) MarshalJSON() ([]byte, error) {
...
func (o GetTimeSeriesSub200ResponseMeta) ToMap() (map[string]interface{}, error) {
...
type NullableGetTimeSeriesSub200ResponseMeta struct {
	value *GetTimeSeriesSub200ResponseMeta
	isSet bool
}

func (v NullableGetTimeSeriesSub200ResponseMeta) Get() *GetTimeSeriesSub200ResponseMeta {
	return v.value
}

func (v *NullableGetTimeSeriesSub200ResponseMeta) Set(val *GetTimeSeriesSub200ResponseMeta) {
	v.value = val
	v.isSet = true
}

func (v NullableGetTimeSeriesSub200ResponseMeta) IsSet() bool {
	return v.isSet
}

func (v *NullableGetTimeSeriesSub200ResponseMeta) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetTimeSeriesSub200ResponseMeta(val *GetTimeSeriesSub200ResponseMeta) *NullableGetTimeSeriesSub200ResponseMeta {
	return &NullableGetTimeSeriesSub200ResponseMeta{value: val, isSet: true}
}

func (v NullableGetTimeSeriesSub200ResponseMeta) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetTimeSeriesSub200ResponseMeta) UnmarshalJSON(src []byte) error {
	v.isSet = true
