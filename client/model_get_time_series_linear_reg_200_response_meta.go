...
// checks if the GetTimeSeriesLinearReg200ResponseMeta type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetTimeSeriesLinearReg200ResponseMeta{}

// GetTimeSeriesLinearReg200ResponseMeta Json object with request general information
type GetTimeSeriesLinearReg200ResponseMeta struct {
	...
	Indicator *GetTimeSeriesLinearReg200ResponseMetaIndicator `json:"indicator,omitempty"`
}
...
func NewGetTimeSeriesLinearReg200ResponseMeta() *GetTimeSeriesLinearReg200ResponseMeta {
	this := GetTimeSeriesLinearReg200ResponseMeta{}
	return &this
}
...
func (o *GetTimeSeriesLinearReg200ResponseMeta) HasSymbol() bool {
	if o != nil && !IsNil(o.Symbol) {
		return true
	}
...
func (o *GetTimeSeriesLinearReg200ResponseMeta) HasInterval() bool {
	if o != nil && !IsNil(o.Interval) {
		return true
	}
...
func (o *GetTimeSeriesLinearReg200ResponseMeta) HasCurrency() bool {
	if o != nil && !IsNil(o.Currency) {
		return true
	}
...
func (o *GetTimeSeriesLinearReg200ResponseMeta) HasExchangeTimezone() bool {
	if o != nil && !IsNil(o.ExchangeTimezone) {
		return true
	}
...
func (o *GetTimeSeriesLinearReg200ResponseMeta) HasExchange() bool {
	if o != nil && !IsNil(o.Exchange) {
		return true
	}
...
func (o *GetTimeSeriesLinearReg200ResponseMeta) HasMicCode() bool {
	if o != nil && !IsNil(o.MicCode) {
		return true
	}
...
func (o *GetTimeSeriesLinearReg200ResponseMeta) HasType() bool {
	if o != nil && !IsNil(o.Type) {
		return true
	}
...
func (o *GetTimeSeriesLinearReg200ResponseMeta) GetIndicator() GetTimeSeriesLinearReg200ResponseMetaIndicator {
	if o == nil || IsNil(o.Indicator) {
		var ret GetTimeSeriesLinearReg200ResponseMetaIndicator
		return ret
	}
	return *o.Indicator
}
...
func (o *GetTimeSeriesLinearReg200ResponseMeta) HasIndicator() bool {
	if o != nil && !IsNil(o.Indicator) {
		return true
	}
...
// SetIndicator gets a reference to the given GetTimeSeriesLinearReg200ResponseMetaIndicator and assigns it to the Indicator field.
func (o *GetTimeSeriesLinearReg200ResponseMeta) SetIndicator(v GetTimeSeriesLinearReg200ResponseMetaIndicator) {
	o.Indicator = &v
}

func (o GetTimeSeriesLinearReg200ResponseMeta) MarshalJSON() ([]byte, error) {
...
func (o GetTimeSeriesLinearReg200ResponseMeta) ToMap() (map[string]interface{}, error) {
...
type NullableGetTimeSeriesLinearReg200ResponseMeta struct {
	value *GetTimeSeriesLinearReg200ResponseMeta
	isSet bool
}

func (v NullableGetTimeSeriesLinearReg200ResponseMeta) Get() *GetTimeSeriesLinearReg200ResponseMeta {
	return v.value
}

func (v *NullableGetTimeSeriesLinearReg200ResponseMeta) Set(val *GetTimeSeriesLinearReg200ResponseMeta) {
	v.value = val
	v.isSet = true
}

func (v NullableGetTimeSeriesLinearReg200ResponseMeta) IsSet() bool {
	return v.isSet
}

func (v *NullableGetTimeSeriesLinearReg200ResponseMeta) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetTimeSeriesLinearReg200ResponseMeta(val *GetTimeSeriesLinearReg200ResponseMeta) *NullableGetTimeSeriesLinearReg200ResponseMeta {
	return &NullableGetTimeSeriesLinearReg200ResponseMeta{value: val, isSet: true}
}

func (v NullableGetTimeSeriesLinearReg200ResponseMeta) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetTimeSeriesLinearReg200ResponseMeta) UnmarshalJSON(src []byte) error {
	v.isSet = true
