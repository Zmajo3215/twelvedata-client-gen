...
type GetTimeSeriesTema200Response struct {
	Meta *GetTimeSeriesTema200ResponseMeta `json:"meta,omitempty"`
	// Array of time series data points
	Values []GetTimeSeriesTema200ResponseValuesInner `json:"values,omitempty"`
	// Response status
...
func NewGetTimeSeriesTema200Response() *GetTimeSeriesTema200Response {
...
func (o *GetTimeSeriesTema200Response) HasMeta() bool {
	if o != nil && !IsNil(o.Meta) {
		return true
	}
...
// SetMeta gets a reference to the given GetTimeSeriesTema200ResponseMeta and assigns it to the Meta field.
...
func (o *GetTimeSeriesTema200Response) HasValues() bool {
	if o != nil && !IsNil(o.Values) {
		return true
	}
...
// SetValues gets a reference to the given []GetTimeSeriesTema200ResponseValuesInner and assigns it to the Values field.
...
func (o *GetTimeSeriesTema200Response) HasStatus() bool {
	if o != nil && !IsNil(o.Status) {
		return true
	}
