...
type GetBalanceSheetConsolidated200Response struct {
	// Balance sheet data
	BalanceSheet []BalanceSheetConsolidatedItem `json:"balance_sheet,omitempty"`
	// Response status
...
func NewGetBalanceSheetConsolidated200Response() *GetBalanceSheetConsolidated200Response {
...
func (o *GetBalanceSheetConsolidated200Response) HasBalanceSheet() bool {
	if o != nil && !IsNil(o.BalanceSheet) {
		return true
	}
...
// SetBalanceSheet gets a reference to the given []BalanceSheetConsolidatedItem and assigns it to the BalanceSheet field.
