...
type GetTimeSeriesSma200Response struct {
	Meta *GetTimeSeriesSma200ResponseMeta `json:"meta,omitempty"`
	// Array of time series data points
	Values []GetTimeSeriesSma200ResponseValuesInner `json:"values,omitempty"`
	// Response status
...
func NewGetTimeSeriesSma200Response() *GetTimeSeriesSma200Response {
...
func (o *GetTimeSeriesSma200Response) HasMeta() bool {
	if o != nil && !IsNil(o.Meta) {
		return true
	}
...
// SetMeta gets a reference to the given GetTimeSeriesSma200ResponseMeta and assigns it to the Meta field.
...
func (o *GetTimeSeriesSma200Response) HasValues() bool {
	if o != nil && !IsNil(o.Values) {
		return true
	}
...
// SetValues gets a reference to the given []GetTimeSeriesSma200ResponseValuesInner and assigns it to the Values field.
...
func (o *GetTimeSeriesSma200Response) HasStatus() bool {
	if o != nil && !IsNil(o.Status) {
		return true
	}
