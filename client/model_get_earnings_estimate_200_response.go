...
type GetEarningsEstimate200Response struct {
	Meta *GetEarningsEstimate200ResponseMeta `json:"meta,omitempty"`
	// List of earnings estimates
	EarningsEstimate []GetEarningsEstimate200ResponseEarningsEstimateInner `json:"earnings_estimate,omitempty"`
	// Response status
...
func NewGetEarningsEstimate200Response() *GetEarningsEstimate200Response {
...
func (o *GetEarningsEstimate200Response) HasMeta() bool {
	if o != nil && !IsNil(o.Meta) {
		return true
	}
...
// SetMeta gets a reference to the given GetEarningsEstimate200ResponseMeta and assigns it to the Meta field.
func (o *GetEarningsEstimate200Response) SetMeta(v GetEarningsEstimate200ResponseMeta) {
	o.Meta = &v
}

// GetEarningsEstimate returns the EarningsEstimate field value if set, zero value otherwise.
func (o *GetEarningsEstimate200Response) GetEarningsEstimate() []GetEarningsEstimate200ResponseEarningsEstimateInner {
	if o == nil || IsNil(o.EarningsEstimate) {
...
// GetEarningsEstimateOk returns a tuple with the EarningsEstimate field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// HasEarningsEstimate returns a boolean if a field has been set.
func (o *GetEarningsEstimate200Response) HasEarningsEstimate() bool {
	if o != nil && !IsNil(o.EarningsEstimate) {
		return true
	}
...
// SetEarningsEstimate gets a reference to the given []GetEarningsEstimate200ResponseEarningsEstimateInner and assigns it to the EarningsEstimate field.
...
func (o *GetEarningsEstimate200Response) HasStatus() bool {
	if o != nil && !IsNil(o.Status) {
		return true
	}
