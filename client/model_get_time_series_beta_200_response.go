...
type GetTimeSeriesBeta200Response struct {
	Meta *GetTimeSeriesBeta200ResponseMeta `json:"meta,omitempty"`
	// Array of time series data points
	Values []GetTimeSeriesBeta200ResponseValuesInner `json:"values,omitempty"`
	// Response status
...
// SetMeta gets a reference to the given GetTimeSeriesBeta200ResponseMeta and assigns it to the Meta field.
...
// SetValues gets a reference to the given []GetTimeSeriesBeta200ResponseValuesInner and assigns it to the Values field.
