...
type GetTimeSeriesPlusDM200ResponseValuesInner struct {
	...
	// plus_dm value
	PlusDm *string `json:"plus_dm,omitempty"`
}
...
func NewGetTimeSeriesPlusDM200ResponseValuesInner() *GetTimeSeriesPlusDM200ResponseValuesInner {
...
func (o *GetTimeSeriesPlusDM200ResponseValuesInner) HasDatetime() bool {
	if o != nil && !IsNil(o.Datetime) {
		return true
	}
...
// GetPlusDm returns the PlusDm field value if set, zero value otherwise.
func (o *GetTimeSeriesPlusDM200ResponseValuesInner) GetPlusDm() string {
	if o == nil || IsNil(o.PlusDm) {
		var ret string
		return ret
	}
	return *o.PlusDm
...
// GetPlusDmOk returns a tuple with the PlusDm field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// HasPlusDm returns a boolean if a field has been set.
func (o *GetTimeSeriesPlusDM200ResponseValuesInner) HasPlusDm() bool {
	if o != nil && !IsNil(o.PlusDm) {
		return true
	}
...
// SetPlusDm gets a reference to the given string and assigns it to the PlusDm field.
