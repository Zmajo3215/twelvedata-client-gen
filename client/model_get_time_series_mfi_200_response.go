...
type GetTimeSeriesMfi200Response struct {
	Meta *GetTimeSeriesMfi200ResponseMeta `json:"meta,omitempty"`
	// Array of time series data points
	Values []GetTimeSeriesMfi200ResponseValuesInner `json:"values,omitempty"`
	// Response status
...
func NewGetTimeSeriesMfi200Response() *GetTimeSeriesMfi200Response {
...
func (o *GetTimeSeriesMfi200Response) HasMeta() bool {
	if o != nil && !IsNil(o.Meta) {
		return true
	}
...
// SetMeta gets a reference to the given GetTimeSeriesMfi200ResponseMeta and assigns it to the Meta field.
...
func (o *GetTimeSeriesMfi200Response) HasValues() bool {
	if o != nil && !IsNil(o.Values) {
		return true
	}
...
// SetValues gets a reference to the given []GetTimeSeriesMfi200ResponseValuesInner and assigns it to the Values field.
...
func (o *GetTimeSeriesMfi200Response) HasStatus() bool {
	if o != nil && !IsNil(o.Status) {
		return true
	}
