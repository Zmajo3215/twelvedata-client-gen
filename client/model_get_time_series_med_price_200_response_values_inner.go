...
type GetTimeSeriesMedPrice200ResponseValuesInner struct {
	...
	// Medprice value
	Medprice *string `json:"medprice,omitempty"`
}
...
func NewGetTimeSeriesMedPrice200ResponseValuesInner() *GetTimeSeriesMedPrice200ResponseValuesInner {
...
func (o *GetTimeSeriesMedPrice200ResponseValuesInner) HasDatetime() bool {
	if o != nil && !IsNil(o.Datetime) {
		return true
	}
...
// GetMedprice returns the Medprice field value if set, zero value otherwise.
func (o *GetTimeSeriesMedPrice200ResponseValuesInner) GetMedprice() string {
	if o == nil || IsNil(o.Medprice) {
		var ret string
		return ret
	}
	return *o.Medprice
...
// GetMedpriceOk returns a tuple with the Medprice field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// HasMedprice returns a boolean if a field has been set.
func (o *GetTimeSeriesMedPrice200ResponseValuesInner) HasMedprice() bool {
	if o != nil && !IsNil(o.Medprice) {
		return true
	}
...
// SetMedprice gets a reference to the given string and assigns it to the Medprice field.
