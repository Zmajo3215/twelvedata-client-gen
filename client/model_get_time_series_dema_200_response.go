...
type GetTimeSeriesDema200Response struct {
	Meta *GetTimeSeriesDema200ResponseMeta `json:"meta,omitempty"`
	// Array of time series data points
	Values []GetTimeSeriesDema200ResponseValuesInner `json:"values,omitempty"`
	// Response status
...
func NewGetTimeSeriesDema200Response() *GetTimeSeriesDema200Response {
...
func (o *GetTimeSeriesDema200Response) HasMeta() bool {
	if o != nil && !IsNil(o.Meta) {
		return true
	}
...
// SetMeta gets a reference to the given GetTimeSeriesDema200ResponseMeta and assigns it to the Meta field.
...
func (o *GetTimeSeriesDema200Response) HasValues() bool {
	if o != nil && !IsNil(o.Values) {
		return true
	}
...
// SetValues gets a reference to the given []GetTimeSeriesDema200ResponseValuesInner and assigns it to the Values field.
...
func (o *GetTimeSeriesDema200Response) HasStatus() bool {
	if o != nil && !IsNil(o.Status) {
		return true
	}
