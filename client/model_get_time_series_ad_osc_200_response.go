...
type GetTimeSeriesAdOsc200Response struct {
	Meta *GetTimeSeriesAdOsc200ResponseMeta `json:"meta,omitempty"`
	// Array of time series data points
	Values []GetTimeSeriesAdOsc200ResponseValuesInner `json:"values,omitempty"`
	// Response status
...
func NewGetTimeSeriesAdOsc200Response() *GetTimeSeriesAdOsc200Response {
...
func (o *GetTimeSeriesAdOsc200Response) HasMeta() bool {
	if o != nil && !IsNil(o.Meta) {
		return true
	}
...
// SetMeta gets a reference to the given GetTimeSeriesAdOsc200ResponseMeta and assigns it to the Meta field.
...
func (o *GetTimeSeriesAdOsc200Response) HasValues() bool {
	if o != nil && !IsNil(o.Values) {
		return true
	}
...
// SetValues gets a reference to the given []GetTimeSeriesAdOsc200ResponseValuesInner and assigns it to the Values field.
...
func (o *GetTimeSeriesAdOsc200Response) HasStatus() bool {
	if o != nil && !IsNil(o.Status) {
		return true
	}
