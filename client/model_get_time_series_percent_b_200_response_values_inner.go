...
type GetTimeSeriesPercentB200ResponseValuesInner struct {
	...
	// Percent_b value
	PercentB *string `json:"percent_b,omitempty"`
}
...
// GetPercentB returns the PercentB field value if set, zero value otherwise.
func (o *GetTimeSeriesPercentB200ResponseValuesInner) GetPercentB() string {
	if o == nil || IsNil(o.PercentB) {
		var ret string
		return ret
	}
	return *o.PercentB
...
// GetPercentBOk returns a tuple with the PercentB field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// SetPercentB gets a reference to the given string and assigns it to the PercentB field.
