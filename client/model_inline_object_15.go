...
type InlineObject15 struct {
	Meta *InlineObject15Meta `json:"meta,omitempty"`
	// Array of time series data points
	Values []InlineObject15ValuesInner `json:"values,omitempty"`
	// Response status
...
func (o *InlineObject15) HasMeta() bool {
	if o != nil && !IsNil(o.Meta) {
		return true
	}
...
// SetMeta gets a reference to the given InlineObject15Meta and assigns it to the Meta field.
...
func (o *InlineObject15) HasValues() bool {
	if o != nil && !IsNil(o.Values) {
		return true
	}
...
// SetValues gets a reference to the given []InlineObject15ValuesInner and assigns it to the Values field.
