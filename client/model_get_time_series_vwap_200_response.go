...
type GetTimeSeriesVwap200Response struct {
	Meta *GetTimeSeriesVwap200ResponseMeta `json:"meta,omitempty"`
	// Array of time series data points
	Values []GetTimeSeriesVwap200ResponseValuesInner `json:"values,omitempty"`
	// Response status
...
// SetMeta gets a reference to the given GetTimeSeriesVwap200ResponseMeta and assigns it to the Meta field.
...
// SetValues gets a reference to the given []GetTimeSeriesVwap200ResponseValuesInner and assigns it to the Values field.
