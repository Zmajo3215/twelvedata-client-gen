...
// checks if the GetTimeSeriesWillR200ResponseMeta type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetTimeSeriesWillR200ResponseMeta{}

// GetTimeSeriesWillR200ResponseMeta Json object with request general information
type GetTimeSeriesWillR200ResponseMeta struct {
	...
	Indicator *GetTimeSeriesWillR200ResponseMetaIndicator `json:"indicator,omitempty"`
}
...
func NewGetTimeSeriesWillR200ResponseMeta() *GetTimeSeriesWillR200ResponseMeta {
	this := GetTimeSeriesWillR200ResponseMeta{}
	return &this
}
...
func (o *GetTimeSeriesWillR200ResponseMeta) HasSymbol() bool {
	if o != nil && !IsNil(o.Symbol) {
		return true
	}
...
func (o *GetTimeSeriesWillR200ResponseMeta) HasInterval() bool {
	if o != nil && !IsNil(o.Interval) {
		return true
	}
...
func (o *GetTimeSeriesWillR200ResponseMeta) HasCurrency() bool {
	if o != nil && !IsNil(o.Currency) {
		return true
	}
...
func (o *GetTimeSeriesWillR200ResponseMeta) HasExchangeTimezone() bool {
	if o != nil && !IsNil(o.ExchangeTimezone) {
		return true
	}
...
func (o *GetTimeSeriesWillR200ResponseMeta) HasExchange() bool {
	if o != nil && !IsNil(o.Exchange) {
		return true
	}
...
func (o *GetTimeSeriesWillR200ResponseMeta) HasMicCode() bool {
	if o != nil && !IsNil(o.MicCode) {
		return true
	}
...
func (o *GetTimeSeriesWillR200ResponseMeta) HasType() bool {
	if o != nil && !IsNil(o.Type) {
		return true
	}
...
func (o *GetTimeSeriesWillR200ResponseMeta) GetIndicator() GetTimeSeriesWillR200ResponseMetaIndicator {
	if o == nil || IsNil(o.Indicator) {
		var ret GetTimeSeriesWillR200ResponseMetaIndicator
		return ret
	}
	return *o.Indicator
}
...
func (o *GetTimeSeriesWillR200ResponseMeta) HasIndicator() bool {
	if o != nil && !IsNil(o.Indicator) {
		return true
	}
...
// SetIndicator gets a reference to the given GetTimeSeriesWillR200ResponseMetaIndicator and assigns it to the Indicator field.
func (o *GetTimeSeriesWillR200ResponseMeta) SetIndicator(v GetTimeSeriesWillR200ResponseMetaIndicator) {
	o.Indicator = &v
}

func (o GetTimeSeriesWillR200ResponseMeta) MarshalJSON() ([]byte, error) {
...
func (o GetTimeSeriesWillR200ResponseMeta) ToMap() (map[string]interface{}, error) {
...
type NullableGetTimeSeriesWillR200ResponseMeta struct {
	value *GetTimeSeriesWillR200ResponseMeta
	isSet bool
}

func (v NullableGetTimeSeriesWillR200ResponseMeta) Get() *GetTimeSeriesWillR200ResponseMeta {
	return v.value
}

func (v *NullableGetTimeSeriesWillR200ResponseMeta) Set(val *GetTimeSeriesWillR200ResponseMeta) {
	v.value = val
	v.isSet = true
}

func (v NullableGetTimeSeriesWillR200ResponseMeta) IsSet() bool {
	return v.isSet
}

func (v *NullableGetTimeSeriesWillR200ResponseMeta) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetTimeSeriesWillR200ResponseMeta(val *GetTimeSeriesWillR200ResponseMeta) *NullableGetTimeSeriesWillR200ResponseMeta {
	return &NullableGetTimeSeriesWillR200ResponseMeta{value: val, isSet: true}
}

func (v NullableGetTimeSeriesWillR200ResponseMeta) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetTimeSeriesWillR200ResponseMeta) UnmarshalJSON(src []byte) error {
	v.isSet = true
