...
type GetTimeSeriesCmo200Response struct {
	Meta *GetTimeSeriesCmo200ResponseMeta `json:"meta,omitempty"`
	// Array of time series data points
	Values []GetTimeSeriesCmo200ResponseValuesInner `json:"values,omitempty"`
	// Response status
...
func NewGetTimeSeriesCmo200Response() *GetTimeSeriesCmo200Response {
...
func (o *GetTimeSeriesCmo200Response) HasMeta() bool {
	if o != nil && !IsNil(o.Meta) {
		return true
	}
...
// SetMeta gets a reference to the given GetTimeSeriesCmo200ResponseMeta and assigns it to the Meta field.
...
func (o *GetTimeSeriesCmo200Response) HasValues() bool {
	if o != nil && !IsNil(o.Values) {
		return true
	}
...
// SetValues gets a reference to the given []GetTimeSeriesCmo200ResponseValuesInner and assigns it to the Values field.
...
func (o *GetTimeSeriesCmo200Response) HasStatus() bool {
	if o != nil && !IsNil(o.Status) {
		return true
	}
