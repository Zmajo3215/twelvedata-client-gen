...
// checks if the GetTimeSeriesLog10200ResponseMeta type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetTimeSeriesLog10200ResponseMeta{}

// GetTimeSeriesLog10200ResponseMeta Json object with request general information
type GetTimeSeriesLog10200ResponseMeta struct {
	...
	Indicator *GetTimeSeriesLog10200ResponseMetaIndicator `json:"indicator,omitempty"`
}
...
func NewGetTimeSeriesLog10200ResponseMeta() *GetTimeSeriesLog10200ResponseMeta {
	this := GetTimeSeriesLog10200ResponseMeta{}
	return &this
}
...
func (o *GetTimeSeriesLog10200ResponseMeta) GetIndicator() GetTimeSeriesLog10200ResponseMetaIndicator {
	if o == nil || IsNil(o.Indicator) {
		var ret GetTimeSeriesLog10200ResponseMetaIndicator
		return ret
	}
	return *o.Indicator
}
...
// SetIndicator gets a reference to the given GetTimeSeriesLog10200ResponseMetaIndicator and assigns it to the Indicator field.
func (o *GetTimeSeriesLog10200ResponseMeta) SetIndicator(v GetTimeSeriesLog10200ResponseMetaIndicator) {
	o.Indicator = &v
}

func (o GetTimeSeriesLog10200ResponseMeta) MarshalJSON() ([]byte, error) {
...
func (o GetTimeSeriesLog10200ResponseMeta) ToMap() (map[string]interface{}, error) {
...
type NullableGetTimeSeriesLog10200ResponseMeta struct {
	value *GetTimeSeriesLog10200ResponseMeta
	isSet bool
}

func (v NullableGetTimeSeriesLog10200ResponseMeta) Get() *GetTimeSeriesLog10200ResponseMeta {
	return v.value
}

func (v *NullableGetTimeSeriesLog10200ResponseMeta) Set(val *GetTimeSeriesLog10200ResponseMeta) {
	v.value = val
	v.isSet = true
}

func (v NullableGetTimeSeriesLog10200ResponseMeta) IsSet() bool {
	return v.isSet
}

func (v *NullableGetTimeSeriesLog10200ResponseMeta) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetTimeSeriesLog10200ResponseMeta(val *GetTimeSeriesLog10200ResponseMeta) *NullableGetTimeSeriesLog10200ResponseMeta {
	return &NullableGetTimeSeriesLog10200ResponseMeta{value: val, isSet: true}
}

func (v NullableGetTimeSeriesLog10200ResponseMeta) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetTimeSeriesLog10200ResponseMeta) UnmarshalJSON(src []byte) error {
	v.isSet = true
