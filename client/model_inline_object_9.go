...
type InlineObject9 struct {
	Meta *InlineObject9Meta `json:"meta,omitempty"`
	// Array of time series data points
	Values []InlineObject9ValuesInner `json:"values,omitempty"`
	// Response status
...
// SetMeta gets a reference to the given InlineObject9Meta and assigns it to the Meta field.
...
// SetValues gets a reference to the given []InlineObject9ValuesInner and assigns it to the Values field.
