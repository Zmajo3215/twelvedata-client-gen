...
// GetMinusDi returns the MinusDi field value if set, zero value otherwise.
func (o *GetTimeSeriesMinusDI200ResponseValuesInner) GetMinusDi() string {
	if o == nil || IsNil(o.MinusDi) {
		var ret string
		return ret
	}
	return *o.MinusDi
...
// GetMinusDiOk returns a tuple with the MinusDi field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// SetMinusDi gets a reference to the given string and assigns it to the MinusDi field.
