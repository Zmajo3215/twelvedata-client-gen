...
type GetTimeSeriesNatr200ResponseValuesInner struct {
	...
	// natr value
	Natr *string `json:"natr,omitempty"`
}
...
func NewGetTimeSeriesNatr200ResponseValuesInner() *GetTimeSeriesNatr200ResponseValuesInner {
...
func (o *GetTimeSeriesNatr200ResponseValuesInner) HasDatetime() bool {
	if o != nil && !IsNil(o.Datetime) {
		return true
	}
...
// GetNatr returns the Natr field value if set, zero value otherwise.
func (o *GetTimeSeriesNatr200ResponseValuesInner) GetNatr() string {
	if o == nil || IsNil(o.Natr) {
		var ret string
		return ret
	}
	return *o.Natr
...
// GetNatrOk returns a tuple with the Natr field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// HasNatr returns a boolean if a field has been set.
func (o *GetTimeSeriesNatr200ResponseValuesInner) HasNatr() bool {
	if o != nil && !IsNil(o.Natr) {
		return true
	}
...
// SetNatr gets a reference to the given string and assigns it to the Natr field.
