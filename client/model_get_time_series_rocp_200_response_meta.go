...
// checks if the GetTimeSeriesRocp200ResponseMeta type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetTimeSeriesRocp200ResponseMeta{}

// GetTimeSeriesRocp200ResponseMeta Json object with request general information
type GetTimeSeriesRocp200ResponseMeta struct {
	...
	Indicator *GetTimeSeriesRocp200ResponseMetaIndicator `json:"indicator,omitempty"`
}
...
func NewGetTimeSeriesRocp200ResponseMeta() *GetTimeSeriesRocp200ResponseMeta {
	this := GetTimeSeriesRocp200ResponseMeta{}
	return &this
}
...
func (o *GetTimeSeriesRocp200ResponseMeta) HasSymbol() bool {
	if o != nil && !IsNil(o.Symbol) {
		return true
	}
...
func (o *GetTimeSeriesRocp200ResponseMeta) HasInterval() bool {
	if o != nil && !IsNil(o.Interval) {
		return true
	}
...
func (o *GetTimeSeriesRocp200ResponseMeta) HasCurrency() bool {
	if o != nil && !IsNil(o.Currency) {
		return true
	}
...
func (o *GetTimeSeriesRocp200ResponseMeta) HasExchangeTimezone() bool {
	if o != nil && !IsNil(o.ExchangeTimezone) {
		return true
	}
...
func (o *GetTimeSeriesRocp200ResponseMeta) HasExchange() bool {
	if o != nil && !IsNil(o.Exchange) {
		return true
	}
...
func (o *GetTimeSeriesRocp200ResponseMeta) HasMicCode() bool {
	if o != nil && !IsNil(o.MicCode) {
		return true
	}
...
func (o *GetTimeSeriesRocp200ResponseMeta) HasType() bool {
	if o != nil && !IsNil(o.Type) {
		return true
	}
...
func (o *GetTimeSeriesRocp200ResponseMeta) GetIndicator() GetTimeSeriesRocp200ResponseMetaIndicator {
	if o == nil || IsNil(o.Indicator) {
		var ret GetTimeSeriesRocp200ResponseMetaIndicator
		return ret
	}
	return *o.Indicator
}
...
func (o *GetTimeSeriesRocp200ResponseMeta) HasIndicator() bool {
	if o != nil && !IsNil(o.Indicator) {
		return true
	}
...
// SetIndicator gets a reference to the given GetTimeSeriesRocp200ResponseMetaIndicator and assigns it to the Indicator field.
func (o *GetTimeSeriesRocp200ResponseMeta) SetIndicator(v GetTimeSeriesRocp200ResponseMetaIndicator) {
	o.Indicator = &v
}

func (o GetTimeSeriesRocp200ResponseMeta) MarshalJSON() ([]byte, error) {
...
func (o GetTimeSeriesRocp200ResponseMeta) ToMap() (map[string]interface{}, error) {
...
type NullableGetTimeSeriesRocp200ResponseMeta struct {
	value *GetTimeSeriesRocp200ResponseMeta
	isSet bool
}

func (v NullableGetTimeSeriesRocp200ResponseMeta) Get() *GetTimeSeriesRocp200ResponseMeta {
	return v.value
}

func (v *NullableGetTimeSeriesRocp200ResponseMeta) Set(val *GetTimeSeriesRocp200ResponseMeta) {
	v.value = val
	v.isSet = true
}

func (v NullableGetTimeSeriesRocp200ResponseMeta) IsSet() bool {
	return v.isSet
}

func (v *NullableGetTimeSeriesRocp200ResponseMeta) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetTimeSeriesRocp200ResponseMeta(val *GetTimeSeriesRocp200ResponseMeta) *NullableGetTimeSeriesRocp200ResponseMeta {
	return &NullableGetTimeSeriesRocp200ResponseMeta{value: val, isSet: true}
}

func (v NullableGetTimeSeriesRocp200ResponseMeta) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetTimeSeriesRocp200ResponseMeta) UnmarshalJSON(src []byte) error {
	v.isSet = true
