...
// checks if the GetTimeSeriesSarExt200ResponseMeta type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetTimeSeriesSarExt200ResponseMeta{}

// GetTimeSeriesSarExt200ResponseMeta Json object with request general information
type GetTimeSeriesSarExt200ResponseMeta struct {
	...
	Indicator *GetTimeSeriesSarExt200ResponseMetaIndicator `json:"indicator,omitempty"`
}
...
func NewGetTimeSeriesSarExt200ResponseMeta() *GetTimeSeriesSarExt200ResponseMeta {
	this := GetTimeSeriesSarExt200ResponseMeta{}
	return &this
}
...
func (o *GetTimeSeriesSarExt200ResponseMeta) HasSymbol() bool {
	if o != nil && !IsNil(o.Symbol) {
		return true
	}
...
func (o *GetTimeSeriesSarExt200ResponseMeta) HasInterval() bool {
	if o != nil && !IsNil(o.Interval) {
		return true
	}
...
func (o *GetTimeSeriesSarExt200ResponseMeta) HasCurrency() bool {
	if o != nil && !IsNil(o.Currency) {
		return true
	}
...
func (o *GetTimeSeriesSarExt200ResponseMeta) HasExchangeTimezone() bool {
	if o != nil && !IsNil(o.ExchangeTimezone) {
		return true
	}
...
func (o *GetTimeSeriesSarExt200ResponseMeta) HasExchange() bool {
	if o != nil && !IsNil(o.Exchange) {
		return true
	}
...
func (o *GetTimeSeriesSarExt200ResponseMeta) HasMicCode() bool {
	if o != nil && !IsNil(o.MicCode) {
		return true
	}
...
func (o *GetTimeSeriesSarExt200ResponseMeta) HasType() bool {
	if o != nil && !IsNil(o.Type) {
		return true
	}
...
func (o *GetTimeSeriesSarExt200ResponseMeta) GetIndicator() GetTimeSeriesSarExt200ResponseMetaIndicator {
	if o == nil || IsNil(o.Indicator) {
		var ret GetTimeSeriesSarExt200ResponseMetaIndicator
		return ret
	}
	return *o.Indicator
}
...
func (o *GetTimeSeriesSarExt200ResponseMeta) HasIndicator() bool {
	if o != nil && !IsNil(o.Indicator) {
		return true
	}
...
// SetIndicator gets a reference to the given GetTimeSeriesSarExt200ResponseMetaIndicator and assigns it to the Indicator field.
func (o *GetTimeSeriesSarExt200ResponseMeta) SetIndicator(v GetTimeSeriesSarExt200ResponseMetaIndicator) {
	o.Indicator = &v
}

func (o GetTimeSeriesSarExt200ResponseMeta) MarshalJSON() ([]byte, error) {
...
func (o GetTimeSeriesSarExt200ResponseMeta) ToMap() (map[string]interface{}, error) {
...
type NullableGetTimeSeriesSarExt200ResponseMeta struct {
	value *GetTimeSeriesSarExt200ResponseMeta
	isSet bool
}

func (v NullableGetTimeSeriesSarExt200ResponseMeta) Get() *GetTimeSeriesSarExt200ResponseMeta {
	return v.value
}

func (v *NullableGetTimeSeriesSarExt200ResponseMeta) Set(val *GetTimeSeriesSarExt200ResponseMeta) {
	v.value = val
	v.isSet = true
}

func (v NullableGetTimeSeriesSarExt200ResponseMeta) IsSet() bool {
	return v.isSet
}

func (v *NullableGetTimeSeriesSarExt200ResponseMeta) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetTimeSeriesSarExt200ResponseMeta(val *GetTimeSeriesSarExt200ResponseMeta) *NullableGetTimeSeriesSarExt200ResponseMeta {
	return &NullableGetTimeSeriesSarExt200ResponseMeta{value: val, isSet: true}
}

func (v NullableGetTimeSeriesSarExt200ResponseMeta) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetTimeSeriesSarExt200ResponseMeta) UnmarshalJSON(src []byte) error {
	v.isSet = true
