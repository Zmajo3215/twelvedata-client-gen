...
// checks if the InlineObject15Meta type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &InlineObject15Meta{}

// InlineObject15Meta Json object with request general information
type InlineObject15Meta struct {
	...
	Indicator *InlineObject15MetaIndicator `json:"indicator,omitempty"`
}
...
func (o *InlineObject15Meta) GetIndicator() InlineObject15MetaIndicator {
	if o == nil || IsNil(o.Indicator) {
		var ret InlineObject15MetaIndicator
		return ret
	}
	return *o.Indicator
}
...
// SetIndicator gets a reference to the given InlineObject15MetaIndicator and assigns it to the Indicator field.
func (o *InlineObject15Meta) SetIndicator(v InlineObject15MetaIndicator) {
	o.Indicator = &v
}

func (o InlineObject15Meta) MarshalJSON() ([]byte, error) {
...
func (o InlineObject15Meta) ToMap() (map[string]interface{}, error) {
...
type NullableInlineObject15Meta struct {
	value *InlineObject15Meta
	isSet bool
}

func (v NullableInlineObject15Meta) Get() *InlineObject15Meta {
	return v.value
}

func (v *NullableInlineObject15Meta) Set(val *InlineObject15Meta) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject15Meta) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject15Meta) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject15Meta(val *InlineObject15Meta) *NullableInlineObject15Meta {
	return &NullableInlineObject15Meta{value: val, isSet: true}
}

func (v NullableInlineObject15Meta) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject15Meta) UnmarshalJSON(src []byte) error {
	v.isSet = true
