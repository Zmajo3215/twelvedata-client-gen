...
func NewGetTimeSeriesLn200ResponseMetaIndicator() *GetTimeSeriesLn200ResponseMetaIndicator {
...
func (o *GetTimeSeriesLn200ResponseMetaIndicator) HasName() bool {
	if o != nil && !IsNil(o.Name) {
		return true
	}
...
func (o *GetTimeSeriesLn200ResponseMetaIndicator) HasSeriesType() bool {
	if o != nil && !IsNil(o.SeriesType) {
		return true
	}
