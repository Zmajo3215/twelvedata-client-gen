...
type GetTimeSeriesRoc200Response struct {
	Meta *GetTimeSeriesRoc200ResponseMeta `json:"meta,omitempty"`
	// Array of time series data points
	Values []GetTimeSeriesRoc200ResponseValuesInner `json:"values,omitempty"`
	// Response status
...
func NewGetTimeSeriesRoc200Response() *GetTimeSeriesRoc200Response {
...
func (o *GetTimeSeriesRoc200Response) HasMeta() bool {
	if o != nil && !IsNil(o.Meta) {
		return true
	}
...
// SetMeta gets a reference to the given GetTimeSeriesRoc200ResponseMeta and assigns it to the Meta field.
...
func (o *GetTimeSeriesRoc200Response) HasValues() bool {
	if o != nil && !IsNil(o.Values) {
		return true
	}
...
// SetValues gets a reference to the given []GetTimeSeriesRoc200ResponseValuesInner and assigns it to the Values field.
...
func (o *GetTimeSeriesRoc200Response) HasStatus() bool {
	if o != nil && !IsNil(o.Status) {
		return true
	}
