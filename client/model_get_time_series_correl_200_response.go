...
type GetTimeSeriesCorrel200Response struct {
	Meta *GetTimeSeriesCorrel200ResponseMeta `json:"meta,omitempty"`
	// Array of time series data points
	Values []GetTimeSeriesCorrel200ResponseValuesInner `json:"values,omitempty"`
	// Response status
...
// SetMeta gets a reference to the given GetTimeSeriesCorrel200ResponseMeta and assigns it to the Meta field.
...
// SetValues gets a reference to the given []GetTimeSeriesCorrel200ResponseValuesInner and assigns it to the Values field.
