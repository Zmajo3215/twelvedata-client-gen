...
```go
import openapi "github.com/Zmajo3215/twelvedata-client-gen"
```
...
*AnalysisAPI* | [**GetEdgarFilingsArchive**](docs/AnalysisAPI.md#getedgarfilingsarchive) | **Get** /edgar_filings/archive | EDGAR fillings
...
*MarketDataAPI* | [**GetCurrencyConversion**](docs/MarketDataAPI.md#getcurrencyconversion) | **Get** /currency_conversion | Currency conversion
*MarketDataAPI* | [**GetEod**](docs/MarketDataAPI.md#geteod) | **Get** /eod | End of day price
*MarketDataAPI* | [**GetExchangeRate**](docs/MarketDataAPI.md#getexchangerate) | **Get** /exchange_rate | Exchange rate
...
*ReferenceDataAPI* | [**GetETFsFamily**](docs/ReferenceDataAPI.md#getetfsfamily) | **Get** /etfs/family | ETFs families
*ReferenceDataAPI* | [**GetETFsList**](docs/ReferenceDataAPI.md#getetfslist) | **Get** /etfs/list | ETFs directory
*ReferenceDataAPI* | [**GetETFsType**](docs/ReferenceDataAPI.md#getetfstype) | **Get** /etfs/type | ETFs types
...
*ReferenceDataAPI* | [**GetMutualFundsFamily**](docs/ReferenceDataAPI.md#getmutualfundsfamily) | **Get** /mutual_funds/family | MFs families
*ReferenceDataAPI* | [**GetMutualFundsList**](docs/ReferenceDataAPI.md#getmutualfundslist) | **Get** /mutual_funds/list | MFs directory
*ReferenceDataAPI* | [**GetMutualFundsType**](docs/ReferenceDataAPI.md#getmutualfundstype) | **Get** /mutual_funds/type | MFs types
...
*TimeSeriesAPI* | [**GetTimeSeries**](docs/TimeSeriesAPI.md#gettimeseries) | **Get** /time_series | Time series
*TimeSeriesAPI* | [**GetTimeSeriesCross**](docs/TimeSeriesAPI.md#gettimeseriescross) | **Get** /time_series/cross | Time series cross
...
Note, each API key must be added to a map of `map[string]APIKey` where the key is: authorizationHeader and passed in as the auth context for each request.
...
auth := context.WithValue(
		...
		map[string]openapi.APIKey{
			"authorizationHeader": {Key: "API_KEY_STRING"},
		},
	)
...
Note, each API key must be added to a map of `map[string]APIKey` where the key is: queryParameter and passed in as the auth context for each request.
...
auth := context.WithValue(
		...
		openapi.ContextAPIKeys,
		map[string]openapi.APIKey{
			"queryParameter": {Key: "API_KEY_STRING"},
		},
	)
r, err := client.Service.Operation(auth, args)
```
