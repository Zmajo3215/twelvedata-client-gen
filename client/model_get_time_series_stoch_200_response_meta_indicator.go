...
type GetTimeSeriesStoch200ResponseMetaIndicator struct {
	...
	FastKPeriod *int64 `json:"fast_k_period,omitempty"`
	// The time period for the slow %K line in the Stochastic Oscillator
	SlowKPeriod *int64 `json:"slow_k_period,omitempty"`
	// The time period for the slow %D line in the Stochastic Oscillator
	SlowDPeriod *int64 `json:"slow_d_period,omitempty"`
	// The type of slow %K Moving Average used
	SlowKmaType *string `json:"slow_kma_type,omitempty"`
	// The type of slow Displaced Moving Average used
	SlowDmaType *string `json:"slow_dma_type,omitempty"`
}
...
func NewGetTimeSeriesStoch200ResponseMetaIndicator() *GetTimeSeriesStoch200ResponseMetaIndicator {
...
func (o *GetTimeSeriesStoch200ResponseMetaIndicator) HasName() bool {
	if o != nil && !IsNil(o.Name) {
		return true
	}
...
// GetFastKPeriod returns the FastKPeriod field value if set, zero value otherwise.
func (o *GetTimeSeriesStoch200ResponseMetaIndicator) GetFastKPeriod() int64 {
	if o == nil || IsNil(o.FastKPeriod) {
		var ret int64
		return ret
	}
...
// GetFastKPeriodOk returns a tuple with the FastKPeriod field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// HasFastKPeriod returns a boolean if a field has been set.
func (o *GetTimeSeriesStoch200ResponseMetaIndicator) HasFastKPeriod() bool {
	if o != nil && !IsNil(o.FastKPeriod) {
		return true
	}
...
// SetFastKPeriod gets a reference to the given int64 and assigns it to the FastKPeriod field.
func (o *GetTimeSeriesStoch200ResponseMetaIndicator) SetFastKPeriod(v int64) {
	o.FastKPeriod = &v
}

// GetSlowKPeriod returns the SlowKPeriod field value if set, zero value otherwise.
func (o *GetTimeSeriesStoch200ResponseMetaIndicator) GetSlowKPeriod() int64 {
	if o == nil || IsNil(o.SlowKPeriod) {
		var ret int64
		return ret
	}
...
// GetSlowKPeriodOk returns a tuple with the SlowKPeriod field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// HasSlowKPeriod returns a boolean if a field has been set.
func (o *GetTimeSeriesStoch200ResponseMetaIndicator) HasSlowKPeriod() bool {
	if o != nil && !IsNil(o.SlowKPeriod) {
		return true
	}
...
// SetSlowKPeriod gets a reference to the given int64 and assigns it to the SlowKPeriod field.
func (o *GetTimeSeriesStoch200ResponseMetaIndicator) SetSlowKPeriod(v int64) {
	o.SlowKPeriod = &v
}

// GetSlowDPeriod returns the SlowDPeriod field value if set, zero value otherwise.
func (o *GetTimeSeriesStoch200ResponseMetaIndicator) GetSlowDPeriod() int64 {
	if o == nil || IsNil(o.SlowDPeriod) {
		var ret int64
		return ret
	}
...
// GetSlowDPeriodOk returns a tuple with the SlowDPeriod field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// HasSlowDPeriod returns a boolean if a field has been set.
func (o *GetTimeSeriesStoch200ResponseMetaIndicator) HasSlowDPeriod() bool {
	if o != nil && !IsNil(o.SlowDPeriod) {
		return true
	}
...
// SetSlowDPeriod gets a reference to the given int64 and assigns it to the SlowDPeriod field.
func (o *GetTimeSeriesStoch200ResponseMetaIndicator) SetSlowDPeriod(v int64) {
	o.SlowDPeriod = &v
}

// GetSlowKmaType returns the SlowKmaType field value if set, zero value otherwise.
func (o *GetTimeSeriesStoch200ResponseMetaIndicator) GetSlowKmaType() string {
	if o == nil || IsNil(o.SlowKmaType) {
		var ret string
		return ret
	}
...
// GetSlowKmaTypeOk returns a tuple with the SlowKmaType field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// HasSlowKmaType returns a boolean if a field has been set.
func (o *GetTimeSeriesStoch200ResponseMetaIndicator) HasSlowKmaType() bool {
	if o != nil && !IsNil(o.SlowKmaType) {
		return true
	}
...
// SetSlowKmaType gets a reference to the given string and assigns it to the SlowKmaType field.
func (o *GetTimeSeriesStoch200ResponseMetaIndicator) SetSlowKmaType(v string) {
	o.SlowKmaType = &v
}

// GetSlowDmaType returns the SlowDmaType field value if set, zero value otherwise.
func (o *GetTimeSeriesStoch200ResponseMetaIndicator) GetSlowDmaType() string {
	if o == nil || IsNil(o.SlowDmaType) {
		var ret string
		return ret
	}
...
// GetSlowDmaTypeOk returns a tuple with the SlowDmaType field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// HasSlowDmaType returns a boolean if a field has been set.
func (o *GetTimeSeriesStoch200ResponseMetaIndicator) HasSlowDmaType() bool {
	if o != nil && !IsNil(o.SlowDmaType) {
		return true
	}
...
// SetSlowDmaType gets a reference to the given string and assigns it to the SlowDmaType field.
