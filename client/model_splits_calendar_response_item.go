...
func NewSplitsCalendarResponseItem() *SplitsCalendarResponseItem {
...
func (o *SplitsCalendarResponseItem) HasDate() bool {
	if o != nil && !IsNil(o.Date) {
		return true
	}
...
func (o *SplitsCalendarResponseItem) HasDescription() bool {
	if o != nil && !IsNil(o.Description) {
		return true
	}
...
func (o *SplitsCalendarResponseItem) HasRatio() bool {
	if o != nil && !IsNil(o.Ratio) {
		return true
	}
...
func (o *SplitsCalendarResponseItem) HasFromFactor() bool {
	if o != nil && !IsNil(o.FromFactor) {
		return true
	}
...
// SetFromFactor gets a reference to the given float64 and assigns it to the FromFactor field.
...
func (o *SplitsCalendarResponseItem) HasToFactor() bool {
	if o != nil && !IsNil(o.ToFactor) {
		return true
	}
...
// SetToFactor gets a reference to the given float64 and assigns it to the ToFactor field.
