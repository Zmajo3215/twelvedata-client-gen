...
type GetTimeSeriesRocp200ResponseValuesInner struct {
	...
	// ROCP value
	Rocp *string `json:"rocp,omitempty"`
}
...
func NewGetTimeSeriesRocp200ResponseValuesInner() *GetTimeSeriesRocp200ResponseValuesInner {
...
func (o *GetTimeSeriesRocp200ResponseValuesInner) HasDatetime() bool {
	if o != nil && !IsNil(o.Datetime) {
		return true
	}
...
// GetRocp returns the Rocp field value if set, zero value otherwise.
func (o *GetTimeSeriesRocp200ResponseValuesInner) GetRocp() string {
	if o == nil || IsNil(o.Rocp) {
		var ret string
		return ret
	}
	return *o.Rocp
...
// GetRocpOk returns a tuple with the Rocp field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// HasRocp returns a boolean if a field has been set.
func (o *GetTimeSeriesRocp200ResponseValuesInner) HasRocp() bool {
	if o != nil && !IsNil(o.Rocp) {
		return true
	}
...
// SetRocp gets a reference to the given string and assigns it to the Rocp field.
