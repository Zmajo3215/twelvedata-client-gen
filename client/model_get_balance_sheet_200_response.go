...
type GetBalanceSheet200Response struct {
	Meta *GetBalanceSheet200ResponseMeta `json:"meta,omitempty"`
	// Array of balance sheet records
	BalanceSheet []GetBalanceSheet200ResponseBalanceSheetInner `json:"balance_sheet,omitempty"`
}
...
func NewGetBalanceSheet200Response() *GetBalanceSheet200Response {
...
func (o *GetBalanceSheet200Response) HasMeta() bool {
	if o != nil && !IsNil(o.Meta) {
		return true
	}
...
// SetMeta gets a reference to the given GetBalanceSheet200ResponseMeta and assigns it to the Meta field.
...
func (o *GetBalanceSheet200Response) HasBalanceSheet() bool {
	if o != nil && !IsNil(o.BalanceSheet) {
		return true
	}
...
// SetBalanceSheet gets a reference to the given []GetBalanceSheet200ResponseBalanceSheetInner and assigns it to the BalanceSheet field.
