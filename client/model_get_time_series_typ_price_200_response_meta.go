...
// checks if the GetTimeSeriesTypPrice200ResponseMeta type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetTimeSeriesTypPrice200ResponseMeta{}

// GetTimeSeriesTypPrice200ResponseMeta Json object with request general information
type GetTimeSeriesTypPrice200ResponseMeta struct {
	...
	Indicator *GetTimeSeriesTypPrice200ResponseMetaIndicator `json:"indicator,omitempty"`
}
...
func NewGetTimeSeriesTypPrice200ResponseMeta() *GetTimeSeriesTypPrice200ResponseMeta {
	this := GetTimeSeriesTypPrice200ResponseMeta{}
	return &this
}
...
func (o *GetTimeSeriesTypPrice200ResponseMeta) HasSymbol() bool {
	if o != nil && !IsNil(o.Symbol) {
		return true
	}
...
func (o *GetTimeSeriesTypPrice200ResponseMeta) HasInterval() bool {
	if o != nil && !IsNil(o.Interval) {
		return true
	}
...
func (o *GetTimeSeriesTypPrice200ResponseMeta) HasCurrency() bool {
	if o != nil && !IsNil(o.Currency) {
		return true
	}
...
func (o *GetTimeSeriesTypPrice200ResponseMeta) HasExchangeTimezone() bool {
	if o != nil && !IsNil(o.ExchangeTimezone) {
		return true
	}
...
func (o *GetTimeSeriesTypPrice200ResponseMeta) HasExchange() bool {
	if o != nil && !IsNil(o.Exchange) {
		return true
	}
...
func (o *GetTimeSeriesTypPrice200ResponseMeta) HasMicCode() bool {
	if o != nil && !IsNil(o.MicCode) {
		return true
	}
...
func (o *GetTimeSeriesTypPrice200ResponseMeta) HasType() bool {
	if o != nil && !IsNil(o.Type) {
		return true
	}
...
func (o *GetTimeSeriesTypPrice200ResponseMeta) GetIndicator() GetTimeSeriesTypPrice200ResponseMetaIndicator {
	if o == nil || IsNil(o.Indicator) {
		var ret GetTimeSeriesTypPrice200ResponseMetaIndicator
		return ret
	}
	return *o.Indicator
}
...
func (o *GetTimeSeriesTypPrice200ResponseMeta) HasIndicator() bool {
	if o != nil && !IsNil(o.Indicator) {
		return true
	}
...
// SetIndicator gets a reference to the given GetTimeSeriesTypPrice200ResponseMetaIndicator and assigns it to the Indicator field.
func (o *GetTimeSeriesTypPrice200ResponseMeta) SetIndicator(v GetTimeSeriesTypPrice200ResponseMetaIndicator) {
	o.Indicator = &v
}

func (o GetTimeSeriesTypPrice200ResponseMeta) MarshalJSON() ([]byte, error) {
...
func (o GetTimeSeriesTypPrice200ResponseMeta) ToMap() (map[string]interface{}, error) {
...
type NullableGetTimeSeriesTypPrice200ResponseMeta struct {
	value *GetTimeSeriesTypPrice200ResponseMeta
	isSet bool
}

func (v NullableGetTimeSeriesTypPrice200ResponseMeta) Get() *GetTimeSeriesTypPrice200ResponseMeta {
	return v.value
}

func (v *NullableGetTimeSeriesTypPrice200ResponseMeta) Set(val *GetTimeSeriesTypPrice200ResponseMeta) {
	v.value = val
	v.isSet = true
}

func (v NullableGetTimeSeriesTypPrice200ResponseMeta) IsSet() bool {
	return v.isSet
}

func (v *NullableGetTimeSeriesTypPrice200ResponseMeta) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetTimeSeriesTypPrice200ResponseMeta(val *GetTimeSeriesTypPrice200ResponseMeta) *NullableGetTimeSeriesTypPrice200ResponseMeta {
	return &NullableGetTimeSeriesTypPrice200ResponseMeta{value: val, isSet: true}
}

func (v NullableGetTimeSeriesTypPrice200ResponseMeta) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetTimeSeriesTypPrice200ResponseMeta) UnmarshalJSON(src []byte) error {
	v.isSet = true
