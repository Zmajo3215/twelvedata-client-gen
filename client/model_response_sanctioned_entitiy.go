...
type ResponseSanctionedEntitiy struct {
	...
	Sanction *ResponseSanctionItem `json:"sanction,omitempty"`
}
...
// SetSanction gets a reference to the given ResponseSanctionItem and assigns it to the Sanction field.
