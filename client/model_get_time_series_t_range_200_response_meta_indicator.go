...
func NewGetTimeSeriesTRange200ResponseMetaIndicator() *GetTimeSeriesTRange200ResponseMetaIndicator {
...
func (o *GetTimeSeriesTRange200ResponseMetaIndicator) HasName() bool {
	if o != nil && !IsNil(o.Name) {
		return true
	}
