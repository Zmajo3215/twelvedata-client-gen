...
type GetTimeSeriesMinMaxIndex200ResponseValuesInner struct {
	...
	Minidx *string `json:"minidx,omitempty"`
	// Index of the highest value over the specified period
	Maxidx *string `json:"maxidx,omitempty"`
}
...
// GetMinidx returns the Minidx field value if set, zero value otherwise.
func (o *GetTimeSeriesMinMaxIndex200ResponseValuesInner) GetMinidx() string {
	if o == nil || IsNil(o.Minidx) {
		var ret string
		return ret
	}
	return *o.Minidx
...
// GetMinidxOk returns a tuple with the Minidx field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// SetMinidx gets a reference to the given string and assigns it to the Minidx field.
func (o *GetTimeSeriesMinMaxIndex200ResponseValuesInner) SetMinidx(v string) {
	o.Minidx = &v
}

// GetMaxidx returns the Maxidx field value if set, zero value otherwise.
func (o *GetTimeSeriesMinMaxIndex200ResponseValuesInner) GetMaxidx() string {
	if o == nil || IsNil(o.Maxidx) {
		var ret string
		return ret
	}
	return *o.Maxidx
...
// GetMaxidxOk returns a tuple with the Maxidx field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// SetMaxidx gets a reference to the given string and assigns it to the Maxidx field.
