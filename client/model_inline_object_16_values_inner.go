...
func NewInlineObject16ValuesInner() *InlineObject16ValuesInner {
...
func (o *InlineObject16ValuesInner) HasDatetime() bool {
	if o != nil && !IsNil(o.Datetime) {
		return true
	}
...
// GetTan returns the Tan field value if set, zero value otherwise.
func (o *InlineObject16ValuesInner) GetTan() string {
	if o == nil || IsNil(o.Tan) {
		var ret string
		return ret
	}
	return *o.Tan
...
// GetTanOk returns a tuple with the Tan field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// HasTan returns a boolean if a field has been set.
func (o *InlineObject16ValuesInner) HasTan() bool {
	if o != nil && !IsNil(o.Tan) {
		return true
	}
...
// SetTan gets a reference to the given string and assigns it to the Tan field.
