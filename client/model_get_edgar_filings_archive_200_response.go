...
type GetEdgarFilingsArchive200Response struct {
	Meta *GetEdgarFilingsArchive200ResponseMeta `json:"meta,omitempty"`
	// List of filings
	Values []EdgarFilingValue `json:"values,omitempty"`
}
...
// SetMeta gets a reference to the given GetEdgarFilingsArchive200ResponseMeta and assigns it to the Meta field.
...
// SetValues gets a reference to the given []EdgarFilingValue and assigns it to the Values field.
