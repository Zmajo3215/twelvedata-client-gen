...
type GetTimeSeriesSqrt200ResponseValuesInner struct {
	...
	// SQRT value
	Sqrt *string `json:"sqrt,omitempty"`
}
...
func NewGetTimeSeriesSqrt200ResponseValuesInner() *GetTimeSeriesSqrt200ResponseValuesInner {
...
func (o *GetTimeSeriesSqrt200ResponseValuesInner) HasDatetime() bool {
	if o != nil && !IsNil(o.Datetime) {
		return true
	}
...
// GetSqrt returns the Sqrt field value if set, zero value otherwise.
func (o *GetTimeSeriesSqrt200ResponseValuesInner) GetSqrt() string {
	if o == nil || IsNil(o.Sqrt) {
		var ret string
		return ret
	}
	return *o.Sqrt
...
// GetSqrtOk returns a tuple with the Sqrt field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// HasSqrt returns a boolean if a field has been set.
func (o *GetTimeSeriesSqrt200ResponseValuesInner) HasSqrt() bool {
	if o != nil && !IsNil(o.Sqrt) {
		return true
	}
...
// SetSqrt gets a reference to the given string and assigns it to the Sqrt field.
