...
func NewGetTimeSeriesMinIndex200ResponseValuesInner() *GetTimeSeriesMinIndex200ResponseValuesInner {
...
func (o *GetTimeSeriesMinIndex200ResponseValuesInner) HasDatetime() bool {
	if o != nil && !IsNil(o.Datetime) {
		return true
	}
...
func (o *GetTimeSeriesMinIndex200ResponseValuesInner) HasMinidx() bool {
	if o != nil && !IsNil(o.Minidx) {
		return true
	}
