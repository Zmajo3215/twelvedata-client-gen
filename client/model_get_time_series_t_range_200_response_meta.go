...
// checks if the GetTimeSeriesTRange200ResponseMeta type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetTimeSeriesTRange200ResponseMeta{}

// GetTimeSeriesTRange200ResponseMeta json object with request general information
type GetTimeSeriesTRange200ResponseMeta struct {
	...
	Indicator *GetTimeSeriesTRange200ResponseMetaIndicator `json:"indicator,omitempty"`
}
...
func NewGetTimeSeriesTRange200ResponseMeta() *GetTimeSeriesTRange200ResponseMeta {
	this := GetTimeSeriesTRange200ResponseMeta{}
	return &this
}
...
func (o *GetTimeSeriesTRange200ResponseMeta) GetIndicator() GetTimeSeriesTRange200ResponseMetaIndicator {
	if o == nil || IsNil(o.Indicator) {
		var ret GetTimeSeriesTRange200ResponseMetaIndicator
		return ret
	}
	return *o.Indicator
}
...
// SetIndicator gets a reference to the given GetTimeSeriesTRange200ResponseMetaIndicator and assigns it to the Indicator field.
func (o *GetTimeSeriesTRange200ResponseMeta) SetIndicator(v GetTimeSeriesTRange200ResponseMetaIndicator) {
	o.Indicator = &v
}

func (o GetTimeSeriesTRange200ResponseMeta) MarshalJSON() ([]byte, error) {
...
func (o GetTimeSeriesTRange200ResponseMeta) ToMap() (map[string]interface{}, error) {
...
type NullableGetTimeSeriesTRange200ResponseMeta struct {
	value *GetTimeSeriesTRange200ResponseMeta
	isSet bool
}

func (v NullableGetTimeSeriesTRange200ResponseMeta) Get() *GetTimeSeriesTRange200ResponseMeta {
	return v.value
}

func (v *NullableGetTimeSeriesTRange200ResponseMeta) Set(val *GetTimeSeriesTRange200ResponseMeta) {
	v.value = val
	v.isSet = true
}

func (v NullableGetTimeSeriesTRange200ResponseMeta) IsSet() bool {
	return v.isSet
}

func (v *NullableGetTimeSeriesTRange200ResponseMeta) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetTimeSeriesTRange200ResponseMeta(val *GetTimeSeriesTRange200ResponseMeta) *NullableGetTimeSeriesTRange200ResponseMeta {
	return &NullableGetTimeSeriesTRange200ResponseMeta{value: val, isSet: true}
}

func (v NullableGetTimeSeriesTRange200ResponseMeta) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetTimeSeriesTRange200ResponseMeta) UnmarshalJSON(src []byte) error {
	v.isSet = true
