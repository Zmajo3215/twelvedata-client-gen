...
type GetTimeSeriesHtSine200ResponseValuesInner struct {
	...
	// ht_sine value
	HtSine *string `json:"ht_sine,omitempty"`
	// ht_leadsine value
	HtLeadsine *string `json:"ht_leadsine,omitempty"`
}
...
func NewGetTimeSeriesHtSine200ResponseValuesInner() *GetTimeSeriesHtSine200ResponseValuesInner {
...
func (o *GetTimeSeriesHtSine200ResponseValuesInner) HasDatetime() bool {
	if o != nil && !IsNil(o.Datetime) {
		return true
	}
...
// GetHtSine returns the HtSine field value if set, zero value otherwise.
func (o *GetTimeSeriesHtSine200ResponseValuesInner) GetHtSine() string {
	if o == nil || IsNil(o.HtSine) {
		var ret string
		return ret
	}
	return *o.HtSine
...
// GetHtSineOk returns a tuple with the HtSine field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// HasHtSine returns a boolean if a field has been set.
func (o *GetTimeSeriesHtSine200ResponseValuesInner) HasHtSine() bool {
	if o != nil && !IsNil(o.HtSine) {
		return true
	}
...
// SetHtSine gets a reference to the given string and assigns it to the HtSine field.
func (o *GetTimeSeriesHtSine200ResponseValuesInner) SetHtSine(v string) {
	o.HtSine = &v
}

// GetHtLeadsine returns the HtLeadsine field value if set, zero value otherwise.
func (o *GetTimeSeriesHtSine200ResponseValuesInner) GetHtLeadsine() string {
	if o == nil || IsNil(o.HtLeadsine) {
		var ret string
		return ret
	}
	return *o.HtLeadsine
...
// GetHtLeadsineOk returns a tuple with the HtLeadsine field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// HasHtLeadsine returns a boolean if a field has been set.
func (o *GetTimeSeriesHtSine200ResponseValuesInner) HasHtLeadsine() bool {
	if o != nil && !IsNil(o.HtLeadsine) {
		return true
	}
...
// SetHtLeadsine gets a reference to the given string and assigns it to the HtLeadsine field.
