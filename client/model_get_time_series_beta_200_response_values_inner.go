...
func NewGetTimeSeriesBeta200ResponseValuesInner() *GetTimeSeriesBeta200ResponseValuesInner {
...
func (o *GetTimeSeriesBeta200ResponseValuesInner) HasDatetime() bool {
	if o != nil && !IsNil(o.Datetime) {
		return true
	}
...
func (o *GetTimeSeriesBeta200ResponseValuesInner) HasBeta() bool {
	if o != nil && !IsNil(o.Beta) {
		return true
	}
...
// SetBeta gets a reference to the given string and assigns it to the Beta field.
