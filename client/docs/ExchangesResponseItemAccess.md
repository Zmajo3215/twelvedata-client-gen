...
------------ | ------------- | ------------- | -------------
**Global** | Pointer to **string** | Level of access to the symbol | [optional] 
**Plan** | Pointer to **string** | The plan name for the symbol | [optional] 

## Methods

### NewExchangesResponseItemAccess

`func NewExchangesResponseItemAccess() *ExchangesResponseItemAccess`
...
### NewExchangesResponseItemAccessWithDefaults
...
`func (o *ExchangesResponseItemAccess) HasGlobal() bool`
...
`func (o *ExchangesResponseItemAccess) HasPlan() bool`
