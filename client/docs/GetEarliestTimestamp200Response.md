...
------------ | ------------- | ------------- | -------------
**Datetime** | Pointer to **string** | Earliest datetime, the format depends on interval | [optional] 
**UnixTime** | Pointer to **int64** | Datetime converted to UNIX timestamp | [optional] 

## Methods

### NewGetEarliestTimestamp200Response

`func NewGetEarliestTimestamp200Response() *GetEarliestTimestamp200Response`
...
`func (o *GetEarliestTimestamp200Response) HasDatetime() bool`
...
`func (o *GetEarliestTimestamp200Response) HasUnixTime() bool`
