...
------------ | ------------- | ------------- | -------------
**Symbol** | Pointer to **string** | Requested currency symbol | [optional] 
**Rate** | Pointer to **float64** | Real-time exchange rate for the corresponding symbol | [optional] 
**Amount** | Pointer to **float64** | Amount of converted currency | [optional] 
**Timestamp** | Pointer to **int64** | Unix timestamp of the rate | [optional] 

## Methods

### NewGetCurrencyConversion200Response

`func NewGetCurrencyConversion200Response() *GetCurrencyConversion200Response`
...
`func (o *GetCurrencyConversion200Response) HasSymbol() bool`
...
`func (o *GetCurrencyConversion200Response) HasRate() bool`
...
`func (o *GetCurrencyConversion200Response) HasTimestamp() bool`
