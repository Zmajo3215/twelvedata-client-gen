...
------------ | ------------- | ------------- | -------------
**Enable** | Pointer to **bool** | If the indicator is tested, approved and is recommended for use returns &lt;code&gt;true&lt;/code&gt;, otherwise returns &lt;code&gt;false&lt;/code&gt; | [optional] 
**FullName** | Pointer to **string** | Full indicator name | [optional] 
**Description** | Pointer to **string** | Brief description of the indicator | [optional] 
**Type** | Pointer to **string** | Group to which indicator belongs to | [optional] 
**Overlay** | Pointer to **bool** | If indicator should be plotted over price bars returns &lt;code&gt;true&lt;/code&gt;, otherwise returns &lt;code&gt;false&lt;/code&gt; | [optional] 
