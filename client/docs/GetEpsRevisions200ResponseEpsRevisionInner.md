...
------------ | ------------- | ------------- | -------------
**Date** | Pointer to **string** | Date of the EPS estimate | [optional] 
...
`func NewGetEpsRevisions200ResponseEpsRevisionInner() *GetEpsRevisions200ResponseEpsRevisionInner`
...
`func (o *GetEpsRevisions200ResponseEpsRevisionInner) HasDate() bool`
...
`func (o *GetEpsRevisions200ResponseEpsRevisionInner) HasPeriod() bool`
