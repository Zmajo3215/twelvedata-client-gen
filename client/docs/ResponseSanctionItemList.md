...
------------ | ------------- | ------------- | -------------
**Name** | Pointer to **string** | The sanction list name | [optional] 
...
`func NewResponseSanctionItemList() *ResponseSanctionItemList`
...
`func (o *ResponseSanctionItemList) HasName() bool`
