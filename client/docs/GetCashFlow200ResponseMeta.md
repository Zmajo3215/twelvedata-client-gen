...
------------ | ------------- | ------------- | -------------
**Symbol** | Pointer to **string** | Symbol ticker of instrument | [optional] 
**Name** | Pointer to **string** | Name of the company | [optional] 
**Currency** | Pointer to **string** | Currency of the cash flow data according to the ISO 4217 standard | [optional] 
...
**Period** | Pointer to **string** | Period of the cash flow data (Annual or Quarterly) | [optional] 

## Methods

### NewGetCashFlow200ResponseMeta

`func NewGetCashFlow200ResponseMeta() *GetCashFlow200ResponseMeta`
...
### NewGetCashFlow200ResponseMetaWithDefaults
...
`func (o *GetCashFlow200ResponseMeta) HasSymbol() bool`
...
`func (o *GetCashFlow200ResponseMeta) HasName() bool`
...
`func (o *GetCashFlow200ResponseMeta) HasCurrency() bool`
...
`func (o *GetCashFlow200ResponseMeta) HasExchange() bool`
...
`func (o *GetCashFlow200ResponseMeta) HasMicCode() bool`
...
`func (o *GetCashFlow200ResponseMeta) HasExchangeTimezone() bool`
...
`func (o *GetCashFlow200ResponseMeta) HasPeriod() bool`
