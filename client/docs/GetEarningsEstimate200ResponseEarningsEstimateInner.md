...
------------ | ------------- | ------------- | -------------
**Date** | Pointer to **string** | Date of the earnings estimate | [optional] 
...
`func NewGetEarningsEstimate200ResponseEarningsEstimateInner() *GetEarningsEstimate200ResponseEarningsEstimateInner`
...
`func (o *GetEarningsEstimate200ResponseEarningsEstimateInner) HasDate() bool`
...
`func (o *GetEarningsEstimate200ResponseEarningsEstimateInner) HasPeriod() bool`
