...
------------ | ------------- | ------------- | -------------
**FiscalDate** | Pointer to **string** | Date of the balance sheet release | [optional] 
...
`func NewBalanceSheetConsolidatedItem() *BalanceSheetConsolidatedItem`
...
`func (o *BalanceSheetConsolidatedItem) HasFiscalDate() bool`
