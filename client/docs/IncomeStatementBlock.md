...
------------ | ------------- | ------------- | -------------
**FiscalDate** | Pointer to **string** | Date of the income statement release | [optional] 
...
`func NewIncomeStatementBlock() *IncomeStatementBlock`
...
`func (o *IncomeStatementBlock) HasFiscalDate() bool`
