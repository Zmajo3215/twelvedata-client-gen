...
------------ | ------------- | ------------- | -------------
**Timestamp** | Pointer to **string** | Current timestamp in UTC timezone | [optional] 
**CurrentUsage** | Pointer to **int64** | Number of requests made in last minute | [optional] 
**PlanLimit** | Pointer to **int64** | Your personal API limit (requests/minute) depending on the plan | [optional] 
...
`func NewGetApiUsage200Response() *GetApiUsage200Response`
...
`func (o *GetApiUsage200Response) HasTimestamp() bool`
...
`func (o *GetApiUsage200Response) HasCurrentUsage() bool`
...
`func (o *GetApiUsage200Response) HasPlanLimit() bool`
