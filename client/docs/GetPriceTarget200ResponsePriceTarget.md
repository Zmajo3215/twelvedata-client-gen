...
**Currency** | Pointer to **string** | Currency in which the price targets values are quoted | [optional] 

## Methods

### NewGetPriceTarget200ResponsePriceTarget

`func NewGetPriceTarget200ResponsePriceTarget() *GetPriceTarget200ResponsePriceTarget`
...
`func (o *GetPriceTarget200ResponsePriceTarget) HasCurrency() bool`
