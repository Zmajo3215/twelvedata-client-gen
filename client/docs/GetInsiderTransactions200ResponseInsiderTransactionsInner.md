...
------------ | ------------- | ------------- | -------------
**FullName** | Pointer to **string** | Full name of an individual, including first name, middle name, last name, and suffix | [optional] 
**Position** | Pointer to **string** | Job position of insider | [optional] 
**DateReported** | Pointer to **string** | Date the transaction was reported | [optional] 
...
**Description** | Pointer to **string** | Exact price or price range of the transaction if available | [optional] 
