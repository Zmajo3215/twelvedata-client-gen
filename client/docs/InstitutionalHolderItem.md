...
------------ | ------------- | ------------- | -------------
**EntityName** | Pointer to **string** | Refers to the legal name of the institution | [optional] 
...
`func NewInstitutionalHolderItem() *InstitutionalHolderItem`
...
`func (o *InstitutionalHolderItem) HasEntityName() bool`
