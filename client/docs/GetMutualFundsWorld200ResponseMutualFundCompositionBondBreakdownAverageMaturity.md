...
------------ | ------------- | ------------- | -------------
**Fund** | Pointer to **map[string]interface{}** | Average maturity of bond holding of a fund | [optional] 
**Category** | Pointer to **float64** | Average maturity of bond holding of funds in the same category | [optional] 

## Methods

### NewGetMutualFundsWorld200ResponseMutualFundCompositionBondBreakdownAverageMaturity
...
### NewGetMutualFundsWorld200ResponseMutualFundCompositionBondBreakdownAverageMaturityWithDefaults
...
`func (o *GetMutualFundsWorld200ResponseMutualFundCompositionBondBreakdownAverageMaturity) GetFund() map[string]interface{}`

GetFund returns the Fund field if non-nil, zero value otherwise.

### GetFundOk

`func (o *GetMutualFundsWorld200ResponseMutualFundCompositionBondBreakdownAverageMaturity) GetFundOk() (*map[string]interface{}, bool)`
...
`func (o *GetMutualFundsWorld200ResponseMutualFundCompositionBondBreakdownAverageMaturity) SetFund(v map[string]interface{})`
