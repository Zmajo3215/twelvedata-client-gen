...
------------ | ------------- | ------------- | -------------
**Name** | Pointer to **string** | The full name of exchange | [optional] 
**Code** | Pointer to **string** | Market identifier code (MIC) under ISO 10383 standard | [optional] 
**Country** | Pointer to **string** | Country where the exchange is located | [optional] 
**IsMarketOpen** | Pointer to **bool** | Indicates if the market is currently open | [optional] 
**TimeAfterOpen** | Pointer to **string** | Time after market opening in &lt;code&gt;HH:MM:SS&lt;/code&gt; format; if currently closed - returns &lt;code&gt;00:00:00&lt;/code&gt; | [optional] 
**TimeToOpen** | Pointer to **string** | Time to market opening in &lt;code&gt;HH:MM:SS&lt;/code&gt; format; if currently open - returns &lt;code&gt;00:00:00&lt;/code&gt; | [optional] 
**TimeToClose** | Pointer to **string** | Time to market closing in &lt;code&gt;HH:MM:SS&lt;/code&gt; format; if currently closed - returns &lt;code&gt;00:00:00&lt;/code&gt; | [optional] 
