...
------------ | ------------- | ------------- | -------------
**Symbol** | Pointer to **string** | The ticker symbol of an instrument | [optional] 
...
`func NewGetLogo200ResponseMeta() *GetLogo200ResponseMeta`
...
`func (o *GetLogo200ResponseMeta) HasSymbol() bool`
