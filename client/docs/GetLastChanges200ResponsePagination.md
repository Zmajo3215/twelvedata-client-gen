...
------------ | ------------- | ------------- | -------------
**CurrentPage** | Pointer to **int64** | Current page number | [optional] 
**PerPage** | Pointer to **int64** | Records per page | [optional] 

## Methods

### NewGetLastChanges200ResponsePagination

`func NewGetLastChanges200ResponsePagination() *GetLastChanges200ResponsePagination`
...
### NewGetLastChanges200ResponsePaginationWithDefaults
...
`func (o *GetLastChanges200ResponsePagination) HasCurrentPage() bool`
...
`func (o *GetLastChanges200ResponsePagination) HasPerPage() bool`
