...
**MicCode** | Pointer to **string** | Market identifier code, e.g. DIGITAL_CURRENCY, PHYSICAL_CURRENCY, etc. | [optional] 
...
`func NewGetAssetsResponseItem() *GetAssetsResponseItem`
...
`func (o *GetAssetsResponseItem) HasCode() bool`
...
`func (o *GetAssetsResponseItem) HasMicCode() bool`
