...
------------ | ------------- | ------------- | -------------
**Date** | Pointer to **string** | Market capitalization date | [optional] 
**Value** | Pointer to **int64** | Market capitalization value | [optional] 

## Methods

### NewGetMarketCap200ResponseMarketCapInner

`func NewGetMarketCap200ResponseMarketCapInner() *GetMarketCap200ResponseMarketCapInner`
...
### NewGetMarketCap200ResponseMarketCapInnerWithDefaults
...
`func (o *GetMarketCap200ResponseMarketCapInner) HasDate() bool`
...
`func (o *GetMarketCap200ResponseMarketCapInner) HasValue() bool`
