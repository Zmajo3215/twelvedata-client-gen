...
------------ | ------------- | ------------- | -------------
**MutualFund** | Pointer to [**GetMutualFundsWorldRatings200ResponseMutualFund**](GetMutualFundsWorldRatings200ResponseMutualFund.md) |  | [optional] 
**Status** | Pointer to **string** | Status of the response | [optional] 

## Methods

### NewGetMutualFundsWorldRatings200Response
...
### NewGetMutualFundsWorldRatings200ResponseWithDefaults
...
GetMutualFundOk returns a tuple with the MutualFund field if it's non-nil, zero value otherwise
