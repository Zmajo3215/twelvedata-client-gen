...
------------ | ------------- | ------------- | -------------
**Data** | Pointer to [**map[string]GetTechnicalIndicators200ResponseDataValue**](GetTechnicalIndicators200ResponseDataValue.md) | Map of technical indicators available at Twelve Data API | [optional] 
