...
------------ | ------------- | ------------- | -------------
**Name** | Pointer to **string** | Name of cryptocurrency exchange | [optional] 

## Methods

### NewCryptocurrencyExchangesResponseItem

`func NewCryptocurrencyExchangesResponseItem() *CryptocurrencyExchangesResponseItem`
...
### NewCryptocurrencyExchangesResponseItemWithDefaults
...
`func (o *CryptocurrencyExchangesResponseItem) HasName() bool`
