...
------------ | ------------- | ------------- | -------------
**Name** | Pointer to **string** | Full name of an executive, including first name, middle name, last name, and suffix | [optional] 
**Title** | Pointer to **string** | Refers to job title | [optional] 
...
`func NewGetKeyExecutives200ResponseKeyExecutivesInner() *GetKeyExecutives200ResponseKeyExecutivesInner`
...
`func (o *GetKeyExecutives200ResponseKeyExecutivesInner) HasName() bool`
...
`func (o *GetKeyExecutives200ResponseKeyExecutivesInner) HasTitle() bool`
