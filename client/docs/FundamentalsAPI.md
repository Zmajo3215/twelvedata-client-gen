...
func main() {
	...
	period := "period_example" // string | The reporting period for the balane sheet data (optional) (default to "annual")
 ...
 **period** | **string** | The reporting period for the balane sheet data | [default to &quot;annual&quot;]
...
func main() {
	...
	micCode := "XNAS" // string | Market Identifier Code (MIC) under ISO 10383 standard (optional)
	country := "United States" // string | Country where instrument is traded, e.g., `United States` or `US` (optional)
	period := "period_example" // string | The reporting period for the balance sheet data. (optional) (default to "annual")
 ...
 **micCode** | **string** | Market Identifier Code (MIC) under ISO 10383 standard | 
 **country** | **string** | Country where instrument is traded, e.g., &#x60;United States&#x60; or &#x60;US&#x60; | 
 **period** | **string** | The reporting period for the balance sheet data. | [default to &quot;annual&quot;]
 **startDate** | **string** | Begin date for filtering items by fiscal date. Returns income statements with fiscal dates on or after this date. Format &#x60;2006-01-02&#x60; | 
 **endDate** | **string** | End date for filtering items by fiscal date. Returns income statements with fiscal dates on or before this date. Format &#x60;2006-01-02&#x60; | 
 **outputsize** | **int64** | Number of records in response | [default to 6]
...
func main() {
	...
	micCode := "XNAS" // string | Market Identifier Code (MIC) under ISO 10383 standard (optional)
	country := "United States" // string | Country where instrument is traded, e.g., `United States` or `US` (optional)
	period := "period_example" // string | The reporting period for the cash flow statements (optional) (default to "annual")
 ...
 **micCode** | **string** | Market Identifier Code (MIC) under ISO 10383 standard | 
 **country** | **string** | Country where instrument is traded, e.g., &#x60;United States&#x60; or &#x60;US&#x60; | 
 **period** | **string** | The reporting period for the cash flow statements | [default to &quot;annual&quot;]
...
func main() {
	...
	period := "period_example" // string | Type of earning, returns only 1 record. When is not empty, dates and outputsize parameters are ignored (optional)
 ...
 **period** | **string** | Type of earning, returns only 1 record. When is not empty, dates and outputsize parameters are ignored | 
...
func main() {
	...
	micCode := "XNAS" // string | Market Identifier Code (MIC) under ISO 10383 standard (optional)
	country := "United States" // string | Country where instrument is traded, e.g., `United States` or `US` (optional)
	period := "annual" // string | The reporting period for the income statement data (optional)
 ...
 **micCode** | **string** | Market Identifier Code (MIC) under ISO 10383 standard | 
 **country** | **string** | Country where instrument is traded, e.g., &#x60;United States&#x60; or &#x60;US&#x60; | 
 **period** | **string** | The reporting period for the income statement data | 
...
func main() {
	...
	micCode := "XNAS" // string | Market Identifier Code (MIC) under ISO 10383 standard (optional)
	country := "United States" // string | Country where instrument is traded, e.g., `United States` or `US` (optional)
	period := "period_example" // string | The reporting period for the income statement data (optional)
	startDate := "2024-01-01" // string | Begin date for filtering income statements by fiscal date. Returns income statements with fiscal dates on or after this date. Format `2006-01-02` (optional)
	endDate := "2024-12-31" // string | End date for filtering income statements by fiscal date. Returns income statements with fiscal dates on or before this date. Format `2006-01-02` (optional)
	outputsize := int64(789) // int64 | Number of records in response (optional) (default to 6)
...
func main() {
	endpoint := "statistics" // string | Endpoint name
...
func main() {
	...
	micCode := "XNAS" // string | Market Identifier Code (MIC) under ISO 10383 standard (optional)
	country := "United States" // string | Country where instrument is traded, e.g., `United States` or `US` (optional)
	range_ := "range__example" // string | Range of data to be returned (optional) (default to "last")
 ...
 **micCode** | **string** | Market Identifier Code (MIC) under ISO 10383 standard | 
 **country** | **string** | Country where instrument is traded, e.g., &#x60;United States&#x60; or &#x60;US&#x60; | 
 **range_** | **string** | Range of data to be returned | [default to &quot;last&quot;]
