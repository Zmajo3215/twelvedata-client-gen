...
------------ | ------------- | ------------- | -------------
**Count** | Pointer to **int64** | Total number of matching instruments | [optional] 
**List** | Pointer to [**[]FundResponseItem**](FundResponseItem.md) |  | [optional] 

## Methods

### NewGetFunds200ResponseResult

`func NewGetFunds200ResponseResult() *GetFunds200ResponseResult`
...
`func (o *GetFunds200ResponseResult) HasCount() bool`
...
`func (o *GetFunds200ResponseResult) HasList() bool`
