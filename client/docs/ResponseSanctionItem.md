...
------------ | ------------- | ------------- | -------------
**Source** | Pointer to **string** | The sanction source | [optional] 
**Program** | Pointer to **string** | The sanction program | [optional] 
**Notes** | Pointer to **string** | Notes for the sanction | [optional] 
**Lists** | Pointer to [**[]ResponseSanctionItemList**](ResponseSanctionItemList.md) | Sanction lists | [optional] 

## Methods

### NewResponseSanctionItem

`func NewResponseSanctionItem() *ResponseSanctionItem`
...
`func (o *ResponseSanctionItem) HasSource() bool`
...
`func (o *ResponseSanctionItem) HasProgram() bool`
...
`func (o *ResponseSanctionItem) HasNotes() bool`
...
`func (o *ResponseSanctionItem) HasLists() bool`
