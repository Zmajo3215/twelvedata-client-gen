...
type GetTimeSeriesLinearReg200ResponseValuesInner struct {
	...
	// linearreg value
	Linearreg *string `json:"linearreg,omitempty"`
}
...
func NewGetTimeSeriesLinearReg200ResponseValuesInner() *GetTimeSeriesLinearReg200ResponseValuesInner {
...
func (o *GetTimeSeriesLinearReg200ResponseValuesInner) HasDatetime() bool {
	if o != nil && !IsNil(o.Datetime) {
		return true
	}
...
// GetLinearreg returns the Linearreg field value if set, zero value otherwise.
func (o *GetTimeSeriesLinearReg200ResponseValuesInner) GetLinearreg() string {
	if o == nil || IsNil(o.Linearreg) {
		var ret string
		return ret
	}
	return *o.Linearreg
...
// GetLinearregOk returns a tuple with the Linearreg field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// HasLinearreg returns a boolean if a field has been set.
func (o *GetTimeSeriesLinearReg200ResponseValuesInner) HasLinearreg() bool {
	if o != nil && !IsNil(o.Linearreg) {
		return true
	}
...
// SetLinearreg gets a reference to the given string and assigns it to the Linearreg field.
