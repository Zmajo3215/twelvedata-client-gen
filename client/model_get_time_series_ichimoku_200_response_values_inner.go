...
type GetTimeSeriesIchimoku200ResponseValuesInner struct {
	...
	// Senkou span A value
	SenkouSpanA *string `json:"senkou_span_a,omitempty"`
	// Senkou span B value
	SenkouSpanB *string `json:"senkou_span_b,omitempty"`
	// Chikou span value
...
func NewGetTimeSeriesIchimoku200ResponseValuesInner() *GetTimeSeriesIchimoku200ResponseValuesInner {
...
func (o *GetTimeSeriesIchimoku200ResponseValuesInner) HasDatetime() bool {
	if o != nil && !IsNil(o.Datetime) {
		return true
	}
...
// GetSenkouSpanA returns the SenkouSpanA field value if set, zero value otherwise.
func (o *GetTimeSeriesIchimoku200ResponseValuesInner) GetSenkouSpanA() string {
	if o == nil || IsNil(o.SenkouSpanA) {
		var ret string
		return ret
	}
...
// GetSenkouSpanAOk returns a tuple with the SenkouSpanA field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// HasSenkouSpanA returns a boolean if a field has been set.
func (o *GetTimeSeriesIchimoku200ResponseValuesInner) HasSenkouSpanA() bool {
	if o != nil && !IsNil(o.SenkouSpanA) {
		return true
	}
...
// SetSenkouSpanA gets a reference to the given string and assigns it to the SenkouSpanA field.
func (o *GetTimeSeriesIchimoku200ResponseValuesInner) SetSenkouSpanA(v string) {
	o.SenkouSpanA = &v
}

// GetSenkouSpanB returns the SenkouSpanB field value if set, zero value otherwise.
func (o *GetTimeSeriesIchimoku200ResponseValuesInner) GetSenkouSpanB() string {
	if o == nil || IsNil(o.SenkouSpanB) {
		var ret string
		return ret
	}
...
// GetSenkouSpanBOk returns a tuple with the SenkouSpanB field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// HasSenkouSpanB returns a boolean if a field has been set.
func (o *GetTimeSeriesIchimoku200ResponseValuesInner) HasSenkouSpanB() bool {
	if o != nil && !IsNil(o.SenkouSpanB) {
		return true
	}
...
// SetSenkouSpanB gets a reference to the given string and assigns it to the SenkouSpanB field.
...
func (o GetTimeSeriesIchimoku200ResponseValuesInner) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.SenkouSpanA) {
		toSerialize["senkou_span_a"] = o.SenkouSpanA
	}
	if !IsNil(o.SenkouSpanB) {
