...
// checks if the GetTimeSeriesTema200ResponseMeta type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetTimeSeriesTema200ResponseMeta{}

// GetTimeSeriesTema200ResponseMeta Json object with request general information
type GetTimeSeriesTema200ResponseMeta struct {
	...
	Indicator *GetTimeSeriesTema200ResponseMetaIndicator `json:"indicator,omitempty"`
}
...
func NewGetTimeSeriesTema200ResponseMeta() *GetTimeSeriesTema200ResponseMeta {
	this := GetTimeSeriesTema200ResponseMeta{}
	return &this
}
...
func (o *GetTimeSeriesTema200ResponseMeta) GetIndicator() GetTimeSeriesTema200ResponseMetaIndicator {
	if o == nil || IsNil(o.Indicator) {
		var ret GetTimeSeriesTema200ResponseMetaIndicator
		return ret
	}
	return *o.Indicator
}
...
// SetIndicator gets a reference to the given GetTimeSeriesTema200ResponseMetaIndicator and assigns it to the Indicator field.
func (o *GetTimeSeriesTema200ResponseMeta) SetIndicator(v GetTimeSeriesTema200ResponseMetaIndicator) {
	o.Indicator = &v
}

func (o GetTimeSeriesTema200ResponseMeta) MarshalJSON() ([]byte, error) {
...
func (o GetTimeSeriesTema200ResponseMeta) ToMap() (map[string]interface{}, error) {
...
type NullableGetTimeSeriesTema200ResponseMeta struct {
	value *GetTimeSeriesTema200ResponseMeta
	isSet bool
}

func (v NullableGetTimeSeriesTema200ResponseMeta) Get() *GetTimeSeriesTema200ResponseMeta {
	return v.value
}

func (v *NullableGetTimeSeriesTema200ResponseMeta) Set(val *GetTimeSeriesTema200ResponseMeta) {
	v.value = val
	v.isSet = true
}

func (v NullableGetTimeSeriesTema200ResponseMeta) IsSet() bool {
	return v.isSet
}

func (v *NullableGetTimeSeriesTema200ResponseMeta) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetTimeSeriesTema200ResponseMeta(val *GetTimeSeriesTema200ResponseMeta) *NullableGetTimeSeriesTema200ResponseMeta {
	return &NullableGetTimeSeriesTema200ResponseMeta{value: val, isSet: true}
}

func (v NullableGetTimeSeriesTema200ResponseMeta) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetTimeSeriesTema200ResponseMeta) UnmarshalJSON(src []byte) error {
	v.isSet = true
