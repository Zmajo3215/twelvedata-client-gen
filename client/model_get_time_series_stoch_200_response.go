...
type GetTimeSeriesStoch200Response struct {
	Meta *GetTimeSeriesStoch200ResponseMeta `json:"meta,omitempty"`
	// Array of time series data points
	Values []GetTimeSeriesStoch200ResponseValuesInner `json:"values,omitempty"`
	// Response status
...
// SetMeta gets a reference to the given GetTimeSeriesStoch200ResponseMeta and assigns it to the Meta field.
...
// SetValues gets a reference to the given []GetTimeSeriesStoch200ResponseValuesInner and assigns it to the Values field.
