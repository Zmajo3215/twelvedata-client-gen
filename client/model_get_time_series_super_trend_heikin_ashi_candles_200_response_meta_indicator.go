...
func NewGetTimeSeriesSuperTrendHeikinAshiCandles200ResponseMetaIndicator() *GetTimeSeriesSuperTrendHeikinAshiCandles200ResponseMetaIndicator {
...
func (o *GetTimeSeriesSuperTrendHeikinAshiCandles200ResponseMetaIndicator) HasName() bool {
	if o != nil && !IsNil(o.Name) {
		return true
	}
...
func (o *GetTimeSeriesSuperTrendHeikinAshiCandles200ResponseMetaIndicator) HasPeriod() bool {
	if o != nil && !IsNil(o.Period) {
		return true
	}
...
func (o *GetTimeSeriesSuperTrendHeikinAshiCandles200ResponseMetaIndicator) HasMultiplier() bool {
	if o != nil && !IsNil(o.Multiplier) {
		return true
	}
