...
// checks if the GetTimeSeriesLinearRegSlope200ResponseMeta type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetTimeSeriesLinearRegSlope200ResponseMeta{}

// GetTimeSeriesLinearRegSlope200ResponseMeta Json object with request general information
type GetTimeSeriesLinearRegSlope200ResponseMeta struct {
	...
	Indicator *GetTimeSeriesLinearRegSlope200ResponseMetaIndicator `json:"indicator,omitempty"`
}
...
func NewGetTimeSeriesLinearRegSlope200ResponseMeta() *GetTimeSeriesLinearRegSlope200ResponseMeta {
	this := GetTimeSeriesLinearRegSlope200ResponseMeta{}
	return &this
}
...
func (o *GetTimeSeriesLinearRegSlope200ResponseMeta) HasSymbol() bool {
	if o != nil && !IsNil(o.Symbol) {
		return true
	}
...
func (o *GetTimeSeriesLinearRegSlope200ResponseMeta) HasInterval() bool {
	if o != nil && !IsNil(o.Interval) {
		return true
	}
...
func (o *GetTimeSeriesLinearRegSlope200ResponseMeta) HasCurrency() bool {
	if o != nil && !IsNil(o.Currency) {
		return true
	}
...
func (o *GetTimeSeriesLinearRegSlope200ResponseMeta) HasExchangeTimezone() bool {
	if o != nil && !IsNil(o.ExchangeTimezone) {
		return true
	}
...
func (o *GetTimeSeriesLinearRegSlope200ResponseMeta) HasExchange() bool {
	if o != nil && !IsNil(o.Exchange) {
		return true
	}
...
func (o *GetTimeSeriesLinearRegSlope200ResponseMeta) HasMicCode() bool {
	if o != nil && !IsNil(o.MicCode) {
		return true
	}
...
func (o *GetTimeSeriesLinearRegSlope200ResponseMeta) HasType() bool {
	if o != nil && !IsNil(o.Type) {
		return true
	}
...
func (o *GetTimeSeriesLinearRegSlope200ResponseMeta) GetIndicator() GetTimeSeriesLinearRegSlope200ResponseMetaIndicator {
	if o == nil || IsNil(o.Indicator) {
		var ret GetTimeSeriesLinearRegSlope200ResponseMetaIndicator
		return ret
	}
	return *o.Indicator
}
...
func (o *GetTimeSeriesLinearRegSlope200ResponseMeta) HasIndicator() bool {
	if o != nil && !IsNil(o.Indicator) {
		return true
	}
...
// SetIndicator gets a reference to the given GetTimeSeriesLinearRegSlope200ResponseMetaIndicator and assigns it to the Indicator field.
func (o *GetTimeSeriesLinearRegSlope200ResponseMeta) SetIndicator(v GetTimeSeriesLinearRegSlope200ResponseMetaIndicator) {
	o.Indicator = &v
}

func (o GetTimeSeriesLinearRegSlope200ResponseMeta) MarshalJSON() ([]byte, error) {
...
func (o GetTimeSeriesLinearRegSlope200ResponseMeta) ToMap() (map[string]interface{}, error) {
...
type NullableGetTimeSeriesLinearRegSlope200ResponseMeta struct {
	value *GetTimeSeriesLinearRegSlope200ResponseMeta
	isSet bool
}

func (v NullableGetTimeSeriesLinearRegSlope200ResponseMeta) Get() *GetTimeSeriesLinearRegSlope200ResponseMeta {
	return v.value
}

func (v *NullableGetTimeSeriesLinearRegSlope200ResponseMeta) Set(val *GetTimeSeriesLinearRegSlope200ResponseMeta) {
	v.value = val
	v.isSet = true
}

func (v NullableGetTimeSeriesLinearRegSlope200ResponseMeta) IsSet() bool {
	return v.isSet
}

func (v *NullableGetTimeSeriesLinearRegSlope200ResponseMeta) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetTimeSeriesLinearRegSlope200ResponseMeta(val *GetTimeSeriesLinearRegSlope200ResponseMeta) *NullableGetTimeSeriesLinearRegSlope200ResponseMeta {
	return &NullableGetTimeSeriesLinearRegSlope200ResponseMeta{value: val, isSet: true}
}

func (v NullableGetTimeSeriesLinearRegSlope200ResponseMeta) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetTimeSeriesLinearRegSlope200ResponseMeta) UnmarshalJSON(src []byte) error {
	v.isSet = true
