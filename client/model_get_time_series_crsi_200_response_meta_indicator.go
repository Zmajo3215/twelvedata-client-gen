...
type GetTimeSeriesCrsi200ResponseMetaIndicator struct {
	...
	RsiPeriod *int64 `json:"rsi_period,omitempty"`
	// Number of periods for RSI used to calculate up/down trend
	UpDownLength *int64 `json:"up_down_length,omitempty"`
	// Number of periods used to calculate PercentRank
	PercentRankPeriod *int64 `json:"percent_rank_period,omitempty"`
}
...
func NewGetTimeSeriesCrsi200ResponseMetaIndicator() *GetTimeSeriesCrsi200ResponseMetaIndicator {
...
func (o *GetTimeSeriesCrsi200ResponseMetaIndicator) HasName() bool {
	if o != nil && !IsNil(o.Name) {
		return true
	}
...
func (o *GetTimeSeriesCrsi200ResponseMetaIndicator) HasSeriesType() bool {
	if o != nil && !IsNil(o.SeriesType) {
		return true
	}
...
// GetRsiPeriod returns the RsiPeriod field value if set, zero value otherwise.
func (o *GetTimeSeriesCrsi200ResponseMetaIndicator) GetRsiPeriod() int64 {
	if o == nil || IsNil(o.RsiPeriod) {
		var ret int64
		return ret
	}
	return *o.RsiPeriod
...
// GetRsiPeriodOk returns a tuple with the RsiPeriod field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// HasRsiPeriod returns a boolean if a field has been set.
func (o *GetTimeSeriesCrsi200ResponseMetaIndicator) HasRsiPeriod() bool {
	if o != nil && !IsNil(o.RsiPeriod) {
		return true
	}
...
// SetRsiPeriod gets a reference to the given int64 and assigns it to the RsiPeriod field.
func (o *GetTimeSeriesCrsi200ResponseMetaIndicator) SetRsiPeriod(v int64) {
	o.RsiPeriod = &v
}

// GetUpDownLength returns the UpDownLength field value if set, zero value otherwise.
func (o *GetTimeSeriesCrsi200ResponseMetaIndicator) GetUpDownLength() int64 {
	if o == nil || IsNil(o.UpDownLength) {
		var ret int64
		return ret
	}
...
// GetUpDownLengthOk returns a tuple with the UpDownLength field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// HasUpDownLength returns a boolean if a field has been set.
func (o *GetTimeSeriesCrsi200ResponseMetaIndicator) HasUpDownLength() bool {
	if o != nil && !IsNil(o.UpDownLength) {
		return true
	}
...
// SetUpDownLength gets a reference to the given int64 and assigns it to the UpDownLength field.
func (o *GetTimeSeriesCrsi200ResponseMetaIndicator) SetUpDownLength(v int64) {
	o.UpDownLength = &v
}

// GetPercentRankPeriod returns the PercentRankPeriod field value if set, zero value otherwise.
func (o *GetTimeSeriesCrsi200ResponseMetaIndicator) GetPercentRankPeriod() int64 {
	if o == nil || IsNil(o.PercentRankPeriod) {
		var ret int64
		return ret
	}
...
// GetPercentRankPeriodOk returns a tuple with the PercentRankPeriod field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// HasPercentRankPeriod returns a boolean if a field has been set.
func (o *GetTimeSeriesCrsi200ResponseMetaIndicator) HasPercentRankPeriod() bool {
	if o != nil && !IsNil(o.PercentRankPeriod) {
		return true
	}
...
// SetPercentRankPeriod gets a reference to the given int64 and assigns it to the PercentRankPeriod field.
