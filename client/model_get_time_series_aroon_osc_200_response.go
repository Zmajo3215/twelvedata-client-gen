...
type GetTimeSeriesAroonOsc200Response struct {
	Meta *GetTimeSeriesAroonOsc200ResponseMeta `json:"meta,omitempty"`
	// Array of time series data points
	Values []GetTimeSeriesAroonOsc200ResponseValuesInner `json:"values,omitempty"`
	// Response status
...
func NewGetTimeSeriesAroonOsc200Response() *GetTimeSeriesAroonOsc200Response {
...
func (o *GetTimeSeriesAroonOsc200Response) HasMeta() bool {
	if o != nil && !IsNil(o.Meta) {
		return true
	}
...
// SetMeta gets a reference to the given GetTimeSeriesAroonOsc200ResponseMeta and assigns it to the Meta field.
...
func (o *GetTimeSeriesAroonOsc200Response) HasValues() bool {
	if o != nil && !IsNil(o.Values) {
		return true
	}
...
// SetValues gets a reference to the given []GetTimeSeriesAroonOsc200ResponseValuesInner and assigns it to the Values field.
...
func (o *GetTimeSeriesAroonOsc200Response) HasStatus() bool {
	if o != nil && !IsNil(o.Status) {
		return true
	}
