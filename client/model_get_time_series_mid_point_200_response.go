...
type GetTimeSeriesMidPoint200Response struct {
	Meta *GetTimeSeriesMidPoint200ResponseMeta `json:"meta,omitempty"`
	// Array of time series data points
	Values []GetTimeSeriesMidPoint200ResponseValuesInner `json:"values,omitempty"`
	// Response status
...
// SetMeta gets a reference to the given GetTimeSeriesMidPoint200ResponseMeta and assigns it to the Meta field.
...
// SetValues gets a reference to the given []GetTimeSeriesMidPoint200ResponseValuesInner and assigns it to the Values field.
