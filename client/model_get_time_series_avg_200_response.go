...
type GetTimeSeriesAvg200Response struct {
	Meta *GetTimeSeriesAvg200ResponseMeta `json:"meta,omitempty"`
	// Array of time series data points
	Values []GetTimeSeriesAvg200ResponseValuesInner `json:"values,omitempty"`
	// Response status
...
func NewGetTimeSeriesAvg200Response() *GetTimeSeriesAvg200Response {
...
func (o *GetTimeSeriesAvg200Response) HasMeta() bool {
	if o != nil && !IsNil(o.Meta) {
		return true
	}
...
// SetMeta gets a reference to the given GetTimeSeriesAvg200ResponseMeta and assigns it to the Meta field.
...
func (o *GetTimeSeriesAvg200Response) HasValues() bool {
	if o != nil && !IsNil(o.Values) {
		return true
	}
...
// SetValues gets a reference to the given []GetTimeSeriesAvg200ResponseValuesInner and assigns it to the Values field.
...
func (o *GetTimeSeriesAvg200Response) HasStatus() bool {
	if o != nil && !IsNil(o.Status) {
		return true
	}
