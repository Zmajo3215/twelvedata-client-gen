...
type GetTimeSeriesHlc3200Response struct {
	Meta *GetTimeSeriesHlc3200ResponseMeta `json:"meta,omitempty"`
	// Array of time series data points
	Values []GetTimeSeriesHlc3200ResponseValuesInner `json:"values,omitempty"`
	// Response status
...
func NewGetTimeSeriesHlc3200Response() *GetTimeSeriesHlc3200Response {
...
func (o *GetTimeSeriesHlc3200Response) HasMeta() bool {
	if o != nil && !IsNil(o.Meta) {
		return true
	}
...
// SetMeta gets a reference to the given GetTimeSeriesHlc3200ResponseMeta and assigns it to the Meta field.
...
func (o *GetTimeSeriesHlc3200Response) HasValues() bool {
	if o != nil && !IsNil(o.Values) {
		return true
	}
...
// SetValues gets a reference to the given []GetTimeSeriesHlc3200ResponseValuesInner and assigns it to the Values field.
...
func (o *GetTimeSeriesHlc3200Response) HasStatus() bool {
	if o != nil && !IsNil(o.Status) {
		return true
	}
