...
type GetDirectHolders200Response struct {
	Meta *GetDirectHolders200ResponseMeta `json:"meta,omitempty"`
	// List of direct holders for the financial instrument
	DirectHolders []DirectHolderItem `json:"direct_holders,omitempty"`
}
...
func NewGetDirectHolders200Response() *GetDirectHolders200Response {
...
func (o *GetDirectHolders200Response) HasMeta() bool {
	if o != nil && !IsNil(o.Meta) {
		return true
	}
...
// SetMeta gets a reference to the given GetDirectHolders200ResponseMeta and assigns it to the Meta field.
func (o *GetDirectHolders200Response) SetMeta(v GetDirectHolders200ResponseMeta) {
	o.Meta = &v
}

// GetDirectHolders returns the DirectHolders field value if set, zero value otherwise.
func (o *GetDirectHolders200Response) GetDirectHolders() []DirectHolderItem {
	if o == nil || IsNil(o.DirectHolders) {
...
// GetDirectHoldersOk returns a tuple with the DirectHolders field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// HasDirectHolders returns a boolean if a field has been set.
func (o *GetDirectHolders200Response) HasDirectHolders() bool {
	if o != nil && !IsNil(o.DirectHolders) {
		return true
	}
...
// SetDirectHolders gets a reference to the given []DirectHolderItem and assigns it to the DirectHolders field.
