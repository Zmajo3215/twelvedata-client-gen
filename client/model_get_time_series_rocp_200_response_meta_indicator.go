...
func NewGetTimeSeriesRocp200ResponseMetaIndicator() *GetTimeSeriesRocp200ResponseMetaIndicator {
...
func (o *GetTimeSeriesRocp200ResponseMetaIndicator) HasName() bool {
	if o != nil && !IsNil(o.Name) {
		return true
	}
...
func (o *GetTimeSeriesRocp200ResponseMetaIndicator) HasSeriesType() bool {
	if o != nil && !IsNil(o.SeriesType) {
		return true
	}
...
func (o *GetTimeSeriesRocp200ResponseMetaIndicator) HasTimePeriod() bool {
	if o != nil && !IsNil(o.TimePeriod) {
		return true
	}
