...
type InlineObject11 struct {
	Meta *InlineObject11Meta `json:"meta,omitempty"`
	// Array of time series data points
	Values []InlineObject11ValuesInner `json:"values,omitempty"`
	// Response status
...
// SetMeta gets a reference to the given InlineObject11Meta and assigns it to the Meta field.
...
// SetValues gets a reference to the given []InlineObject11ValuesInner and assigns it to the Values field.
