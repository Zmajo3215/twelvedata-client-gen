...
type ForexResponseItem struct {
	...
	CurrencyGroup *string `json:"currency_group,omitempty"`
...
// GetCurrencyGroup returns the CurrencyGroup field value if set, zero value otherwise.
func (o *ForexResponseItem) GetCurrencyGroup() string {
	if o == nil || IsNil(o.CurrencyGroup) {
		var ret string
		return ret
	}
...
// GetCurrencyGroupOk returns a tuple with the CurrencyGroup field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// SetCurrencyGroup gets a reference to the given string and assigns it to the CurrencyGroup field.
