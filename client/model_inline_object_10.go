...
type InlineObject10 struct {
	Meta *InlineObject10Meta `json:"meta,omitempty"`
	// Array of time series data points
	Values []InlineObject10ValuesInner `json:"values,omitempty"`
	// Response status
...
func (o *InlineObject10) HasMeta() bool {
	if o != nil && !IsNil(o.Meta) {
		return true
	}
...
// SetMeta gets a reference to the given InlineObject10Meta and assigns it to the Meta field.
...
func (o *InlineObject10) HasValues() bool {
	if o != nil && !IsNil(o.Values) {
		return true
	}
...
// SetValues gets a reference to the given []InlineObject10ValuesInner and assigns it to the Values field.
...
func (o *InlineObject10) HasStatus() bool {
	if o != nil && !IsNil(o.Status) {
		return true
	}
