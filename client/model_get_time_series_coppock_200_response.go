...
type GetTimeSeriesCoppock200Response struct {
	Meta *GetTimeSeriesCoppock200ResponseMeta `json:"meta,omitempty"`
	// Array of time series data points
	Values []GetTimeSeriesCoppock200ResponseValuesInner `json:"values,omitempty"`
	// Response status
...
func NewGetTimeSeriesCoppock200Response() *GetTimeSeriesCoppock200Response {
...
func (o *GetTimeSeriesCoppock200Response) HasMeta() bool {
	if o != nil && !IsNil(o.Meta) {
		return true
	}
...
// SetMeta gets a reference to the given GetTimeSeriesCoppock200ResponseMeta and assigns it to the Meta field.
...
func (o *GetTimeSeriesCoppock200Response) HasValues() bool {
	if o != nil && !IsNil(o.Values) {
		return true
	}
...
// SetValues gets a reference to the given []GetTimeSeriesCoppock200ResponseValuesInner and assigns it to the Values field.
...
func (o *GetTimeSeriesCoppock200Response) HasStatus() bool {
	if o != nil && !IsNil(o.Status) {
		return true
	}
