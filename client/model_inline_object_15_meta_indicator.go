...
func NewInlineObject15MetaIndicator() *InlineObject15MetaIndicator {
...
func (o *InlineObject15MetaIndicator) HasName() bool {
	if o != nil && !IsNil(o.Name) {
		return true
	}
...
func (o *InlineObject15MetaIndicator) HasSeriesType() bool {
	if o != nil && !IsNil(o.SeriesType) {
		return true
	}
