...
func NewGetTimeSeriesObv200ResponseMetaIndicator() *GetTimeSeriesObv200ResponseMetaIndicator {
...
func (o *GetTimeSeriesObv200ResponseMetaIndicator) HasName() bool {
	if o != nil && !IsNil(o.Name) {
		return true
	}
...
func (o *GetTimeSeriesObv200ResponseMetaIndicator) HasSeriesType() bool {
	if o != nil && !IsNil(o.SeriesType) {
		return true
	}
