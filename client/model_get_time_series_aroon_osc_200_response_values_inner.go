...
type GetTimeSeriesAroonOsc200ResponseValuesInner struct {
	...
	Aroonosc *string `json:"aroonosc,omitempty"`
}
...
// GetAroonosc returns the Aroonosc field value if set, zero value otherwise.
func (o *GetTimeSeriesAroonOsc200ResponseValuesInner) GetAroonosc() string {
	if o == nil || IsNil(o.Aroonosc) {
		var ret string
		return ret
	}
	return *o.Aroonosc
...
// GetAroonoscOk returns a tuple with the Aroonosc field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// SetAroonosc gets a reference to the given string and assigns it to the Aroonosc field.
