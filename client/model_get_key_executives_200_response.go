...
type GetKeyExecutives200Response struct {
	Meta *GetKeyExecutives200ResponseMeta `json:"meta,omitempty"`
...
func NewGetKeyExecutives200Response() *GetKeyExecutives200Response {
...
func (o *GetKeyExecutives200Response) HasMeta() bool {
	if o != nil && !IsNil(o.Meta) {
		return true
	}
...
// SetMeta gets a reference to the given GetKeyExecutives200ResponseMeta and assigns it to the Meta field.
