...
type GetTimeSeriesCorrel200ResponseValuesInner struct {
	...
	// Correl value
	Correl *string `json:"correl,omitempty"`
}
...
func NewGetTimeSeriesCorrel200ResponseValuesInner() *GetTimeSeriesCorrel200ResponseValuesInner {
...
func (o *GetTimeSeriesCorrel200ResponseValuesInner) HasDatetime() bool {
	if o != nil && !IsNil(o.Datetime) {
		return true
	}
...
// GetCorrel returns the Correl field value if set, zero value otherwise.
func (o *GetTimeSeriesCorrel200ResponseValuesInner) GetCorrel() string {
	if o == nil || IsNil(o.Correl) {
		var ret string
		return ret
	}
	return *o.Correl
...
// GetCorrelOk returns a tuple with the Correl field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// HasCorrel returns a boolean if a field has been set.
func (o *GetTimeSeriesCorrel200ResponseValuesInner) HasCorrel() bool {
	if o != nil && !IsNil(o.Correl) {
		return true
	}
...
// SetCorrel gets a reference to the given string and assigns it to the Correl field.
