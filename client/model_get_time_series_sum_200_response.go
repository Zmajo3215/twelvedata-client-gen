...
type GetTimeSeriesSum200Response struct {
	Meta *GetTimeSeriesSum200ResponseMeta `json:"meta,omitempty"`
	// Array of time series data points
	Values []GetTimeSeriesSum200ResponseValuesInner `json:"values,omitempty"`
	// Response status
...
// SetMeta gets a reference to the given GetTimeSeriesSum200ResponseMeta and assigns it to the Meta field.
...
// SetValues gets a reference to the given []GetTimeSeriesSum200ResponseValuesInner and assigns it to the Values field.
