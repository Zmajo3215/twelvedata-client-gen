...
type GetTaxInfo200Response struct {
	Meta *GetTaxInfo200ResponseMeta `json:"meta,omitempty"`
	Data *GetTaxInfo200ResponseData `json:"data,omitempty"`
...
// SetMeta gets a reference to the given GetTaxInfo200ResponseMeta and assigns it to the Meta field.
...
// SetData gets a reference to the given GetTaxInfo200ResponseData and assigns it to the Data field.
