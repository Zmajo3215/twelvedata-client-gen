...
type GetTimeSeriesStochF200ResponseMetaIndicator struct {
	...
	FastDPeriod *int64 `json:"fast_d_period,omitempty"`
	// The type of fast Displaced Moving Average used
	FastDmaType *string `json:"fast_dma_type,omitempty"`
}
...
func NewGetTimeSeriesStochF200ResponseMetaIndicator() *GetTimeSeriesStochF200ResponseMetaIndicator {
...
func (o *GetTimeSeriesStochF200ResponseMetaIndicator) HasName() bool {
	if o != nil && !IsNil(o.Name) {
		return true
	}
...
func (o *GetTimeSeriesStochF200ResponseMetaIndicator) HasFastKPeriod() bool {
	if o != nil && !IsNil(o.FastKPeriod) {
		return true
	}
...
// GetFastDPeriod returns the FastDPeriod field value if set, zero value otherwise.
func (o *GetTimeSeriesStochF200ResponseMetaIndicator) GetFastDPeriod() int64 {
	if o == nil || IsNil(o.FastDPeriod) {
		var ret int64
		return ret
	}
...
// GetFastDPeriodOk returns a tuple with the FastDPeriod field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// HasFastDPeriod returns a boolean if a field has been set.
func (o *GetTimeSeriesStochF200ResponseMetaIndicator) HasFastDPeriod() bool {
	if o != nil && !IsNil(o.FastDPeriod) {
		return true
	}
...
// SetFastDPeriod gets a reference to the given int64 and assigns it to the FastDPeriod field.
func (o *GetTimeSeriesStochF200ResponseMetaIndicator) SetFastDPeriod(v int64) {
	o.FastDPeriod = &v
}

// GetFastDmaType returns the FastDmaType field value if set, zero value otherwise.
func (o *GetTimeSeriesStochF200ResponseMetaIndicator) GetFastDmaType() string {
	if o == nil || IsNil(o.FastDmaType) {
		var ret string
		return ret
	}
...
// GetFastDmaTypeOk returns a tuple with the FastDmaType field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// HasFastDmaType returns a boolean if a field has been set.
func (o *GetTimeSeriesStochF200ResponseMetaIndicator) HasFastDmaType() bool {
	if o != nil && !IsNil(o.FastDmaType) {
		return true
	}
...
// SetFastDmaType gets a reference to the given string and assigns it to the FastDmaType field.
...
func (o GetTimeSeriesStochF200ResponseMetaIndicator) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.FastDPeriod) {
		toSerialize["fast_d_period"] = o.FastDPeriod
	}
	if !IsNil(o.FastDmaType) {
