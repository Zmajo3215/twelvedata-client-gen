...
type GetMutualFundsWorld200Response struct {
	MutualFund *GetMutualFundsWorld200ResponseMutualFund `json:"mutual_fund,omitempty"`
...
func NewGetMutualFundsWorld200Response() *GetMutualFundsWorld200Response {
...
func (o *GetMutualFundsWorld200Response) HasMutualFund() bool {
	if o != nil && !IsNil(o.MutualFund) {
		return true
	}
...
// SetMutualFund gets a reference to the given GetMutualFundsWorld200ResponseMutualFund and assigns it to the MutualFund field.
...
func (o *GetMutualFundsWorld200Response) HasStatus() bool {
	if o != nil && !IsNil(o.Status) {
		return true
	}
