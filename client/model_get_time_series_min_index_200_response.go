...
type GetTimeSeriesMinIndex200Response struct {
	Meta *GetTimeSeriesMinIndex200ResponseMeta `json:"meta,omitempty"`
	// Array of time series data points
	Values []GetTimeSeriesMinIndex200ResponseValuesInner `json:"values,omitempty"`
	// Response status
...
func NewGetTimeSeriesMinIndex200Response() *GetTimeSeriesMinIndex200Response {
...
func (o *GetTimeSeriesMinIndex200Response) HasMeta() bool {
	if o != nil && !IsNil(o.Meta) {
		return true
	}
...
// SetMeta gets a reference to the given GetTimeSeriesMinIndex200ResponseMeta and assigns it to the Meta field.
...
func (o *GetTimeSeriesMinIndex200Response) HasValues() bool {
	if o != nil && !IsNil(o.Values) {
		return true
	}
...
// SetValues gets a reference to the given []GetTimeSeriesMinIndex200ResponseValuesInner and assigns it to the Values field.
...
func (o *GetTimeSeriesMinIndex200Response) HasStatus() bool {
	if o != nil && !IsNil(o.Status) {
		return true
	}
