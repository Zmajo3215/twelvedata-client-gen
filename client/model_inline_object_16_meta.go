...
type InlineObject16Meta struct {
	...
	Indicator *InlineObject16MetaIndicator `json:"indicator,omitempty"`
}
...
func NewInlineObject16Meta() *InlineObject16Meta {
...
func (o *InlineObject16Meta) HasSymbol() bool {
	if o != nil && !IsNil(o.Symbol) {
		return true
	}
...
func (o *InlineObject16Meta) HasInterval() bool {
	if o != nil && !IsNil(o.Interval) {
		return true
	}
...
func (o *InlineObject16Meta) HasCurrency() bool {
	if o != nil && !IsNil(o.Currency) {
		return true
	}
...
func (o *InlineObject16Meta) HasExchangeTimezone() bool {
	if o != nil && !IsNil(o.ExchangeTimezone) {
		return true
	}
...
func (o *InlineObject16Meta) HasExchange() bool {
	if o != nil && !IsNil(o.Exchange) {
		return true
	}
...
func (o *InlineObject16Meta) HasMicCode() bool {
	if o != nil && !IsNil(o.MicCode) {
		return true
	}
...
func (o *InlineObject16Meta) HasType() bool {
	if o != nil && !IsNil(o.Type) {
		return true
	}
...
func (o *InlineObject16Meta) HasIndicator() bool {
	if o != nil && !IsNil(o.Indicator) {
		return true
	}
...
// SetIndicator gets a reference to the given InlineObject16MetaIndicator and assigns it to the Indicator field.
