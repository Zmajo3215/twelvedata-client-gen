...
type GetTimeSeriesUltOsc200Response struct {
	Meta *GetTimeSeriesUltOsc200ResponseMeta `json:"meta,omitempty"`
	// Array of time series data points
	Values []GetTimeSeriesUltOsc200ResponseValuesInner `json:"values,omitempty"`
	// Response status
...
// SetMeta gets a reference to the given GetTimeSeriesUltOsc200ResponseMeta and assigns it to the Meta field.
...
// SetValues gets a reference to the given []GetTimeSeriesUltOsc200ResponseValuesInner and assigns it to the Values field.
