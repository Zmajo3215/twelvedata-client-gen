...
type GetTimeSeriesLinearRegAngle200Response struct {
	Meta *GetTimeSeriesLinearRegAngle200ResponseMeta `json:"meta,omitempty"`
	// Array of time series data points
	Values []GetTimeSeriesLinearRegAngle200ResponseValuesInner `json:"values,omitempty"`
	// Response status
...
func NewGetTimeSeriesLinearRegAngle200Response() *GetTimeSeriesLinearRegAngle200Response {
...
func (o *GetTimeSeriesLinearRegAngle200Response) HasMeta() bool {
	if o != nil && !IsNil(o.Meta) {
		return true
	}
...
// SetMeta gets a reference to the given GetTimeSeriesLinearRegAngle200ResponseMeta and assigns it to the Meta field.
...
func (o *GetTimeSeriesLinearRegAngle200Response) HasValues() bool {
	if o != nil && !IsNil(o.Values) {
		return true
	}
...
// SetValues gets a reference to the given []GetTimeSeriesLinearRegAngle200ResponseValuesInner and assigns it to the Values field.
...
func (o *GetTimeSeriesLinearRegAngle200Response) HasStatus() bool {
	if o != nil && !IsNil(o.Status) {
		return true
	}
