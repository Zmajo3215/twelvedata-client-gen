...
type GetTimeSeriesMinMax200Response struct {
	Meta *GetTimeSeriesMinMax200ResponseMeta `json:"meta,omitempty"`
	// Array of time series data points
	Values []GetTimeSeriesMinMax200ResponseValuesInner `json:"values,omitempty"`
	// Response status
...
// SetMeta gets a reference to the given GetTimeSeriesMinMax200ResponseMeta and assigns it to the Meta field.
...
// SetValues gets a reference to the given []GetTimeSeriesMinMax200ResponseValuesInner and assigns it to the Values field.
