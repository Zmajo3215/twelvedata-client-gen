...
type GetMutualFundsList200ResponseResult struct {
	...
	List []MutualFundsListResponseListItem `json:"list,omitempty"`
}
...
// SetList gets a reference to the given []MutualFundsListResponseListItem and assigns it to the List field.
