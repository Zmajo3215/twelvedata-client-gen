...
type ExchangeScheduleResponseItem struct {
	...
	Sessions []ExchangeScheduleSession `json:"sessions,omitempty"`
}
...
// SetSessions gets a reference to the given []ExchangeScheduleSession and assigns it to the Sessions field.
