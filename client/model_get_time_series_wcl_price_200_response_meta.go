...
// checks if the GetTimeSeriesWclPrice200ResponseMeta type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetTimeSeriesWclPrice200ResponseMeta{}

// GetTimeSeriesWclPrice200ResponseMeta Json object with request general information
type GetTimeSeriesWclPrice200ResponseMeta struct {
	...
	Indicator *GetTimeSeriesWclPrice200ResponseMetaIndicator `json:"indicator,omitempty"`
}
...
func NewGetTimeSeriesWclPrice200ResponseMeta() *GetTimeSeriesWclPrice200ResponseMeta {
	this := GetTimeSeriesWclPrice200ResponseMeta{}
	return &this
}
...
func (o *GetTimeSeriesWclPrice200ResponseMeta) GetIndicator() GetTimeSeriesWclPrice200ResponseMetaIndicator {
	if o == nil || IsNil(o.Indicator) {
		var ret GetTimeSeriesWclPrice200ResponseMetaIndicator
		return ret
	}
	return *o.Indicator
}
...
// SetIndicator gets a reference to the given GetTimeSeriesWclPrice200ResponseMetaIndicator and assigns it to the Indicator field.
func (o *GetTimeSeriesWclPrice200ResponseMeta) SetIndicator(v GetTimeSeriesWclPrice200ResponseMetaIndicator) {
	o.Indicator = &v
}

func (o GetTimeSeriesWclPrice200ResponseMeta) MarshalJSON() ([]byte, error) {
...
func (o GetTimeSeriesWclPrice200ResponseMeta) ToMap() (map[string]interface{}, error) {
...
type NullableGetTimeSeriesWclPrice200ResponseMeta struct {
	value *GetTimeSeriesWclPrice200ResponseMeta
	isSet bool
}

func (v NullableGetTimeSeriesWclPrice200ResponseMeta) Get() *GetTimeSeriesWclPrice200ResponseMeta {
	return v.value
}

func (v *NullableGetTimeSeriesWclPrice200ResponseMeta) Set(val *GetTimeSeriesWclPrice200ResponseMeta) {
	v.value = val
	v.isSet = true
}

func (v NullableGetTimeSeriesWclPrice200ResponseMeta) IsSet() bool {
	return v.isSet
}

func (v *NullableGetTimeSeriesWclPrice200ResponseMeta) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetTimeSeriesWclPrice200ResponseMeta(val *GetTimeSeriesWclPrice200ResponseMeta) *NullableGetTimeSeriesWclPrice200ResponseMeta {
	return &NullableGetTimeSeriesWclPrice200ResponseMeta{value: val, isSet: true}
}

func (v NullableGetTimeSeriesWclPrice200ResponseMeta) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetTimeSeriesWclPrice200ResponseMeta) UnmarshalJSON(src []byte) error {
	v.isSet = true
