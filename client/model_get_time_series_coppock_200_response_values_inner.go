...
type GetTimeSeriesCoppock200ResponseValuesInner struct {
	...
	// Coppock value
	Coppock *string `json:"coppock,omitempty"`
}
...
func NewGetTimeSeriesCoppock200ResponseValuesInner() *GetTimeSeriesCoppock200ResponseValuesInner {
...
func (o *GetTimeSeriesCoppock200ResponseValuesInner) HasDatetime() bool {
	if o != nil && !IsNil(o.Datetime) {
		return true
	}
...
// GetCoppock returns the Coppock field value if set, zero value otherwise.
func (o *GetTimeSeriesCoppock200ResponseValuesInner) GetCoppock() string {
	if o == nil || IsNil(o.Coppock) {
		var ret string
		return ret
	}
	return *o.Coppock
...
// GetCoppockOk returns a tuple with the Coppock field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// HasCoppock returns a boolean if a field has been set.
func (o *GetTimeSeriesCoppock200ResponseValuesInner) HasCoppock() bool {
	if o != nil && !IsNil(o.Coppock) {
		return true
	}
...
// SetCoppock gets a reference to the given string and assigns it to the Coppock field.
