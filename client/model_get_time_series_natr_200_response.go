...
type GetTimeSeriesNatr200Response struct {
	Meta *GetTimeSeriesNatr200ResponseMeta `json:"meta,omitempty"`
	// Array of time series data points
	Values []GetTimeSeriesNatr200ResponseValuesInner `json:"values,omitempty"`
	// Response status
...
// SetMeta gets a reference to the given GetTimeSeriesNatr200ResponseMeta and assigns it to the Meta field.
...
// SetValues gets a reference to the given []GetTimeSeriesNatr200ResponseValuesInner and assigns it to the Values field.
