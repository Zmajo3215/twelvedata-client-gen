...
type InlineObject8 struct {
	Meta *InlineObject8Meta `json:"meta,omitempty"`
	// Array of time series data points
	Values []InlineObject8ValuesInner `json:"values,omitempty"`
	// Response status
...
// SetMeta gets a reference to the given InlineObject8Meta and assigns it to the Meta field.
...
// SetValues gets a reference to the given []InlineObject8ValuesInner and assigns it to the Values field.
