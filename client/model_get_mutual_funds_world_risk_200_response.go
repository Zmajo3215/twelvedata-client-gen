...
type GetMutualFundsWorldRisk200Response struct {
	MutualFund *GetMutualFundsWorldRisk200ResponseMutualFund `json:"mutual_fund,omitempty"`
...
func NewGetMutualFundsWorldRisk200Response() *GetMutualFundsWorldRisk200Response {
...
func (o *GetMutualFundsWorldRisk200Response) HasMutualFund() bool {
	if o != nil && !IsNil(o.MutualFund) {
		return true
	}
...
// SetMutualFund gets a reference to the given GetMutualFundsWorldRisk200ResponseMutualFund and assigns it to the MutualFund field.
...
func (o *GetMutualFundsWorldRisk200Response) HasStatus() bool {
	if o != nil && !IsNil(o.Status) {
		return true
	}
