...
type InlineObject9Meta struct {
	...
	Indicator *InlineObject9MetaIndicator `json:"indicator,omitempty"`
}
...
func NewInlineObject9Meta() *InlineObject9Meta {
...
func (o *InlineObject9Meta) HasSymbol() bool {
	if o != nil && !IsNil(o.Symbol) {
		return true
	}
...
func (o *InlineObject9Meta) HasInterval() bool {
	if o != nil && !IsNil(o.Interval) {
		return true
	}
...
func (o *InlineObject9Meta) HasCurrency() bool {
	if o != nil && !IsNil(o.Currency) {
		return true
	}
...
func (o *InlineObject9Meta) HasExchangeTimezone() bool {
	if o != nil && !IsNil(o.ExchangeTimezone) {
		return true
	}
...
func (o *InlineObject9Meta) HasExchange() bool {
	if o != nil && !IsNil(o.Exchange) {
		return true
	}
...
func (o *InlineObject9Meta) HasMicCode() bool {
	if o != nil && !IsNil(o.MicCode) {
		return true
	}
...
func (o *InlineObject9Meta) HasType() bool {
	if o != nil && !IsNil(o.Type) {
		return true
	}
...
func (o *InlineObject9Meta) HasIndicator() bool {
	if o != nil && !IsNil(o.Indicator) {
		return true
	}
...
// SetIndicator gets a reference to the given InlineObject9MetaIndicator and assigns it to the Indicator field.
