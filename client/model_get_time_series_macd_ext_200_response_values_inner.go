...
func NewGetTimeSeriesMacdExt200ResponseValuesInner() *GetTimeSeriesMacdExt200ResponseValuesInner {
...
func (o *GetTimeSeriesMacdExt200ResponseValuesInner) HasDatetime() bool {
	if o != nil && !IsNil(o.Datetime) {
		return true
	}
...
func (o *GetTimeSeriesMacdExt200ResponseValuesInner) HasMacd() bool {
	if o != nil && !IsNil(o.Macd) {
		return true
	}
...
// SetMacd gets a reference to the given string and assigns it to the Macd field.
func (o *GetTimeSeriesMacdExt200ResponseValuesInner) SetMacd(v string) {
	o.Macd = &v
}

// GetMacdSignal returns the MacdSignal field value if set, zero value otherwise.
func (o *GetTimeSeriesMacdExt200ResponseValuesInner) GetMacdSignal() string {
	if o == nil || IsNil(o.MacdSignal) {
		var ret string
		return ret
	}
	return *o.MacdSignal
...
// GetMacdSignalOk returns a tuple with the MacdSignal field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
func (o *GetTimeSeriesMacdExt200ResponseValuesInner) HasMacdSignal() bool {
	if o != nil && !IsNil(o.MacdSignal) {
		return true
	}
...
// SetMacdSignal gets a reference to the given string and assigns it to the MacdSignal field.
func (o *GetTimeSeriesMacdExt200ResponseValuesInner) SetMacdSignal(v string) {
	o.MacdSignal = &v
}

// GetMacdHist returns the MacdHist field value if set, zero value otherwise.
func (o *GetTimeSeriesMacdExt200ResponseValuesInner) GetMacdHist() string {
	if o == nil || IsNil(o.MacdHist) {
		var ret string
		return ret
	}
	return *o.MacdHist
...
// GetMacdHistOk returns a tuple with the MacdHist field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
func (o *GetTimeSeriesMacdExt200ResponseValuesInner) HasMacdHist() bool {
	if o != nil && !IsNil(o.MacdHist) {
		return true
	}
...
// SetMacdHist gets a reference to the given string and assigns it to the MacdHist field.
