...
// checks if the GetTimeSeriesRocr200ResponseMeta type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetTimeSeriesRocr200ResponseMeta{}

// GetTimeSeriesRocr200ResponseMeta Json object with request general information
type GetTimeSeriesRocr200ResponseMeta struct {
	...
	Indicator *GetTimeSeriesRocr200ResponseMetaIndicator `json:"indicator,omitempty"`
}
...
func NewGetTimeSeriesRocr200ResponseMeta() *GetTimeSeriesRocr200ResponseMeta {
	this := GetTimeSeriesRocr200ResponseMeta{}
	return &this
}
...
func (o *GetTimeSeriesRocr200ResponseMeta) GetIndicator() GetTimeSeriesRocr200ResponseMetaIndicator {
	if o == nil || IsNil(o.Indicator) {
		var ret GetTimeSeriesRocr200ResponseMetaIndicator
		return ret
	}
	return *o.Indicator
}
...
// SetIndicator gets a reference to the given GetTimeSeriesRocr200ResponseMetaIndicator and assigns it to the Indicator field.
func (o *GetTimeSeriesRocr200ResponseMeta) SetIndicator(v GetTimeSeriesRocr200ResponseMetaIndicator) {
	o.Indicator = &v
}

func (o GetTimeSeriesRocr200ResponseMeta) MarshalJSON() ([]byte, error) {
...
func (o GetTimeSeriesRocr200ResponseMeta) ToMap() (map[string]interface{}, error) {
...
type NullableGetTimeSeriesRocr200ResponseMeta struct {
	value *GetTimeSeriesRocr200ResponseMeta
	isSet bool
}

func (v NullableGetTimeSeriesRocr200ResponseMeta) Get() *GetTimeSeriesRocr200ResponseMeta {
	return v.value
}

func (v *NullableGetTimeSeriesRocr200ResponseMeta) Set(val *GetTimeSeriesRocr200ResponseMeta) {
	v.value = val
	v.isSet = true
}

func (v NullableGetTimeSeriesRocr200ResponseMeta) IsSet() bool {
	return v.isSet
}

func (v *NullableGetTimeSeriesRocr200ResponseMeta) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetTimeSeriesRocr200ResponseMeta(val *GetTimeSeriesRocr200ResponseMeta) *NullableGetTimeSeriesRocr200ResponseMeta {
	return &NullableGetTimeSeriesRocr200ResponseMeta{value: val, isSet: true}
}

func (v NullableGetTimeSeriesRocr200ResponseMeta) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetTimeSeriesRocr200ResponseMeta) UnmarshalJSON(src []byte) error {
	v.isSet = true
