...
func NewGetEdgarFilingsArchive200ResponseMeta() *GetEdgarFilingsArchive200ResponseMeta {
...
func (o *GetEdgarFilingsArchive200ResponseMeta) HasSymbol() bool {
	if o != nil && !IsNil(o.Symbol) {
		return true
	}
...
func (o *GetEdgarFilingsArchive200ResponseMeta) HasExchange() bool {
	if o != nil && !IsNil(o.Exchange) {
		return true
	}
...
func (o *GetEdgarFilingsArchive200ResponseMeta) HasMicCode() bool {
	if o != nil && !IsNil(o.MicCode) {
		return true
	}
...
func (o *GetEdgarFilingsArchive200ResponseMeta) HasType() bool {
	if o != nil && !IsNil(o.Type) {
		return true
	}
