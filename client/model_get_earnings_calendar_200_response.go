...
type GetEarningsCalendar200Response struct {
	...
	Earnings map[string][]GetEarningsCalendar200ResponseEarningsValueInner `json:"earnings,omitempty"`
	// Response status
...
// SetEarnings gets a reference to the given map[string][]GetEarningsCalendar200ResponseEarningsValueInner and assigns it to the Earnings field.
