...
type InlineObject15ValuesInner struct {
	...
	// SINH value
	Sinh *string `json:"sinh,omitempty"`
}
...
func NewInlineObject15ValuesInner() *InlineObject15ValuesInner {
...
func (o *InlineObject15ValuesInner) HasDatetime() bool {
	if o != nil && !IsNil(o.Datetime) {
		return true
	}
...
// GetSinh returns the Sinh field value if set, zero value otherwise.
func (o *InlineObject15ValuesInner) GetSinh() string {
	if o == nil || IsNil(o.Sinh) {
		var ret string
		return ret
	}
	return *o.Sinh
...
// GetSinhOk returns a tuple with the Sinh field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// HasSinh returns a boolean if a field has been set.
func (o *InlineObject15ValuesInner) HasSinh() bool {
	if o != nil && !IsNil(o.Sinh) {
		return true
	}
...
// SetSinh gets a reference to the given string and assigns it to the Sinh field.
