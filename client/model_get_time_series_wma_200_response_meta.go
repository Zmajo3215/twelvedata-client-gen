...
// checks if the GetTimeSeriesWma200ResponseMeta type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetTimeSeriesWma200ResponseMeta{}

// GetTimeSeriesWma200ResponseMeta Json object with request general information
type GetTimeSeriesWma200ResponseMeta struct {
	...
	Indicator *GetTimeSeriesWma200ResponseMetaIndicator `json:"indicator,omitempty"`
}
...
func NewGetTimeSeriesWma200ResponseMeta() *GetTimeSeriesWma200ResponseMeta {
	this := GetTimeSeriesWma200ResponseMeta{}
	return &this
}
...
func (o *GetTimeSeriesWma200ResponseMeta) GetIndicator() GetTimeSeriesWma200ResponseMetaIndicator {
	if o == nil || IsNil(o.Indicator) {
		var ret GetTimeSeriesWma200ResponseMetaIndicator
		return ret
	}
	return *o.Indicator
}
...
// SetIndicator gets a reference to the given GetTimeSeriesWma200ResponseMetaIndicator and assigns it to the Indicator field.
func (o *GetTimeSeriesWma200ResponseMeta) SetIndicator(v GetTimeSeriesWma200ResponseMetaIndicator) {
	o.Indicator = &v
}

func (o GetTimeSeriesWma200ResponseMeta) MarshalJSON() ([]byte, error) {
...
func (o GetTimeSeriesWma200ResponseMeta) ToMap() (map[string]interface{}, error) {
...
type NullableGetTimeSeriesWma200ResponseMeta struct {
	value *GetTimeSeriesWma200ResponseMeta
	isSet bool
}

func (v NullableGetTimeSeriesWma200ResponseMeta) Get() *GetTimeSeriesWma200ResponseMeta {
	return v.value
}

func (v *NullableGetTimeSeriesWma200ResponseMeta) Set(val *GetTimeSeriesWma200ResponseMeta) {
	v.value = val
	v.isSet = true
}

func (v NullableGetTimeSeriesWma200ResponseMeta) IsSet() bool {
	return v.isSet
}

func (v *NullableGetTimeSeriesWma200ResponseMeta) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetTimeSeriesWma200ResponseMeta(val *GetTimeSeriesWma200ResponseMeta) *NullableGetTimeSeriesWma200ResponseMeta {
	return &NullableGetTimeSeriesWma200ResponseMeta{value: val, isSet: true}
}

func (v NullableGetTimeSeriesWma200ResponseMeta) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetTimeSeriesWma200ResponseMeta) UnmarshalJSON(src []byte) error {
	v.isSet = true
