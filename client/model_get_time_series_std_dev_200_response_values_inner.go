...
func NewGetTimeSeriesStdDev200ResponseValuesInner() *GetTimeSeriesStdDev200ResponseValuesInner {
...
func (o *GetTimeSeriesStdDev200ResponseValuesInner) HasDatetime() bool {
	if o != nil && !IsNil(o.Datetime) {
		return true
	}
...
func (o *GetTimeSeriesStdDev200ResponseValuesInner) HasStddev() bool {
	if o != nil && !IsNil(o.Stddev) {
		return true
	}
...
// SetStddev gets a reference to the given string and assigns it to the Stddev field.
