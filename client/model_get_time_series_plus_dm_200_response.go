...
type GetTimeSeriesPlusDM200Response struct {
	Meta *GetTimeSeriesPlusDM200ResponseMeta `json:"meta,omitempty"`
	// Array of time series data points
	Values []GetTimeSeriesPlusDM200ResponseValuesInner `json:"values,omitempty"`
	// Response status
...
// SetMeta gets a reference to the given GetTimeSeriesPlusDM200ResponseMeta and assigns it to the Meta field.
...
// SetValues gets a reference to the given []GetTimeSeriesPlusDM200ResponseValuesInner and assigns it to the Values field.
