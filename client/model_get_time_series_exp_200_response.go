...
type GetTimeSeriesExp200Response struct {
	Meta *GetTimeSeriesExp200ResponseMeta `json:"meta,omitempty"`
	// Array of time series data points
	Values []GetTimeSeriesExp200ResponseValuesInner `json:"values,omitempty"`
	// Response status
...
func NewGetTimeSeriesExp200Response() *GetTimeSeriesExp200Response {
...
func (o *GetTimeSeriesExp200Response) HasMeta() bool {
	if o != nil && !IsNil(o.Meta) {
		return true
	}
...
// SetMeta gets a reference to the given GetTimeSeriesExp200ResponseMeta and assigns it to the Meta field.
...
func (o *GetTimeSeriesExp200Response) HasValues() bool {
	if o != nil && !IsNil(o.Values) {
		return true
	}
...
// SetValues gets a reference to the given []GetTimeSeriesExp200ResponseValuesInner and assigns it to the Values field.
...
func (o *GetTimeSeriesExp200Response) HasStatus() bool {
	if o != nil && !IsNil(o.Status) {
		return true
	}
