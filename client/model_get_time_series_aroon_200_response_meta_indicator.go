...
func NewGetTimeSeriesAroon200ResponseMetaIndicator() *GetTimeSeriesAroon200ResponseMetaIndicator {
...
func (o *GetTimeSeriesAroon200ResponseMetaIndicator) HasName() bool {
	if o != nil && !IsNil(o.Name) {
		return true
	}
...
func (o *GetTimeSeriesAroon200ResponseMetaIndicator) HasTimePeriod() bool {
	if o != nil && !IsNil(o.TimePeriod) {
		return true
	}
