...
type GetIncomeStatement200Response struct {
	Meta *GetIncomeStatement200ResponseMeta `json:"meta,omitempty"`
...
func NewGetIncomeStatement200Response() *GetIncomeStatement200Response {
...
func (o *GetIncomeStatement200Response) HasMeta() bool {
	if o != nil && !IsNil(o.Meta) {
		return true
	}
...
// SetMeta gets a reference to the given GetIncomeStatement200ResponseMeta and assigns it to the Meta field.
