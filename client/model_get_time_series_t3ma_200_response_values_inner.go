...
type GetTimeSeriesT3ma200ResponseValuesInner struct {
	...
	// T3MA value
	T3ma *string `json:"t3ma,omitempty"`
}
...
// GetT3ma returns the T3ma field value if set, zero value otherwise.
func (o *GetTimeSeriesT3ma200ResponseValuesInner) GetT3ma() string {
	if o == nil || IsNil(o.T3ma) {
		var ret string
		return ret
	}
	return *o.T3ma
...
// GetT3maOk returns a tuple with the T3ma field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// SetT3ma gets a reference to the given string and assigns it to the T3ma field.
