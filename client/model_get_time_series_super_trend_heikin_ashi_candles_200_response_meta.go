...
// checks if the GetTimeSeriesSuperTrendHeikinAshiCandles200ResponseMeta type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetTimeSeriesSuperTrendHeikinAshiCandles200ResponseMeta{}

// GetTimeSeriesSuperTrendHeikinAshiCandles200ResponseMeta Json object with request general information
type GetTimeSeriesSuperTrendHeikinAshiCandles200ResponseMeta struct {
	...
	Indicator *GetTimeSeriesSuperTrendHeikinAshiCandles200ResponseMetaIndicator `json:"indicator,omitempty"`
}
...
func NewGetTimeSeriesSuperTrendHeikinAshiCandles200ResponseMeta() *GetTimeSeriesSuperTrendHeikinAshiCandles200ResponseMeta {
	this := GetTimeSeriesSuperTrendHeikinAshiCandles200ResponseMeta{}
	return &this
}
...
func (o *GetTimeSeriesSuperTrendHeikinAshiCandles200ResponseMeta) HasSymbol() bool {
	if o != nil && !IsNil(o.Symbol) {
		return true
	}
...
func (o *GetTimeSeriesSuperTrendHeikinAshiCandles200ResponseMeta) HasInterval() bool {
	if o != nil && !IsNil(o.Interval) {
		return true
	}
...
func (o *GetTimeSeriesSuperTrendHeikinAshiCandles200ResponseMeta) HasCurrency() bool {
	if o != nil && !IsNil(o.Currency) {
		return true
	}
...
func (o *GetTimeSeriesSuperTrendHeikinAshiCandles200ResponseMeta) HasExchangeTimezone() bool {
	if o != nil && !IsNil(o.ExchangeTimezone) {
		return true
	}
...
func (o *GetTimeSeriesSuperTrendHeikinAshiCandles200ResponseMeta) HasExchange() bool {
	if o != nil && !IsNil(o.Exchange) {
		return true
	}
...
func (o *GetTimeSeriesSuperTrendHeikinAshiCandles200ResponseMeta) HasMicCode() bool {
	if o != nil && !IsNil(o.MicCode) {
		return true
	}
...
func (o *GetTimeSeriesSuperTrendHeikinAshiCandles200ResponseMeta) GetIndicator() GetTimeSeriesSuperTrendHeikinAshiCandles200ResponseMetaIndicator {
	if o == nil || IsNil(o.Indicator) {
		var ret GetTimeSeriesSuperTrendHeikinAshiCandles200ResponseMetaIndicator
		return ret
	}
	return *o.Indicator
}
...
func (o *GetTimeSeriesSuperTrendHeikinAshiCandles200ResponseMeta) HasIndicator() bool {
	if o != nil && !IsNil(o.Indicator) {
		return true
	}
...
// SetIndicator gets a reference to the given GetTimeSeriesSuperTrendHeikinAshiCandles200ResponseMetaIndicator and assigns it to the Indicator field.
...
func (o GetTimeSeriesSuperTrendHeikinAshiCandles200ResponseMeta) MarshalJSON() ([]byte, error) {
...
func (o GetTimeSeriesSuperTrendHeikinAshiCandles200ResponseMeta) ToMap() (map[string]interface{}, error) {
...
type NullableGetTimeSeriesSuperTrendHeikinAshiCandles200ResponseMeta struct {
	value *GetTimeSeriesSuperTrendHeikinAshiCandles200ResponseMeta
	isSet bool
}

func (v NullableGetTimeSeriesSuperTrendHeikinAshiCandles200ResponseMeta) Get() *GetTimeSeriesSuperTrendHeikinAshiCandles200ResponseMeta {
	return v.value
}

func (v *NullableGetTimeSeriesSuperTrendHeikinAshiCandles200ResponseMeta) Set(val *GetTimeSeriesSuperTrendHeikinAshiCandles200ResponseMeta) {
	v.value = val
	v.isSet = true
}

func (v NullableGetTimeSeriesSuperTrendHeikinAshiCandles200ResponseMeta) IsSet() bool {
	return v.isSet
}

func (v *NullableGetTimeSeriesSuperTrendHeikinAshiCandles200ResponseMeta) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetTimeSeriesSuperTrendHeikinAshiCandles200ResponseMeta(val *GetTimeSeriesSuperTrendHeikinAshiCandles200ResponseMeta) *NullableGetTimeSeriesSuperTrendHeikinAshiCandles200ResponseMeta {
	return &NullableGetTimeSeriesSuperTrendHeikinAshiCandles200ResponseMeta{value: val, isSet: true}
}

func (v NullableGetTimeSeriesSuperTrendHeikinAshiCandles200ResponseMeta) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetTimeSeriesSuperTrendHeikinAshiCandles200ResponseMeta) UnmarshalJSON(src []byte) error {
	v.isSet = true
