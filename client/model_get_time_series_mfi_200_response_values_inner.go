...
// GetMfi returns the Mfi field value if set, zero value otherwise.
func (o *GetTimeSeriesMfi200ResponseValuesInner) GetMfi() string {
	if o == nil || IsNil(o.Mfi) {
		var ret string
		return ret
	}
	return *o.Mfi
...
// GetMfiOk returns a tuple with the Mfi field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// SetMfi gets a reference to the given string and assigns it to the Mfi field.
