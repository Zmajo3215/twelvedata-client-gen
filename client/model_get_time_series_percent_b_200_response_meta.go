...
// checks if the GetTimeSeriesPercentB200ResponseMeta type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetTimeSeriesPercentB200ResponseMeta{}

// GetTimeSeriesPercentB200ResponseMeta Json object with request general information
type GetTimeSeriesPercentB200ResponseMeta struct {
	...
	Indicator *GetTimeSeriesPercentB200ResponseMetaIndicator `json:"indicator,omitempty"`
}
...
func NewGetTimeSeriesPercentB200ResponseMeta() *GetTimeSeriesPercentB200ResponseMeta {
	this := GetTimeSeriesPercentB200ResponseMeta{}
	return &this
}
...
func (o *GetTimeSeriesPercentB200ResponseMeta) HasSymbol() bool {
	if o != nil && !IsNil(o.Symbol) {
		return true
	}
...
func (o *GetTimeSeriesPercentB200ResponseMeta) HasInterval() bool {
	if o != nil && !IsNil(o.Interval) {
		return true
	}
...
func (o *GetTimeSeriesPercentB200ResponseMeta) HasCurrency() bool {
	if o != nil && !IsNil(o.Currency) {
		return true
	}
...
func (o *GetTimeSeriesPercentB200ResponseMeta) HasExchangeTimezone() bool {
	if o != nil && !IsNil(o.ExchangeTimezone) {
		return true
	}
...
func (o *GetTimeSeriesPercentB200ResponseMeta) HasExchange() bool {
	if o != nil && !IsNil(o.Exchange) {
		return true
	}
...
func (o *GetTimeSeriesPercentB200ResponseMeta) HasMicCode() bool {
	if o != nil && !IsNil(o.MicCode) {
		return true
	}
...
func (o *GetTimeSeriesPercentB200ResponseMeta) HasType() bool {
	if o != nil && !IsNil(o.Type) {
		return true
	}
...
func (o *GetTimeSeriesPercentB200ResponseMeta) GetIndicator() GetTimeSeriesPercentB200ResponseMetaIndicator {
	if o == nil || IsNil(o.Indicator) {
		var ret GetTimeSeriesPercentB200ResponseMetaIndicator
		return ret
	}
	return *o.Indicator
}
...
func (o *GetTimeSeriesPercentB200ResponseMeta) HasIndicator() bool {
	if o != nil && !IsNil(o.Indicator) {
		return true
	}
...
// SetIndicator gets a reference to the given GetTimeSeriesPercentB200ResponseMetaIndicator and assigns it to the Indicator field.
func (o *GetTimeSeriesPercentB200ResponseMeta) SetIndicator(v GetTimeSeriesPercentB200ResponseMetaIndicator) {
	o.Indicator = &v
}

func (o GetTimeSeriesPercentB200ResponseMeta) MarshalJSON() ([]byte, error) {
...
func (o GetTimeSeriesPercentB200ResponseMeta) ToMap() (map[string]interface{}, error) {
...
type NullableGetTimeSeriesPercentB200ResponseMeta struct {
	value *GetTimeSeriesPercentB200ResponseMeta
	isSet bool
}

func (v NullableGetTimeSeriesPercentB200ResponseMeta) Get() *GetTimeSeriesPercentB200ResponseMeta {
	return v.value
}

func (v *NullableGetTimeSeriesPercentB200ResponseMeta) Set(val *GetTimeSeriesPercentB200ResponseMeta) {
	v.value = val
	v.isSet = true
}

func (v NullableGetTimeSeriesPercentB200ResponseMeta) IsSet() bool {
	return v.isSet
}

func (v *NullableGetTimeSeriesPercentB200ResponseMeta) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetTimeSeriesPercentB200ResponseMeta(val *GetTimeSeriesPercentB200ResponseMeta) *NullableGetTimeSeriesPercentB200ResponseMeta {
	return &NullableGetTimeSeriesPercentB200ResponseMeta{value: val, isSet: true}
}

func (v NullableGetTimeSeriesPercentB200ResponseMeta) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetTimeSeriesPercentB200ResponseMeta) UnmarshalJSON(src []byte) error {
	v.isSet = true
