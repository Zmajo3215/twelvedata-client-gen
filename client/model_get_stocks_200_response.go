...
type GetStocks200Response struct {
	...
	Data []StocksResponseItem `json:"data,omitempty"`
	// Response status
...
func (o *GetStocks200Response) HasData() bool {
	if o != nil && !IsNil(o.Data) {
		return true
	}
...
// SetData gets a reference to the given []StocksResponseItem and assigns it to the Data field.
...
func (o *GetStocks200Response) HasStatus() bool {
	if o != nil && !IsNil(o.Status) {
		return true
	}
