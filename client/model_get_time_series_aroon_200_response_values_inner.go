...
type GetTimeSeriesAroon200ResponseValuesInner struct {
	...
	// Aroon down value
	AroonDown *string `json:"aroon_down,omitempty"`
	// Aroon up value
	AroonUp *string `json:"aroon_up,omitempty"`
}
...
func NewGetTimeSeriesAroon200ResponseValuesInner() *GetTimeSeriesAroon200ResponseValuesInner {
...
func (o *GetTimeSeriesAroon200ResponseValuesInner) HasDatetime() bool {
	if o != nil && !IsNil(o.Datetime) {
		return true
	}
...
// GetAroonDown returns the AroonDown field value if set, zero value otherwise.
func (o *GetTimeSeriesAroon200ResponseValuesInner) GetAroonDown() string {
	if o == nil || IsNil(o.AroonDown) {
		var ret string
		return ret
	}
	return *o.AroonDown
...
// GetAroonDownOk returns a tuple with the AroonDown field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// HasAroonDown returns a boolean if a field has been set.
func (o *GetTimeSeriesAroon200ResponseValuesInner) HasAroonDown() bool {
	if o != nil && !IsNil(o.AroonDown) {
		return true
	}
...
// SetAroonDown gets a reference to the given string and assigns it to the AroonDown field.
func (o *GetTimeSeriesAroon200ResponseValuesInner) SetAroonDown(v string) {
	o.AroonDown = &v
}

// GetAroonUp returns the AroonUp field value if set, zero value otherwise.
func (o *GetTimeSeriesAroon200ResponseValuesInner) GetAroonUp() string {
	if o == nil || IsNil(o.AroonUp) {
		var ret string
		return ret
	}
	return *o.AroonUp
...
// GetAroonUpOk returns a tuple with the AroonUp field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// HasAroonUp returns a boolean if a field has been set.
func (o *GetTimeSeriesAroon200ResponseValuesInner) HasAroonUp() bool {
	if o != nil && !IsNil(o.AroonUp) {
		return true
	}
...
// SetAroonUp gets a reference to the given string and assigns it to the AroonUp field.
