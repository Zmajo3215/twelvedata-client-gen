...
type GetTimeSeriesMom200Response struct {
	Meta *GetTimeSeriesMom200ResponseMeta `json:"meta,omitempty"`
	// Array of time series data points
	Values []GetTimeSeriesMom200ResponseValuesInner `json:"values,omitempty"`
	// Response status
...
func NewGetTimeSeriesMom200Response() *GetTimeSeriesMom200Response {
...
func (o *GetTimeSeriesMom200Response) HasMeta() bool {
	if o != nil && !IsNil(o.Meta) {
		return true
	}
...
// SetMeta gets a reference to the given GetTimeSeriesMom200ResponseMeta and assigns it to the Meta field.
...
func (o *GetTimeSeriesMom200Response) HasValues() bool {
	if o != nil && !IsNil(o.Values) {
		return true
	}
...
// SetValues gets a reference to the given []GetTimeSeriesMom200ResponseValuesInner and assigns it to the Values field.
...
func (o *GetTimeSeriesMom200Response) HasStatus() bool {
	if o != nil && !IsNil(o.Status) {
		return true
	}
