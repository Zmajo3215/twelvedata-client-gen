...
type GetTimeSeriesHtSine200ResponseMeta struct {
	...
	Indicator *GetTimeSeriesHtSine200ResponseMetaIndicator `json:"indicator,omitempty"`
}
...
// SetIndicator gets a reference to the given GetTimeSeriesHtSine200ResponseMetaIndicator and assigns it to the Indicator field.
