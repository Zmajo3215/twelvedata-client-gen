...
type GetTimeSeriesHtDcPeriod200Response struct {
	Meta *GetTimeSeriesHtDcPeriod200ResponseMeta `json:"meta,omitempty"`
	// Array of time series data points
	Values []GetTimeSeriesHtDcPeriod200ResponseValuesInner `json:"values,omitempty"`
	// Response status
...
func NewGetTimeSeriesHtDcPeriod200Response() *GetTimeSeriesHtDcPeriod200Response {
...
func (o *GetTimeSeriesHtDcPeriod200Response) HasMeta() bool {
	if o != nil && !IsNil(o.Meta) {
		return true
	}
...
// SetMeta gets a reference to the given GetTimeSeriesHtDcPeriod200ResponseMeta and assigns it to the Meta field.
...
func (o *GetTimeSeriesHtDcPeriod200Response) HasValues() bool {
	if o != nil && !IsNil(o.Values) {
		return true
	}
...
// SetValues gets a reference to the given []GetTimeSeriesHtDcPeriod200ResponseValuesInner and assigns it to the Values field.
...
func (o *GetTimeSeriesHtDcPeriod200Response) HasStatus() bool {
	if o != nil && !IsNil(o.Status) {
		return true
	}
