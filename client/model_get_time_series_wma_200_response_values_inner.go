...
func NewGetTimeSeriesWma200ResponseValuesInner() *GetTimeSeriesWma200ResponseValuesInner {
...
func (o *GetTimeSeriesWma200ResponseValuesInner) HasDatetime() bool {
	if o != nil && !IsNil(o.Datetime) {
		return true
	}
...
// GetWma returns the Wma field value if set, zero value otherwise.
func (o *GetTimeSeriesWma200ResponseValuesInner) GetWma() string {
	if o == nil || IsNil(o.Wma) {
		var ret string
		return ret
	}
	return *o.Wma
...
// GetWmaOk returns a tuple with the Wma field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// HasWma returns a boolean if a field has been set.
func (o *GetTimeSeriesWma200ResponseValuesInner) HasWma() bool {
	if o != nil && !IsNil(o.Wma) {
		return true
	}
...
// SetWma gets a reference to the given string and assigns it to the Wma field.
