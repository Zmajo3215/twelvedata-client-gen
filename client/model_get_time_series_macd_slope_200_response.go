...
type GetTimeSeriesMacdSlope200Response struct {
	Meta *GetTimeSeriesMacdSlope200ResponseMeta `json:"meta,omitempty"`
	// Array of time series data points
	Values []GetTimeSeriesMacdSlope200ResponseValuesInner `json:"values,omitempty"`
	// Response status
...
// SetMeta gets a reference to the given GetTimeSeriesMacdSlope200ResponseMeta and assigns it to the Meta field.
...
// SetValues gets a reference to the given []GetTimeSeriesMacdSlope200ResponseValuesInner and assigns it to the Values field.
