...
func NewGetEarnings200ResponseMeta() *GetEarnings200ResponseMeta {
...
func (o *GetEarnings200ResponseMeta) HasSymbol() bool {
	if o != nil && !IsNil(o.Symbol) {
		return true
	}
...
func (o *GetEarnings200ResponseMeta) HasName() bool {
	if o != nil && !IsNil(o.Name) {
		return true
	}
...
func (o *GetEarnings200ResponseMeta) HasCurrency() bool {
	if o != nil && !IsNil(o.Currency) {
		return true
	}
...
func (o *GetEarnings200ResponseMeta) HasExchange() bool {
	if o != nil && !IsNil(o.Exchange) {
		return true
	}
...
func (o *GetEarnings200ResponseMeta) HasMicCode() bool {
	if o != nil && !IsNil(o.MicCode) {
		return true
	}
...
func (o *GetEarnings200ResponseMeta) HasExchangeTimezone() bool {
	if o != nil && !IsNil(o.ExchangeTimezone) {
		return true
	}
