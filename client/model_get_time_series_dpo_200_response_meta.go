...
// checks if the GetTimeSeriesDpo200ResponseMeta type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetTimeSeriesDpo200ResponseMeta{}

// GetTimeSeriesDpo200ResponseMeta Json object with request general information
type GetTimeSeriesDpo200ResponseMeta struct {
	...
	Indicator *GetTimeSeriesDpo200ResponseMetaIndicator `json:"indicator,omitempty"`
}
...
func NewGetTimeSeriesDpo200ResponseMeta() *GetTimeSeriesDpo200ResponseMeta {
	this := GetTimeSeriesDpo200ResponseMeta{}
	return &this
}
...
func (o *GetTimeSeriesDpo200ResponseMeta) GetIndicator() GetTimeSeriesDpo200ResponseMetaIndicator {
	if o == nil || IsNil(o.Indicator) {
		var ret GetTimeSeriesDpo200ResponseMetaIndicator
		return ret
	}
	return *o.Indicator
}
...
// SetIndicator gets a reference to the given GetTimeSeriesDpo200ResponseMetaIndicator and assigns it to the Indicator field.
func (o *GetTimeSeriesDpo200ResponseMeta) SetIndicator(v GetTimeSeriesDpo200ResponseMetaIndicator) {
	o.Indicator = &v
}

func (o GetTimeSeriesDpo200ResponseMeta) MarshalJSON() ([]byte, error) {
...
func (o GetTimeSeriesDpo200ResponseMeta) ToMap() (map[string]interface{}, error) {
...
type NullableGetTimeSeriesDpo200ResponseMeta struct {
	value *GetTimeSeriesDpo200ResponseMeta
	isSet bool
}

func (v NullableGetTimeSeriesDpo200ResponseMeta) Get() *GetTimeSeriesDpo200ResponseMeta {
	return v.value
}

func (v *NullableGetTimeSeriesDpo200ResponseMeta) Set(val *GetTimeSeriesDpo200ResponseMeta) {
	v.value = val
	v.isSet = true
}

func (v NullableGetTimeSeriesDpo200ResponseMeta) IsSet() bool {
	return v.isSet
}

func (v *NullableGetTimeSeriesDpo200ResponseMeta) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetTimeSeriesDpo200ResponseMeta(val *GetTimeSeriesDpo200ResponseMeta) *NullableGetTimeSeriesDpo200ResponseMeta {
	return &NullableGetTimeSeriesDpo200ResponseMeta{value: val, isSet: true}
}

func (v NullableGetTimeSeriesDpo200ResponseMeta) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetTimeSeriesDpo200ResponseMeta) UnmarshalJSON(src []byte) error {
	v.isSet = true
