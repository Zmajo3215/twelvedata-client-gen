...
type CryptocurrencyResponseItem struct {
	...
	AvailableExchanges []string `json:"available_exchanges,omitempty"`
...
// GetAvailableExchanges returns the AvailableExchanges field value if set, zero value otherwise.
func (o *CryptocurrencyResponseItem) GetAvailableExchanges() []string {
	if o == nil || IsNil(o.AvailableExchanges) {
		var ret []string
		return ret
	}
...
// GetAvailableExchangesOk returns a tuple with the AvailableExchanges field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// SetAvailableExchanges gets a reference to the given []string and assigns it to the AvailableExchanges field.
func (o *CryptocurrencyResponseItem) SetAvailableExchanges(v []string) {
	o.AvailableExchanges = v
}

// GetCurrencyBase returns the CurrencyBase field value if set, zero value otherwise.
func (o *CryptocurrencyResponseItem) GetCurrencyBase() string {
	if o == nil || IsNil(o.CurrencyBase) {
		var ret string
		return ret
	}
...
// GetCurrencyBaseOk returns a tuple with the CurrencyBase field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// SetCurrencyBase gets a reference to the given string and assigns it to the CurrencyBase field.
func (o *CryptocurrencyResponseItem) SetCurrencyBase(v string) {
	o.CurrencyBase = &v
}

// GetCurrencyQuote returns the CurrencyQuote field value if set, zero value otherwise.
func (o *CryptocurrencyResponseItem) GetCurrencyQuote() string {
	if o == nil || IsNil(o.CurrencyQuote) {
		var ret string
		return ret
	}
...
// GetCurrencyQuoteOk returns a tuple with the CurrencyQuote field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// SetCurrencyQuote gets a reference to the given string and assigns it to the CurrencyQuote field.
