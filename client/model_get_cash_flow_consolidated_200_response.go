...
func NewGetCashFlowConsolidated200Response() *GetCashFlowConsolidated200Response {
...
func (o *GetCashFlowConsolidated200Response) HasCashFlow() bool {
	if o != nil && !IsNil(o.CashFlow) {
		return true
	}
...
// SetCashFlow gets a reference to the given []CashFlowData and assigns it to the CashFlow field.
