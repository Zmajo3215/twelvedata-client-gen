...
type GetSourceSanctionedEntities200Response struct {
	...
	Sanctions []ResponseSanctionedEntitiy `json:"sanctions,omitempty"`
...
// SetSanctions gets a reference to the given []ResponseSanctionedEntitiy and assigns it to the Sanctions field.
