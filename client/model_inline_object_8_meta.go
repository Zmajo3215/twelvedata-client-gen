...
// checks if the InlineObject8Meta type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &InlineObject8Meta{}

// InlineObject8Meta Json object with request general information
type InlineObject8Meta struct {
	...
	Indicator *InlineObject8MetaIndicator `json:"indicator,omitempty"`
}
...
func (o *InlineObject8Meta) GetIndicator() InlineObject8MetaIndicator {
	if o == nil || IsNil(o.Indicator) {
		var ret InlineObject8MetaIndicator
		return ret
	}
	return *o.Indicator
}
...
// SetIndicator gets a reference to the given InlineObject8MetaIndicator and assigns it to the Indicator field.
func (o *InlineObject8Meta) SetIndicator(v InlineObject8MetaIndicator) {
	o.Indicator = &v
}

func (o InlineObject8Meta) MarshalJSON() ([]byte, error) {
...
func (o InlineObject8Meta) ToMap() (map[string]interface{}, error) {
...
type NullableInlineObject8Meta struct {
	value *InlineObject8Meta
	isSet bool
}

func (v NullableInlineObject8Meta) Get() *InlineObject8Meta {
	return v.value
}

func (v *NullableInlineObject8Meta) Set(val *InlineObject8Meta) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject8Meta) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject8Meta) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject8Meta(val *InlineObject8Meta) *NullableInlineObject8Meta {
	return &NullableInlineObject8Meta{value: val, isSet: true}
}

func (v NullableInlineObject8Meta) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject8Meta) UnmarshalJSON(src []byte) error {
	v.isSet = true
